                ...
                if(detik.equals("01")&&((nilai_menit%10)==0)){
                    ...
                    try {
                        ...
                        ps=koneksi.prepareStatement(
                                "SELECT referensi_mobilejkn_bpjs2.nobooking,referensi_mobilejkn_bpjs2.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,referensi_mobilejkn_bpjs2.nohp,referensi_mobilejkn_bpjs2.nomorkartu,"+
                                "referensi_mobilejkn_bpjs2.nik,referensi_mobilejkn_bpjs2.tanggalperiksa,poliklinik.nm_poli,dokter.nm_dokter,referensi_mobilejkn_bpjs2.jampraktek,"+
                                "referensi_mobilejkn_bpjs2.jeniskunjungan,referensi_mobilejkn_bpjs2.nomorreferensi,referensi_mobilejkn_bpjs2.status,referensi_mobilejkn_bpjs2.validasi,"+
                                "referensi_mobilejkn_bpjs2.kodepoli,referensi_mobilejkn_bpjs2.pasienbaru,referensi_mobilejkn_bpjs2.kodedokter,referensi_mobilejkn_bpjs2.jampraktek,"+
                                "referensi_mobilejkn_bpjs2.nomorantrean,referensi_mobilejkn_bpjs2.angkaantrean,referensi_mobilejkn_bpjs2.estimasidilayani,referensi_mobilejkn_bpjs2.sisakuotajkn,"+
                                "referensi_mobilejkn_bpjs2.kuotajkn,referensi_mobilejkn_bpjs2.sisakuotanonjkn,referensi_mobilejkn_bpjs2.kuotanonjkn "+
                                "FROM referensi_mobilejkn_bpjs2 INNER JOIN reg_periksa ON referensi_mobilejkn_bpjs2.no_rawat=reg_periksa.no_rawat "+
                                "INNER JOIN pasien ON reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                                "INNER JOIN poliklinik ON reg_periksa.kd_poli=poliklinik.kd_poli "+
                                "INNER JOIN dokter ON reg_periksa.kd_dokter=dokter.kd_dokter "+
                                "WHERE referensi_mobilejkn_bpjs2.statuskirim='Belum' and referensi_mobilejkn_bpjs2.tanggalperiksa between "+(Tanggal1.getText().equals(Tanggal2.getText())?"SUBDATE('"+Tanggal2.getText()+"',INTERVAL 6 DAY) and '"+Tanggal2.getText()+"'":"'"+Tanggal1.getText()+"' and '"+Tanggal2.getText()+"'")+
                                "order by referensi_mobilejkn_bpjs2.tanggalperiksa");
                        try {
                            rs=ps.executeQuery();
                            while(rs.next()){
                                try {     
                                    ...
                                    if(nameNode.path("code").asText().equals("200")||nameNode.path("code").asText().equals("208")||nameNode.path("message").asText().equals("Ok")){
                                        Sequel.queryu2("update referensi_mobilejkn_bpjs2 set statuskirim='Sudah' where nobooking='"+rs.getString("nobooking")+"'");
                                    }  
                        ...
                        ps=koneksi.prepareStatement(
                                "SELECT * FROM referensi_mobilejkn_bpjs2_batal where referensi_mobilejkn_bpjs2_batal.statuskirim='Belum' and referensi_mobilejkn_bpjs2_batal.tanggalbatal between "+(Tanggal1.getText().equals(Tanggal2.getText())?"SUBDATE('"+Tanggal2.getText()+"',INTERVAL 6 DAY) and '"+Tanggal2.getText()+"'":"'"+Tanggal1.getText()+"' and '"+Tanggal2.getText()+"'"));
                        try {
                            rs=ps.executeQuery();
                            while(rs.next()){
                                try {     
                                    ...
                                    if(nameNode.path("code").asText().equals("200")){
                                        Sequel.queryu2("update referensi_mobilejkn_bpjs2_batal set statuskirim='Sudah' where nomorreferensi='"+rs.getString("nomorreferensi")+"'");
                                        datajam=rs.getString("tanggalbatal");
                                        if(!datajam.equals("")){
                                            if(Sequel.menyimpantf2("referensi_mobilejkn_bpjs2_taskid","?,?,?","task id",3,new String[]{rs.getString("no_rawat"),"99",datajam})==true){
                                                ...
                                                try {     
                                                    ...
                                                    nameNode = root.path("metadata");
                                                    if(!nameNode.path("code").asText().equals("200")){
                                                        Sequel.queryu2("delete from referensi_mobilejkn_bpjs2_taskid where taskid='99' and no_rawat='"+rs.getString("no_rawat")+"'");
                                                    }  
                                                    TeksArea.append("respon WS BPJS : "+nameNode.path("code").asText()+" "+nameNode.path("message").asText()+"\n");
                                                }catch (Exception ex) {
                                                    System.out.println("Notifikasi Bridging : "+ex);
                        ...
                        ps=koneksi.prepareStatement(
                                ...
                                "INNER JOIN poliklinik ON reg_periksa.kd_poli=poliklinik.kd_poli "+
                                "INNER JOIN dokter ON reg_periksa.kd_dokter=dokter.kd_dokter "+
                                "WHERE referensi_mobilejkn_bpjs2.statuskirim='Sudah' and referensi_mobilejkn_bpjs2.tanggalperiksa between '"+Tanggal1.getText()+"' and '"+Tanggal2.getText()+"' "+
                                "order by referensi_mobilejkn_bpjs2.tanggalperiksa");
                        try {
                            rs=ps.executeQuery();
                            while(rs.next()){
                                datajam=Sequel.cariIsi("select mutasi_berkas2.dikirim from mutasi_berkas2 where mutasi_berkas2.no_rawat=? and mutasi_berkas2.dikirim<>'0000-00-00 00:00:00'",rs.getString("no_rawat"));
                                if(!datajam.equals("")){
                                    if(Sequel.menyimpantf2("referensi_mobilejkn_bpjs2_taskid","?,?,?","task id",3,new String[]{rs.getString("no_rawat"),"3",datajam})==true){
                                        parsedDate = dateFormat.parse(datajam);
                                        try {     
                                            ...
                                            nameNode = root.path("metadata");
                                            if(!nameNode.path("code").asText().equals("200")){
                                                Sequel.queryu2("delete from referensi_mobilejkn_bpjs2_taskid where taskid='3' and no_rawat='"+rs.getString("no_rawat")+"'");
                                            }  
                                            TeksArea.append("respon WS BPJS : "+nameNode.path("code").asText()+" "+nameNode.path("message").asText()+"\n");
                                        }catch (Exception ex) {
                                            System.out.println("Notifikasi Bridging : "+ex);
                                ...
                                datajam=Sequel.cariIsi("select mutasi_berkas2.diterima from mutasi_berkas2 where mutasi_berkas2.no_rawat=? and mutasi_berkas2.diterima<>'0000-00-00 00:00:00'",rs.getString("no_rawat"));
                                if(!datajam.equals("")){
                                    if(Sequel.menyimpantf2("referensi_mobilejkn_bpjs2_taskid","?,?,?","task id",3,new String[]{rs.getString("no_rawat"),"4",datajam})==true){
                                        parsedDate = dateFormat.parse(datajam);
                                        try {     
                                            ...
                                            nameNode = root.path("metadata");
                                            if(!nameNode.path("code").asText().equals("200")){
                                                Sequel.queryu2("delete from referensi_mobilejkn_bpjs2_taskid where taskid='4' and no_rawat='"+rs.getString("no_rawat")+"'");
                                            }   
                                            TeksArea.append("respon WS BPJS : "+nameNode.path("code").asText()+" "+nameNode.path("message").asText()+"\n");
                                        }catch (Exception ex) {
                                            System.out.println("Notifikasi Bridging : "+ex);
                                ...
                                datajam=Sequel.cariIsi("select concat(pemeriksaan_ralan2.tgl_perawatan,' ',pemeriksaan_ralan2.jam_rawat) from pemeriksaan_ralan2 where pemeriksaan_ralan2.no_rawat=?",rs.getString("no_rawat"));
                                if(!datajam.equals("")){
                                    if(Sequel.menyimpantf2("referensi_mobilejkn_bpjs2_taskid","?,?,?","task id",3,new String[]{rs.getString("no_rawat"),"5",datajam})==true){
                                        parsedDate = dateFormat.parse(datajam);
                                        try {     
                                            ...
                                            nameNode = root.path("metadata");
                                            if(!nameNode.path("code").asText().equals("200")){
                                                Sequel.queryu2("delete from referensi_mobilejkn_bpjs2_taskid where taskid='5' and no_rawat='"+rs.getString("no_rawat")+"'");
                                            }  
                                            TeksArea.append("respon WS BPJS : "+nameNode.path("code").asText()+" "+nameNode.path("message").asText()+"\n");
                                        }catch (Exception ex) {
                                            System.out.println("Notifikasi Bridging : "+ex);
                                ...
                                noresep=Sequel.cariIsi("select resep_obat2.no_resep from resep_obat2 where resep_obat2.no_rawat=?",rs.getString("no_rawat"));
                                if(!noresep.equals("")){
                                    try {     
                                ...
                                datajam=Sequel.cariIsi("select concat(resep_obat2.tgl_perawatan,' ',resep_obat2.jam) from resep_obat2 where resep_obat2.tgl_perawatan<>'0000-00-00' and resep_obat2.status='ralan' and resep_obat2.no_rawat=?",rs.getString("no_rawat"));
                                if(!datajam.equals("")){
                                    if(Sequel.menyimpantf2("referensi_mobilejkn_bpjs2_taskid","?,?,?","task id",3,new String[]{rs.getString("no_rawat"),"6",datajam})==true){
                                        parsedDate = dateFormat.parse(datajam);
                                        try {     
                                            ...
                                            nameNode = root.path("metadata");
                                            if(!nameNode.path("code").asText().equals("200")){
                                                Sequel.queryu2("delete from referensi_mobilejkn_bpjs2_taskid where taskid='6' and no_rawat='"+rs.getString("no_rawat")+"'");
                                            }  
                                            TeksArea.append("respon WS BPJS : "+nameNode.path("code").asText()+" "+nameNode.path("message").asText()+"\n");
                                        }catch (Exception ex) {
                                            System.out.println("Notifikasi Bridging : "+ex);
                                ...
                                datajam=Sequel.cariIsi("select concat(resep_obat2.tgl_penyerahan,' ',resep_obat2.jam_penyerahan) from resep_obat2 where resep_obat2.status='ralan' and resep_obat2.no_rawat=? and concat(resep_obat2.tgl_penyerahan,' ',resep_obat2.jam_penyerahan)<>'0000-00-00 00:00:00'",rs.getString("no_rawat"));
                                if(!datajam.equals("")){
                                    if(Sequel.menyimpantf2("referensi_mobilejkn_bpjs2_taskid","?,?,?","task id",3,new String[]{rs.getString("no_rawat"),"7",datajam})==true){
                                        parsedDate = dateFormat.parse(datajam);
                                        try {     
                                            ...
                                            nameNode = root.path("metadata");
                                            if(!nameNode.path("code").asText().equals("200")){
                                                Sequel.queryu2("delete from referensi_mobilejkn_bpjs2_taskid where taskid='7' and no_rawat='"+rs.getString("no_rawat")+"'");
                                            }  
                                            TeksArea.append("respon WS BPJS : "+nameNode.path("code").asText()+" "+nameNode.path("message").asText()+"\n");
                                        }catch (Exception ex) {
                                            System.out.println("Notifikasi Bridging : "+ex);
                        ...
                        ps=koneksi.prepareStatement(
                                ...
                                "and reg_periksa.no_rawat not in (select referensi_mobilejkn_bpjs2.no_rawat from referensi_mobilejkn_bpjs2 where referensi_mobilejkn_bpjs2.tanggalperiksa between '"+Tanggal1.getText()+"' and '"+Tanggal2.getText()+"') "+

...
public class RMPenilaianAwalMedisRanapAnak1 extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(BorderFactory.createTitledBorder("::[ Penilaian Awal Medis Rawat Inap Anak ]::"));
        ...
        DTPCari1 = new Tanggal(); DTPCari1.setForeground(new Color(50, 50, 50)); DTPCari1.setPreferredSize(new Dimension(90, 23));
        jLabel21 = new Label(); jLabel21.setText("s.d."); jLabel21.setPreferredSize(new Dimension(23, 23));
        DTPCari2 = new Tanggal(); DTPCari2.setForeground(new Color(50, 50, 50)); DTPCari2.setPreferredSize(new Dimension(90, 23));
    ...
    public void isCek() {
        ...
        BtnPrint.setEnabled(akses.getpenilaian_awal_medis_ranap());
    }
...
with open("src/rekammedis/RMPenilaianAwalMedisRanapAnak1.java", "w") as f:
    f.write(java_code)

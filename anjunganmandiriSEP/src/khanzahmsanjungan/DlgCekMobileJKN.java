 ...
 * @author Kode
 */
public class DlgCekMobileJKN extends javax.swing.JDialog {
    ...
    private String status = "Baru", BASENOREG = "", URUTNOREG = "", aktifjadwal = "",norawat="",norm="";
     ...
     * @param id
     */
    public DlgCekMobileJKN(java.awt.Frame parent, boolean id) {
        super(parent, id);
        initComponents();
    ...
    private void initComponents() {
        ...
        NoBooking = new component.TextBox();
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 215, 255)), "::[ Cek Booking Mobile JKN!!! ]::", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Poppins", 0, 24), new java.awt.Color(0, 131, 62))); // NOI18N
        jPanel1.setForeground(new java.awt.Color(0, 131, 62));
        jPanel1.setPreferredSize(new java.awt.Dimension(400, 70));
        jPanel1.setLayout(new java.awt.GridBagLayout());

        NoBooking.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 131, 62), 2, true));
        NoBooking.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        NoBooking.setFont(new java.awt.Font("Poppins", 0, 24)); // NOI18N
        NoBooking.setPreferredSize(new java.awt.Dimension(350, 75));
        NoBooking.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                NoBookingActionPerformed(evt);
            }
        });
        ...
        jPanel1.add(NoBooking, gridBagConstraints);
    ...
    private void NoBookingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NoBookingActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_NoBookingActionPerformed

    private void NoBookingKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NoBookingKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (Sequel.cariInteger("select count(bridging_surat_kontrol_bpjs.no_surat) from bridging_surat_kontrol_bpjs where bridging_surat_kontrol_bpjs.no_surat='" + NoBooking.getText() + "'") > 0) {
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                DlgRegistrasiSEPPertama form = new DlgRegistrasiSEPPertama(null, true);
                form.tampilKontrol(NoBooking.getText());
    ...
    private void BtnClose2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnClose2ActionPerformed
        if (Sequel.cariInteger("select count(referensi_mobilejkn_bpjs.nobooking) from referensi_mobilejkn_bpjs where referensi_mobilejkn_bpjs.nobooking='" + NoBooking.getText() + "'") > 0) {
            norawat=Sequel.cariIsi("select referensi_mobilejkn_bpjs.no_rawat from referensi_mobilejkn_bpjs where referensi_mobilejkn_bpjs.nobooking='" + NoBooking.getText() + "'");
            norm=Sequel.cariIsi("select referensi_mobilejkn_bpjs.norm from referensi_mobilejkn_bpjs where referensi_mobilejkn_bpjs.nobooking='" + NoBooking.getText() + "'");
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            DlgRegistrasiSEPPertamaJKN form = new DlgRegistrasiSEPPertamaJKN(null, true);
            form.tampilKontrol(NoBooking.getText());
            form.setSize(this.getWidth(), this.getHeight());
            form.setLocationRelativeTo(jPanel1);
            this.dispose();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCekMobileJKN dialog = new DlgCekMobileJKN(new javax.swing.JFrame(), true);
    ...
    private component.TextBox NoBooking;

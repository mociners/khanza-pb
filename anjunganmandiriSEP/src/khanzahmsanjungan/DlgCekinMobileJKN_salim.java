 ...
 * @author Kode
 */
public class DlgCekinMobileJKN_salim extends javax.swing.JDialog {
     ...
     * @param id
     */
    public DlgCekinMobileJKN_salim(java.awt.Frame parent, boolean id) {
        super(parent, id);
        initComponents();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCekinMobileJKN_salim dialog = new DlgCekinMobileJKN_salim(new javax.swing.JFrame(), true);

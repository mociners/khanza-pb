...
import bridging.OrthancDlgSetRadiologiModalities;
...
public class DlgCariPermintaanRadiologi extends javax.swing.JDialog {
    ...
    private Connection koneksi2=koneksiDBJii.condb();
    ...
    private String alarm="",formalarm="",nol_detik,detik,tglsampel="",tglhasil="",norm="",kamar="",namakamar="",
            ...
            InformasiTambahan="",Klinis="",finger="",Modality="",Hamil="",ACSN="",requestJson="";
    ...
    public DlgCariPermintaanRadiologi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Permintaan","No.Rawat","Pasien","Permintaan","Jam","Sampel","Jam","Hasil","Jam","Kode Dokter","Dokter Perujuk","Dokter Radiologi","Poli Registrasi","Informasi Tambahan","Diagnosis Klinis","Kode Bayar","Jenis Bayar"
        }){
    ...
    private void initComponents() {
        ...
        BtnKirimDataOrthanc1 = new widget.Button();
        ...
        TanggalPulang.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-01-2026 13:21:21" }));
        ...
        CmbDr.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Semua" }));
        CmbDr.setName("CmbDr"); // NOI18N
        CmbDr.setPreferredSize(new java.awt.Dimension(200, 23));
        CmbDr.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                CmbDrActionPerformed(evt);
            }
        });
        panelGlass8.add(CmbDr);
        ...
        BtnRiwayatPenunjang.setPreferredSize(new java.awt.Dimension(215, 23));
        ...
        BtnKirimDataOrthanc1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnKirimDataOrthanc1.setText("Mapping Modality Radiologi");
        BtnKirimDataOrthanc1.setFocusPainted(false);
        BtnKirimDataOrthanc1.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnKirimDataOrthanc1.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnKirimDataOrthanc1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnKirimDataOrthanc1.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnKirimDataOrthanc1.setName("BtnKirimDataOrthanc1"); // NOI18N
        BtnKirimDataOrthanc1.setPreferredSize(new java.awt.Dimension(215, 23));
        BtnKirimDataOrthanc1.setRoundRect(false);
        BtnKirimDataOrthanc1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnKirimDataOrthanc1ActionPerformed(evt);
            }
        });
        FormMenu.add(BtnKirimDataOrthanc1);

        BtnKirimDataOrthanc.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnKirimDataOrthanc.setText("Kirim Permintaan USG  ke RIS Orthanc");
...
private void tbRadiologiRalanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbRadiologiRalanKeyPressed
   if(tabMode.getRowCount()!=0){
        ...
        if (TabPilihRawat.getSelectedIndex() == 0) {
            if (tbRadiologiRalan.getSelectedRow() != -1) {
                ...
                if (NoPermintaan.trim().equals("")) {
                    ...
                    param.put("tgllahir", Sequel.cariIsi("select DATE_FORMAT(tgl_lahir,'%d-%m-%Y')as tgl_lahir from pasien where pasien.no_rkm_medis=? ", norm));
                    param.put("tlpn", Sequel.cariIsi("select no_tlp from pasien where pasien.no_rkm_medis=? ", norm));
                    param.put("Agama", Sequel.cariIsi("select agama from pasien where pasien.no_rkm_medis=? ", norm));
                    param.put("bayar", Sequel.cariIsi("select penjab.png_jawab from penjab inner join reg_periksa on penjab.kd_pj=reg_periksa.kd_pj where reg_periksa.no_rawat=? ", NoRawat));
                 ...
                 //   param.put("diagnosa", Sequel.cariIsi("select permintaan_radiologi.diagnosa_klinis from permintaan_radiologi where permintaan_radiologi.no_rawat=?", NoRawat));
                    ...
                    param.put("berat",Sequel.cariIsi("select pemeriksaan_ralan.berat from pemeriksan_ralan where pemeriksaan_ralan.no_rawat=? ", NoRawat));
                    kamar = "Poli";
            ...
            if (tbRadiologiRanap.getSelectedRow() != -1) {
                ...
                if (NoPermintaan.trim().equals("")) {
                    ...
                    param.put("jkel", Sequel.cariIsi("select pasien.jk from pasien where pasien.no_rkm_medis=? ", norm));
                    param.put("umur", Sequel.cariIsi("select umur from pasien where no_rkm_medis=?", norm));
                    param.put("tgllahir", Sequel.cariIsi("select DATE_FORMAT(tgl_lahir,'%d-%m-%Y')as tgl_lahir from pasien where no_rkm_medis=?", norm));
                    param.put("tlpn", Sequel.cariIsi("select no_tlp from pasien where pasien.no_rkm_medis=? ", norm));
                    param.put("Agama", Sequel.cariIsi("select agama from pasien where pasien.no_rkm_medis=? ", norm));
                    param.put("bayar", Sequel.cariIsi("select penjab.png_jawab from penjab inner join reg_periksa on penjab.kd_pj=reg_periksa.kd_pj where reg_periksa.no_rawat=? ", NoRawat));
                    param.put("lahir", Sequel.cariIsi("select DATE_FORMAT(pasien.tgl_lahir,'%d-%m-%Y') from pasien where pasien.no_rkm_medis=? ", norm));
                ...
                if(tbRadiologiRalan.getSelectedRow()!= -1){
                    if(tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),0).toString().trim().equals("")){
                        ...
                        if(Sampel.equals("")){
                            ...
                            Modality = Sequel.cariIsi("select left(permintaan_pemeriksaan_radiologi.kd_jenis_prw,2) from permintaan_pemeriksaan_radiologi where permintaan_pemeriksaan_radiologi.noorder=? ",tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),0).toString());;
                            //Modality = "CR";
                            /*
                            "select permintaan_pemeriksaan_radiologi.kd_jenis_prw,jns_perawatan_radiologi.nm_perawatan "+
                            "from permintaan_pemeriksaan_radiologi inner join jns_perawatan_radiologi on "+
                        ...
                        Panoramic = PX
                        DR  = DX
                        Cathlab (Angiography) = XA
                        Fluoroscopy = RF
                        */
                        Hamil= "4"; //undefined
                        ACSN=tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),0).toString();
                        String Nama=tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),2).toString().split(" ")[1];
                        String NoRm=tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),2).toString().split(" ")[0];
                        String jk=Sequel.cariIsi("select if(pasien.jk='L','M','F') as jk from pasien where pasien.no_rkm_medis=? ",NoRm);
                        String tglLahir=Sequel.cariIsi("select tgl_lahir from pasien where pasien.no_rkm_medis=? ",NoRm).replaceAll("-", "");
                        String tglReg=tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),5).toString().replaceAll("-", "");
                        String jamReg=tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),6).toString().replaceAll(":", "");
                        String kodepemeriksaan=Sequel.cariIsi("select permintaan_pemeriksaan_radiologi.kd_jenis_prw from permintaan_pemeriksaan_radiologi    where noorder=? ",ACSN);
                        String pemeriksaan=Sequel.cariIsi("select nm_perawatan from jns_perawatan_radiologi   where kd_jenis_prw=? ",kodepemeriksaan);
                        String WorklistStructure="structured";
                        try{
                            ...
                            "\"PatientName\": \""+Nama+"\","+
                            "\"NoRkmMedis\": \""+NoRm+"\","+
                            "\"PatientBirthDate\": \""+tglLahir+"\","+
                            "\"PatientSex\": \""+jk+"\","+
                            "\"PregnancyStatus\": \""+Hamil+"\","+
                            "\"Modality\": \""+Modality+"\","+
                            "\"DateStart\": \""+tglReg+"\","+
                            "\"TimeStart\": \""+jamReg+"\","+
                            "\"ExamProcedure\": \""+pemeriksaan+"\","+
                            "\"ExamCode\": \""+kodepemeriksaan+"\","+
                            "\"WorklistStructure\": \""+WorklistStructure+"\""+
                            "}";
                            requestEntity = new HttpEntity(requestJson,headers);
                            root = mapper.readTree(orthanc.getRest().exchange(koneksiDB.URLORTHANC()+"/api/", HttpMethod.POST, requestEntity, String.class).getBody()); //sesuaikan dengan webservice anda
    ...
    private void BtnKirimDataOrthanc1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKirimDataOrthanc1ActionPerformed
        OrthancDlgSetRadiologiModalities orthanc=new OrthancDlgSetRadiologiModalities(null,false);
        orthanc.setSize(internalFrame1.getWidth(),internalFrame1.getHeight());
        orthanc.setLocationRelativeTo(internalFrame1);
        orthanc.setVisible(true);
    }//GEN-LAST:event_BtnKirimDataOrthanc1ActionPerformed
    ...
    private void BtnRiwayatPenunjangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnRiwayatPenunjangActionPerformed
        ...
        if(NoRawat.trim().equals("")){
            ...
            resume.setNoRm(norm,Sequel.cariIsi("select pasien.nm_pasien from pasien where pasien.no_rkm_medis=?",norm));
    ...
    private void CmbDrActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CmbDrActionPerformed
        pilihTab();
    }//GEN-LAST:event_CmbDrActionPerformed
    ...
    */
    ...
    private widget.Button BtnKirimDataOrthanc1;
    ...
    private void tampil() {
        ...
        try {
            ...
            ps=koneksi.prepareStatement(
                    ...
                    "permintaan_radiologi.dokter_perujuk,dokter.nm_dokter,ifnull(dokter_rad.nm_dokter,'-') as nm_dokter_rad,poliklinik.nm_poli,permintaan_radiologi.informasi_tambahan,permintaan_radiologi.diagnosa_klinis "+
                    ...
                    "left join dokter as dokter_rad on permintaan_radiologi.kd_dokter_radiologi=dokter_rad.kd_dokter "+
                    "inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli "+
                    "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                    "where permintaan_radiologi.status='ralan' and permintaan_radiologi.tgl_permintaan between ? and ? "+
                    (CmbDr.getSelectedItem()!=null && !CmbDr.getSelectedItem().toString().equals("Semua")?"and dokter_rad.nm_dokter=? ":"")+
                    ...
                    "or pasien.nm_pasien like ? or permintaan_radiologi.diagnosa_klinis like ? or dokter.nm_dokter like ? or dokter_rad.nm_dokter like ? or penjab.png_jawab like ?) ")+
                    "order by permintaan_radiologi.tgl_permintaan,permintaan_radiologi.jam_permintaan desc");
            try {
                int n=1;
                ps.setString(n++,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                ps.setString(n++,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                if(CmbDr.getSelectedItem()!=null && !CmbDr.getSelectedItem().toString().equals("Semua")){
                    ps.setString(n++,CmbDr.getSelectedItem().toString());
                }
                if(!semua){
                    ps.setString(n++,"%"+CrDokter.getText().trim()+"%");
                    ps.setString(n++,"%"+CrPoli.getText().trim()+"%");
                    ps.setString(n++,"%"+TCari.getText()+"%");
                    ps.setString(n++,"%"+TCari.getText()+"%");
                    ps.setString(n++,"%"+TCari.getText()+"%");
                    ps.setString(n++,"%"+TCari.getText()+"%");
                    ps.setString(n++,"%"+TCari.getText()+"%");
    ...
    private void tampil2() {
        ...
        try {
            ...
            ps=koneksi.prepareStatement(
                    ...
                    "or dokter.nm_dokter like ? or dokter_rad.nm_dokter like ? or penjab.png_jawab like ?)")+" order by permintaan_radiologi.tgl_permintaan,permintaan_radiologi.jam_permintaan desc");
            try {
                int n=1;
                ps.setString(n++,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                ps.setString(n++,Valid.SetTgl(Tgl2.getSelectedItem()+""));
        ...
        try {
            ...
            if(cmbStatus.getSelectedIndex()==0){
                ps=koneksi.prepareStatement(
                        ...
                        "(permintaan_radiologi.noorder like ? or permintaan_radiologi.no_rawat like ? or "+
                        "reg_periksa.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                        "permintaan_radiologi.diagnosa_klinis like ? or dokter.nm_dokter like ? or dokter_rad.nm_dokter like ? or penjab.png_jawab like ?)")+
            ...
            try {
                ...
                if(!semua){
                    ps.setString(n++,"%"+CrDokter2.getText().trim()+"%");
                    ps.setString(n++,"%"+Kamar.getText().trim()+"%");
                    ps.setString(n++,"%"+TCari.getText()+"%");
                    ps.setString(n++,"%"+TCari.getText()+"%");
                    ps.setString(n++,"%"+TCari.getText()+"%");
                    ps.setString(n++,"%"+TCari.getText()+"%");
        ...
        try {
            ...
            if(cmbStatus.getSelectedIndex()==0){
                ps=koneksi.prepareStatement(
                        ...
                        "dokter.nm_dokter like ? or dokter_rad.nm_dokter like ? or penjab.png_jawab like ?)")+" group by permintaan_radiologi.noorder,jns_perawatan_radiologi.kd_jenis_prw order by permintaan_radiologi.tgl_permintaan desc,permintaan_radiologi.jam_permintaan desc,kamar_inap.tgl_masuk desc");
            }else{
                ps=koneksi.prepareStatement(
                        "select permintaan_radiologi.noorder,permintaan_radiologi.no_rawat,reg_periksa.no_rkm_medis,"+
                        "pasien.nm_pasien,jns_perawatan_radiologi.nm_perawatan,permintaan_radiologi.tgl_permintaan,reg_periksa.kd_pj,penjab.png_jawab,"+
    ...
    private void tampilDokterRad() {
        PreparedStatement psDokter = null;
        ResultSet rsDokter = null;

        try {
            psDokter = koneksi.prepareStatement(
                    "select dokter.nm_dokter from dokter inner join spesialis on dokter.kd_sps=spesialis.kd_sps "
                    + "where spesialis.nm_sps like '%rad%' order by dokter.nm_dokter");
            try {
                rsDokter = psDokter.executeQuery();

                CmbDr.removeAllItems(); 
                CmbDr.addItem("Semua");

                while (rsDokter.next()) {
                    CmbDr.addItem(rsDokter.getString(1));
                }
            } catch (Exception e) {
                System.out.println("Notifikasi : " + e);
            } finally {

...
import rekammedis.DlgBeriInstrumen;
import rekammedis.DlgPemakaianAlatKassa;
...
import rekammedis.RMDataCatatanKamarPemulihan;
...
import rekammedis.RMObservasiAnestesi;
import rekammedis.RMPenandaanAreaOperasi;
import rekammedis.RMPenilaianPraAnastesidanSedasi;
...
public class DlgBookingOperasi extends javax.swing.JDialog {
    ...
    private int i = 0;
    private String status = "", bangsal = "", lokasistok = "", kamar = "", diagnosa = "", order = "", kelas = "", penjab = "", norawatibu = "", posisi = "", DEPOAKTIFOBAT = "", norm = "",finger="";
    ...
    private void initComponents() {
        ...
        BtnPreAnastesi1 = new widget.Button();
        BtnLembarObservasiAnestesi = new widget.Button();
        BtnLembarObservasiAnestesi1 = new widget.Button();
        BtnTagihanOperasi = new widget.Button();
        BtnLaporanOperasi = new widget.Button();
        BtnInstrumen2 = new widget.Button();
        ...
        BtnInstrumen3 = new widget.Button();
        BtnCatatanKamarPemulihan = new widget.Button();
        ...
        DTPCari3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "14-01-2025" }));
        ...
        DTPCari4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "14-01-2025" }));
        ...
        ScrollMenu.setPreferredSize(new java.awt.Dimension(115, 350));

        FormMenu.setBackground(new java.awt.Color(255, 255, 255));
        FormMenu.setBorder(null);
        FormMenu.setName("FormMenu"); // NOI18N
        FormMenu.setPreferredSize(new java.awt.Dimension(115, 700));
        ...
        BtnPreAnastesi1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnPreAnastesi1.setText("Penilaian Pra Anestesi dan Sedasi");
        BtnPreAnastesi1.setFocusPainted(false);
        BtnPreAnastesi1.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnPreAnastesi1.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnPreAnastesi1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnPreAnastesi1.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnPreAnastesi1.setName("BtnPreAnastesi1"); // NOI18N
        BtnPreAnastesi1.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnPreAnastesi1.setRoundRect(false);
        BtnPreAnastesi1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPreAnastesi1ActionPerformed(evt);
            }
        });
        FormMenu.add(BtnPreAnastesi1);

        BtnLembarObservasiAnestesi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnLembarObservasiAnestesi.setText("Lembar Observasi Anestesi");
        BtnLembarObservasiAnestesi.setFocusPainted(false);
        BtnLembarObservasiAnestesi.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnLembarObservasiAnestesi.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnLembarObservasiAnestesi.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnLembarObservasiAnestesi.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnLembarObservasiAnestesi.setName("BtnLembarObservasiAnestesi"); // NOI18N
        BtnLembarObservasiAnestesi.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnLembarObservasiAnestesi.setRoundRect(false);
        BtnLembarObservasiAnestesi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnLembarObservasiAnestesiActionPerformed(evt);
            }
        });
        FormMenu.add(BtnLembarObservasiAnestesi);

        BtnLembarObservasiAnestesi1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnLembarObservasiAnestesi1.setText("Asesmen Keperawatan Perioperatif");
        BtnLembarObservasiAnestesi1.setFocusPainted(false);
        BtnLembarObservasiAnestesi1.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnLembarObservasiAnestesi1.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnLembarObservasiAnestesi1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnLembarObservasiAnestesi1.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnLembarObservasiAnestesi1.setName("BtnLembarObservasiAnestesi1"); // NOI18N
        BtnLembarObservasiAnestesi1.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnLembarObservasiAnestesi1.setRoundRect(false);
        BtnLembarObservasiAnestesi1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnLembarObservasiAnestesi1ActionPerformed(evt);
            }
        });
        FormMenu.add(BtnLembarObservasiAnestesi1);
        ...
        BtnInstrumen2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnInstrumen2.setText("Laporan Operasi 2");
        BtnInstrumen2.setFocusPainted(false);
        BtnInstrumen2.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnInstrumen2.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnInstrumen2.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnInstrumen2.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnInstrumen2.setName("BtnInstrumen2"); // NOI18N
        BtnInstrumen2.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnInstrumen2.setRoundRect(false);
        BtnInstrumen2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnInstrumen2ActionPerformed(evt);
            }
        });
        FormMenu.add(BtnInstrumen2);
        ...
        BtnInstrumen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnInstrumen.setText("Pemakaian Instrumen");
        BtnInstrumen.setFocusPainted(false);
        BtnInstrumen.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnInstrumen.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnInstrumen.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnInstrumen.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnInstrumen.setName("BtnInstrumen"); // NOI18N
        BtnInstrumen.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnInstrumen.setRoundRect(false);
        BtnInstrumen.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnInstrumenActionPerformed(evt);
            }
        });
        FormMenu.add(BtnInstrumen);

        BtnInstrumen3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnInstrumen3.setText("Pemakaian Alat dan Kassa");
        BtnInstrumen3.setFocusPainted(false);
        BtnInstrumen3.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnInstrumen3.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnInstrumen3.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnInstrumen3.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnInstrumen3.setName("BtnInstrumen3"); // NOI18N
        BtnInstrumen3.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnInstrumen3.setRoundRect(false);
        BtnInstrumen3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnInstrumen3ActionPerformed(evt);
            }
        });
        FormMenu.add(BtnInstrumen3);

        BtnCatatanKamarPemulihan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnCatatanKamarPemulihan.setText("Catatan Kamar Pemulihan");
        BtnCatatanKamarPemulihan.setFocusPainted(false);
        BtnCatatanKamarPemulihan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnCatatanKamarPemulihan.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnCatatanKamarPemulihan.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnCatatanKamarPemulihan.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnCatatanKamarPemulihan.setName("BtnCatatanKamarPemulihan"); // NOI18N
        BtnCatatanKamarPemulihan.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnCatatanKamarPemulihan.setRoundRect(false);
        BtnCatatanKamarPemulihan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnCatatanKamarPemulihanActionPerformed(evt);
            }
        });
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
    ...
    private void BtnInstrumenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnInstrumenActionPerformed
        if (TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")) {
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            DlgBeriInstrumen form = new DlgBeriInstrumen(null, false);
            //form.isCek();
            form.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
            form.emptTeks();
            form.setNoRm(TNoRw.getText(), TPasien.getText(), KdDokter.getText(), NmDokter.getText());
            //form.tampil();
            this.setCursor(Cursor.getDefaultCursor());
        }
        ...
        if (TNoRw.getText().trim().equals("")) {
            ...
            if (Sequel.cariRegistrasi(TNoRw.getText()) > 0) {
                ...
                if (Sequel.cariInteger("select count(no_rawat) from stok_obat_pasien where no_rawat=? ", TNoRw.getText()) > 0) {
                    ...
                    dlgobt.setNoRm(TNoRw.getText(), norm, TPasien.getText(), DTPTgl.getDate());
    ...
    private void BtnCatatanKamarPemulihanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCatatanKamarPemulihanActionPerformed
        if (tabMode.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        } else {
            if (tbObat.getSelectedRow() != -1) {
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                RMDataCatatanKamarPemulihan form = new RMDataCatatanKamarPemulihan(null, false);
                form.isCek();
                form.emptTeks();
                form.setNoRm(TNoRw.getText(), DTPCari2.getDate());
                form.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
    ...
    }//GEN-LAST:event_BtnCatatanKamarPemulihanActionPerformed
    ...
    private void BtnLembarObservasiAnestesiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnLembarObservasiAnestesiActionPerformed
        if (tabMode.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        } else {
    ...
    }//GEN-LAST:event_BtnLembarObservasiAnestesiActionPerformed

    private void BtnPreAnastesi1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPreAnastesi1ActionPerformed
        if (tabMode.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        } else {
            if (tbObat.getSelectedRow() != -1) {
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                RMPenilaianPraAnastesidanSedasi form = new RMPenilaianPraAnastesidanSedasi(null, false);
                form.isCek();
                form.emptTeks();
                form.setNoRm(TNoRw.getText(), DTPCari2.getDate());
                form.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
    ...
    }//GEN-LAST:event_BtnPreAnastesi1ActionPerformed

    private void BtnInstrumen2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnInstrumen2ActionPerformed
        if (tabMode.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        } else {
    ...
    }//GEN-LAST:event_BtnInstrumen2ActionPerformed

    private void BtnInstrumen3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnInstrumen3ActionPerformed
        if (TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        } else {
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            DlgPemakaianAlatKassa form = new DlgPemakaianAlatKassa(null, false);
            //form.isCek();
            form.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
    ...
    }//GEN-LAST:event_BtnInstrumen3ActionPerformed

    private void BtnLembarObservasiAnestesi1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnLembarObservasiAnestesi1ActionPerformed
        if (tabMode.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        } else {
            if (tbObat.getSelectedRow() != -1) {
                ...
                form.emptTeks();
                form.isCek();
                form.setData(TNoRw.getText(), TPasien.getText(), Kamar.getText());
    ...
    }//GEN-LAST:event_BtnLembarObservasiAnestesi1ActionPerformed
        ...
        if (tbObat.getSelectedRow() > -1) {
            if (!tbObat.getValueAt(tbObat.getSelectedRow(), 1).toString().equals("")) {
                try {
                    ...
                    rs2 = koneksi.prepareStatement("SELECT booking_operasi.no_rawat, "
                        + "concat(booking_operasi.tanggal, ' ', booking_operasi.jam_selesai) as tgljamselesai, "
                        + "concat(booking_operasi.tanggal, ' ', booking_operasi.jam_mulai) as tgljammulai, booking_operasi.status, "
                        + "booking_operasi.kd_dokter FROM booking_operasi "
                        + "WHERE booking_operasi.no_rawat ='" + tbObat.getValueAt(tbObat.getSelectedRow(), 1) + "' "
                        + "AND booking_operasi.tanggal ='" + tbObat.getValueAt(tbObat.getSelectedRow(), 5) + "' "
                        + "AND booking_operasi.jam_selesai = '" + tbObat.getValueAt(tbObat.getSelectedRow(), 7) + "'") // Pastikan Anda menggunakan kolom yang benar untuk jam_selesai
                    .executeQuery();

                    if (rs2.next()) {
                        // Mengambil hasil dari query
                        //    String tglJamMulai = rs2.getString("tgljamsmulai");
                        String tglJamSelesai = rs2.getString("tgljamselesai");
                        // Mengonversi hasil ke dalam format yang sesuai untuk tgl2
                        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
                        Date dateselesai = sdf.parse(tglJamSelesai);
                        //     Date datemulai = sdf.parse(tglJamMulai);
                        tgl2.setDate(dateselesai); // Atur tanggal dan jam ke tgl2
                        //   tglmulai=setDate(datemulai);
                    }
                    if (rs2 != null) {
                        rs2.close();
                    }
    ...
    private void BtnSimpan1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpan1ActionPerformed
        if (!Laporan.getText().equals("")) {
            Sequel.queryu("delete from laporan_operasi where no_rawat='" + tbObat.getValueAt(tbObat.getSelectedRow(), 1) + "' and tanggal='" + tbObat.getValueAt(tbObat.getSelectedRow(), 5) + "'");
            Sequel.menyimpan("laporan_operasi", "?,?,?,?,?,?,?,?", "laporan operasi", 8, new String[]{
                tbObat.getValueAt(tbObat.getSelectedRow(), 1).toString(),tbObat.getValueAt(tbObat.getSelectedRow(), 5).toString()+" "+tbObat.getValueAt(tbObat.getSelectedRow(), 6).toString(), PreOp.getText(),
    ...
    private widget.Button BtnCatatanKamarPemulihan;
    ...
    private widget.Button BtnInstrumen2;
    private widget.Button BtnInstrumen3;
    private widget.Button BtnKamarInap;
    private widget.Button BtnKeluar;
    private widget.Button BtnLaporanOperasi;
    private widget.Button BtnLembarObservasiAnestesi;
    private widget.Button BtnLembarObservasiAnestesi1;
    ...
    private void MnLaporanOperasiActionPerformed(java.awt.event.ActionEvent evt) {
        if (tbObat.getSelectedRow() > -1) {
            if (!tbObat.getValueAt(tbObat.getSelectedRow(), 1).toString().equals("")) {
                ...
                String kodeoperator = Sequel.cariIsi("select operasi.operator1 from operasi where operasi.no_rawat='" + tbObat.getValueAt(tbObat.getSelectedRow(), 1).toString() + "' and tgl_operasi='" + tbObat.getValueAt(tbObat.getSelectedRow(), 5).toString() + "'");
                ...
                try {
                    try {
                        rs = koneksi.prepareStatement(
                                ...
                                + "operasi.no_rawat='" + tbObat.getValueAt(tbObat.getSelectedRow(), 1).toString() + "' and operasi.tgl_operasi='" + tbObat.getValueAt(tbObat.getSelectedRow(), 5).toString() + "' ").executeQuery();
                        while (rs.next()) {
                    ...
                    try {
                        try {
                            rs = koneksi.prepareStatement(
                                    ...
                                    + "pemeriksaan_ralan.penilaian from pemeriksaan_ralan where pemeriksaan_ralan.no_rawat='" + tbObat.getValueAt(tbObat.getSelectedRow(), 1).toString() + "' "
                    ...
                    try {
                        try {
                            rs = koneksi.prepareStatement(
                                    ...
                                    + "pemeriksaan_ranap.penilaian from pemeriksaan_ranap where pemeriksaan_ranap.no_rawat='" + tbObat.getValueAt(tbObat.getSelectedRow(), 1).toString() + "' "

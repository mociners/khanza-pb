...
public class DlgCariPermintaanLabPA extends javax.swing.JDialog {
    ...
    private String pilihan = "", alarm = "", formalarm = "", nol_detik, detik, tglsampel = "", tglhasil = "", norm = "",
            kamar = "", namakamar = "", InformasiTambahan, DiagnosaKlinis,
            tanggalbahan, diperolehdengan, lokasijaringan, diawetkandengan, pernahdilakukandi, tanggalpa, diagnosapa,
            nomorpa,
    ...
    public DlgCariPermintaanLabPA(java.awt.Frame parent, boolean modal) {
        ...
        tabMode3 = new DefaultTableModel(null, new Object[] {
                ...
                "Jenis Bayar",
                "Tgl.Bahan", "Diperoleh Dengan", "Lokasi Jaringan", "Diawetkan Dengan", "Pernah Dilakukan PA Di",
                "Pada Tanggal",
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(
                javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)),
                "::[ Data Permintaan Laboratorium Patologi Anatomi ]::",
        ...
        if (TabPilihRawat.getSelectedIndex() == 0) {
            if (TabRawatJalan.getSelectedIndex() == 0) {
                if (tabMode.getRowCount() == 0) {
                    ...
                    Valid.MyReport("rptLapPermintaanLabPA.jasper", "report", "::[ Data Permintaan Laboratorium PA ]::",
                            param);
                }
                ...
                if (tabMode2.getRowCount() == 0) {
                    ...
                    Valid.MyReport("rptLapPermintaanLabPA2.jasper", "report",
                            "::[ Data Detail Permintaan Laboratorium PA ]::", param);
                }
            }
        } else if (TabPilihRawat.getSelectedIndex() == 1) {
            if (TabRawatInap.getSelectedIndex() == 0) {
                if (tabMode3.getRowCount() == 0) {
                    ...
                    param.put("emailrs", akses.getemailrs());
                    param.put("logo", Sequel.cariGambar("select setting.logo from setting"));
                    Valid.MyReport("rptLapPermintaanLabPA3.jasper", "report", "::[ Data Permintaan Laboratorium PA ]::",
                            param);
                }
                    ...
                    if (NoPermintaan.trim().equals("")) {
                        ...
                        if (Sampel.equals("") || akses.getkode().equals("Admin Utama")) {
                            if (Sequel.cariInteger(
                                    "select count(permintaan_pemeriksaan_labpa.noorder) from permintaan_pemeriksaan_labpa where permintaan_pemeriksaan_labpa.stts_bayar='Sudah' and permintaan_pemeriksaan_labpa.noorder=?",
                                    NoPermintaan) > 0) {
                                JOptionPane.showMessageDialog(null,
                                ...
                                Sequel.queryu("delete from periksa_lab where no_rawat='" + NoRawat
                                        + "' and kd_jenis_prw in (select kd_jenis_prw from permintaan_pemeriksaan_labpa where noorder='"
                                        + NoPermintaan + "')");
        ...
        if (TabPilihRawat.getSelectedIndex() == 0) {
            if (!NoRawat.equals("")) {
                if (NoPermintaan.trim().equals("")) {
                    ...
                    if (Sequel.mengedittf("permintaan_labpa", "noorder=?", "tgl_sampel=?,jam_sampel=?", 3,
                            new String[] {
            ...
            if (!NoRawat.equals("")) {
                ...
                if (NoPermintaan.trim().equals("")) {
                    ...
                    Valid.MyReport("rptPermintaanLabPA.jasper", "report",
                            "::[ Permintaan Laboratorium Patologi Anatomi ]::", param);
                }
                TeksKosong();
                this.setCursor(Cursor.getDefaultCursor());
            } else {
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode2.addRow(new String[] {
                            ...
                            rs.getString("jam_permintaan"), rs.getString("tgl_sampel"),
                            ...
                            rs.getString("pengambilan_bahan"),
                            rs.getString("diperoleh_dengan"), rs.getString("lokasi_jaringan"),
                            rs.getString("diawetkan_dengan"),
                            rs.getString("pernah_dilakukan_di"), rs.getString("tanggal_pa_sebelumnya"),
                            rs.getString("nomor_pa_sebelumnya"),
        ...
        ActionListener taskPerformer = (ActionEvent e) -> {
            if (aktif == true) {
                ...
                if (detik.equals("05")) {
                    ...
                    if (permintaanbaru > 0) {
                        try {
                            music = new BackgroundMusic("./suara/pa.mp3");
                            music.start();
                        } catch (Exception ex) {

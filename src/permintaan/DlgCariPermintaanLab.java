...
public class DlgCariPermintaanLab extends javax.swing.JDialog {
    ...
    private DefaultTableModel tabMode5, tabMode6;
    ...
    private String pilihan = "", alarm = "", formalarm = "", nol_detik, detik, tglsampel = "", tglhasil = "", norm = "",
            ...
            finger = "";
    private widget.TextBox CrDokterIGD, CrPoliIGD;
    private widget.Table tbLabIGD, tbLabIGD2;
    private javax.swing.JTabbedPane TabIGD;
    private widget.ScrollPane scrollPaneIGD, scrollPaneIGD2;
    ...
    public DlgCariPermintaanLab(java.awt.Frame parent, boolean modal) {
        ...
        tabMode2 = new DefaultTableModel(null, new Object[] {
                "No.Permintaan", "No.Rawat", "Pasien", "Pemeriksaan", "Detail Pemeriksaan", "Satuan", "Nilai Rujukan",
                "Permintaan", "Jam", "Sampel", "Jam", "Hasil",
            ...
            public void windowClosed(WindowEvent e) {
                if (poli.getTable().getSelectedRow() != -1) {
                    if (TabPilihRawat.getSelectedIndex() == 0) {
                        ...
                        CrPoliIGD.setText(poli.getTable().getValueAt(poli.getTable().getSelectedRow(), 1).toString());
                        CrPoliIGD.requestFocus();
                    }
                }
            }
    ...
    private void initComponents() {
        ...
        internalFrame6.setBorder(javax.swing.BorderFactory.createTitledBorder(
                javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)),
                "::[ Pilih Jenis Registrasi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
                javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11),
                new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(
                javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)),
                "::[ Data Permintaan Laboratorium Patologi Klinis ]::",
                ...
                if (tabMode5.getRowCount() == 0) {
                    ...
                    for (i = 0; i < row; i++) {
                        ...
                        Sequel.menyimpan("temporary_permintaan_lab", "'0','" +
                                ...
                                tabMode5.getValueAt(i, 12).toString() + "','" +
                                tabMode5.getValueAt(i, 13).toString() + "','" +
                                tabMode5.getValueAt(i, 14).toString() + "','" +
                                tabMode5.getValueAt(i, 15).toString()
                                + "','','','','','','','','','','','','','','','','','','','','',''", "Periksa Lab");
                    }
                    Map<String, Object> param = new HashMap<>();
                    param.put("namars", akses.getnamars());
                ...
                if (tabMode6.getRowCount() == 0) {
                    ...
                    for (i = 0; i < row; i++) {
                        ...
                        Sequel.menyimpan("temporary_permintaan_lab", "'0','" +
                                ...
                                tabMode6.getValueAt(i, 15).toString() + "','" +
                                tabMode6.getValueAt(i, 16).toString() + "','" +
                                tabMode6.getValueAt(i, 17).toString() + "','" +
                                tabMode6.getValueAt(i, 18).toString() + "','" +
                                tabMode6.getValueAt(i, 19).toString()
                                + "','','','','','','','','','','','','','','','','',''", "Periksa Lab");
                    }
                    Map<String, Object> param = new HashMap<>();
                    param.put("namars", akses.getnamars());
            ...
            if (!NoRawat.equals("")) {
                if (NoPermintaan.trim().equals("") || DiagnosaKlinis.trim().equals("")) {
                    ...
                    if (Sequel.mengedittf("permintaan_lab", "noorder=?", "tgl_sampel=?,jam_sampel=?", 3, new String[] {
                            ...
                            TanggalPulang.getSelectedItem().toString().substring(11, 19), NoPermintaan
                    }) == true) {
                        WindowAmbilSampel.dispose();
                        try {
                        ...
                        TeksKosong();
                        tbLabRalan.setValueAt(Valid.SetTgl(TanggalPulang.getSelectedItem() + ""),
                                tbLabRalan.getSelectedRow(), 5);
                        tbLabRalan.setValueAt(TanggalPulang.getSelectedItem().toString().substring(11, 19),
                                tbLabRalan.getSelectedRow(), 6);
                    }
                }
            } else {
                JOptionPane.showMessageDialog(null, "Maaf, silahkan pilih data permintaan...!!!!");
            ...
            if (!NoRawat.equals("")) {
                if (NoPermintaan.trim().equals("") || DiagnosaKlinis.trim().equals("")) {
                    ...
                    if (Sequel.mengedittf("permintaan_lab", "noorder=?", "tgl_sampel=?,jam_sampel=?", 3, new String[] {
                        ...
                        TeksKosong();
                        tbLabRanap.setValueAt(Valid.SetTgl(TanggalPulang.getSelectedItem() + ""),
                                tbLabRanap.getSelectedRow(), 5);
                        tbLabRanap.setValueAt(TanggalPulang.getSelectedItem().toString().substring(11, 19),
                                tbLabRanap.getSelectedRow(), 6);
                    }
                }
            } else {
                JOptionPane.showMessageDialog(null, "Maaf, silahkan pilih data permintaan...!!!!");
            ...
            if (!NoRawat.equals("")) {
                if (NoPermintaan.trim().equals("") || DiagnosaKlinis.trim().equals("")) {
                    ...
                    if (Sequel.mengedittf("permintaan_lab", "noorder=?", "tgl_sampel=?,jam_sampel=?", 3, new String[] {
                        ...
                        Sequel.queryu("insert into antrilabpk values('1')");
                        TeksKosong();
                        tbLabIGD.setValueAt(Valid.SetTgl(TanggalPulang.getSelectedItem() + ""),
                                tbLabIGD.getSelectedRow(), 5);
                        tbLabIGD.setValueAt(TanggalPulang.getSelectedItem().toString().substring(11, 19),
                                tbLabIGD.getSelectedRow(), 6);
                    }
                }
            } else {
                JOptionPane.showMessageDialog(null, "Maaf, silahkan pilih data permintaan...!!!!");
        ...
        if (TabPilihRawat.getSelectedIndex() == 0) {
            if (!NoRawat.equals("")) {
                ...
                if (NoPermintaan.trim().equals("") || DiagnosaKlinis.trim().equals("")) {
                    ...
                    param.put("norm", norm);
                    param.put("pekerjaan",
                            Sequel.cariIsi("select pasien.pekerjaan from pasien where pasien.no_rkm_medis=?", norm));
                    param.put("noktp",
                            Sequel.cariIsi("select pasien.no_ktp from pasien where pasien.no_rkm_medis=?", norm));
                    param.put("namapasien",
                            Sequel.cariIsi("select pasien.nm_pasien from pasien where pasien.no_rkm_medis=? ", norm));
                    param.put("jkel",
                            Sequel.cariIsi("select pasien.jk from pasien where pasien.no_rkm_medis=? ", norm));
            ...
            if (!NoRawat.equals("")) {
                ...
                if (NoPermintaan.trim().equals("") || DiagnosaKlinis.trim().equals("")) {
                    ...
                    kamar = Sequel.cariIsi(
                            "select ifnull(kamar_inap.kd_kamar,'') from kamar_inap where kamar_inap.no_rawat=? order by kamar_inap.tgl_masuk desc,kamar_inap.jam_masuk desc limit 1",
                            NoRawat);
            ...
            if (!NoRawat.equals("")) {
                ...
                if (NoPermintaan.trim().equals("") || DiagnosaKlinis.trim().equals("")) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            while (rs2.next()) {
                                ...
                                try {
                                    ...
                                    System.out.println("Notif IGD 3 : " + e);
                                } finally {
                                    if (rs3 != null) {
                                        rs3.close();
                                    }
                            ...
                            System.out.println("Notif IGD 2 : " + e);
                        } finally {
                            if (rs2 != null) {
                                rs2.close();
                            }
                        ...
                        System.out.println("Notif IGD : " + e);
                    }
                    Map<String, Object> param = new HashMap<>();
                    param.put("noperiksa", NoPermintaan);
                    norm = Sequel.cariIsi(
                        ...
                        try {
                            ...
                            if (rs.next()) {
                                ...
                                koneksisysmex.prepareStatement(
                                        "insert into LIS_ORDER values('0',now(),'NW','" + rs.getString("no_rkm_medis")
                                                + "','" + rs.getString("nm_pasien") + "'," +
                                                "'" + rs.getString("alamat") + "','" + rs.getString("nm_kel") + "','"
                                                + rs.getString("nm_kec") + "','" + rs.getString("nm_kab") + "'," +
                                                "'OP','" + rs.getString("tgl_lahir") + "','" + rs.getString("jk")
                                                + "','" + rs.getString("noorder") + "','"
                                                + rs.getString("tgl_permintaan") + " " + rs.getString("jam_permintaan")
                                                + "'," +
                                                "'" + rs.getString("kd_poli") + "^" + rs.getString("nm_poli") + "','"
                                                + rs.getString("dokter_perujuk") + "^" + rs.getString("nm_dokter")
                                                + "'," +
                                                "'" + rs.getString("kd_poli") + "','" + pilihan + "','"
                                                + rs.getString("diagnosa_klinis") + "','" + rs.getString("no_rawat")
                                                + "'," +
                                                "'" + Permintaan + "','0')")
                                        .executeUpdate();
                                ...
                                koneksisysmex.prepareStatement(
                                        "insert into LIS_ORDER_DETAIL values('0',now(),'NW','"
                        ...
                        try {
                            ...
                            if (rs.next()) {
                                koneksielims.prepareStatement(
                                        "insert into permintaan_lab values('" + rs.getString("noorder") + "','"
                                                + rs.getString("no_rawat") + "','" + rs.getString("no_rkm_medis") + "',"
                                                +
                                                "'" + rs.getString("nm_pasien") + "','" + rs.getString("email") + "','"
                                                + rs.getString("jk") + "','" + rs.getString("tmp_lahir") + "','"
                                                + rs.getString("tgl_lahir") + "'," +
                                                "'" + rs.getString("alamat") + ", " + rs.getString("nm_kel") + ", "
                                                + rs.getString("nm_kec") + ", " + rs.getString("nm_kab") + ", "
                                                + rs.getString("nm_prop") + "'," +
                                                "'" + rs.getString("tgl_permintaan") + "','"
                                                + rs.getString("jam_permintaan") + "','"
                                                + rs.getString("dokter_perujuk") + "','" + rs.getString("nm_dokter")
                                                + "'," +
                                                "'" + rs.getString("status") + "','" + rs.getString("kd_poli") + "','"
                                                + rs.getString("nm_poli") + "','" + rs.getString("kd_pj") + "','"
                                                + rs.getString("png_jawab") + "'," +
                                                "'" + rs.getString("informasi_tambahan") + "','"
                                                + rs.getString("diagnosa_klinis") + "','0')")
                                        .executeUpdate();
                                ps2 = koneksi.prepareStatement(
                            ...
                            if (rs.next()) {
                                koneksielims.prepareStatement(
                                        "insert into permintaan_lab values('" + rs.getString("noorder") + "','"
                                                ...
                                                + rs.getString("dokter_perujuk") + "','" + rs.getString("nm_dokter")
                                                + "'," +
                                                "'" + rs.getString("status") + "','" + rs.getString("kd_kamar") + "','"
                                                + rs.getString("nm_bangsal") + "','" + rs.getString("kd_pj") + "','"
                                                + rs.getString("png_jawab") + "'," +
                                                "'" + rs.getString("informasi_tambahan") + "','"
                                                + rs.getString("diagnosa_klinis") + "','0')")
                                        .executeUpdate();
            ...
            if (!NoRawat.equals("")) {
                ...
                if (NoPermintaan.trim().equals("") || DiagnosaKlinis.trim().equals("")) {
                    ...
                    loadURL("http://" + koneksiDB.HOSTHYBRIDWEB() + ":" + koneksiDB.PORTWEB() + "/"
                            + koneksiDB.HYBRIDWEB() + "/" + "apiteras.php?nopermintaan=" + NoPermintaan);
                }
                TeksKosong();
                this.setCursor(Cursor.getDefaultCursor());
            } else {
            ...
            if (TabRawatJalan.getSelectedIndex() == 0) {
                if (!NoRawat.equals("")) {
                    if (NoPermintaan.trim().equals("") || DiagnosaKlinis.trim().equals("")) {
                        ...
                        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                        loadURL("http://" + koneksiDB.HOSTHYBRIDWEB() + ":" + koneksiDB.PORTWEB() + "/"
                                + koneksiDB.HYBRIDWEB() + "/" + "apiteras2.php?nopermintaan=" + NoPermintaan);
                        this.setCursor(Cursor.getDefaultCursor());
                    }
                } else {
                    JOptionPane.showMessageDialog(null, "Maaf, silahkan pilih data permintaan...!!!!");
                        ...
                        try {
                            ...
                            if (rs.next()) {
                                koneksismartlab.prepareStatement(
                                        "insert into HisToLisHeader values('0','" + rs.getString("no_rawat") + "','"
                                                + rs.getString("noorder") + "','Rawat Jalan'," +
                                                "'" + rs.getString("no_rkm_medis") + "','" + rs.getString("nm_pasien")
                                                ...
                                                "'Ralan','0','"
                                                + Sequel.cariIsi(
                                                        "select count(noorder) from permintaan_detail_permintaan_lab where noorder='"
                                                                + rs.getString("noorder") + "'")
                                                + "'," +
                                                "'0','" + rs.getString("noorder") + "','" + rs.getString("nm_dokter")
                                                + "','A','" + rs.getString("nm_poli") + "','N','0','"
                                                + rs.getString("tgl_permintaan") + "'," +
                                                "'" + rs.getString("tgl_permintaan") + "')")
                                        .executeUpdate();
                                try {
                                    rs3 = koneksismartlab
                                            .prepareStatement("select RowID from HisToLisHeader where HisNoOrder='"
                                                    + rs.getString("noorder") + "'")
                                            .executeQuery();
                                    if (rs3.next()) {
                                        i = rs3.getInt("RowID");
                                ...
                                try {
                                    ...
                                    rs2 = ps2.executeQuery();
                                    while (rs2.next()) {
                                        koneksismartlab.prepareStatement("insert HisToLisDetail values('0','" + i
                                                + "', '" + rs2.getString("id_template") + "','N','"
                                                + rs.getString("tgl_permintaan") + "','0')").executeUpdate();
                                    }
                                } catch (Exception e) {
                                    System.out.println("Notif : " + e);
                                } finally {
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (rs.next()) {
                                koneksismartlab.prepareStatement(
                                        "insert into HisToLisHeader values('0','" + rs.getString("no_rawat") + "','"
                                                + rs.getString("noorder") + "','Rawat Inap'," +
                                                "'" + rs.getString("no_rkm_medis") + "','" + rs.getString("nm_pasien")
                                                + "','" + rs.getString("jk") + "','" + rs.getString("tgl_lahir") + "',"
                                                +
                                                "'" + rs.getString("alamat") + ", " + rs.getString("nm_kel") + ", "
                                                ...
                                                + "','" + rs.getString("diagnosa_klinis") + "','"
                                                + rs.getString("png_jawab") + "'," +
                                                "'" + rs.getString("kelas") + "','0','"
                                                + Sequel.cariIsi(
                                                        "select count(noorder) from permintaan_detail_permintaan_lab where noorder='"
                                                                + rs.getString("noorder") + "'")
                                                + "'," +
                                                "'0','" + rs.getString("noorder") + "','" + rs.getString("nm_dokter")
                                                + "','A','" + rs.getString("kd_kamar") + "','N','0','"
                                                + rs.getString("tgl_permintaan") + "'," +
                                                "'" + rs.getString("tgl_permintaan") + "')")
                                        .executeUpdate();
                                try {
                        ...
                        try {
                            ...
                            if (rs.next()) {
                                ...
                                try {
                                    ...
                                    rs2 = ps2.executeQuery();
                                    while (rs2.next()) {
                                        koneksivanslab.prepareStatement("insert into detail_permintaan_lab values('"
                                                + rs2.getString("noorder") + "','" + rs2.getString("kd_jenis_prw")
                                                + "','" + rs2.getString("id_template") + "')").executeUpdate();
                                    }
                                } catch (Exception e) {
                            ...
                            if (rs.next()) {
                                koneksiadamlab.prepareStatement(
                                        "insert into registrasi values('" + rs.getString("noorder") + "',now()," +
                                                "'" + rs.getString("kd_poli") + "','RALAN','" + rs.getString("nm_poli")
                                                + "','" + rs.getString("dokter_perujuk") + "','"
                                                + rs.getString("nm_dokter") + "'," +
                                                "'" + rs.getString("no_rkm_medis") + "','" + rs.getString("nm_pasien")
                                                + "','" + rs.getString("jk") + "','" + rs.getString("alamat") + "','"
                                                + rs.getString("tgl_lahir") + "'," +
                                                "'" + rs.getString("no_tlp") + "','" + rs.getString("kd_pj") + "','"
                                                + rs.getString("png_jawab") + "','" + rs.getString("no_ktp") + "','"
                                                + rs.getString("informasi_tambahan") + "','"
                                                + rs.getString("diagnosa_klinis") + "','" + rs.getString("nm_kec")
                                                + "','" + rs.getString("nm_kab") + "','" + rs.getString("nm_prop")
                                                + "','" + JnsRegistrasi.getSelectedItem().toString() + "')")
                                        .executeUpdate();

                                ps2 = koneksi.prepareStatement(
                                        "select permintaan_pemeriksaan_lab.noorder,permintaan_pemeriksaan_lab.kd_jenis_prw,jns_perawatan_lab.nm_perawatan from permintaan_pemeriksaan_lab "
                                                +
                                ...
                                try {
                                    ...
                                    rs2 = ps2.executeQuery();
                                    while (rs2.next()) {
                                        koneksiadamlab.prepareStatement("insert into tindakan values('"
                                                + rs2.getString("noorder") + "','" + rs2.getString("kd_jenis_prw")
                                                + "','" + rs2.getString("nm_perawatan") + "')").executeUpdate();
                                    }
                                } catch (Exception e) {
                                    System.out.println("Notif : " + e);
                                } finally {
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (rs.next()) {
                                koneksiadamlab.prepareStatement(
                                        "insert into registrasi values('" + rs.getString("noorder") + "',now()," +
                                                "'" + rs.getString("kd_bangsal") + "','RANAP','"
                                                + rs.getString("nm_bangsal") + "','" + rs.getString("dokter_perujuk")
                                                + "','" + rs.getString("nm_dokter") + "'," +
                                                "'" + rs.getString("no_rkm_medis") + "','" + rs.getString("nm_pasien")
                                                + "','" + rs.getString("jk") + "','" + rs.getString("alamat") + "','"
                                                + rs.getString("tgl_lahir") + "'," +
        ...
        try {
            ...
            ps = koneksi.prepareStatement(
                    "select permintaan_lab.noorder,permintaan_lab.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,permintaan_lab.tgl_permintaan,"
                            ...
                            "inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli " +
                            "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj " +
                            "where permintaan_lab.status='ralan' and reg_periksa.kd_poli<>'IGDK' and permintaan_lab.tgl_permintaan between ? and ? "
                            +
                            (semua ? ""
                                ...
                                if (engine.getLocation().contains("SuksesKirim")) {
                                    ...
                                    json = engine.getLocation()
                                            .replaceAll("http://" + koneksiDB.HOSTHYBRIDWEB() + ":"
                                                    + koneksiDB.PORTWEB() + "/" + koneksiDB.HYBRIDWEB() + "/json=", "")
                                            .replaceAll("_", " ");
                                    if (!json.equals("")) {
                                        try {
                                            root = mapper.readTree(json);
    ...
    private void initIGD() {
        ...
        tabMode6 = new DefaultTableModel(null, new Object[] {
                "No.Permintaan", "No.Rawat", "Pasien", "Pemeriksaan", "Detail Pemeriksaan", "Satuan",
                "Nilai Rujukan", "Permintaan", "Jam", "Sampel", "Jam", "Hasil",
        ...
        for (int k = 0; k < 16; k++) {
            TableColumn column = tbLabIGD.getColumnModel().getColumn(k);
            if (k == 0) {
                column.setPreferredWidth(90);
            } else if (k == 1) {
                column.setPreferredWidth(105);
        ...
        tbLabIGD.setDefaultRenderer(Object.class, new WarnaTablePermintaanLab());
        ...
        for (int k = 0; k < 20; k++) {
            TableColumn column = tbLabIGD2.getColumnModel().getColumn(k);
            if (k == 0) {
                column.setPreferredWidth(90);
            } else if (k == 1) {
                column.setPreferredWidth(105);
        ...
        scrollPaneIGD = new widget.ScrollPane();
        scrollPaneIGD.setViewportView(tbLabIGD);
        tbLabIGD.setName("tbLabIGD");

        scrollPaneIGD2 = new widget.ScrollPane();
        scrollPaneIGD2.setViewportView(tbLabIGD2);
        tbLabIGD2.setName("tbLabIGD2");

        TabIGD = new javax.swing.JTabbedPane();
        TabIGD.addTab("Data Permintaan", scrollPaneIGD);
        TabIGD.addTab("Item Permintaan", scrollPaneIGD2);
        ...
        widget.InternalFrame internalFrameIGD = new widget.InternalFrame();
        internalFrameIGD.setLayout(new java.awt.BorderLayout(1, 1));
        internalFrameIGD.add(TabIGD, java.awt.BorderLayout.CENTER);

        TabPilihRawat.addTab("IGD", internalFrameIGD);

        CrDokterIGD = new widget.TextBox();
        CrDokterIGD.setName("CrDokterIGD");
        CrDokterIGD.setPreferredSize(new Dimension(140, 23));
        CrPoliIGD = new widget.TextBox();
        CrPoliIGD.setName("CrPoliIGD");
        CrPoliIGD.setPreferredSize(new Dimension(140, 23));
    }
    ...
    private void tampilIGD() {
        Valid.tabelKosong(tabMode5);
        try {
            semua = CrDokterIGD.getText().trim().equals("") && CrPoliIGD.getText().trim().equals("")
                    && TCari.getText().trim().equals("");
            ps = koneksi.prepareStatement(
                    "select permintaan_lab.noorder,permintaan_lab.no_rawat,reg_periksa.no_rkm_medis," +
                            "pasien.nm_pasien,permintaan_lab.tgl_permintaan," +
                            ...
                            "if(permintaan_lab.jam_hasil='00:00:00','',permintaan_lab.jam_hasil) as jam_hasil," +
                            "permintaan_lab.dokter_perujuk,dokter.nm_dokter,poliklinik.nm_poli," +
            ...
            try {
                ...
                ps.setString(2, Valid.SetTgl(Tgl2.getSelectedItem() + ""));
                if (!semua) {
                    ps.setString(3, "%" + CrDokterIGD.getText().trim() + "%");
                    ps.setString(4, "%" + CrPoliIGD.getText().trim() + "%");
                    ps.setString(5, "%" + TCari.getText() + "%");
                    ps.setString(6, "%" + TCari.getText() + "%");
                    ps.setString(7, "%" + TCari.getText() + "%");
                    ps.setString(8, "%" + TCari.getText() + "%");
                    ...
                    try {
                        ...
                        while (rs2.next()) {
                            tabMode5.addRow(new Object[] {
                                    "", "", rs2.getString("nm_perawatan"), "", "", "", "", "", "", "",
                                    "Nilai Rujukan L.D.", "Nilai Rujukan L.A.",
                                    "Nilai Rujukan P.D.", "Nilai Rujukan P.A.", "", ""
                            });
                            ps3 = koneksi.prepareStatement(
                                    "select template_laboratorium.Pemeriksaan," +
                                            ...
                                            "inner join template_laboratorium on permintaan_detail_permintaan_lab.id_template=template_laboratorium.id_template "
                                            +
                                            "where permintaan_detail_permintaan_lab.kd_jenis_prw=? and permintaan_detail_permintaan_lab.noorder=? "
                                            +
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    tabMode6.addRow(new String[] {
                            rs.getString("noorder"), rs.getString("no_rawat"),
                            rs.getString("no_rkm_medis") + " " + rs.getString("nm_pasien"),
                            rs.getString("nm_perawatan"), rs.getString("Pemeriksaan"),
                            rs.getString("satuan"), ld + la + pd + pa,
                            rs.getString("tgl_permintaan"), rs.getString("jam_permintaan"),
                            rs.getString("tgl_sampel"), rs.getString("jam_sampel"),
                            rs.getString("tgl_hasil"), rs.getString("jam_hasil"),
                            rs.getString("dokter_perujuk"), rs.getString("nm_dokter"),

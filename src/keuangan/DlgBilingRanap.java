...
public class DlgBilingRanap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        ChkPiutang1.setText("BPJS");
        ChkPiutang1.setToolTipText("");
        ChkPiutang1.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        ChkPiutang1.setName("ChkPiutang1"); // NOI18N
        ChkPiutang1.setOpaque(false);
        ChkPiutang1.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                ChkPiutang1ItemStateChanged(evt);
            }
        });
        ChkPiutang1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ChkPiutang1ActionPerformed(evt);
            }
        });
        panelBayar.add(ChkPiutang1);
        ChkPiutang1.setBounds(10, 230, 60, 23);
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
        ...
        if (TNoRw.getText().trim().equals("") || TNoRM.getText().trim().equals("") || TPasien.getText().trim().equals("")) {
            ...
            try {
                ...
                if (ChkPiutang.isSelected() == false) {
                    ...
                    ChkPiutang1.setVisible(true);
                     if(ChkPiutang1.isSelected()==false){
                    Sequel.menyimpan("temporary_bayar_ranap", "'0','','','','','','','','Tagihan','','','','','','','','',''", "Rekap Harian Tindakan Dokter");
                    Sequel.menyimpan("temporary_bayar_ranap", "'0','TOTAL TAGIHAN',':','','','','','<b>" + TtlSemua.getText() + "</b>','Tagihan','','','','','','','','',''", "Rekap Harian Tindakan Dokter");
                    Sequel.menyimpan("temporary_bayar_ranap", "'0','PPN',':','','','','','<b>" + Valid.SetAngka(besarppn) + "</b>','Tagihan','','','','','','','','',''", "Rekap Harian Tindakan Dokter");
                    Sequel.menyimpan("temporary_bayar_ranap", "'0','TAGIHAN + PPN',':','','','','','<b>" + TagihanPPn.getText() + "</b>','Tagihan','','','','','','','','',''", "Rekap Harian Tindakan Dokter");
                    Sequel.menyimpan("temporary_bayar_ranap", "'0','','','','','','','','Tagihan','','','','','','','','',''", "Rekap Harian Tindakan Dokter");
                    Sequel.menyimpan("temporary_bayar_ranap", "'0','DEPOSIT',':','','','','','<b>" + Deposit.getText() + "</b>','Tagihan','','','','','','','','',''", "Rekap Harian Tindakan Dokter");
                    Sequel.menyimpan("temporary_bayar_ranap", "'0','SUDAH DIBAYAR PASIEN',':','','','','','<b>" + Valid.SetAngka(bayar) + "</b>','Tagihan','','','','','','','','',''", "Rekap Harian Tindakan Dokter");
                    Sequel.menyimpan("temporary_bayar_ranap", "'0','SISA PIUTANG',':','','','','','<b>" + Valid.SetAngka(piutang) + "</b>','Tagihan','','','','','','','','',''", "Rekap Harian Tindakan Dokter");
                    }else if(ChkPiutang1.isSelected()==true){
                    Sequel.menyimpan("temporary_bayar_ranap","'0','','','','','','','','Tagihan','','','','','','','','',''","Rekap Harian Tindakan Dokter"); 
                    Sequel.menyimpan("temporary_bayar_ranap","'0','TOTAL TAGIHAN',':','','','','','<b>"+TtlSemua.getText()+"</b>','Tagihan','','','','','','','','',''","Rekap Harian Tindakan Dokter"); 
                    Sequel.menyimpan("temporary_bayar_ranap","'0','PPN',':','','','','','<b>"+Valid.SetAngka(besarppn)+"</b>','Tagihan','','','','','','','','',''","Rekap Harian Tindakan Dokter"); 
                    Sequel.menyimpan("temporary_bayar_ranap","'0','TAGIHAN + PPN',':','','','','','<b>"+TagihanPPn.getText()+"</b>','Tagihan','','','','','','','','',''","Rekap Harian Tindakan Dokter"); 
                    ...
                    Sequel.menyimpan("temporary_bayar_ranap","'0','DEPOSIT',':','','','','','<b>"+Deposit.getText()+"</b>','Tagihan','','','','','','','','',''","Rekap Harian Tindakan Dokter"); 
                    Sequel.menyimpan("temporary_bayar_ranap","'0','SUDAH DIBAYAR PASIEN',':','','','','','<b>"+Valid.SetAngka(bayar)+"</b>','Tagihan','','','','','','','','',''","Rekap Harian Tindakan Dokter"); 
                    Sequel.menyimpan("temporary_bayar_ranap","'0','DIJAMIN BPJS',':','','','','','<b>"+Valid.SetAngka(piutang)+"</b>','Tagihan','','','','','','','','',''","Rekap Harian Tindakan Dokter");  
                    }  
                }
    ...
    private void ChkPiutang1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_ChkPiutang1ItemStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_ChkPiutang1ItemStateChanged

    private void ChkPiutang1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkPiutang1ActionPerformed
        // TODO add your handling code here:
    ...
    private widget.CekBox ChkPiutang1;
        ...
        try {
            ...
            try {
                ...
                while (rskamarin.next()) {
                    ...
                    String detailKamar = rskamarin.getString("kd_kamar") + ", " + rskamarin.getString("nm_bangsal") +
                                         " (Masuk: " + rskamarin.getString("tgl_masuk") + " " + rskamarin.getString("jam_masuk") +
                                         " | Keluar: " + rskamarin.getString("tgl_keluar") + " " + rskamarin.getString("jam_keluar") + ")";

                    if (!norawatbayi.equals("")) {
                        if (persenbayi > 0) {
                            tabModeRwJlDr.addRow(new Object[]{true, "                           ", detailKamar + " (Ibu)", ":",
                            ...
                            tabModeRwJlDr.addRow(new Object[]{true, "                           ", detailKamar + " (Bayi)", ":",
                            ...
                            tabModeRwJlDr.addRow(new Object[]{true, "                           ", detailKamar, ":",
                                rskamarin.getDouble("trf_kamar"), rskamarin.getDouble("lama"), tamkur, (rskamarin.getDouble("total") + tamkur), "Kamar"});
                            subttl = subttl + rskamarin.getDouble("total") + tamkur;
                        }
                    } else {

...
public class DlgRBObatDokterRalan extends javax.swing.JDialog {
        ...
        carabayar.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (carabayar.getTable().getSelectedRow() != -1) {
                    pilihancarabayar = carabayar.getTable().getValueAt(carabayar.getTable().getSelectedRow(), 1)
                            .toString();
                }
                prosesCari();
            }
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(
                ...
                "::[ Rekap Penggunaan Obat Dokter Perpasien Rawat Jalan ]::",
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            for (i = 0; i < tabMode.getRowCount(); i++) {
                ...
                Sequel.menyimpan("temporary", "'" + i + "','"
                        ...
                        + "','','','','','','','','','','','','','','','','','','','','','','','','','','','','','"
                        + akses.getalamatip() + "'", "Rekap Obat Perdokter Poli");
            }
            ...
            Valid.MyReportqry("rptRBObatPerdokterRalan.jasper", "report", "[ Rekap Obat Dokter Perpasien Ralan]",
        ...
        if (tbDokter.getRowCount() != 0) {
            if (tbDokter.getSelectedRow() > -1) {
                ...
                for (i = 0; i < tbDokter.getRowCount(); i++) {
                    try {
                        if ((!tbDokter.getValueAt(i, 1).toString().substring(0, 1).equals(""))
                                && (!tbDokter.getValueAt(i, 1).toString().substring(0, 1).equals(" "))) {
                            a++;

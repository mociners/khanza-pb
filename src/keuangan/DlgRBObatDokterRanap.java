...
public class DlgRBObatDokterRanap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(
                ...
                "::[ Rekap Penggunaan Obat Dokter Perpasien Rawat Inap ]::",
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptRBObatPerdokterRanap.jasper", "report", "[ Rekap Obat Dokter Perpasien Ralan ]",
    ...
    private void prosesCari() {
        try {
            ...
            try {
                ...
                while (rsdokter.next()) {
                    tabMode.addRow(
                            new Object[] { i + ". ", rsdokter.getString("nm_dokter"), "", "", null, null, null });

    ...
    public DlgTemplateLaboratorium(java.awt.Frame parent, boolean modal) {
        ...
        tbKamar.addKeyListener(new java.awt.event.KeyAdapter() {
            ...
            public void keyPressed(java.awt.event.KeyEvent evt) {
                if ((evt.isControlDown() || evt.isMetaDown()) && evt.getKeyCode() == KeyEvent.VK_V) {
                    pasteFromClipboard();
                }
            }
        });
    ...
    private void pasteFromClipboard() {
        ...
        if (clipboardData != null && clipboardData.isDataFlavorSupported(DataFlavor.stringFlavor)) {
            try {
                ...
                int startRow = tbKamar.getSelectedRow();
                int startCol = tbKamar.getSelectedColumn();

                // Jika tidak ada sel yang dipilih, mulai dari baris dan kolom pertama
                ...
                for (int i = 0; i < rows.length; i++) {
                    ...
                    for (int j = 0; j < cells.length; j++) {
                        if (startRow + i < tbKamar.getRowCount() && startCol + j < tbKamar.getColumnCount()) {
                            tbKamar.setValueAt(cells[j], startRow + i, startCol + j);
                        }
                    }
                }

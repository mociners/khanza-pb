...
private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
    ...
    */
    ...
    public void emptTeksobat() {
        if(ChkRM.isSelected()==true){
            Valid.autoNomer3(
                "select ifnull(MAX(CONVERT(SUBSTRING(resep_obat.no_resep,9),signed)),0) from resep_obat where resep_obat.no_resep like '"+Valid.SetTgl(DTPBeri.getSelectedItem()+"").replaceAll("-","")+"%'",

...
public final class BPJSDataSEP extends javax.swing.JDialog {
    ...
    private String prb = "", no_peserta = "", link = "", ADDANTRIANAPIMOBILEJKN = "no", requestJson, URL = "", query = "", utc = "", user = "", kddokter = "", tglkkl = "0000-00-00", penunjang = "", kodedokterreg = "", kodepolireg = "",
            jammulai = "", jamselesai = "", datajam = "", jeniskunjungan = "", hari = "", nomorreg = "", respon = "200", nobooking = "", statuscheckin = "", FileName = "",kodeberkas="";
    ...
    private void initComponents() {
        ...
        ppSEP.setText("Print SEP Header Doang");
        ...
        TanggalPulang.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-10-2025 10:59:13" }));
        ...
        TanggalKematian.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-10-2025" }));
        ...
        TanggalRujukKeluar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-10-2025" }));
        ...
        TanggalKunjungRujukan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-10-2025" }));
        ...
        TanggalSEP.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-10-2025" }));
        ...
        TanggalRujuk.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-10-2025" }));
        ...
        TanggalKKL.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-10-2025" }));
        ...
        DTPCariInternal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-10-2025" }));
        ...
        DTPCariInternal2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-10-2025" }));
        ...
        if (tabMode.getRowCount() != 0) {
            ...
            if (evt.getClickCount() == 2) {
                ...
                if (i == 0) {
                    ...
                    ppSEP3BtnPrintActionPerformed(null);
                } else if (i == 2) {
    ...
    private void BtnSimpan5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpan5ActionPerformed
        String noSepUntukRujukan = "";

        if (tbDataSEP.getSelectedRow() != -1) {
            noSepUntukRujukan = tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 0).toString();
        } else {
            noSepUntukRujukan = Sequel.cariIsi("select no_sep from bridging_sep where no_rawat=?", TNoRw.getText());
        }

        if (noSepUntukRujukan == null || noSepUntukRujukan.trim().isEmpty()) {
            JOptionPane.showMessageDialog(null, "No. SEP untuk pasien ini tidak ditemukan. Pastikan SEP sudah dibuat.");
            return;
        }
        ...
        if (TNoRw.getText().trim().equals("") || TPasien.getText().trim().equals("")) {
            ...
            try {
                ...
                if (nameNode.path("code").asText().equals("200")) {
                    ...
                    String noRujukan = response.path("rujukan").path("noRujukan").asText();

                    if (Sequel.cariInteger("select count(no_rujukan) from bridging_rujukan_bpjs where no_rujukan=?", noRujukan) > 0 || 
                        Sequel.cariInteger("select count(no_rujuk) from rujuk where no_rujuk=?", noRujukan) > 0) {

                        JOptionPane.showMessageDialog(null, "Gagal menyimpan. Nomor Rujukan '" + noRujukan + "' yang diterima dari BPJS sudah ada di database lokal.\n" +
                                                            "Silakan hapus data rujukan lama yang duplikat, lalu coba lagi.");
                        return;
                    }

                    if (Sequel.menyimpantf("bridging_rujukan_bpjs", "?,?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Rujukan", 14, new String[]{
                        noSepUntukRujukan, Valid.SetTgl(TanggalRujukKeluar.getSelectedItem() + ""),
                        ...
                        TipeRujukan.getSelectedItem().toString(), KdPoli1.getText(), NmPoli1.getText(), noRujukan, user
                    })) {

                        PreparedStatement psRujuk = koneksi.prepareStatement(
                            "INSERT INTO rujuk (no_rujuk, no_rawat, rujuk_ke, tgl_rujuk, keterangan_diagnosa, kd_dokter, kat_rujuk, ambulance, jam) " +
                            "VALUES (?,?,?,?,?,?,?,?,?)"
                        );
                        try {
                            psRujuk.setString(1, noRujukan);
                            psRujuk.setString(2, TNoRw.getText());
                            psRujuk.setString(3, NmPpkRujukan1.getText());
                            psRujuk.setString(4, Valid.SetTgl(TanggalRujukKeluar.getSelectedItem() + ""));
                            psRujuk.setString(5, NmPenyakit1.getText());
                            psRujuk.setString(6, Sequel.cariIsi("select reg_periksa.kd_dokter from reg_periksa where reg_periksa.no_rawat=?", TNoRw.getText()));
                            psRujuk.setString(7, "-");
                            psRujuk.setString(8, "-");
                            psRujuk.setString(9, "12:00:01");
                ...
                if (ex.toString().contains("UnknownHostException")) {
                    ...
                    JOptionPane.showMessageDialog(null, "Gagal menyimpan data rujukan lokal.\nError: " + ex.getMessage());
                }
            }
        }
    ...
    private void btnPPKRujukan1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPPKRujukan1ActionPerformed
        pilihan = 2;
        faskes.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
        faskes.setLocationRelativeTo(WindowRujukan);
        faskes.setVisible(true);
        faskes.isCek();
    ...
    private void btnDiagnosa1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDiagnosa1ActionPerformed
        pilihan = 2;
        penyakit.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
        penyakit.setLocationRelativeTo(WindowRujukan);
        penyakit.setVisible(true);
        penyakit.isCek();
    ...
    private void btnPoli1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPoli1ActionPerformed
        pilihan = 2;
        poli.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
        poli.setLocationRelativeTo(WindowRujukan);
        poli.setVisible(true);
        poli.isCek();
    ...
    private void getData() {
        if (tbDataSEP.getSelectedRow() != -1) {
            ...
            java.util.function.Function<Object, String> safeString = (obj) -> 
                obj == null ? "" : obj.toString();

            TNoRw.setText(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 1)));
            TNoRM.setText(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 2)));
            TPasien.setText(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 3)));
            NoRujukan.setText(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 6)));
            KdPpkRujukan.setText(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 7)));
            NmPpkRujukan.setText(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 8)));
            KdPPK.setText(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 9)));
            NmPPK.setText(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 10)));
            JenisPelayanan.setSelectedItem(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 11)));
            Catatan.setText(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 12)));
            KdPenyakit.setText(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 13)));
            NmPenyakit.setText(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 14)));
            KdPoli.setText(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 15)));
            NmPoli.setText(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 16)));
            Kelas.setSelectedItem(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 17)));
            NaikKelas.setSelectedItem(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 18)));
            Pembiayaan.setSelectedItem(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 19)));
            PenanggungJawab.setText(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 20)));
            LakaLantas.setSelectedItem(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 21)));
            TglLahir.setText(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 23)));
            JenisPeserta.setText(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 24)));
            JK.setText(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 25)));
            NoKartu.setText(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 26)));
            AsalRujukan.setSelectedItem(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 28)));
            Eksekutif.setSelectedItem(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 29)));
            COB.setSelectedItem(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 30)));
            NoTelp.setText(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 31)));
            Katarak.setSelectedItem(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 32)));
            Keterangan.setText(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 34)));
            Suplesi.setSelectedItem(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 35)));
            NoSEPSuplesi.setText(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 36)));
            KdPropinsi.setText(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 37)));
            NmPropinsi.setText(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 38)));
            KdKabupaten.setText(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 39)));
            NmKabupaten.setText(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 40)));
            KdKecamatan.setText(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 41)));
            NmKecamatan.setText(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 42)));
            NoSKDP.setText(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 43)));
            KdDPJP.setText(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 44)));
            NmDPJP.setText(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 45)));
            TujuanKunjungan.setSelectedItem(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 46)));
            FlagProsedur.setSelectedItem(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 47)));
            Penunjang.setSelectedItem(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 48)));
            AsesmenPoli.setSelectedItem(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 49)));
            KdDPJPLayanan.setText(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 50)));
            NmDPJPLayanan.setText(safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 51)));

            Valid.SetTgl(TanggalSEP, safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 4)));
            Valid.SetTgl(TanggalRujuk, safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 5)));
            Valid.SetTgl(TanggalKKL, safeString.apply(tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 33)));
    ...
    /*    public boolean SimpanAntrianOnSite() {
        ...
        if (Sequel.cariInteger(
            ...
            statuscheckin = Sequel.cariIsi(
                    "select referensi_mobilejkn_bpjs.status from referensi_mobilejkn_bpjs where referensi_mobilejkn_bpjs.no_rawat=?",
                    TNoRw.getText());
    ...
    public void setData(String norawat) {
        try {
            ps = koneksi.prepareStatement(
                ...
                + "bridging_sep.nmprop,bridging_sep.kdkab,bridging_sep.nmkab,bridging_sep.kdkec,bridging_sep.nmkec,bridging_sep.noskdp,bridging_sep.kddpjp,bridging_sep.nmdpdjp,"
                + "bridging_sep.tujuankunjungan,bridging_sep.flagprosedur,bridging_sep.penunjang,bridging_sep.asesmenpelayanan,bridging_sep.kddpjplayanan,bridging_sep.nmdpjplayanan "
                + "from bridging_sep where bridging_sep.no_rawat=?");
            try {
                ps.setString(1, norawat);
                rs = ps.executeQuery();
                if (rs.next()) {
                    TNoRw.setText(rs.getString("no_rawat"));
                    TNoRM.setText(rs.getString("nomr"));
                    TPasien.setText(rs.getString("nama_pasien"));
                    NoRujukan.setText(rs.getString("no_rujukan"));
                    KdPpkRujukan.setText(rs.getString("kdppkrujukan"));
                    NmPpkRujukan.setText(rs.getString("nmppkrujukan"));
                    KdPPK.setText(rs.getString("kdppkpelayanan"));
                    NmPPK.setText(rs.getString("nmppkpelayanan"));
                    JenisPelayanan.setSelectedItem(rs.getString("jnspelayanan"));
                    Catatan.setText(rs.getString("catatan"));
                    KdPenyakit.setText(rs.getString("diagawal"));
                    NmPenyakit.setText(rs.getString("nmdiagnosaawal"));
                    KdPoli.setText(rs.getString("kdpolitujuan"));
                    NmPoli.setText(rs.getString("nmpolitujuan"));
                    Kelas.setSelectedItem(rs.getString("klsrawat"));
                    NaikKelas.setSelectedItem(rs.getString("klsnaik").replaceAll("1", "1. VVIP").replaceAll("2", "2. VIP").replaceAll("3", "3. Kelas I").replaceAll("4", "4. Kelas II").replaceAll("5", "5. Kelas III").replaceAll("6", "6. ICCU").replaceAll("7", "7. ICU").replaceAll("8", "8. Diatas Kelas 1"));
                    Pembiayaan.setSelectedItem(rs.getString("pembiayaan").replaceAll("1", "1. Pribadi").replaceAll("2", "2. Pemberi Kerja").replaceAll("3", "3. Asuransi Lain"));
                    PenanggungJawab.setText(rs.getString("pjnaikkelas"));
                    LakaLantas.setSelectedItem(rs.getString("lakalantas").replaceAll("0", "0. Bukan KLL").replaceAll("1", "1. KLL Bukan KK").replaceAll("2", "2. KLL dan KK").replaceAll("3", "3. KK"));
                    TglLahir.setText(rs.getString("tanggal_lahir"));
                    JenisPeserta.setText(rs.getString("peserta"));
                    JK.setText(rs.getString("jkel"));
                    NoKartu.setText(rs.getString("no_kartu"));
                    AsalRujukan.setSelectedItem(rs.getString("asal_rujukan"));
                    Eksekutif.setSelectedItem(rs.getString("eksekutif"));
                    COB.setSelectedItem(rs.getString("cob"));
                    NoTelp.setText(rs.getString("notelep"));
                    Katarak.setSelectedItem(rs.getString("katarak"));
                    Keterangan.setText(rs.getString("keterangankkl"));
                    Suplesi.setSelectedItem(rs.getString("suplesi"));
                    NoSEPSuplesi.setText(rs.getString("no_sep_suplesi"));
                    KdPropinsi.setText(rs.getString("kdprop"));
                    NmPropinsi.setText(rs.getString("nmprop"));
                    KdKabupaten.setText(rs.getString("kdkab"));
                    NmKabupaten.setText(rs.getString("nmkab"));
                    KdKecamatan.setText(rs.getString("kdkec"));
                    NmKecamatan.setText(rs.getString("nmkec"));
                    NoSKDP.setText(rs.getString("noskdp"));
                    KdDPJP.setText(rs.getString("kddpjp"));
                    NmDPJP.setText(rs.getString("nmdpdjp"));
                    TujuanKunjungan.setSelectedItem(rs.getString("tujuankunjungan").replaceAll("0", "0. Normal").replaceAll("1", "1. Prosedur").replaceAll("2", "2. Konsul Dokter"));
                    FlagProsedur.setSelectedItem(rs.getString("flagprosedur").replaceAll("0", "0. Prosedur Tidak Berkelanjutan").replaceAll("1", "1. Prosedur dan Terapi Berkelanjutan"));
                    Penunjang.setSelectedItem(rs.getString("penunjang"));
                    AsesmenPoli.setSelectedItem(rs.getString("asesmenpelayanan").replaceAll("1", "1. Poli spesialis tidak tersedia pada hari sebelumnya").replaceAll("2", "2. Jam Poli telah berakhir pada hari sebelumnya").replaceAll("3", "3. Spesialis yang dimaksud tidak praktek pada hari sebelumnya").replaceAll("4", "4. Atas Instruksi RS").replaceAll("5", "5. Tujuan Kontrol"));
                    KdDPJPLayanan.setText(rs.getString("kddpjplayanan"));
                    NmDPJPLayanan.setText(rs.getString("nmdpjplayanan"));
                    Valid.SetTgl(TanggalSEP, rs.getString("tglsep"));
                    Valid.SetTgl(TanggalRujuk, rs.getString("tglrujukan"));
                    Valid.SetTgl(TanggalKKL, rs.getString("tglkkl"));
                    Status.setText("AKTIF");
                }
            } catch (Exception e) {
                System.out.println("Notif : " + e);
    ...
    public javax.swing.JDialog getWindowRujukan() {
        return WindowRujukan;
    }
    
    public void cariDanTampilkanRujukan(String norawat, Date tglSEP, java.awt.Component parent) {
        DTPCari1.setDate(tglSEP);
        DTPCari2.setDate(tglSEP);
        TCari.setText(norawat);

        tampil();

        if (tabMode.getRowCount() > 0) {
            tbDataSEP.setRowSelectionInterval(0, 0);
            getData();

            WindowRujukan.setLocationRelativeTo(parent);
            WindowRujukan.setVisible(true);
        } else {
            JOptionPane.showMessageDialog(parent, "Data SEP untuk No. Rawat " + norawat + " tidak ditemukan di database lokal.");
        }
    }
    
    public void cariDanTampilkanRujukan1(String norawat, java.awt.Component parent) {
        TCari.setText(norawat);
    ...
    public void cariDanTampilkanRujukan2(String norawat, Date tglSEP, java.awt.Component parent) {
        DTPCari1.setDate(tglSEP);
        DTPCari2.setDate(tglSEP);
        TCari.setText(norawat);

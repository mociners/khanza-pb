 ...
 * @author dosen
 */
public final class SuratRujukanBalik extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public SuratRujukanBalik(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Surat Rujukan Balik ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(440, 220));
        ...
        TPasien.setBounds(323, 12, 360, 23);
        ...
        DTPBeri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "26-10-2024" }));
        ...
        jLabel14.setBounds(10, 100, 60, 23);
        ...
        Diagnosa.setBounds(80, 100, 570, 23);

        jLabel15.setText("No Kartu BPJS:");
        jLabel15.setName("jLabel15"); // NOI18N
        FormInput.add(jLabel15);
        jLabel15.setBounds(2, 130, 80, 23);
        ...
        NoPeserta.setBounds(90, 130, 250, 23);
        ...
        NoTelp.setBounds(440, 130, 210, 23);

        jLabel16.setText("No Hape:");
        jLabel16.setName("jLabel16"); // NOI18N
        FormInput.add(jLabel16);
        jLabel16.setBounds(380, 130, 50, 23);

        jLabel17.setText("Nama PPK 1:");
        jLabel17.setName("jLabel17"); // NOI18N
        FormInput.add(jLabel17);
        jLabel17.setBounds(10, 160, 90, 23);

        Ppk.setHighlighter(null);
        ...
        FormInput.add(Ppk);
        Ppk.setBounds(110, 160, 230, 23);

        jLabel18.setText("Kondisi saat ini:");
        jLabel18.setName("jLabel18"); // NOI18N
        FormInput.add(jLabel18);
        jLabel18.setBounds(380, 160, 90, 23);

        Kondisi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Terkontrol stabil", "Kontrol ulang" }));
        Kondisi.setName("Kondisi"); // NOI18N
        FormInput.add(Kondisi);
        Kondisi.setBounds(490, 160, 160, 20);

        jLabel19.setText("Tanggal Kontrol:");
        jLabel19.setName("jLabel19"); // NOI18N
        FormInput.add(jLabel19);
        jLabel19.setBounds(-20, 190, 100, 23);

        jLabel20.setText("Tindakan Lanjut:");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(190, 190, 90, 23);
        ...
        TindakLanjut.setBounds(290, 190, 360, 23);

        TanggalKontrol.setForeground(new java.awt.Color(50, 70, 50));
        TanggalKontrol.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "26-10-2024" }));
        ...
        TanggalKontrol.setBounds(90, 190, 90, 23);
...
private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
    ...
    if (TNoRw.getText().trim().equals("") || TPasien.getText().trim().equals("")) {
        ...
        if (reply == JOptionPane.YES_OPTION) {
            ...
            sukses = true;
            if (Sequel.menyimpantf2("surat_rujukan_balik", "?,?,?,?,?,?,?,?,?,?,?", "Nomer Resep", 11, new String[]{
                ...
                cmbJam.getSelectedItem() + ":" + cmbMnt.getSelectedItem() + ":" + cmbDtk.getSelectedItem(),
                Ppk.getText(), Kondisi.getSelectedItem().toString(), Valid.SetTgl(TanggalKontrol.getSelectedItem() + ""),
                TindakLanjut.getText()
            }) == true) {
                simpandata();
            } else {
                emptTeksobat();
                if (Sequel.menyimpantf2("surat_rujukan_balik", "?,?,?,?,?,?,?", "Nomer Resep", 7, new String[]{
                    NoResep.getText(), Valid.SetTgl(DTPBeri.getSelectedItem() + ""),
                    cmbJam.getSelectedItem() + ":" + cmbMnt.getSelectedItem() + ":" + cmbDtk.getSelectedItem(),
                    TNoRw.getText(), KdDokter.getText(), Valid.SetTgl(DTPBeri.getSelectedItem() + ""),
                    cmbJam.getSelectedItem() + ":" + cmbMnt.getSelectedItem() + ":" + cmbDtk.getSelectedItem(),
...
private void ppBersihkanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBersihkanActionPerformed
    ...
    private void BtnCari1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCari1ActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        SuratRujukanBalikCetak form = new SuratRujukanBalikCetak(null, false);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SuratRujukanBalik dialog = new SuratRujukanBalik(new javax.swing.JFrame(), true);
    ...
    public void emptTeksobat() {
        if (ChkRM.isSelected() == true) {
            Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(surat_rujukan_balik.no_resep,3),signed)),0) from surat_rujukan_balik where surat_rujukan_balik.tgl_perawatan='" + Valid.SetTgl(DTPBeri.getSelectedItem() + "") + "' ",
                    "SRB" + DTPBeri.getSelectedItem().toString().substring(6, 10) + DTPBeri.getSelectedItem().toString().substring(3, 5) + DTPBeri.getSelectedItem().toString().substring(0, 2), 3, NoResep);
        }
    }
    ...
    public void setNoRm(String norwt, String norm, String KodeDokter, String NamaDokter, String Pasien) {
        TNoRw.setText(norwt);
        TNoRm.setText(norm);
        TPasien.setText(Pasien);
        KdDokter.setText(KodeDokter);
        NmDokter.setText(NamaDokter);
        NoPeserta.setText(Sequel.cariIsi("select no_peserta from pasien where no_rkm_medis=?", norm));
        NoTelp.setText(Sequel.cariIsi("select no_tlp from pasien where no_rkm_medis=?", norm));
        Ppk.setText(Sequel.cariIsi("select nmppkrujukan from bridging_sep where no_rawat=?", norwt));
        Diagnosa.setText(Sequel.cariIsi("SELECT penilaian FROM pemeriksaan_ralan WHERE no_rawat = ? AND nip = '" + KodeDokter + "'", norwt));
        TCari.requestFocus();
    ...
    private void simpandata() {
        try {
            for (i = 0; i < tbResep.getRowCount(); i++) {
                if (Valid.SetAngka(tbResep.getValueAt(i, 0).toString()) > 0) {
                    if (Sequel.menyimpantf2("surat_rujukan_balik_obat", "?,?,?,?", "data", 4, new String[]{
            ...
            for (i = 0; i < tbObatResepRacikan.getRowCount(); i++) {
                if (Valid.SetAngka(tbObatResepRacikan.getValueAt(i, 4).toString()) > 0) {
                    if (Sequel.menyimpantf2("surat_rujukan_balik_racikan", "?,?,?,?,?,?,?", "resep luar racikan", 7, new String[]{
            ...
            for (i = 0; i < tbDetailResepObatRacikan.getRowCount(); i++) {
                if (Valid.SetAngka(tbDetailResepObatRacikan.getValueAt(i, 10).toString()) > 0) {
                    if (Sequel.menyimpantf2("surat_rujukan_balik_racikan_detail", "?,?,?,?,?,?,?", "resep luar racikan detail", 7, new String[]{

 ...
 * @author perpustakaan
 */
public final class SuratRujukanBalikCetak extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public SuratRujukanBalikCetak(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(8, 1);
        setSize(628, 674);

        Object[] row = {"No.Resep", "Tgl.Resep", "Pasien", "Dokter Peresep", "PPK 1", "Kondisi", "Tanggal Kontrol", "Tindak Lanjut"};
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Surat Rujukan Balik ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        BtnCetak.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item (copy).png"))); // NOI18N
        BtnCetak.setMnemonic('R');
        BtnCetak.setText("Cetak");
        BtnCetak.setToolTipText("Alt+R");
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "26-10-2024 07:36:56" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "26-10-2024 07:36:56" }));
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            if (!tbResep.getValueAt(tbResep.getSelectedRow(), 0).toString().equals("")) {
                Sequel.meghapus("surat_rujukan_balik", "no_resep", tbResep.getValueAt(tbResep.getSelectedRow(), 0).toString());
                tampil();
            } else {
    ...
    private void BtnHapusKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnHapusKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_SPACE) {
            ...
            Valid.pindah(evt, BtnCetak, BtnCetak);
        }
    ...
    private void BtnKeluarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnKeluarKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_SPACE) {
            ...
            Valid.pindah(evt, BtnCetak, TCari);
        }
    ...
    private void BtnSimpanInput3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanInput3ActionPerformed
        if (NoResepUbah3.getText().trim().equals("") || (tbTambahan.getRowCount() <= 0)) {
            ...
            Sequel.queryu2("delete from surat_rujukan_balik_obat where no_resep=?", 1, new String[]{NoResepUbah3.getText()});
            for (i = 0; i < tbTambahan.getRowCount(); i++) {
                Sequel.menyimpan("surat_rujukan_balik_obat", "?,?,?,?", 4, new String[]{
    ...
    private void BtnSimpanInput4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanInput4ActionPerformed
        if (NoResepUbah4.getText().trim().equals("") || (tbTambahan1.getRowCount() <= 0)) {
            ...
            for (i = 0; i < tbTambahan1.getRowCount(); i++) {
                Sequel.queryu2("update surat_rujukan_balik_racikan set aturan_pakai=?,nama_racik=? where no_resep=? and no_racik=?", 4, new String[]{
    ...
    private void BtnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCetakActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            if (!tbResep.getValueAt(tbResep.getSelectedRow(), 0).toString().equals("")) {
                try {
                    ps = koneksi.prepareStatement("select surat_rujukan_balik.no_resep,DATE_FORMAT(surat_rujukan_balik.tgl_perawatan,'%d-%m-%Y')as tgl_perawatan,surat_rujukan_balik.jam,reg_periksa.kd_pj,"
                            + " surat_rujukan_balik.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,surat_rujukan_balik.kd_dokter,dokter.nm_dokter,pasien.no_tlp,pasien.no_peserta,DATE_FORMAT(surat_rujukan_balik.tanggalkontrol,'%d-%m-%Y')as tanggalkontrol "
                            + " from surat_rujukan_balik inner join reg_periksa on surat_rujukan_balik.no_rawat=reg_periksa.no_rawat "
                            + " inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                            + " inner join dokter on surat_rujukan_balik.kd_dokter=dokter.kd_dokter where surat_rujukan_balik.no_resep=? ");
                    try {
                        ...
                        if (rs.next()) {
                            ...
                            ps2 = koneksi.prepareStatement(
                                    "select databarang.kode_brng,databarang.nama_brng,surat_rujukan_balik_obat.jml,kodesatuan.satuan,"
                                    + "surat_rujukan_balik_obat.aturan_pakai from surat_rujukan_balik_obat inner join databarang on surat_rujukan_balik_obat.kode_brng=databarang.kode_brng "
                                    + "inner join kodesatuan on databarang.kode_sat=kodesatuan.kode_sat where surat_rujukan_balik_obat.no_resep=? order by databarang.kode_brng");
                            try {
                            ...
                            psracikan = koneksi.prepareStatement(
                                    "select surat_rujukan_balik_racikan.no_racik,surat_rujukan_balik_racikan.nama_racik,"
                                    + "surat_rujukan_balik_racikan.kd_racik,metode_racik.nm_racik as metode,"
                                    + "surat_rujukan_balik_racikan.jml_dr,surat_rujukan_balik_racikan.aturan_pakai,"
                                    + "surat_rujukan_balik_racikan.keterangan from surat_rujukan_balik_racikan inner join metode_racik "
                                    + "on surat_rujukan_balik_racikan.kd_racik=metode_racik.kd_racik where "
                                    + "surat_rujukan_balik_racikan.no_resep=? order by surat_rujukan_balik_racikan.no_racik");
                            try {
                                ...
                                while (rsracikan.next()) {
                                    rincianobat = "";
                                    ps2 = koneksi.prepareStatement(
                                            "select databarang.kode_brng,databarang.nama_brng,surat_rujukan_balik_racikan_detail.jml,kodesatuan.satuan from "
                                            + "surat_rujukan_balik_racikan_detail inner join databarang on surat_rujukan_balik_racikan_detail.kode_brng=databarang.kode_brng "
                                            + "inner join kodesatuan on databarang.kode_sat=kodesatuan.kode_sat where surat_rujukan_balik_racikan_detail.no_resep=? and "
                                            + "surat_rujukan_balik_racikan_detail.no_racik=? order by databarang.kode_brng");
                                    try {
                                        ps2.setString(1, rs.getString("no_resep"));
                            ...
                            param.put("propinsirs", akses.getpropinsirs());
                            param.put("tanggal", rs.getString("tgl_perawatan"));
                            ...
                            param.put("nohp", rs.getString("no_tlp"));
                            param.put("nobpjs", rs.getString("no_peserta"));
                            param.put("diagnosa", Sequel.cariIsi("SELECT penilaian FROM pemeriksaan_ralan WHERE no_rawat = ? AND nip = '" + rs.getString("kd_dokter") + "'", rs.getString("no_rawat")));
                            param.put("ppk", tbResep.getValueAt(tbResep.getSelectedRow(), 4).toString());
                            param.put("kondisi", tbResep.getValueAt(tbResep.getSelectedRow(), 5).toString());
                            param.put("tanggalkontrol", rs.getString("tanggalkontrol"));
                            param.put("tindakan", tbResep.getValueAt(tbResep.getSelectedRow(), 7).toString());
                            ...
                            Valid.MyReportqry("rptSuratRujukanBalik.jasper", "report", "::[ Lembar Resep Obat Yang Ditebus Keluar Oleh Pasien ]::", "select * from temporary_resep where temporary_resep.temp37='" + akses.getalamatip() + "' order by temporary_resep.no", param);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SuratRujukanBalikCetak dialog = new SuratRujukanBalikCetak(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select surat_rujukan_balik.no_resep,surat_rujukan_balik.tgl_perawatan,surat_rujukan_balik.jam,"
                    + " surat_rujukan_balik.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,surat_rujukan_balik.kd_dokter,dokter.nm_dokter,"
                    + " surat_rujukan_balik.ppk1,surat_rujukan_balik.kondisi,surat_rujukan_balik.tanggalkontrol,surat_rujukan_balik.tindaklanjut "
                    + " from surat_rujukan_balik inner join reg_periksa on surat_rujukan_balik.no_rawat=reg_periksa.no_rawat "
                    + " inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                    + " inner join dokter on surat_rujukan_balik.kd_dokter=dokter.kd_dokter where "
                    + " concat(surat_rujukan_balik.tgl_perawatan,' ',surat_rujukan_balik.jam) between ? and ? and "
                    + " (surat_rujukan_balik.no_resep like ? or surat_rujukan_balik.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or dokter.nm_dokter like ?) "
                    + " order by surat_rujukan_balik.tgl_perawatan,surat_rujukan_balik.jam");
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("nm_dokter"), rs.getString("ppk1"), rs.getString("kondisi"), rs.getString("tanggalkontrol"),
                        rs.getString("tindaklanjut")
                    });
                    ...
                    psracikan = koneksi.prepareStatement(
                            ...
                            + "surat_rujukan_balik_racikan.keterangan from surat_rujukan_balik_racikan inner join metode_racik "
                            + "on surat_rujukan_balik_racikan.kd_racik=metode_racik.kd_racik where "
                            + "surat_rujukan_balik_racikan.no_resep=? ");
                    try {
                        psracikan.setString(1, rs.getString("no_resep"));
                        rsracikan = psracikan.executeQuery();
                        while (rsracikan.next()) {
    ...
    private void tampilresep() {
        ...
        try {
            try {
                ps2 = koneksi.prepareStatement(
                        "select surat_rujukan_balik_obat.kode_brng,databarang.nama_brng,surat_rujukan_balik_obat.jml,surat_rujukan_balik_obat.aturan_pakai from surat_rujukan_balik_obat "
                        + "inner join databarang on surat_rujukan_balik_obat.kode_brng=databarang.kode_brng where surat_rujukan_balik_obat.no_resep=?");
    ...
    private void tampilresep2() {
        ...
        try {
            try {
                ps2 = koneksi.prepareStatement(
                        "select surat_rujukan_balik_racikan.no_racik,surat_rujukan_balik_racikan.nama_racik,surat_rujukan_balik_racikan.aturan_pakai from surat_rujukan_balik_racikan where surat_rujukan_balik_racikan.no_resep=?");
    ...
    public void isCek() {
        ...
        BtnCetak.setEnabled(akses.getresep_luar());
    }
}

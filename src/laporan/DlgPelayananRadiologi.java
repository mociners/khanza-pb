...
public final class DlgPelayananRadiologi extends javax.swing.JDialog {
    ...
    public DlgPelayananRadiologi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Jam Hasil","Permintaan-Sampel(m)","Sampel-Hasil(m)","Permintaan-Hasil(m)","Nama Pemeriksaan"
            }){
    ...
    public void tampil(){        
        try{   
            ...
            ps=koneksi.prepareStatement(
                ...
                "round((TIME_TO_SEC(concat(permintaan_radiologi.tgl_hasil,' ',permintaan_radiologi.jam_hasil))-TIME_TO_SEC(concat(permintaan_radiologi.tgl_permintaan,' ',permintaan_radiologi.jam_permintaan)))/60,2) as permintaanhasil,jns_perawatan_radiologi.nm_perawatan " +
                ...
                "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and reg_periksa.no_rawat=permintaan_radiologi.no_rawat inner join permintaan_pemeriksaan_radiologi on permintaan_pemeriksaan_radiologi.noorder=permintaan_radiologi.noorder inner join jns_perawatan_radiologi on jns_perawatan_radiologi.kd_jenis_prw = permintaan_pemeriksaan_radiologi.kd_jenis_prw   where "+
                ...
                "permintaan_radiologi.tgl_sampel<>'0000-00-00' and permintaan_radiologi.tgl_hasil<>'0000-00-00' and permintaan_radiologi.tgl_permintaan between ? and ? and  jns_perawatan_radiologi.nm_perawatan like ? or " +
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("permintaansampel"),rs.getString("sampelhasil"),rs.getString("permintaanhasil"),rs.getString("nm_perawatan")
                    });
                    i++;

...
public final class DlgKunjunganRalan extends javax.swing.JDialog {
    ...
    public DlgKunjunganRalan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{"No.","Lama","Baru","Nama Pasien","L","P","Alamat","Kode","Diagnosa","Dokter Jaga","No HP"}){
        ...
        try {            
            ...
            switch (pilihan) {
                case "Laporan 1 (HTML)":
                        ...
                        htmlContent.append(                             
                            "<tr class='isi'>"+
                                ...
                                "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>No HP</b></td>"+
                            "</tr>"
                        ); 
                ...
                case "Laporan 3 (CSV)":
                        htmlContent = new StringBuilder();
                        htmlContent.append(                             
                            "\"No.\";\"Lama\";\"Baru\";\"Nama Pasien\";\"L\";\"P\";\"Alamat\";\"Kode\";\"Diagnosa\";\"Dokter Jaga\";\"No HP\"\n"
                        ); 
                        if(TabRawat.getSelectedIndex()==0){
                            for(i=0;i<tabMode.getRowCount();i++){  
                                htmlContent.append(                             
        ...
        try{   
            ...
            if(nmpoli.getText().trim().equals("")&&nmdokter.getText().trim().equals("")&&nmpenjab.getText().trim().equals("")&&nmkabupaten.getText().trim().equals("")&&nmkecamatan.getText().trim().equals("")&&nmkelurahan.getText().trim().equals("")&&TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                        ...
                        "concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab)as almt_pj,pasien.jk,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur) as umur,pasien.tgl_daftar,pasien.no_tlp " +

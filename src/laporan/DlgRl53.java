 ...
 * @author perpustakaan
 */
public final class DlgRl53 extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public DlgRl53(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Object[] rowRwJlDr = {
            "No.", "Kelompok ICD-10", "Kelompok Diagnosis Penyakit", "Kasus Baru (L)","Kasus Baru (P)","Total Kasus Baru",
            "Jumlah Kunjungan (L)","Jumlah Kunjungan (P)","Total Jumlah Kunjungan"
        };
...
// Mengatur lebar kolom
        for (int i = 0; i < rowRwJlDr.length; i++) {
            ...
            if (i == 0) {
                ...
                column.setPreferredWidth(100); // Kolom "Jenis Pelayanan" lebih besar
            } else if (i == 2) {
                column.setPreferredWidth(300); // Kolom "Jenis Pelayanan" lebih besar    
            } else {
                column.setPreferredWidth(140); // Kolom lainnya
            }
        }
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Formulir RL 5.3 10 Besar Kunjungan Penyakit Rawat Jalan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRl53 dialog = new DlgRl53(new javax.swing.JFrame(), true);
        ...
        try {
            ...
            while (rs.next()) {
                dalamkotal = Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa inner join poliklinik on reg_periksa.kd_poli = poliklinik.kd_poli inner join pasien on reg_periksa.no_rkm_medis = pasien.no_rkm_medis "
                        ...
                        + "and pasien.jk = 'L' and reg_periksa.stts<>'Batal'");
                ...
                dalamkotap = Sequel.cariInteger("select count(reg_periksa.no_rawat) from reg_periksa inner join poliklinik on reg_periksa.kd_poli = poliklinik.kd_poli inner join pasien on reg_periksa.no_rkm_medis = pasien.no_rkm_medis "
                        + "where reg_periksa.kd_poli = '" + rs.getString("kd_poli") + "' and reg_periksa.tgl_registrasi between '" + Valid.SetTgl(Tgl1.getSelectedItem() + "") + "' and '" + Valid.SetTgl(Tgl2.getSelectedItem() + "") + "' "
                        + "and pasien.jk = 'P' and reg_periksa.stts<>'Batal'");

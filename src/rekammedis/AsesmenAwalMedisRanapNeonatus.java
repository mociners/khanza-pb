...
//        isMenu();
    ...
    private void initComponents() {
        ...
        MnAsesmenAwalMedisNeonatus = new javax.swing.JMenuItem();
        ...
        MnAsesmenAwalMedisNeonatus.setBackground(new java.awt.Color(255, 255, 254));
        MnAsesmenAwalMedisNeonatus.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnAsesmenAwalMedisNeonatus.setForeground(new java.awt.Color(50, 50, 50));
        MnAsesmenAwalMedisNeonatus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnAsesmenAwalMedisNeonatus.setText("Laporan Penilaian Medis Neonatus");
        MnAsesmenAwalMedisNeonatus.setName("MnAsesmenAwalMedisNeonatus"); // NOI18N
        MnAsesmenAwalMedisNeonatus.setPreferredSize(new java.awt.Dimension(220, 26));
        MnAsesmenAwalMedisNeonatus.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnAsesmenAwalMedisNeonatusActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnAsesmenAwalMedisNeonatus);
        ...
        jLabel88.setBounds(100, 1300, 520, 23);
        ...
        jLabel125.setBounds(660, 2860, 120, 23);
        ...
        if(tabMode.getRowCount()==0){
            ...
            try{
                ...
                try {
                    ...
                    htmlContent.append(                             
                        "<tr class='isi'>"+
                            ...
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='115px'><b>Jam</b></td>"+
			    ...
			    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='150px'><b>Riwayat Penyakit Keluarga</b></td>"+
                            ...
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='90px'><b>Kondisi Saat Lahir</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='50px'><b>Keterangan Kondisi</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='80px'><b>Warna Kulit</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='60px'><b>Denyut Jantung</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='75px'><b>Reflek Gerak</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='67px'><b>Tonus Otot</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='40px'><b>Pernafasan</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='80px'><b>Skor Warna Kulit</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='60px'><b>Skor Denyut Jantung</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='75px'><b>Skor Reflek Gerak</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='67px'><b>Skor Tonus Otot</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='40px'><b>Skor Pernafasan</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='40px'><b>Total Pemeriksaan Fisik</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='40px'><b>HR (x/m)</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='40px'><b>RR (x/menit))</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='40px'><b>Suhu</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='80px'><b>SpO2</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='80px'><b>BBL (gr)</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='80px'><b>PB (cm)</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='80px'><b>LK (cm)</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='80px'><b>LD (cm)</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='80px'><b>LP (cm)</b></td>"+
                            ...
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='80px'><b>Punggung</b></td>"+
                            ...
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='80px'><b>Frekuensi Nafas</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='60px'><b>Retraksi</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='75px'><b>Sianosis</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='67px'><b>Air Entry</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='40px'><b>Merintih</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='80px'><b>Skor Frekuensi Nafas</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='60px'><b>Skor Retraksi</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='75px'><b>Skor Sianosis</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='67px'><b>Skor Air Entry</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='40px'><b>Skor Merintih</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='40px'><b>Total Downes</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='80px'><b>Maturitas Kulit</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='80px'><b>Maturitas Lanugo</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='80px'><b>Maturitas Permukaan Plantar Kaki</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='80px'><b>Maturitas Payudara</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='80px'><b>Maturitas Mata / Daun Telinga</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='300px'><b>Maturitas Kelamin Laki-laki</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='80px'><b>Maturitas Kelamin Perempuan</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='60px'><b>Skor Maturitas Kulit</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='75px'><b>Skor Maturitas Lanugo</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='67px'><b>Skor Maturitas Permukaan Plantar Kaki</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='40px'><b>Skor Maturitas Payudara</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='80px'><b>Skor Maturitas Mata / Daun Telinga</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='60px'><b>Skor Maturitas Kelamin Laki-laki</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='75px'><b>Skor Maturitas Kelamin Perempuan</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='67px'><b>Total Maturitas Fisik</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='40px'><b>Skor Sikap</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='40px'><b>Skor Jendela Pergelangan Tangan</b></td>"+  
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='40px'><b>Skor Rikoil Lengan</b></td>"+   
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='60px'><b>Skor Sudut Popliteal</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='75px'><b>Skor Tanda Scraf</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='67px'><b>Skor Tumit Ke Telinga</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='40px'><b>Total Ballarad</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='200px'><b>Sumbu X Lubechenco</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='200px'><b>Sumbu Y Lubechenco</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='170px'><b>Hasil Laboratorium</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='170px'><b>Hasil Radiologi</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='170px'><b>Hasil Penunjang Lainnya</b></td>"+
			    ...
			    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='300px'><b>Tatalaksana</b></td>"+
                    ...
                    while(rs.next()){
                        htmlContent.append(
                            "<tr class='isi'>"+
                               ...
                               "<td valign='top'>"+rs.getString("jam")+"</td>"+
                               ...
                               "<td valign='top'>"+rs.getString("ket_kondisi")+"</td>"+
                               "<td valign='top'>"+rs.getString("warna")+"</td>"+
                               "<td valign='top'>"+rs.getString("denyut")+"</td>"+
                               "<td valign='top'>"+rs.getString("reflek")+"</td>"+
                               "<td valign='top'>"+rs.getString("tonus")+"</td>"+
                               "<td valign='top'>"+rs.getString("pernafasan")+"</td>"+
                               "<td valign='top'>"+rs.getString("s_warna")+"</td>"+
                               "<td valign='top'>"+rs.getString("s_denyut")+"</td>"+
                               "<td valign='top'>"+rs.getString("s_reflek")+"</td>"+
                               "<td valign='top'>"+rs.getString("s_tonus")+"</td>"+
                               "<td valign='top'>"+rs.getString("s_pernafasan")+"</td>"+
                               "<td valign='top'>"+rs.getString("total_fisik")+"</td>"+
                               "<td valign='top'>"+rs.getString("hr")+"</td>"+
                               "<td valign='top'>"+rs.getString("rr")+"</td>"+
                               "<td valign='top'>"+rs.getString("suhu")+"</td>"+
                               "<td valign='top'>"+rs.getString("spo")+"</td>"+
                               "<td valign='top'>"+rs.getString("bbl")+"</td>"+
                               "<td valign='top'>"+rs.getString("pb")+"</td>"+
                               "<td valign='top'>"+rs.getString("lk")+"</td>"+
                               "<td valign='top'>"+rs.getString("ld")+"</td>"+
                               "<td valign='top'>"+rs.getString("lp")+"</td>"+
                               ...
                               "<td valign='top'>"+rs.getString("punggung")+"</td>"+
                               ...
                               "<td valign='top'>"+rs.getString("frekuensi")+"</td>"+
                               "<td valign='top'>"+rs.getString("retraksi")+"</td>"+
                               "<td valign='top'>"+rs.getString("sianosis")+"</td>"+
                               "<td valign='top'>"+rs.getString("air")+"</td>"+
                               "<td valign='top'>"+rs.getString("merintih")+"</td>"+
                               "<td valign='top'>"+rs.getString("s_frekuensi")+"</td>"+
                               "<td valign='top'>"+rs.getString("s_retraksi")+"</td>"+
                               "<td valign='top'>"+rs.getString("s_sianosis")+"</td>"+
                               "<td valign='top'>"+rs.getString("s_air")+"</td>"+
                               "<td valign='top'>"+rs.getString("s_merintih")+"</td>"+
                               "<td valign='top'>"+rs.getString("total_downes")+"</td>"+
                               "<td valign='top'>"+rs.getString("m_kulit")+"</td>"+
                               "<td valign='top'>"+rs.getString("lanugo")+"</td>"+
                               "<td valign='top'>"+rs.getString("permukaan")+"</td>"+
                               "<td valign='top'>"+rs.getString("payudara")+"</td>"+
                               "<td valign='top'>"+rs.getString("m_mata")+"</td>"+
                               "<td valign='top'>"+rs.getString("laki")+"</td>"+
                               "<td valign='top'>"+rs.getString("perempuan")+"</td>"+
                               "<td valign='top'>"+rs.getString("s_kulit")+"</td>"+
                               "<td valign='top'>"+rs.getString("s_lanugo")+"</td>"+
                               "<td valign='top'>"+rs.getString("s_permukaan")+"</td>"+
                               "<td valign='top'>"+rs.getString("s_payudara")+"</td>"+
                               "<td valign='top'>"+rs.getString("s_mata")+"</td>"+
                               "<td valign='top'>"+rs.getString("s_laki")+"</td>"+
                               "<td valign='top'>"+rs.getString("s_perempuan")+"</td>"+
                               "<td valign='top'>"+rs.getString("total_masturitas")+"</td>"+        
                               "<td valign='top'>"+rs.getString("s_sikap")+"</td>"+
                               "<td valign='top'>"+rs.getString("s_jendela")+"</td>"+
                               "<td valign='top'>"+rs.getString("s_rikoil")+"</td>"+
                               "<td valign='top'>"+rs.getString("s_sudut")+"</td>"+
                               "<td valign='top'>"+rs.getString("s_tanda")+"</td>"+
                               "<td valign='top'>"+rs.getString("s_tumit")+"</td>"+
                               "<td valign='top'>"+rs.getString("total_ballarad")+"</td>"+        
                               "<td valign='top'>"+rs.getString("sumbu_x")+"</td>"+
                               "<td valign='top'>"+rs.getString("sumbu_y")+"</td>"+
                    ...
                    File f = new File("DataAsesmenAwalMedisRanapNeonatus.html");            
                                ...
                                "<table width='4600px' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                                    "<tr class='isi2'>"+
                                        "<td valign='top' align='center'>"+
                                            ...
                                            "<font size='2' face='Tahoma'>DATA ASSESSMENT AWAL MEDIS RAWAT INAP NEONATUS<br><br></font>"+        
                                        "</td>"+
                                   "</tr>"+
                                "</table>")
                    );
...
//        tampilMasalah();
    ...
    private void MnAsesmenAwalMedisNeonatusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnAsesmenAwalMedisNeonatusActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            try {
                param.put("ballarad",getClass().getResource("/picture/ballarad1.png").openStream());
                param.put("nilaimaturitas",getClass().getResource("/picture/nilai_maturitas.png").openStream());
                param.put("lubechenco",getClass().getResource("/picture/lubechenco.png").openStream());
            } catch (Exception e) {
            } 
            finger=Sequel.cariIsi("select sha1(sidikjari.sidikjari) from sidikjari inner join pegawai on pegawai.id=sidikjari.id where pegawai.nik=?",tbObat.getValueAt(tbObat.getSelectedRow(),5).toString());
            param.put("finger","Dikeluarkan di "+akses.getnamars()+", Kabupaten/Kota "+akses.getkabupatenrs()+"\nDitandatangani secara elektronik oleh "+tbObat.getValueAt(tbObat.getSelectedRow(),6).toString()+"\nID "+(finger.equals("")?tbObat.getValueAt(tbObat.getSelectedRow(),5).toString():finger)+"\n"+Valid.SetTgl3(tbObat.getValueAt(tbObat.getSelectedRow(),7).toString())); 
            
            Valid.MyReportqry("rptCetakAsesmenAwalMedisRanapNeonatus.jasper","report","::[ Laporan Asesmen Awal Medis Ranap Neonatus ]::",
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,asesmen_medis_ranap_neonatus.tanggal,"+
                        "asesmen_medis_ranap_neonatus.jam,asesmen_medis_ranap_neonatus.kd_dokter,asesmen_medis_ranap_neonatus.anamnesis,asesmen_medis_ranap_neonatus.hubungan,asesmen_medis_ranap_neonatus.keluhan_utama,asesmen_medis_ranap_neonatus.rps,asesmen_medis_ranap_neonatus.rpk,asesmen_medis_ranap_neonatus.rpd,asesmen_medis_ranap_neonatus.rpo,asesmen_medis_ranap_neonatus.alergi,"+
                        "asesmen_medis_ranap_neonatus.kondisi,asesmen_medis_ranap_neonatus.ket_kondisi,asesmen_medis_ranap_neonatus.warna,asesmen_medis_ranap_neonatus.denyut,asesmen_medis_ranap_neonatus.reflek,asesmen_medis_ranap_neonatus.tonus,asesmen_medis_ranap_neonatus.pernafasan,asesmen_medis_ranap_neonatus.s_warna,asesmen_medis_ranap_neonatus.s_denyut,asesmen_medis_ranap_neonatus.s_reflek,asesmen_medis_ranap_neonatus.s_tonus,asesmen_medis_ranap_neonatus.s_pernafasan,asesmen_medis_ranap_neonatus.total_fisik,asesmen_medis_ranap_neonatus.hr,asesmen_medis_ranap_neonatus.rr,asesmen_medis_ranap_neonatus.suhu,asesmen_medis_ranap_neonatus.spo,"+
                        "asesmen_medis_ranap_neonatus.bbl,asesmen_medis_ranap_neonatus.pb,asesmen_medis_ranap_neonatus.lk,asesmen_medis_ranap_neonatus.ld,asesmen_medis_ranap_neonatus.lp,asesmen_medis_ranap_neonatus.kepala,asesmen_medis_ranap_neonatus.mata,asesmen_medis_ranap_neonatus.gigi,asesmen_medis_ranap_neonatus.tht,asesmen_medis_ranap_neonatus.thoraks,"+
                        ...
                        "inner join dokter on asesmen_medis_ranap_neonatus.kd_dokter=dokter.kd_dokter "+
                        "inner join bahasa_pasien on bahasa_pasien.id=pasien.bahasa_pasien "+
                        "inner join cacat_fisik on cacat_fisik.id=pasien.cacat_fisik where asesmen_medis_ranap_neonatus.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
    }//GEN-LAST:event_MnAsesmenAwalMedisNeonatusActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem MnAsesmenAwalMedisNeonatus;

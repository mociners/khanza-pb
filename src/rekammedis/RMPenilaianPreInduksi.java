...
public final class RMPenilaianPreInduksi extends javax.swing.JDialog {
    ...
    public RMPenilaianPreInduksi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[] {
                ...
                "RR(x/menit)", "Suhu(°C)", "EKG", "Lain-lain", "Asesmen", "Perencanaan",
                "Infus Perifier, Tempat & Ukuran", "CVC", "Posisi",
                "Premedikasi", "Keterangan Premedikasi", "Induksi", "Keterangan Induksi", "Face Mask No",
                "Oro/Nasopharing No", "ETT No",
                "ETT Jenis", "ETT Fiksasi", "LMA No", "LMA Jenis", "Tracheostomi", "Bronchoscopi Fiberoptik",
                "Glidescopi", "Tatalaksana Lain-lain",
                "Intubasi Sesudah Tidur", "Intubasi Oral", "Intubasi Tracheostomi", "Keterangan Intubasi",
                "Sulit Ventilasi", "Sulit Intubasi",
                "Ventilasi", "T.R.Jenis", "T.R.Lokasi", "T.R.Jenis Jarum/No", "T.R.Kateter", "T.R.Kateter Fiksasi",
                "T.R.Obat Obatan", "T.R.Komplikasi",
                "T.R.Hasil"
        }) {
            @Override
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(
                ...
                "::[ Penilaian Pre Induksi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
        ...
        Asesmen.setModel(new javax.swing.DefaultComboBoxModel(
                new String[] { "Sesuai Asesmen Pre Sedasi/Anestesi", "Tidak Sesuai Asesmen Pre Sedasi/Anestesi" }));
        ...
        PosisiInfus.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Supine", "Lithotomi", "Lateral",
                "Prone", "Perlindungan Mata", "Kanan", "Kiri", "Lain-lain" }));
        ...
        if (TNoRM.getText().trim().equals("")) {
            ...
            if (Sequel.menyimpantf("penilaian_pre_induksi",
                    ...
                    "No.Rawat, Tanggal & Jam", 44, new String[] {
                            ...
                            KdDokter.getText(),
                            TD.getText(), Nadi.getText(), RR.getText(), Suhu.getText(), EKG.getText(),
                            ...
                            KeteranganIntubasi.getText(), IntubasiSulitVentilasi.getText(),
                            IntubasiSulitIntubasi.getText(), Ventilasi.getText(), TeknikRegionalJenis.getText(),
                            TeknikRegionalLokasi.getText(), TeknikRegionalJenisJarum.getText(),
                            TeknikRegionalKateter.getSelectedItem().toString(), TeknikRegionalKateterFiksasi.getText(),
                            TeknikRegionalObatobatan.getText(), TeknikRegionalKomplikasi.getText(),
                ...
                tabMode.addRow(new String[] {
                        ...
                        Valid.SetTgl(TglAsuhan.getSelectedItem() + "") + " "
                                + TglAsuhan.getSelectedItem().toString().substring(11, 19),
                        TD.getText(), Nadi.getText(), RR.getText(), Suhu.getText(), EKG.getText(), Lainlain.getText(),
                        Asesmen.getSelectedItem().toString(), Perencanaan.getText(), InfusPerifier.getText(),
                        CVC.getText(), PosisiInfus.getSelectedItem().toString(),
                        Premedikasi.getSelectedItem().toString(), KeteranganPremedikasi.getText(),
                        InfusInduksi.getSelectedItem().toString(), KeteranganInfusInduksi.getText(),
                        FaceMaskNo.getText(), NasopharingNo.getText(), ETTNo.getText(), ETTJenis.getText(),
                        ETTFiksasi.getText(), LMANo.getText(), LMAJenis.getText(), Tracheostomi.getText(),
                        BronchoscopiFiberoptik.getText(), Glidescopi.getText(), TatalaksanaLainlain.getText(),
                        IntubasiSesudahTidur.getSelectedItem().toString(),
                        IntubasiOral.getSelectedItem().toString(), IntubasiTracheostomi.getSelectedItem().toString(),
                        KeteranganIntubasi.getText(), IntubasiSulitVentilasi.getText(), IntubasiSulitIntubasi.getText(),
                        Ventilasi.getText(), TeknikRegionalJenis.getText(),
                        TeknikRegionalLokasi.getText(), TeknikRegionalJenisJarum.getText(),
                        TeknikRegionalKateter.getSelectedItem().toString(), TeknikRegionalKateterFiksasi.getText(),
                        TeknikRegionalObatobatan.getText(), TeknikRegionalKomplikasi.getText(),
                        TeknikRegionalHasil.getText()
        ...
        if (tbObat.getSelectedRow() > -1) {
            ...
            Valid.MyReportqry("rptCetakPenilaianPreInduksi.jasper", "report", "::[ Laporan Penilaian Pre Induksi ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_pre_induksi.tanggal,"
                            ...
                            "inner join dokter on penilaian_pre_induksi.kd_dokter=dokter.kd_dokter where penilaian_pre_induksi.no_rawat='"
                            + tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString() + "' " +
                            "and penilaian_pre_induksi.tanggal='"
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[] {
                            ...
                            rs.getString("perencanaan"), rs.getString("infus_perifier"),
                            rs.getString("cvc"), rs.getString("posisi"), rs.getString("premedikasi"),
                            rs.getString("premedikasi_keterangan"), rs.getString("induksi"),
                            rs.getString("induksi_keterangan"), rs.getString("face_mask_no"),
                            ...
                            rs.getString("teknik_regional_jenis_jarum"),
                            rs.getString("teknik_regional_kateter"), rs.getString("teknik_regional_kateter_viksasi"),
    ...
    private void ganti() {
        if (Sequel.mengedittf("penilaian_pre_induksi", "no_rawat=? and tanggal=?",
                ...
                46, new String[] {
                        ...
                        TeknikRegionalKateter.getSelectedItem().toString(), TeknikRegionalKateterFiksasi.getText(),
                        TeknikRegionalObatobatan.getText(), TeknikRegionalKomplikasi.getText(),
                        TeknikRegionalHasil.getText(), tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString(),
                        tbObat.getValueAt(tbObat.getSelectedRow(), 7).toString()
                }) == true) {

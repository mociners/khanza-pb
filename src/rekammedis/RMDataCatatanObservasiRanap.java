...
public final class RMDataCatatanObservasiRanap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnGrafik.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/DefinedParameters.png"))); // NOI18N
        BtnGrafik.setMnemonic('K');
        BtnGrafik.setText("GRAFIK");
        BtnGrafik.setToolTipText("Alt+K");
        BtnGrafik.setName("BtnGrafik"); // NOI18N
        BtnGrafik.setPreferredSize(new java.awt.Dimension(150, 30));
        BtnGrafik.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnGrafikActionPerformed(evt);
            }
        });
        BtnGrafik.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnGrafikKeyPressed(evt);
            }
        });
    ...
    private void BtnGrafikActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnGrafikActionPerformed
        RMDataCatatanObservasiRanapGrafik grafik = new RMDataCatatanObservasiRanapGrafik("GRAFIK OBSERVASI RAWAT INAP: "+TPasien.getText(),
            "select DATE_FORMAT(tgl_perawatan , '%d/%m/%Y') as tgl,jam_rawat,SUBSTRING_INDEX(td, '/', 1) AS sistolik,SUBSTRING_INDEX(td, '/', -1) AS diastolik,replace(suhu,',','.') as suhu,hr,rr from catatan_observasi_ranap where no_rawat='"+TNoRw.getText()+"' and suhu <>''", "Tensi","Suhu","Nadi","Respirasi");
        ...
        grafik.setVisible(true);        // TODO add your handling code here:
    }//GEN-LAST:event_BtnGrafikActionPerformed

    private void BtnGrafikKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnGrafikKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnGrafikKeyPressed

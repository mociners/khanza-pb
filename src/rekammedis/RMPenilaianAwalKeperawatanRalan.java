...
public final class RMPenilaianAwalKeperawatanRalan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Nilai5 = new widget.ComboBox();
        jLabel101 = new widget.Label();
        NilaiATS = new widget.TextBox();
        ...
        jLabel66.setBounds(460, 600, 400, 23);
        ...
        FormInput.add(Lapor);
        Lapor.setBounds(600, 660, 80, 23);

        ATS.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya" }));
        ATS.setName("ATS"); // NOI18N
        ATS.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                ATSItemStateChanged(evt);
            }
        });
        ...
        KetLapor.setBounds(800, 660, 80, 23);
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-01-2025 04:36:07" }));
        ...
        jLabel97.setBounds(470, 660, 130, 23);
        ...
        jLabel71.setBounds(710, 660, 90, 23);
        ...
        jLabel98.setBounds(370, 600, 40, 23);

        jLabel99.setText("Nilai :");
        jLabel99.setName("jLabel99"); // NOI18N
        FormInput.add(jLabel99);
        jLabel99.setBounds(940, 600, 40, 23);

        jLabel100.setText("Nilai :");
        jLabel100.setName("jLabel100"); // NOI18N
        FormInput.add(jLabel100);
        jLabel100.setBounds(650, 630, 40, 23);

        Nilai5.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "0", "2", "1", "2", "3", "4" }));
        Nilai5.setName("Nilai5"); // NOI18N
        Nilai5.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                Nilai5ItemStateChanged(evt);
            }
        });
        Nilai5.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Nilai5KeyPressed(evt);
            }
        });
        FormInput.add(Nilai5);
        Nilai5.setBounds(690, 630, 50, 23);

        jLabel101.setText("Nilai :");
        jLabel101.setName("jLabel101"); // NOI18N
        FormInput.add(jLabel101);
        jLabel101.setBounds(370, 660, 40, 23);

        NilaiATS.setFocusTraversalPolicyProvider(true);
        NilaiATS.setName("NilaiATS"); // NOI18N
        NilaiATS.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                NilaiATSKeyPressed(evt);
            }
        });
        FormInput.add(NilaiATS);
        NilaiATS.setBounds(410, 600, 50, 23);
    ...
    private void Nilai5ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_Nilai5ItemStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_Nilai5ItemStateChanged

    private void Nilai5KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Nilai5KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_Nilai5KeyPressed

    private void ATSItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_ATSItemStateChanged
    /*   if(SkalaResiko1.getSelectedIndex()==0){
            NilaiResiko1.setText("0");
        }else{
            NilaiResiko1.setText("25");
        } */
    if(ATS.getSelectedIndex()==0){
        NilaiATS.setText("0");
    }
    }//GEN-LAST:event_ATSItemStateChanged

    private void NilaiATSKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NilaiATSKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_NilaiATSKeyPressed
    ...
    */
    ...
    private widget.ComboBox Nilai5;
    private widget.TextBox NilaiATS;

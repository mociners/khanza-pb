            ...
            try {
                ...
                if(rs.next()){
                    String[] namaParameter = {
                        "Usia <= 15 tahun dan >= 65 tahun dengan ketergantungan total",
                        "Pasien dengan resiko complain tinggi",
                        "Pasien dengan resiko tinggi",
                        "Riwayat gangguan mental psikiatrik : resiko bunuh diri dan melukai diri sendiri",
                        "Sering masuk IGD dan pasien readmisi rumah sakit",
                        "Pasien melarikan diri dari pelayanan / perawatan",
                        "Kasus yang melebihi rata rata dirawat",
                        "Masalah social",
                        "Perkiraan asuhan dengan biaya tinggi",
                        "Kemungkinan system pembiayaan yang kompleks / finansial",
                        "Membutuhkan asuhan >= 3 dokter spesialis",
                        "Riwayat penggunaan peralatan medis di masa lalu",
                        "Pasien dengan resiko tinggi",
                        "Kasus dengan penyakit kronis, katastropik dan/atau terminal",
                        "Status fungsional rendah, bantuan dalam pemenuhan ADL tinggi",
                        "Kebutuhan kontinuitas pelayanan / discharge planning",
                        "Pasien dengan masalah hukum"
                    };
                    for(int x = 1; x <= 17; x++){

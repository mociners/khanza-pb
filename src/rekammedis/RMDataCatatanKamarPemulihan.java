...
public final class RMDataCatatanKamarPemulihan extends javax.swing.JDialog {
    ...
    public RMDataCatatanKamarPemulihan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[] {
                "No.Rawat", "No.R.M.", "Nama Pasien", "Tgl.Lahir", "Jam Masuk", "Pernapasan", "Bila Spontan",
                "Kesadaran",
                "Aktifitas 1", "Sirkulasi 1", "Pernapasan 1", "Kesadaran 1", "Warna Kulit 1", "Total 1",
                "Jam Di", "Aktifitas 2", "Sirkulasi 2", "Pernapasan 2", "Kesadaran 2", "Warna Kulit 2", "Total 2",
                "VAS",
                "Jam Keluar", "Aktifitas 3", "Sirkulasi 3", "Pernapasan 3", "Kesadaran 3", "Warna Kulit 3", "Total 3",
                "Ke", "Catatan", "Bila Kesakitan", "Bila Mual", "Obat", "Infus", "Pemantauan", "Selama", "Lainnya",
                "NIP", "Nama Petugas"
        }) {
            @Override
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(
                ...
                "::[ Catatan Kamar Pemulihan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRw.getText().trim().equals("") || TPasien.getText().trim().equals("")) {
            ...
            if (Sequel.menyimpantf("catatan_kamar_pemulihan",
                    "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "Data", 36,
                    new String[] {
                            TNoRw.getText(), Valid.SetTgl(TanggalMasuk.getSelectedItem() + ""),
                            Pernapasan.getSelectedItem() + "", BilaSpontan.getSelectedItem() + "",
                            Kesadaran.getSelectedItem() + "",
                            AktifitasMasuk.getText(), SirkulasiMasuk.getText(), PernapasanMasuk.getText(),
                            KesadaranMasuk.getText(), WarnaKulitMasuk.getText(), TotalMasuk.getText(),
                            Valid.SetTgl(TanggalDi.getSelectedItem() + ""), AktifitasDi.getText(),
                            SirkulasiDi.getText(), PernapasanDi.getText(), KesadaranDi.getText(),
                            WarnaKulitDi.getText(), TotalDi.getText(), Vas.getText(),
                            Valid.SetTgl(TanggalKeluar.getSelectedItem() + ""), AktifitasKeluar.getText(),
                            SirkulasiKeluar.getText(), PernapasanKeluar.getText(), KesadaranKeluar.getText(),
                            WarnaKulitKeluar.getText(), TotalKeluar.getText(),
                            Ke.getSelectedItem() + "", Catatan.getText(), Kesakitan.getText(), MualMuntah.getText(),
                            Obat.getText(), Infus.getText(), PemantauanNadi.getText(), Selama.getText(),
                            Lainnya.getText(),
                            NIP.getText()
                    }) == true) {
                tabMode.addRow(new String[] {
                        TNoRw.getText(), TNoRM.getText(), TPasien.getText(), TglLahir.getText(),
                        Valid.SetTgl(TanggalMasuk.getSelectedItem() + ""), Pernapasan.getSelectedItem() + "",
                        BilaSpontan.getSelectedItem() + "", Kesadaran.getSelectedItem() + "",
                        AktifitasMasuk.getText(), SirkulasiMasuk.getText(), PernapasanMasuk.getText(),
                        KesadaranMasuk.getText(), WarnaKulitMasuk.getText(), TotalMasuk.getText(),
                        Valid.SetTgl(TanggalDi.getSelectedItem() + ""), AktifitasDi.getText(), SirkulasiDi.getText(),
                        PernapasanDi.getText(), KesadaranDi.getText(), WarnaKulitDi.getText(), TotalDi.getText(),
                        Vas.getText(),
                        Valid.SetTgl(TanggalKeluar.getSelectedItem() + ""), AktifitasKeluar.getText(),
                        SirkulasiKeluar.getText(), PernapasanKeluar.getText(), KesadaranKeluar.getText(),
                        WarnaKulitKeluar.getText(), TotalKeluar.getText(),
                        Ke.getSelectedItem() + "", Catatan.getText(), Kesakitan.getText(), MualMuntah.getText(),
                        Obat.getText(), Infus.getText(), PemantauanNadi.getText(), Selama.getText(), Lainnya.getText(),
    ...
    private void MnCetakCatatanActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_MnCetakCatatanActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            ...
            String finger = Sequel.cariIsi(
                    ...
                    tbObat.getValueAt(tbObat.getSelectedRow(), 38).toString()); // NIP is at column 38
            param.put("finger",
                    "Dikeluarkan di " + akses.getnamars() + ", Kabupaten/Kota " + akses.getkabupatenrs()
                            + "\nDitandatangani secara elektronik oleh "
                            + tbObat.getValueAt(tbObat.getSelectedRow(), 39).toString() + "\nID " // NamaPegawai is at
                                                                                                  // column 39
                            + (finger.equals("") ? tbObat.getValueAt(tbObat.getSelectedRow(), 38).toString() : finger)
                            + "\n" + tbObat.getValueAt(tbObat.getSelectedRow(), 4).toString()); // Tanggal Masuk Kamar
                                                                                                // Pulih as sign date

            Valid.MyReportqry("rptCatatanKamarPemulihan.jasper", "report", "::[ Catatan Kamar Pemulihan ]::",
                    "select reg_periksa.no_rawat, pasien.no_rkm_medis, pasien.nm_pasien, pasien.tgl_lahir, catatan_kamar_pemulihan.jam_masuk, "
                            + "catatan_kamar_pemulihan.status_pernapasan, catatan_kamar_pemulihan.spontan, catatan_kamar_pemulihan.status_kesadaran, "
                            + "catatan_kamar_pemulihan.aktifitas1, catatan_kamar_pemulihan.sirkulasi1, catatan_kamar_pemulihan.pernapasan1, "
                            + "catatan_kamar_pemulihan.kesadaran1, catatan_kamar_pemulihan.warnakulit1, catatan_kamar_pemulihan.total1, "
                            + "catatan_kamar_pemulihan.jamdi, catatan_kamar_pemulihan.aktifitas2, catatan_kamar_pemulihan.sirkulasi2, "
                            + "catatan_kamar_pemulihan.pernapasan2, catatan_kamar_pemulihan.kesadaran2, catatan_kamar_pemulihan.kulit2, catatan_kamar_pemulihan.total2, "
                            + "catatan_kamar_pemulihan.vas, catatan_kamar_pemulihan.jamkeluar, catatan_kamar_pemulihan.aktifitas3, catatan_kamar_pemulihan.sirkulasi3, "
                            + "catatan_kamar_pemulihan.pernapasan3, catatan_kamar_pemulihan.kesadaran3, catatan_kamar_pemulihan.kulit3, "
                            + "catatan_kamar_pemulihan.total3, catatan_kamar_pemulihan.ke, catatan_kamar_pemulihan.catatan, "
                            + "catatan_kamar_pemulihan.kesakitan, catatan_kamar_pemulihan.mualmuntah, catatan_kamar_pemulihan.obat, "
                            + "catatan_kamar_pemulihan.infus, catatan_kamar_pemulihan.pemantauan, catatan_kamar_pemulihan.selama, catatan_kamar_pemulihan.lainnya, "
                            + "catatan_kamar_pemulihan.pegawai, petugas.nama "
                            + "from catatan_kamar_pemulihan inner join reg_periksa on catatan_kamar_pemulihan.no_rawat=reg_periksa.no_rawat "
                            + "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                            + "inner join petugas on catatan_kamar_pemulihan.pegawai=petugas.nip "
                            + "where catatan_kamar_pemulihan.no_rawat='"
                            + tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString() + "' "
                            + "and catatan_kamar_pemulihan.jam_masuk='"
                            + tbObat.getValueAt(tbObat.getSelectedRow(), 4).toString() + "'",
                    param);
        } else {
            JOptionPane.showMessageDialog(null, "Maaf, silahkan pilih data terlebih dahulu..!!!!");
        }
    }// GEN-LAST:event_MnCetakCatatanActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if (TCari.getText().trim().equals("")) {
                Valid.MyReportqry("rptDataCatatanObservasiIGD.jasper", "report", "::[ Data Catatan Observasi IGD ]::",
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.tgl_lahir,catatan_kamar_pemulihan.jam_masuk,"
                                + "catatan_kamar_pemulihan.status_pernapasan,catatan_kamar_pemulihan.spontan,catatan_kamar_pemulihan.status_kesadaran,"
                                + "catatan_kamar_pemulihan.aktifitas1,catatan_kamar_pemulihan.sirkulasi1,catatan_kamar_pemulihan.pernapasan1,catatan_kamar_pemulihan.kesadaran1,catatan_kamar_pemulihan.warnakulit1,catatan_kamar_pemulihan.total1,"
                                + "catatan_kamar_pemulihan.jamdi,catatan_kamar_pemulihan.aktifitas2,catatan_kamar_pemulihan.sirkulasi2,catatan_kamar_pemulihan.pernapasan2,catatan_kamar_pemulihan.kesadaran2,catatan_kamar_pemulihan.kulit2,catatan_kamar_pemulihan.total2,catatan_kamar_pemulihan.vas,"
                                + "catatan_kamar_pemulihan.jamkeluar,catatan_kamar_pemulihan.aktifitas3,catatan_kamar_pemulihan.sirkulasi3,catatan_kamar_pemulihan.pernapasan3,catatan_kamar_pemulihan.kesadaran3,catatan_kamar_pemulihan.kulit3,catatan_kamar_pemulihan.total3,"
                                + "catatan_kamar_pemulihan.ke,catatan_kamar_pemulihan.catatan,catatan_kamar_pemulihan.kesakitan,catatan_kamar_pemulihan.mualmuntah,catatan_kamar_pemulihan.obat,catatan_kamar_pemulihan.infus,catatan_kamar_pemulihan.pemantauan,catatan_kamar_pemulihan.selama,catatan_kamar_pemulihan.lainnya,"
                                + "catatan_kamar_pemulihan.pegawai,petugas.nama from catatan_kamar_pemulihan inner join reg_periksa on catatan_kamar_pemulihan.no_rawat=reg_periksa.no_rawat "
                                + "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                                + "inner join petugas on catatan_kamar_pemulihan.pegawai=petugas.nip where "
                                + "catatan_kamar_pemulihan.jam_masuk between '"
                                + Valid.SetTgl(DTPCari1.getSelectedItem() + "") + " 00:00:00' and '"
                                + Valid.SetTgl(DTPCari2.getSelectedItem() + "")
                                + " 23:59:59' order by catatan_kamar_pemulihan.jam_masuk",
                        param);
            } else {
                Valid.MyReportqry("rptDataCatatanObservasiIGD.jasper", "report", "::[ Data Catatan Observasi IGD ]::",
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.tgl_lahir,catatan_kamar_pemulihan.jam_masuk,"
                                ...
                                + "%' or catatan_kamar_pemulihan.pegawai like '%" + TCari.getText().trim()
                                + "%' or petugas.nama like '%" + TCari.getText().trim() + "%') "
                                + "order by catatan_kamar_pemulihan.jam_masuk ",
                        param);
            }
        }
    ...
    private javax.swing.JMenuItem MnCetakCatatan;
            ...
            if (TCari.getText().toString().trim().equals("")) {
                ps = koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.tgl_lahir,catatan_kamar_pemulihan.jam_masuk,"
                                ...
                                + "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                                + "inner join petugas on catatan_kamar_pemulihan.pegawai=petugas.nip where "
                                + "catatan_kamar_pemulihan.jam_masuk between ? and ? order by catatan_kamar_pemulihan.jam_masuk");
            } else {
                ps = koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.tgl_lahir,catatan_kamar_pemulihan.jam_masuk,"
                                + "catatan_kamar_pemulihan.status_pernapasan,catatan_kamar_pemulihan.spontan,catatan_kamar_pemulihan.status_kesadaran,"
                                ...
                                + "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                                + "inner join petugas on catatan_kamar_pemulihan.pegawai=petugas.nip where "
                                + "catatan_kamar_pemulihan.jam_masuk between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or catatan_kamar_pemulihan.pegawai like ? or petugas.nama like ?) "
                                + "order by catatan_kamar_pemulihan.jam_masuk ");
            }
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[] {
                            ...
                            rs.getString("jam_masuk"), rs.getString("status_pernapasan"), rs.getString("spontan"),
                            rs.getString("status_kesadaran"),
                            rs.getString("aktifitas1"), rs.getString("sirkulasi1"), rs.getString("pernapasan1"),
                            rs.getString("kesadaran1"), rs.getString("warnakulit1"), rs.getString("total1"),
                            rs.getString("jamdi"), rs.getString("aktifitas2"), rs.getString("sirkulasi2"),
                            rs.getString("pernapasan2"), rs.getString("kesadaran2"), rs.getString("kulit2"),
                            rs.getString("total2"), rs.getString("vas"),
                            rs.getString("jamkeluar"), rs.getString("aktifitas3"), rs.getString("sirkulasi3"),
                            rs.getString("pernapasan3"), rs.getString("kesadaran3"), rs.getString("kulit3"),
                            rs.getString("total3"),
                            rs.getString("ke"), rs.getString("catatan"), rs.getString("kesakitan"),
                            rs.getString("mualmuntah"), rs.getString("obat"), rs.getString("infus"),
                            rs.getString("pemantauan"), rs.getString("selama"), rs.getString("lainnya"),
                            rs.getString("pegawai"), rs.getString("nama")
                    });
                }
            } catch (Exception e) {
    ...
    private void initCatatan() {
        if (MnCetakCatatan == null) {
            MnCetakCatatan = new javax.swing.JMenuItem();
            MnCetakCatatan.setBackground(new java.awt.Color(255, 255, 254));
            MnCetakCatatan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
            MnCetakCatatan.setForeground(new java.awt.Color(50, 50, 50));
            MnCetakCatatan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
            MnCetakCatatan.setText("Formulir Catatan Kamar Pemulihan");
            MnCetakCatatan.setName("MnCetakCatatan"); // NOI18N
            MnCetakCatatan.setPreferredSize(new java.awt.Dimension(230, 26));
            MnCetakCatatan.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent evt) {
                    MnCetakCatatanActionPerformed(evt);
                }
            });
            jPopupMenu1.add(MnCetakCatatan);
        }
        ...
        if (tbObat.getSelectedRow() != -1) {
            ...
            Valid.SetTgl(TanggalMasuk, tbObat.getValueAt(tbObat.getSelectedRow(), 4).toString());
            Pernapasan.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 5).toString());
            BilaSpontan.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 6).toString());
            Kesadaran.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 7).toString());
            ...
            KesadaranMasuk.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 11).toString());
            WarnaKulitMasuk.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 12).toString());
            TotalMasuk.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 13).toString());
            Valid.SetTgl(TanggalDi, tbObat.getValueAt(tbObat.getSelectedRow(), 14).toString());
            AktifitasDi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 15).toString());
            SirkulasiDi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 16).toString());
            PernapasanDi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 17).toString());
            KesadaranDi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 18).toString());
            WarnaKulitDi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 19).toString());
            TotalDi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 20).toString());
            Vas.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 21).toString());
            Valid.SetTgl(TanggalKeluar, tbObat.getValueAt(tbObat.getSelectedRow(), 22).toString());
            AktifitasKeluar.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 23).toString());
            SirkulasiKeluar.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 24).toString());
            PernapasanKeluar.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 25).toString());
            KesadaranKeluar.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 26).toString());
            WarnaKulitKeluar.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 27).toString());
            TotalKeluar.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 28).toString());
            Ke.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 29).toString());
            Catatan.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 30).toString());
            Kesakitan.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 31).toString());
            MualMuntah.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 32).toString());
            Obat.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 33).toString());
            Infus.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 34).toString());
            PemantauanNadi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 35).toString());
            Selama.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 36).toString());
            Lainnya.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 37).toString());
            NIP.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 38).toString());
            NamaPegawai.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 39).toString());
        }
    }
    ...
    private void isForm() {
        if (ChkInput.isSelected() == true) {
            ...
            PanelInput.setPreferredSize(new Dimension(WIDTH, 670));
    ...
    private void ganti() {
         ...
         * "catatan_kamar_pemulihan","tgl_perawatan=? and jam_rawat=? and no_rawat=?"
         * ,"no_rawat=?,tgl_perawatan=?,jam_rawat=?,gcs=?,td=?,hr=?,rr=?,suhu=?,spo2=?,nip=?"
         * ,13,new String[]{
         * TNoRw.getText(),Valid.SetTgl(TanggalMasuk.getSelectedItem()+""),JamMasuk.
         * getSelectedItem()+":"+MenitMasuk.getSelectedItem()+":"+DetikMasuk.
         * getSelectedItem(),
         * AktifitasMasuk.getText(),SirkulasiMasuk.getText(),PernapasanMasuk.getText(),
         * WarnaKulitMasuk.getText(),TotalMasuk.getText(),Catatan.getText(),NIP.getText(
         * ),tbObat.getValueAt(tbObat.getSelectedRow(),6).toString(),
         * tbObat.getValueAt(tbObat.getSelectedRow(),7).toString(),tbObat.getValueAt(
         ...
         * tbObat.setValueAt(Valid.SetTgl(TanggalMasuk.getSelectedItem()+""),tbObat.
         * getSelectedRow(),6);
         * tbObat.setValueAt(JamMasuk.getSelectedItem()+":"+MenitMasuk.getSelectedItem()
         * +":"+DetikMasuk.getSelectedItem(),tbObat.getSelectedRow(),7);
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from catatan_kamar_pemulihan where jam_masuk=? and no_rawat=?", 2, new String[] {
                tbObat.getValueAt(tbObat.getSelectedRow(), 4).toString(),
                tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString()
        }) == true) {

 ...
 * @author perpustakaan
 */
public final class RMPenilaianAwalMedisIGDSpesialis extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMPenilaianAwalMedisIGDSpesialis(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        BtnAmbilData = new widget.Button();
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-06-2024 13:39:11" }));
        ...
        BtnAmbilData.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/2.png"))); // NOI18N
        BtnAmbilData.setMnemonic('S');
        BtnAmbilData.setText("Ambil Data dari Asesmen Awal Medis IGD");
        BtnAmbilData.setToolTipText("Alt+S");
        BtnAmbilData.setName("BtnAmbilData"); // NOI18N
        BtnAmbilData.setPreferredSize(new java.awt.Dimension(200, 30));
        BtnAmbilData.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAmbilDataActionPerformed(evt);
            }
        });
        BtnAmbilData.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnAmbilDataKeyPressed(evt);
            }
        });
        FormInput.add(BtnAmbilData);
        BtnAmbilData.setBounds(860, 100, 290, 30);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("penilaian_medis_igd_spesialis","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",36,new String[]{
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalMedisIGD.jasper","report","::[ Laporan Penilaian Awal Medis IGD ]::",
                "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_igd_spesialis.tanggal,"+
                ...
                "penilaian_medis_igd_spesialis.kepala,penilaian_medis_igd_spesialis.mata,penilaian_medis_igd_spesialis.gigi,penilaian_medis_igd_spesialis.leher,penilaian_medis_igd_spesialis.thoraks,penilaian_medis_igd_spesialis.abdomen,penilaian_medis_igd_spesialis.ekstremitas,penilaian_medis_igd_spesialis.genital,penilaian_medis_igd_spesialis.ket_fisik,"+
                "penilaian_medis_igd_spesialis.ket_lokalis,penilaian_medis_igd_spesialis.ekg,penilaian_medis_igd_spesialis.rad,penilaian_medis_igd_spesialis.lab,penilaian_medis_igd_spesialis.diagnosis,penilaian_medis_igd_spesialis.tata,dokter.nm_dokter "+
                "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join penilaian_medis_igd_spesialis on reg_periksa.no_rawat=penilaian_medis_igd_spesialis.no_rawat "+
                "inner join dokter on penilaian_medis_igd_spesialis.kd_dokter=dokter.kd_dokter where penilaian_medis_igd_spesialis.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
    ...
    private void BtnAmbilDataKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnAmbilDataKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnAmbilDataKeyPressed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalMedisIGDSpesialis dialog = new RMPenilaianAwalMedisIGDSpesialis(new javax.swing.JFrame(), true);
    ...
    private widget.Button BtnAmbilData;
        ...
        try{
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                        ...
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join penilaian_medis_igd_spesialis on reg_periksa.no_rawat=penilaian_medis_igd_spesialis.no_rawat "+
                        "inner join dokter on penilaian_medis_igd_spesialis.kd_dokter=dokter.kd_dokter where "+
                        "penilaian_medis_igd_spesialis.tanggal between ? and ? order by penilaian_medis_igd_spesialis.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_igd_spesialis.tanggal,"+
                        "penilaian_medis_igd_spesialis.kd_dokter,penilaian_medis_igd_spesialis.anamnesis,penilaian_medis_igd_spesialis.hubungan,penilaian_medis_igd_spesialis.keluhan_utama,penilaian_medis_igd_spesialis.rps,penilaian_medis_igd_spesialis.rpk,penilaian_medis_igd_spesialis.rpd,penilaian_medis_igd_spesialis.rpo,penilaian_medis_igd_spesialis.alergi,"+
                        ...
                        "inner join penilaian_medis_igd_spesialis on reg_periksa.no_rawat=penilaian_medis_igd_spesialis.no_rawat "+
                        "inner join dokter on penilaian_medis_igd_spesialis.kd_dokter=dokter.kd_dokter where "+
                        "penilaian_medis_igd_spesialis.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                        "penilaian_medis_igd_spesialis.kd_dokter like ? or dokter.nm_dokter like ?) order by penilaian_medis_igd_spesialis.tanggal");
            }
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from penilaian_medis_igd_spesialis where no_rawat=?",1,new String[]{

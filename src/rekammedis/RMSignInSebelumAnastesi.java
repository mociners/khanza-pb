...
public final class RMSignInSebelumAnastesi extends javax.swing.JDialog {
    ...
    public RMSignInSebelumAnastesi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[] {
                ...
                "Kode Dokter Anest", "Nama Dokter Anestesi", "Identitas", "Alergi", "Area Operasi", "Resiko Aspirasi",
                "Antisipasi Resiko Aspirasi",
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(
                ...
                "::[ Data Sign-In Sebelum Anestesi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
        ...
        KesiapanAlatAnes.setModel(
                new javax.swing.DefaultComboBoxModel(new String[] { "Lengkap", "Pulsa Oximetri", "Tidak Lengkap" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRw.getText().trim().equals("") || TPasien.getText().trim().equals("")) {
            ...
            if (Sequel.menyimpantf("signin_sebelum_anestesi", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "Data", 17,
                    new String[] {
                            TNoRw.getText(),
                            ...
                            Alergi.getText(),
                            ResikoAspirasi.getSelectedItem().toString(), AntisipasiResikoAspirasi.getText(),
                            ResikoKehilanganDarah.getSelectedItem().toString(), JalurIVLine.getText(),
                            RencanaAntisipasiKehilanganDarah.getText(), KesiapanAlatAnes.getSelectedItem().toString(),
                            RencanaAntisipasiKesiapanAlat.getText(), KdPetugasOK.getText()
                    }) == true) {
                tampil();
                emptTeks();
            }
                    ...
                    while (rs.next()) {
                        htmlContent.append(
                                "<tr class='isi'>" +
                                        ...
                                        "<td valign='top'>" + rs.getString("resiko_aspirasi_rencana_antisipasi")
                                        + "</td>" +
                                        "<td valign='top'>" + rs.getString("resiko_kehilangan_darah") + "</td>" +
                                        "<td valign='top'>" + rs.getString("resiko_kehilangan_darah_line") + "</td>" +
                                        "<td valign='top'>" + rs.getString("resiko_kehilangan_darah_rencana_antisipasi")
                                        + "</td>" +
                                        "<td valign='top'>" + rs.getString("kesiapan_alat_obat_anestesi") + "</td>" +
                                        "<td valign='top'>"
                                        + rs.getString("kesiapan_alat_obat_anestesi_rencana_antisipasi") + "</td>" +
        ...
        if (tbObat.getSelectedRow() > -1) {
            ...
            param.put("finger2",
                    "Dikeluarkan di " + akses.getnamars() + ", Kabupaten/Kota " + akses.getkabupatenrs()
                            ...
                            + "\n" + Tanggal.getSelectedItem());
            Valid.MyReportqry("rptFormulirSIgnInSebelumAnestesi.jasper", "report",
                    ...
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.tgl_lahir,pasien.jk,signin_sebelum_anestesi.tanggal,"
                            ...
                            +
                            "inner join petugas on petugas.nip=signin_sebelum_anestesi.nip_perawat_ok " +
                            "where signin_sebelum_anestesi.no_rawat='"
                            + tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString()
                            + "' and signin_sebelum_anestesi.tanggal='"
    ...
    private void ganti() {
        Sequel.mengedit("signin_sebelum_anestesi", "no_rawat=? and tanggal=?",
                ...
                19, new String[] {
                        ...
                        AreaOperasi.getSelectedItem().toString(), Alergi.getText(),
                        ResikoAspirasi.getSelectedItem().toString(), AntisipasiResikoAspirasi.getText(),
                        ResikoKehilanganDarah.getSelectedItem().toString(), JalurIVLine.getText(),
                        RencanaAntisipasiKehilanganDarah.getText(), KesiapanAlatAnes.getSelectedItem().toString(),
                        RencanaAntisipasiKesiapanAlat.getText(), KdPetugasOK.getText(),

 ...
 * @author perpustakaan
 */
public final class RMHemodialisaPerencaanPulang extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMHemodialisaPerencaanPulang(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        namadokter3 = new widget.TextBox();
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Perencanaan Pulang (Disharge Planning) Hemodialisa ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-07-2024" }));
        ...
        jLabel18.setBounds(0, 200, 70, 23);
        ...
        FormInput.add(kddok);
        kddok.setBounds(70, 200, 94, 23);

        namadokter.setEditable(false);
        namadokter.setName("namadokter"); // NOI18N
        FormInput.add(namadokter);
        namadokter.setBounds(170, 200, 185, 23);
        ...
        btnDokter.setBounds(350, 200, 28, 23);

        jLabel24.setText("Edukasi:");
        jLabel24.setName("jLabel24"); // NOI18N
        FormInput.add(jLabel24);
        jLabel24.setBounds(-40, 70, 115, 23);
        ...
        FormInput.add(TLama);
        TLama.setBounds(80, 70, 700, 23);

        jLabel27.setText("Lain-lain:");
        jLabel27.setName("jLabel27"); // NOI18N
        FormInput.add(jLabel27);
        jLabel27.setBounds(120, 160, 50, 23);
        ...
        TAkses.setBounds(170, 160, 610, 23);
        ...
        TDialist.setBounds(170, 100, 610, 23);

        jLabel36.setText("Rencana Konsultasi:");
        jLabel36.setName("jLabel36"); // NOI18N
        FormInput.add(jLabel36);
        jLabel36.setBounds(-30, 100, 200, 23);
        ...
        TPenarikan.setBounds(170, 130, 610, 23);

        jLabel41.setText("Rencana Pemeriksaan Penunjang:");
        jLabel41.setName("jLabel41"); // NOI18N
        FormInput.add(jLabel41);
        jLabel41.setBounds(-30, 130, 200, 23);

        jLabel17.setText("Tanggal Tindakan HD Berikutnya:");
        jLabel17.setName("jLabel17"); // NOI18N
        jLabel17.setVerifyInputWhenFocusTarget(false);
        FormInput.add(jLabel17);
        jLabel17.setBounds(400, 40, 170, 23);

        Tanggal1.setForeground(new java.awt.Color(50, 70, 50));
        Tanggal1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-07-2024" }));
        ...
        Tanggal1.setBounds(580, 40, 90, 23);

        jLabel20.setText("Dokter P.J. :");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(0, 200, 70, 23);
        ...
        btnDokter1.setBounds(350, 200, 28, 23);

        jLabel22.setText("Perawat:");
        jLabel22.setName("jLabel22"); // NOI18N
        FormInput.add(jLabel22);
        jLabel22.setBounds(380, 200, 70, 23);

        jLabel23.setName("jLabel23"); // NOI18N
        FormInput.add(jLabel23);
        jLabel23.setBounds(390, 200, 70, 23);
        ...
        kddok3.setBounds(460, 200, 94, 23);

        namadokter3.setEditable(false);
        namadokter3.setName("namadokter3"); // NOI18N
        FormInput.add(namadokter3);
        namadokter3.setBounds(560, 200, 185, 23);
        ...
        btnDokter3.setBounds(740, 200, 28, 23);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMHemodialisaPerencaanPulang dialog = new RMHemodialisaPerencaanPulang(new javax.swing.JFrame(), true);
    ...
    private widget.TextBox namadokter3;

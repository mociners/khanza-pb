...
public class RMPenilaianAwalKeperawatanRanapAnakNeo extends JDialog {
    ...
    public RMPenilaianAwalKeperawatanRanapAnakNeo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        jam();
    ...
    private void initComponents() {
        ...
        // Tumbuh Kembang
        panelisi pTumbuhKembang = new panelisi();
        pTumbuhKembang.setLayout(new BoxLayout(pTumbuhKembang, 1));
        pTumbuhKembang.setBorder(new TitledBorder("DATA PERTUMBUHAN DAN PERKEMBANGAN"));

        // Riwayat prenatal
        JPanel pPrenatal = new JPanel(new FlowLayout(0, 2, 0));
        pPrenatal.setOpaque(false);
        cmbLamaHamil = new ComboBox();
        cmbLamaHamil.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Cukup Bulan", "Kurang Bulan", "Lebih Bulan" }));
        cmbLamaHamil.setPreferredSize(new Dimension(120, 23));
        pPrenatal.add(this.createLabel("Lama kehamilan :"));
        pPrenatal.add(cmbLamaHamil);
        
        cmbKomplikasi = new ComboBox();
        cmbKomplikasi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya" }));
        cmbKomplikasi.setPreferredSize(new Dimension(80, 23));
        pPrenatal.add(this.createLabel(" Komplikasi :"));
        pPrenatal.add(cmbKomplikasi);

        cmbMasalahNeonatus = new ComboBox();
        cmbMasalahNeonatus.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya" }));
        cmbMasalahNeonatus.setPreferredSize(new Dimension(80, 23));
        pPrenatal.add(this.createLabel(" Masalah neonatus :"));
        pPrenatal.add(cmbMasalahNeonatus);

        cmbMasalahMaternal = new ComboBox();
        cmbMasalahMaternal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya" }));
        cmbMasalahMaternal.setPreferredSize(new Dimension(80, 23));
        pPrenatal.add(this.createLabel(" Masalah maternal :"));
        pPrenatal.add(cmbMasalahMaternal);
        
        pTumbuhKembang.add(this.wrapRow("Riwayat prenatal :", pPrenatal));

        // Riwayat imunisasi
        JPanel pImunisasi = new JPanel(new GridLayout(4, 3, 2, 2));
        pImunisasi.setOpaque(false);
        chkBCG = this.createCekBox("BCG Polio I");
        chkPolioII = this.createCekBox("Polio II");
        chkPolioIII = this.createCekBox("Polio III");
        chkPolioIV = this.createCekBox("Polio IV");
        chkHepB0 = this.createCekBox("Hepatitis B 0");
        chkHepB1 = this.createCekBox("Hepatitis B I");
        chkHepB2 = this.createCekBox("Hepatitis B II");
        chkHepB3 = this.createCekBox("Hepatitis B III");
        chkCampak = this.createCekBox("Campak");
        
        JPanel pLainnya = new JPanel(new FlowLayout(0, 0, 0));
        pLainnya.setOpaque(false);
        chkLainnya = this.createCekBox("Lainnya ");
        txtLainnya = new TextBox();
        txtLainnya.setPreferredSize(new Dimension(100, 23));
        pLainnya.add(chkLainnya);
        pLainnya.add(txtLainnya);

        pImunisasi.add(chkBCG);
        pImunisasi.add(chkHepB0);
        pImunisasi.add(chkCampak);
        pImunisasi.add(chkPolioII);
        pImunisasi.add(chkHepB1);
        pImunisasi.add(pLainnya);
        pImunisasi.add(chkPolioIII);
        pImunisasi.add(chkHepB2);
        pImunisasi.add(new JLabel("")); 
        pImunisasi.add(chkPolioIV);
        pImunisasi.add(chkHepB3);
        pImunisasi.add(new JLabel("")); 

        pTumbuhKembang.add(this.wrapRow("Riwayat imunisasi :", pImunisasi));

        // --- Layout Tumbuh Kembang 2 Kolom ---
        JPanel pTumbuhKembang2Kolom = new JPanel(new FlowLayout(FlowLayout.LEFT, 35, 0));
        pTumbuhKembang2Kolom.setOpaque(false);

        // KOLOM KIRI
        JPanel pKiriTK = new JPanel(new GridLayout(8, 1, 0, 2));
        pKiriTK.setOpaque(false);
        
        JPanel pKondisiBayi = new JPanel(new FlowLayout(FlowLayout.LEFT, 2, 0));
        pKondisiBayi.setOpaque(false);
        pKondisiBayi.add(this.createLabel("Post natal            Kondisi Bayi :"));
        txtKondisiBayi = new TextBox();
        txtKondisiBayi.setPreferredSize(new Dimension(150, 23));
        pKondisiBayi.add(txtKondisiBayi);
        pKiriTK.add(pKondisiBayi);
        
        JPanel pRiwayatTKField = new JPanel(new FlowLayout(FlowLayout.LEFT, 2, 0));
        pRiwayatTKField.setOpaque(false);
        pRiwayatTKField.add(this.createLabel("Riwayat Tumbuh Kembang :"));
        txtRiwayatTK = new TextBox();
        txtRiwayatTK.setPreferredSize(new Dimension(170, 23));
        pRiwayatTKField.add(txtRiwayatTK);
        pKiriTK.add(pRiwayatTKField);
        
        JPanel pDuduk = new JPanel(new FlowLayout(FlowLayout.LEFT, 2, 0));
        pDuduk.setOpaque(false);
        pDuduk.add(this.createLabel("Umur saat duduk      :"));
        txtDuduk = new TextBox();
        txtDuduk.setPreferredSize(new Dimension(184, 23));
        pDuduk.add(txtDuduk);
        pKiriTK.add(pDuduk);
        
        JPanel pMengoceh = new JPanel(new FlowLayout(FlowLayout.LEFT, 2, 0));
        pMengoceh.setOpaque(false);
        pMengoceh.add(this.createLabel("Umur saat mengoceh   :"));
        txtMengoceh = new TextBox();
        txtMengoceh.setPreferredSize(new Dimension(176, 23));
        pMengoceh.add(txtMengoceh);
        pKiriTK.add(pMengoceh);
        
        JPanel pBerdiri = new JPanel(new FlowLayout(FlowLayout.LEFT, 2, 0));
        pBerdiri.setOpaque(false);
        pBerdiri.add(this.createLabel("Umur saat berdiri    :"));
        txtBerdiri = new TextBox();
        txtBerdiri.setPreferredSize(new Dimension(184, 23));
        pBerdiri.add(txtBerdiri);
        pKiriTK.add(pBerdiri);
        
        JPanel pBicara = new JPanel(new FlowLayout(FlowLayout.LEFT, 2, 0));
        pBicara.setOpaque(false);
        pBicara.add(this.createLabel("Umur saat bicara     :"));
        txtBicara = new TextBox();
        txtBicara.setPreferredSize(new Dimension(184, 23));
        pBicara.add(txtBicara);
        pKiriTK.add(pBicara);
        
        JPanel pBerjalan = new JPanel(new FlowLayout(FlowLayout.LEFT, 2, 0));
        pBerjalan.setOpaque(false);
        pBerjalan.add(this.createLabel("Umur saat berjalan   :"));
        txtBerjalan = new TextBox();
        txtBerjalan.setPreferredSize(new Dimension(181, 23));
        pBerjalan.add(txtBerjalan);
        pKiriTK.add(pBerjalan);
        
        pKiriTK.add(new JLabel("")); // empty 8th row
        pTumbuhKembang2Kolom.add(pKiriTK);

        // KOLOM KANAN
        JPanel pKananTK = new JPanel(new GridLayout(8, 1, 0, 2));
        pKananTK.setOpaque(false);
        
        JPanel pApgar = new JPanel(new FlowLayout(FlowLayout.LEFT, 2, 0));
        pApgar.setOpaque(false);
        pApgar.add(this.createLabel("APGAR SCORE          :"));
        txtApgar = new TextBox();
        txtApgar.setPreferredSize(new Dimension(175, 23));
        pApgar.add(txtApgar);
        pKananTK.add(pApgar);
        
        JPanel pLK = new JPanel(new FlowLayout(FlowLayout.LEFT, 2, 0));
        pLK.setOpaque(false);
        pLK.add(this.createLabel("LK/LD/LLA            :"));
        txtLK = new TextBox();
        txtLK.setPreferredSize(new Dimension(45, 23));
        txtLD = new TextBox();
        txtLD.setPreferredSize(new Dimension(45, 23));
        txtLLA = new TextBox();
        txtLLA.setPreferredSize(new Dimension(45, 23));
        pLK.add(txtLK);
        pLK.add(this.createLabel("/"));
        pLK.add(txtLD);
        pLK.add(this.createLabel("/"));
        pLK.add(txtLLA);
        pKananTK.add(pLK);
        
        JPanel pBBLahir = new JPanel(new FlowLayout(FlowLayout.LEFT, 2, 0));
        pBBLahir.setOpaque(false);
        pBBLahir.add(this.createLabel("BB Anak saat lahir   :"));
        txtBBLahir = new TextBox();
        txtBBLahir.setPreferredSize(new Dimension(139, 23));
        pBBLahir.add(txtBBLahir);
        pBBLahir.add(this.createLabel("gram"));
        pKananTK.add(pBBLahir);
        
        JPanel pPBLahir = new JPanel(new FlowLayout(FlowLayout.LEFT, 2, 0));
        pPBLahir.setOpaque(false);
        pPBLahir.add(this.createLabel("PB Anak saat lahir   :"));
        txtPBLahir = new TextBox();
        txtPBLahir.setPreferredSize(new Dimension(146, 23));
        pPBLahir.add(txtPBLahir);
        pPBLahir.add(this.createLabel("cm"));
        pKananTK.add(pPBLahir);
        
        JPanel pASI = new JPanel(new FlowLayout(FlowLayout.LEFT, 2, 0));
        pASI.setOpaque(false);
        pASI.add(this.createLabel("ASI sampai umur      :"));
        txtASI = new TextBox();
        txtASI.setPreferredSize(new Dimension(103, 23));
        pASI.add(txtASI);
        pASI.add(this.createLabel("bulan/tahun"));
        pKananTK.add(pASI);
        
        JPanel pFormula = new JPanel(new FlowLayout(FlowLayout.LEFT, 2, 0));
        pFormula.setOpaque(false);
        pFormula.add(this.createLabel("Formula dimulai      :"));
        txtFormulaMulai = new TextBox();
        txtFormulaMulai.setPreferredSize(new Dimension(60, 23));
        pFormula.add(txtFormulaMulai);
        pFormula.add(this.createLabel("sampai umur"));
        txtFormulaSampai = new TextBox();
        txtFormulaSampai.setPreferredSize(new Dimension(60, 23));
        pFormula.add(txtFormulaSampai);
        pKananTK.add(pFormula);
        
        JPanel pMakananTambahan = new JPanel(new FlowLayout(FlowLayout.LEFT, 2, 0));
        pMakananTambahan.setOpaque(false);
        pMakananTambahan.add(this.createLabel("Makanan tambahan     :"));
        txtMakananTambahan = new TextBox();
        txtMakananTambahan.setPreferredSize(new Dimension(175, 23));
        pMakananTambahan.add(txtMakananTambahan);
        pKananTK.add(pMakananTambahan);
        
        JPanel pPolaAsuhAnak = new JPanel(new FlowLayout(FlowLayout.LEFT, 2, 0));
        pPolaAsuhAnak.setOpaque(false);
        pPolaAsuhAnak.add(this.createLabel("Pola asuh anak       :"));
        txtPolaAsuhAnak = new TextBox();
        txtPolaAsuhAnak.setPreferredSize(new Dimension(175, 23));
        pPolaAsuhAnak.add(txtPolaAsuhAnak);
        pKananTK.add(pPolaAsuhAnak);
        
        pTumbuhKembang2Kolom.add(pKananTK);
        
        pTumbuhKembang.add(pTumbuhKembang2Kolom);

        // Pola asuh anak
        JPanel pPolaAsuh = new JPanel(new GridLayout(4, 1, 2, 2));
        pPolaAsuh.setOpaque(false);
        
        JPanel pPengasuh = new JPanel(new FlowLayout(0, 2, 0));
        pPengasuh.setOpaque(false);
        chkAyah = this.createCekBox("Ayah");
        chkIbu = this.createCekBox("Ibu");
        chkNenek = this.createCekBox("Nenek");
        chkSaudaraLain = this.createCekBox("Saudara lainnya");
        txtSaudaraLain = new TextBox();
        txtSaudaraLain.setPreferredSize(new Dimension(100, 23));
        pPengasuh.add(this.createLabel("- Pengasuh :"));
        pPengasuh.add(chkAyah);
        pPengasuh.add(chkIbu);
        pPengasuh.add(chkNenek);
        pPengasuh.add(chkSaudaraLain);
        pPengasuh.add(txtSaudaraLain);
        pPolaAsuh.add(pPengasuh);

        JPanel pPembawaan = new JPanel(new FlowLayout(0, 2, 0));
        pPembawaan.setOpaque(false);
        chkPeriang = this.createCekBox("Periang");
        chkPenyendiri = this.createCekBox("Penyendiri");
        chkPemberani = this.createCekBox("Pemberani");
        chkPembawaanLain = this.createCekBox("Lainnya");
        txtPembawaanLain = new TextBox();
        txtPembawaanLain.setPreferredSize(new Dimension(100, 23));
        pPembawaan.add(this.createLabel("- Pembawaan umum :"));
        pPembawaan.add(chkPeriang);
        pPembawaan.add(chkPenyendiri);
        pPembawaan.add(chkPemberani);
        pPembawaan.add(chkPembawaanLain);
        pPembawaan.add(txtPembawaanLain);
        pPolaAsuh.add(pPembawaan);

        JPanel pTempramen = new JPanel(new FlowLayout(0, 2, 0));
        pTempramen.setOpaque(false);
        chkPemarah = this.createCekBox("Pemarah");
        chkRamah = this.createCekBox("Ramah");
        chkTempramenLain = this.createCekBox("Lainnya");
        txtTempramenLain = new TextBox();
        txtTempramenLain.setPreferredSize(new Dimension(100, 23));
        pTempramen.add(this.createLabel("- Tempramen :"));
        pTempramen.add(chkPemarah);
        pTempramen.add(chkRamah);
        pTempramen.add(chkTempramenLain);
        pTempramen.add(txtTempramenLain);
        pPolaAsuh.add(pTempramen);

        JPanel pPerilakuUnik = new JPanel(new FlowLayout(0, 2, 0));
        pPerilakuUnik.setOpaque(false);
        ComboBox cmbPerilakuUnik = new ComboBox();
        cmbPerilakuUnik.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya" }));
        cmbPerilakuUnik.setPreferredSize(new Dimension(80, 23));
        txtPerilakuUnik = new TextBox();
        txtPerilakuUnik.setPreferredSize(new Dimension(150, 23));
        pPerilakuUnik.add(this.createLabel("- Kebiasaan perilaku unik :"));
        pPerilakuUnik.add(cmbPerilakuUnik);
        pPerilakuUnik.add(this.createLabel("Jelaskan :"));
        pPerilakuUnik.add(txtPerilakuUnik);
        pPolaAsuh.add(pPerilakuUnik);

        pTumbuhKembang.add(this.wrapRow("Pola asuh anak :", pPolaAsuh));

        // Masalah keperawatan
        JPanel pMasalahKepTK = new JPanel(new GridLayout(2, 1, 2, 2));
        pMasalahKepTK.setOpaque(false);
        chkRisikoPenyakit = this.createCekBox("Risiko terjadi penyakit yang dapat dicegah dengan imunisasi (Pd3I)");
        
        JPanel pGangguanTK = new JPanel(new FlowLayout(0, 2, 0));
        pGangguanTK.setOpaque(false);
        chkGangguanTK = this.createCekBox("Gangguan tumbuh kembang");
        txtGangguanTK = new TextBox();
        txtGangguanTK.setPreferredSize(new Dimension(200, 23));
        pGangguanTK.add(chkGangguanTK);
        pGangguanTK.add(txtGangguanTK);

        pMasalahKepTK.add(chkRisikoPenyakit);
        pMasalahKepTK.add(pGangguanTK);

        pTumbuhKembang.add(this.wrapRow("Masalah keperawatan :", pMasalahKepTK));

        FormInput.add(pTumbuhKembang);
        ...
        this.MnCetak.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent evt) {
                if (RMPenilaianAwalKeperawatanRanapAnakNeo.this.tabMode.getRowCount() == 0) {
                    JOptionPane.showMessageDialog(null, "Maaf, data sudah habis. Tidak ada data yang bisa anda print...!!!!");
                    RMPenilaianAwalKeperawatanRanapAnakNeo.this.BtnBatal.requestFocus();
                } else if (RMPenilaianAwalKeperawatanRanapAnakNeo.this.tbData.getSelectedRow() <= -1) {
        ...
        this.BtnSimpan.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                RMPenilaianAwalKeperawatanRanapAnakNeo.this.simpan();
            }
        });
        this.BtnBatal.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                RMPenilaianAwalKeperawatanRanapAnakNeo.this.emptTeks();
            }
        });
        this.BtnHapus.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                RMPenilaianAwalKeperawatanRanapAnakNeo.this.hapus();
            }
        });
        this.BtnEdit.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                RMPenilaianAwalKeperawatanRanapAnakNeo.this.ganti();
            }
        });
        this.BtnKeluar.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                RMPenilaianAwalKeperawatanRanapAnakNeo.this.dispose();
            }
        });
    }
    ...
    private void jam() {
        ActionListener taskPerformer = new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (RMPenilaianAwalKeperawatanRanapAnakNeo.this.ChkAsesmen.isSelected()) {
                    this.nilai_jam = now.getHours();
                    this.nilai_menit = now.getMinutes();
                    this.nilai_detik = now.getSeconds();
                } else {
                    this.nilai_jam = RMPenilaianAwalKeperawatanRanapAnakNeo.this.JamAsesmen.getSelectedIndex();
                    this.nilai_menit = RMPenilaianAwalKeperawatanRanapAnakNeo.this.MenitAsesmen.getSelectedIndex();
                    this.nilai_detik = RMPenilaianAwalKeperawatanRanapAnakNeo.this.DetikAsesmen.getSelectedIndex();
                }
                if (this.nilai_jam <= 9) {
                    nol_jam = "0";
                }
                ...
                RMPenilaianAwalKeperawatanRanapAnakNeo.this.JamAsesmen.setSelectedItem(jam);
                RMPenilaianAwalKeperawatanRanapAnakNeo.this.MenitAsesmen.setSelectedItem(menit);
                RMPenilaianAwalKeperawatanRanapAnakNeo.this.DetikAsesmen.setSelectedItem(detik);
                nol_jam = "";
                nol_menit = "";
                nol_detik = "";
                if (RMPenilaianAwalKeperawatanRanapAnakNeo.this.ChkTiba.isSelected()) {
                    this.nilai_jam = now.getHours();
                    this.nilai_menit = now.getMinutes();
                    this.nilai_detik = now.getSeconds();
                } else {
                    this.nilai_jam = RMPenilaianAwalKeperawatanRanapAnakNeo.this.JamTiba.getSelectedIndex();
                    this.nilai_menit = RMPenilaianAwalKeperawatanRanapAnakNeo.this.MenitTiba.getSelectedIndex();
                    this.nilai_detik = RMPenilaianAwalKeperawatanRanapAnakNeo.this.DetikTiba.getSelectedIndex();
                }
                if (this.nilai_jam <= 9) {
                    nol_jam = "0";
                }
                ...
                RMPenilaianAwalKeperawatanRanapAnakNeo.this.JamTiba.setSelectedItem(jam);
                RMPenilaianAwalKeperawatanRanapAnakNeo.this.MenitTiba.setSelectedItem(menit);
                RMPenilaianAwalKeperawatanRanapAnakNeo.this.DetikTiba.setSelectedItem(detik);
            }
        };
    ...
    private void simpan() {
        if (this.TNoRw.getText().trim().equals("")) {
            ...
            String[] stringArray = new String[271];
            ...
            stringArray[220] = this.cmbLamaHamil.getSelectedItem().toString();
            stringArray[221] = this.cmbKomplikasi.getSelectedItem().toString();
            stringArray[222] = this.cmbMasalahNeonatus.getSelectedItem().toString();
            stringArray[223] = this.cmbMasalahMaternal.getSelectedItem().toString();
            stringArray[224] = this.chkBCG.isSelected() ? "Ya" : "Tidak";
            stringArray[225] = this.chkPolioII.isSelected() ? "Ya" : "Tidak";
            stringArray[226] = this.chkPolioIII.isSelected() ? "Ya" : "Tidak";
            stringArray[227] = this.chkPolioIV.isSelected() ? "Ya" : "Tidak";
            stringArray[228] = this.chkHepB0.isSelected() ? "Ya" : "Tidak";
            stringArray[229] = this.chkHepB1.isSelected() ? "Ya" : "Tidak";
            stringArray[230] = this.chkHepB2.isSelected() ? "Ya" : "Tidak";
            stringArray[231] = this.chkHepB3.isSelected() ? "Ya" : "Tidak";
            stringArray[232] = this.chkCampak.isSelected() ? "Ya" : "Tidak";
            stringArray[233] = this.chkLainnya.isSelected() ? "Ya" : "Tidak";
            stringArray[234] = this.txtLainnya.getText();
            stringArray[235] = this.txtKondisiBayi.getText();
            stringArray[236] = this.txtApgar.getText();
            stringArray[237] = this.txtLK.getText();
            stringArray[238] = this.txtLD.getText();
            stringArray[239] = this.txtLLA.getText();
            stringArray[240] = this.txtBBLahir.getText();
            stringArray[241] = this.txtPBLahir.getText();
            stringArray[242] = this.txtRiwayatTK.getText();
            stringArray[243] = this.txtDuduk.getText();
            stringArray[244] = this.txtMengoceh.getText();
            stringArray[245] = this.txtBerdiri.getText();
            stringArray[246] = this.txtBicara.getText();
            stringArray[247] = this.txtBerjalan.getText();
            stringArray[248] = this.txtASI.getText();
            stringArray[249] = this.txtFormulaMulai.getText();
            stringArray[250] = this.txtFormulaSampai.getText();
            stringArray[251] = this.txtMakananTambahan.getText();
            stringArray[252] = this.txtPolaAsuhAnak.getText();
            stringArray[253] = this.chkAyah.isSelected() ? "Ya" : "Tidak";
            stringArray[254] = this.chkIbu.isSelected() ? "Ya" : "Tidak";
            stringArray[255] = this.chkNenek.isSelected() ? "Ya" : "Tidak";
            stringArray[256] = this.chkSaudaraLain.isSelected() ? "Ya" : "Tidak";
            stringArray[257] = this.txtSaudaraLain.getText();
            stringArray[258] = this.chkPeriang.isSelected() ? "Ya" : "Tidak";
            stringArray[259] = this.chkPenyendiri.isSelected() ? "Ya" : "Tidak";
            stringArray[260] = this.chkPemberani.isSelected() ? "Ya" : "Tidak";
            stringArray[261] = this.chkPembawaanLain.isSelected() ? "Ya" : "Tidak";
            stringArray[262] = this.txtPembawaanLain.getText();
            stringArray[263] = this.chkPemarah.isSelected() ? "Ya" : "Tidak";
            stringArray[264] = this.chkRamah.isSelected() ? "Ya" : "Tidak";
            stringArray[265] = this.chkTempramenLain.isSelected() ? "Ya" : "Tidak";
            stringArray[266] = this.txtTempramenLain.getText();
            stringArray[267] = this.txtPerilakuUnik.getText();
            stringArray[268] = this.chkRisikoPenyakit.isSelected() ? "Ya" : "Tidak";
            stringArray[269] = this.chkGangguanTK.isSelected() ? "Ya" : "Tidak";
            stringArray[270] = this.txtGangguanTK.getText();
            if (this.Sequel.menyimpantf("penilaian_awal_keperawatan_ranap_anak_neo", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "Data", 271, stringArray)) {
                this.tampil();
                this.emptTeks();
    ...
    private void ganti() {
        if (this.TNoRw.getText().trim().equals("")) {
            ...
            stringArray[219] = this.cmbLamaHamil.getSelectedItem().toString();
            stringArray[220] = this.cmbKomplikasi.getSelectedItem().toString();
            stringArray[221] = this.cmbMasalahNeonatus.getSelectedItem().toString();
            stringArray[222] = this.cmbMasalahMaternal.getSelectedItem().toString();
            stringArray[223] = this.chkBCG.isSelected() ? "Ya" : "Tidak";
            stringArray[224] = this.chkPolioII.isSelected() ? "Ya" : "Tidak";
            stringArray[225] = this.chkPolioIII.isSelected() ? "Ya" : "Tidak";
            stringArray[226] = this.chkPolioIV.isSelected() ? "Ya" : "Tidak";
            stringArray[227] = this.chkHepB0.isSelected() ? "Ya" : "Tidak";
            stringArray[228] = this.chkHepB1.isSelected() ? "Ya" : "Tidak";
            stringArray[229] = this.chkHepB2.isSelected() ? "Ya" : "Tidak";
            stringArray[230] = this.chkHepB3.isSelected() ? "Ya" : "Tidak";
            stringArray[231] = this.chkCampak.isSelected() ? "Ya" : "Tidak";
            stringArray[232] = this.chkLainnya.isSelected() ? "Ya" : "Tidak";
            stringArray[233] = this.txtLainnya.getText();
            stringArray[234] = this.txtKondisiBayi.getText();
            stringArray[235] = this.txtApgar.getText();
            stringArray[236] = this.txtLK.getText();
            stringArray[237] = this.txtLD.getText();
            stringArray[238] = this.txtLLA.getText();
            stringArray[239] = this.txtBBLahir.getText();
            stringArray[240] = this.txtPBLahir.getText();
            stringArray[241] = this.txtRiwayatTK.getText();
            stringArray[242] = this.txtDuduk.getText();
            stringArray[243] = this.txtMengoceh.getText();
            stringArray[244] = this.txtBerdiri.getText();
            stringArray[245] = this.txtBicara.getText();
            stringArray[246] = this.txtBerjalan.getText();
            stringArray[247] = this.txtASI.getText();
            stringArray[248] = this.txtFormulaMulai.getText();
            stringArray[249] = this.txtFormulaSampai.getText();
            stringArray[250] = this.txtMakananTambahan.getText();
            stringArray[251] = this.txtPolaAsuhAnak.getText();
            stringArray[252] = this.chkAyah.isSelected() ? "Ya" : "Tidak";
            stringArray[253] = this.chkIbu.isSelected() ? "Ya" : "Tidak";
            stringArray[254] = this.chkNenek.isSelected() ? "Ya" : "Tidak";
            stringArray[255] = this.chkSaudaraLain.isSelected() ? "Ya" : "Tidak";
            stringArray[256] = this.txtSaudaraLain.getText();
            stringArray[257] = this.chkPeriang.isSelected() ? "Ya" : "Tidak";
            stringArray[258] = this.chkPenyendiri.isSelected() ? "Ya" : "Tidak";
            stringArray[259] = this.chkPemberani.isSelected() ? "Ya" : "Tidak";
            stringArray[260] = this.chkPembawaanLain.isSelected() ? "Ya" : "Tidak";
            stringArray[261] = this.txtPembawaanLain.getText();
            stringArray[262] = this.chkPemarah.isSelected() ? "Ya" : "Tidak";
            stringArray[263] = this.chkRamah.isSelected() ? "Ya" : "Tidak";
            stringArray[264] = this.chkTempramenLain.isSelected() ? "Ya" : "Tidak";
            stringArray[265] = this.txtTempramenLain.getText();
            stringArray[266] = this.txtPerilakuUnik.getText();
            stringArray[267] = this.chkRisikoPenyakit.isSelected() ? "Ya" : "Tidak";
            stringArray[268] = this.chkGangguanTK.isSelected() ? "Ya" : "Tidak";
            stringArray[269] = this.txtGangguanTK.getText();
            stringArray[270] = this.TNoRw.getText();
            if (this.Sequel.mengedittf("penilaian_awal_keperawatan_ranap_anak_neo", "no_rawat=?", "tanggal=?, informasi_dari=?, tgl_tiba=?, nip=?, kd_dokter=?, diagnosa_masuk=?, suhu=?, td=?, nadi_utama=?, rr_utama=?, riwayat_keluarga=?, riwayat_pasien=?, deskripsi_penyakit=?, riwayat_sekarang=?, alat_bantu_igd=?, alat_bantu_persetujuan=?, alat_bantu_perintah=?, alergi=?, jenis_alergi=?, status_nikah=?, pendidikan=?, agama=?, warga_negara=?, pekerjaan=?, aktivitas=?, tinggal_bersama=?, ket_tinggal=?, tempat_tinggal=?, ket_tempat_tinggal=?, curiga=?, curiga_ya=?, curiga_tidak=?, budaya=?, budaya_ya=?, budaya_tidak=?, anak=?, jumlah_anak=?, bimbingan_ibadah=?, masalah_psiko_1=?, masalah_psiko_2=?, masalah_psiko_3=?, masalah_psiko_4=?, kondisi_psikologis=?, ket_psiko=?, status_mental=?, orientasi_orang=?, ket_ori_orang=?, orientasi_tempat=?, ket_ori_tempat=?, orientasi_waktu=?, ket_ori_waktu=?, orientasi_situasi=?, ket_ori_situasi=?, memori=?, pupil_kanan_uk=?, pupil_kanan_reflex=?, pupil_kiri_uk=?, pupil_kiri_reflex=?, gcs_e=?, gcs_m=?, gcs_v=?, gcs_jml=?, tanda_meningeal_kaku=?, tanda_meningeal_brudzinski=?, tanda_meningeal_kernig=?, tanda_meningeal_lain=?, masalah_neuro_1=?, masalah_neuro_2=?, jalan_nafas=?, benda_asing=?, airway_ukuran=?, pernafasan=?, bunyi_nafas=?, kesulitan_nafas=?, alat_nafas=?, oksigen=?, oksigen_ltr=?, oksigen_jenis=?, frekuensi_nafas=?, batuk=?, spo2=?, masalah_nafas_1=?, masalah_nafas_2=?, masalah_nafas_3=?, masalah_nafas_4=?, sirkulasi=?, crt=?, denyut_nadi=?, nadi=?, nadi_jelas=?, irama=?, pacemaker=?, pacemaker_jelas=?, akral=?, masalah_sirk_1=?, ket_masalah_sirk_1=?, masalah_sirk_2=?, ket_masalah_sirk_2=?, masalah_sirk_3=?, ket_masalah_sirk_3=?, bak=?, bak_lainnya=?, kateter=?, kateter_jelas=?, urin_jumlah=?, urin_warna=?, prostat=?, nyeri_pinggang=?, kelainan_kemih=?, kelainan_sebut=?, masalah_kemih_1=?, ket_masalah_kemih_1=?, status_ob_g=?, status_ob_p=?, status_ob_a=?, menstruasi=?, kehamilan=?, kehamilan_hpht=?, kehamilan_hpl=?, post_partum=?, lochea=?, lochea_jumlah=?, payudara=?, pengeluaran_asi=?, kontraksi=?, papsmear=?, papsmear_tgl=?, mammo=?, mammo_tgl=?, sadari=?, skrining_kanker=?, skrining_tgl=?, masalah_rep_1=?, masalah_rep_2=?, masalah_rep_3=?, masalah_rep_4=?, masalah_rep_lain=?, gejala_awal=?, kekerasan_fisik=?, turgor=?, rambut=?, kuku=?, luka=?, luka_dalam=?, perdarahan_integ=?, fraktur=?, lokasi=?, lokasi_lain=?, masalah_integ_1=?, ket_masalah_integ_1=?, masalah_integ_2=?, ket_masalah_integ_2=?, masalah_integ_3=?, ket_masalah_integ_3=?, masalah_integ_4=?, ket_masalah_integ_4=?, telinga=?, telinga_lainnya=?, hidung=?, tenggorokan=?, gigi=?, sakit_gigi=?, gigi_palsu=?, mata=?, mata_lainnya=?, masalah_tht=?, wasir=?, perdarahan_rectal=?, jenis_diit=?, feeding_tube=?, pembatasan_cairan=?, abdomen=?, bunyi_usus=?, bunyi_usus_freq=?, bab=?, bab_sejak=?, bab_freq=?, konsistensi=?, warna_cerna=?, pencahar=?, masalah_pencernaan=?, nyeri_tidak_ada=?, nyeri_ada=?, nyeri_akut=?, nyeri_kronis=?, nyeri_viseral=?, nyeri_somatis=?, nyeri_provokes_diam=?, nyeri_provokes_mobilisasi=?, nyeri_provokes_ditekan=?, nyeri_provokes_tiduran=?, nyeri_provokes_berdiri=?, nyeri_provokes_berjalan=?, nyeri_provokes_lainnya=?, nyeri_quality_tajam=?, nyeri_quality_tumpul=?, nyeri_quality_ditusuk=?, nyeri_quality_ditarik=?, nyeri_quality_dipukul=?, nyeri_quality_berdenyut=?, nyeri_quality_dibakar=?, nyeri_quality_ditikam=?, nyeri_quality_disayat=?, nyeri_quality_lainnya=?, nyeri_radiation=?, nyeri_radiation_lokasi=?, nyeri_severity_metode=?, nyeri_severity_skor=?, nyeri_severity_nyeri=?, nyeri_time_setiap=?, nyeri_time_selama=?, nyeri_time_sejak=?, cpot_ekspresi=?, cpot_gerakan=?, cpot_ketegangan=?, cpot_ventilator=?, cpot_vokalisasi=?, cpot_total=?, cpot_kategori=?, lama_kehamilan=?, komplikasi=?, masalah_neonatus=?, masalah_maternal=?, imun_bcg=?, imun_polio_2=?, imun_polio_3=?, imun_polio_4=?, imun_hepb_0=?, imun_hepb_1=?, imun_hepb_2=?, imun_hepb_3=?, imun_campak=?, imun_lainnya=?, imun_ket_lainnya=?, kondisi_bayi=?, apgar_score=?, lk=?, ld=?, lla=?, bb_lahir=?, pb_lahir=?, riwayat_tumbuh_kembang=?, umur_duduk=?, umur_mengoceh=?, umur_berdiri=?, umur_bicara=?, umur_berjalan=?, asi_sampai_umur=?, formula_dimulai=?, formula_sampai=?, makanan_tambahan=?, pola_asuh=?, pengasuh_ayah=?, pengasuh_ibu=?, pengasuh_nenek=?, pengasuh_saudara=?, pengasuh_saudara_ket=?, pembawaan_periang=?, pembawaan_penyendiri=?, pembawaan_pemberani=?, pembawaan_lainnya=?, pembawaan_ket_lainnya=?, tempramen_pemarah=?, tempramen_ramah=?, tempramen_lainnya=?, tempramen_ket_lainnya=?, perilaku_unik=?, risiko_penyakit=?, gangguan_tk=?, gangguan_tk_ket=?", 271, stringArray)) {
                this.tampil();
                this.emptTeks();
            }
        }
...
private void tampil() {
    ...
    private widget.ComboBox cmbLamaHamil;
    private widget.ComboBox cmbKomplikasi;
    private widget.ComboBox cmbMasalahNeonatus;
    private widget.ComboBox cmbMasalahMaternal;
    
    private widget.CekBox chkBCG;
    private widget.CekBox chkPolioII;
    private widget.CekBox chkPolioIII;
    private widget.CekBox chkPolioIV;
    private widget.CekBox chkHepB0;
    private widget.CekBox chkHepB1;
    private widget.CekBox chkHepB2;
    private widget.CekBox chkHepB3;
    private widget.CekBox chkCampak;
    private widget.CekBox chkLainnya;
    private widget.TextBox txtLainnya;
    
    private widget.TextBox txtKondisiBayi;
    private widget.TextBox txtApgar;
    private widget.TextBox txtLK;
    private widget.TextBox txtLD;
    private widget.TextBox txtLLA;
    private widget.TextBox txtBBLahir;
    private widget.TextBox txtPBLahir;
    
    private widget.TextBox txtRiwayatTK;
    private widget.TextBox txtDuduk;
    private widget.TextBox txtMengoceh;
    private widget.TextBox txtBerdiri;
    private widget.TextBox txtBicara;
    private widget.TextBox txtBerjalan;
    
    private widget.TextBox txtASI;
    private widget.TextBox txtFormulaMulai;
    private widget.TextBox txtFormulaSampai;
    private widget.TextBox txtMakananTambahan;
    
    private widget.TextBox txtPolaAsuhAnak;
    
    private widget.CekBox chkAyah;
    private widget.CekBox chkIbu;
    private widget.CekBox chkNenek;
    private widget.CekBox chkSaudaraLain;
    private widget.TextBox txtSaudaraLain;
    
    private widget.CekBox chkPeriang;
    private widget.CekBox chkPenyendiri;
    private widget.CekBox chkPemberani;
    private widget.CekBox chkPembawaanLain;
    private widget.TextBox txtPembawaanLain;
    
    private widget.CekBox chkPemarah;
    private widget.CekBox chkRamah;
    private widget.CekBox chkTempramenLain;
    private widget.TextBox txtTempramenLain;
    
    private widget.TextBox txtPerilakuUnik;
    private widget.CekBox chkRisikoPenyakit;
    private widget.CekBox chkGangguanTK;
    private widget.TextBox txtGangguanTK;
}

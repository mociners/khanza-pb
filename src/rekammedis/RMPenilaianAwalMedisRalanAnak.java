...
public final class RMPenilaianAwalMedisRalanAnak extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Tgl.Lahir/ Umur :");
        jLabel8.setName("jLabel8"); // NOI18N
        FormInput.add(jLabel8);
        jLabel8.setBounds(570, 10, 90, 23);

        TglLahir.setEditable(false);
        TglLahir.setHighlighter(null);
        TglLahir.setName("TglLahir"); // NOI18N
        FormInput.add(TglLahir);
        TglLahir.setBounds(664, 10, 110, 23);
        ...
        jLabel11.setBounds(780, 10, 30, 23);
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-01-2025 06:03:07" }));
        ...
        try {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    TglLahir.setText(rs.getString("tgl_lahir") + "/" + rs.getString("umur"));
                }
            } catch (Exception e) {
                System.out.println("Notif : " + e);
            } finally {

...
public final class RMLayananKedokteranFisikRehabilitasi extends javax.swing.JDialog {
    ...
    private RMCari5SOAPFisio soapterakhir = new RMCari5SOAPFisio(null, false);
...
// Menambahkan renderer untuk warna tabel
            ...
            public void windowClosed(WindowEvent e) {
                if (soapterakhir.getTable().getSelectedRow() != -1) {
                    if (pilihan == 1) {
                        ...
                        Program.setText(soapterakhir.getTable().getValueAt(soapterakhir.getTable().getSelectedRow(), 5).toString());                        
                    }
    ...
    private void initComponents() {
        ...
        jLabel24.setBounds(100, 10, 80, 23);
        ...
        BtnSimpan1.setText("Ambil Data SOAPIE");
        ...
        BtnSimpan1.setBounds(810, 10, 170, 30);
        ...
        BtnSoapie1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/search_page.png"))); // NOI18N
        BtnSoapie1.setMnemonic('S');
        BtnSoapie1.setText("Riwayat SOAPIE");
        BtnSoapie1.setToolTipText("Alt+S");
        BtnSoapie1.setName("BtnSoapie1"); // NOI18N
        BtnSoapie1.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnSoapie1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnSoapie1ActionPerformed(evt);
            }
        });
        BtnSoapie1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnSoapie1KeyPressed(evt);
            }
        });
        FormInput1.add(BtnSoapie1);
        BtnSoapie1.setBounds(820, 10, 150, 30);
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "23-02-2025" }));
    ...
    private void BtnSoapie1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSoapie1ActionPerformed
        if (TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        } else {
    ...
    }//GEN-LAST:event_BtnSoapie1ActionPerformed

    private void BtnSoapie1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSoapie1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnSoapie1KeyPressed
    ...
    private widget.Button BtnSoapie1;

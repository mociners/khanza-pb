...
public final class RMSignOutSebelumMenutupLuka extends javax.swing.JDialog {
    ...
    public RMSignOutSebelumMenutupLuka(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[] {
                ...
                "Kode Dokter Anest", "Nama Dokter Anestesi", "Verbal Tindakan", "Verbal Kasa", "Verbal Instrumen",
                "Verbal Alat Tajam", "Kelengkapan Spesimen Label",
                "Kelengkapan Spesimen Formulir", "P.K.Dokter Bedah", "P.K.Dokter Anestesi", "P.K.Perawat OK",
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(
                ...
                "::[ Data Sign-Out Sebelum Menutup Luka ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
        ...
        KelengkapanSpesimenLabel.setModel(new javax.swing.DefaultComboBoxModel(
                new String[] { "Lengkap", "Tidak Lengkap", "Tidak Ada Pemeriksaan Spesimen" }));
        ...
        KelengkapanSpesimenFormulir.setModel(new javax.swing.DefaultComboBoxModel(
                new String[] { "Lengkap", "Tidak Lengkap", "Tidak Ada Pemeriksaan Spesimen" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRw.getText().trim().equals("") || TPasien.getText().trim().equals("")) {
            ...
            if (Sequel.menyimpantf("signout_sebelum_menutup_luka", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "Data", 17,
                    new String[] {
                            TNoRw.getText(),
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_BtnHapusActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            if (akses.getkode().equals("Admin Utama")) {
                ...
                if (akses.getkode().equals(tbObat.getValueAt(tbObat.getSelectedRow(), 8).toString())
                        || akses.getkode().equals(tbObat.getValueAt(tbObat.getSelectedRow(), 10).toString())
                        || akses.getkode().equals(tbObat.getValueAt(tbObat.getSelectedRow(), 22).toString())) {
                    hapus();
                } else {
                    ...
                    while (rs.next()) {
                        htmlContent.append(
                                "<tr class='isi'>" +
                                        ...
                                        +
                                        "<td valign='top'>" + rs.getString("peninjauan_kegiatan_dokter_anestesi")
                                        + "</td>" +
                                        "<td valign='top'>" + rs.getString("peninjauan_kegiatan_perawat_kamar_ok")
                                        + "</td>" +
        ...
        if (tbObat.getSelectedRow() > -1) {
            ...
            param.put("finger3",
                    "Dikeluarkan di " + akses.getnamars() + ", Kabupaten/Kota " + akses.getkabupatenrs()
                            ...
                            + (finger3.equals("") ? tbObat.getValueAt(tbObat.getSelectedRow(), 8).toString() : finger3)
                            + "\n" + Tanggal.getSelectedItem());
            Valid.MyReportqry("rptFormulirSignOutSebelumMenutupLuka.jasper", "report",
                    "::[ Formulir Sign-Out Sebelum Menutup Luka ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.tgl_lahir,pasien.jk,signout_sebelum_menutup_luka.tanggal,"
                            +
                            "signout_sebelum_menutup_luka.sncn,signout_sebelum_menutup_luka.tindakan,signout_sebelum_menutup_luka.kd_dokter_bedah,dokterbedah.nm_dokter as dokterbedah,"
                            +
                            ...
                            +
                            "inner join petugas on petugas.nip=signout_sebelum_menutup_luka.nip_perawat_ok  " +
                            "where signout_sebelum_menutup_luka.no_rawat='"
                            + tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString()
                            + "' and signout_sebelum_menutup_luka.tanggal='"
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[] {
                            ...
                            rs.getString("kelengkapan_specimen_label"),
                            rs.getString("kelengkapan_specimen_formulir"),

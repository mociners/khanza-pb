...
public final class RMPenilaianAwalKeperawatanIGD extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(
                ...
                "::[ Penilaian Awal Keperawatan IGD ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(870, 1403));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        if (RPD.getText().trim().equals("")) {
            Valid.textKosong(RPD, "Riwayat Penyakit Dahulu");
            return;
        }
        if (RPO.getText().trim().equals("")) {
        ...
        try {
            // PERUBAHAN UTAMA: Membangun string SQL secara dinamis untuk memastikan tidak
            // ada karakter aneh
            StringBuilder sqlBuilder = new StringBuilder("{CALL SimpanPenilaianIGD(");
            for (int j = 0; j < 81; j++) {
                sqlBuilder.append("?");
                if (j < 80) { // Tambahkan koma untuk semua kecuali yang terakhir
                    sqlBuilder.append(",");
                }
            }
            sqlBuilder.append(")}");
            ...
            // Debug untuk memastikan string yang dibuat sudah benar
            System.out.println("DEBUG: Generated SQL Call -> " + sql);

            cs = koneksi.prepareCall(sql);

            int i = 1;
            cs.setString(i++, TNoRw.getText());
            cs.setTimestamp(i++, new java.sql.Timestamp(TglAsuhan.getDate().getTime()));
            cs.setString(i++, Informasi.getSelectedItem().toString());
            cs.setString(i++, KeluhanUtama.getText());
            cs.setString(i++, RPD.getText());
            cs.setString(i++, RPO.getText());
            cs.setString(i++, StatusKehamilan.getSelectedItem().toString());
            cs.setString(i++, Gravida.getText());
            cs.setString(i++, Para.getText());
            cs.setString(i++, Abortus.getText());
            cs.setString(i++, HPHT.getText());
            cs.setString(i++, Airway.getSelectedItem().toString());
            cs.setString(i++, Breathing.getSelectedItem().toString());
            cs.setString(i++, Spo2.getText());
            cs.setString(i++, Nadi.getSelectedItem().toString());
            cs.setString(i++, CRT.getSelectedItem().toString());
            cs.setString(i++, WarnaKulit.getSelectedItem().toString());
            cs.setString(i++, CirculationPerdarahan.getSelectedItem().toString());
            cs.setString(i++, TurgorKulit.getSelectedItem().toString());
            cs.setString(i++, ResponNeurologi.getSelectedItem().toString());
            cs.setString(i++, PupilNeurologi.getSelectedItem().toString());
            cs.setString(i++, Reflek.getText());
            cs.setString(i++, GCS.getText());
            cs.setString(i++, Tekanan.getSelectedItem().toString());
            cs.setString(i++, Pupil.getSelectedItem().toString());
            cs.setString(i++, Neurosensorik.getSelectedItem().toString());
            cs.setString(i++, Integumen.getSelectedItem().toString());
            cs.setString(i++, Turgor.getSelectedItem().toString());
            cs.setString(i++, Edema.getSelectedItem().toString());
            cs.setString(i++, Mukosa.getSelectedItem().toString());
            cs.setString(i++, Perdarahan.getSelectedItem().toString());
            cs.setString(i++, JumlahPerdarahan.getText());
            cs.setString(i++, WarnaPerdarahan.getText());
            cs.setString(i++, Intoksikasi.getSelectedItem().toString());
            cs.setString(i++, BAB.getText());
            cs.setString(i++, XBAB.getText());
            cs.setString(i++, KBAB.getText());
            cs.setString(i++, WBAB.getText());
            cs.setString(i++, BAK.getText());
            cs.setString(i++, XBAK.getText());
            cs.setString(i++, WBAK.getText());
            cs.setString(i++, LBAK.getText());
            cs.setString(i++, Psikologis.getSelectedItem().toString());
            cs.setString(i++, Jiwa.getSelectedItem().toString());
            cs.setString(i++, Perilaku.getSelectedItem().toString());
            cs.setString(i++, Dilaporkan.getText());
            cs.setString(i++, Sebutkan.getText());
            cs.setString(i++, Hubungan.getSelectedItem().toString());
            cs.setString(i++, TinggalDengan.getSelectedItem().toString());
            cs.setString(i++, KetTinggal.getText());
            cs.setString(i++, StatusBudaya.getSelectedItem().toString());
            cs.setString(i++, KetBudaya.getText());
            cs.setString(i++, PendidikanPJ.getSelectedItem().toString());
            cs.setString(i++, KetPendidikanPJ.getText());
            cs.setString(i++, Edukasi.getSelectedItem().toString());
            cs.setString(i++, KetEdukasi.getText());
            cs.setString(i++, ADL.getSelectedItem().toString());
            cs.setString(i++, Aktifitas.getSelectedItem().toString());
            cs.setString(i++, AlatBantu.getSelectedItem().toString());
            cs.setString(i++, KetAlatBantu.getText());
            cs.setString(i++, Nyeri.getSelectedItem().toString());
            cs.setString(i++, Provokes.getSelectedItem().toString());
            cs.setString(i++, KetProvokes.getText());
            cs.setString(i++, Quality.getSelectedItem().toString());
            cs.setString(i++, KetQuality.getText());
            cs.setString(i++, Lokasi.getText());
            cs.setString(i++, Menyebar.getSelectedItem().toString());
            cs.setString(i++, SkalaNyeri.getSelectedItem().toString());
            cs.setString(i++, Durasi.getText());
            cs.setString(i++, NyeriHilang.getSelectedItem().toString());
            cs.setString(i++, KetNyeri.getText());
            cs.setString(i++, PadaDokter.getSelectedItem().toString());
            cs.setString(i++, KetDokter.getText());
            cs.setString(i++, ATS.getSelectedItem().toString());
            cs.setString(i++, BJM.getSelectedItem().toString());
            cs.setString(i++, MSA.getSelectedItem().toString());
            cs.setString(i++, Hasil.getSelectedItem().toString());
            cs.setString(i++, Lapor.getSelectedItem().toString());
            cs.setString(i++, KetLapor.getText());
            cs.setString(i++, Rencana.getText());
            cs.setString(i++, KdPetugas.getText());

            cs.executeUpdate();

            for (int row = 0; row < tbMasalahKeperawatan.getRowCount(); row++) {
                if (tbMasalahKeperawatan.getValueAt(row, 0).toString().equals("true")) {
                    Sequel.menyimpan2("penilaian_awal_keperawatan_igd_masalah", "?,?", 2,
                            new String[] { TNoRw.getText(), tbMasalahKeperawatan.getValueAt(row, 1).toString() });
                }
            }
            for (int row = 0; row < tbRencanaKeperawatan.getRowCount(); row++) {
                if (tbRencanaKeperawatan.getValueAt(row, 0).toString().equals("true")) {
                    Sequel.menyimpan2("penilaian_awal_keperawatan_ralan_rencana_igd", "?,?", 2,
                            new String[] { TNoRw.getText(), tbRencanaKeperawatan.getValueAt(row, 1).toString() });
                }
            }
    ...
    private void tbObatMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_tbObatMouseClicked
        System.out.println("===== tbObatMouseClicked CALLED =====");
        if (tabMode.getRowCount() != 0) {
            try {
                System.out.println("Calling getData()...");
                getData(); // <<< PENTING: Panggil getData untuk populate form
                System.out.println("getData() completed");
                System.out.println("After getData, KeluhanUtama: " + KeluhanUtama.getText());
        ...
        System.out.println("===== tbObatMouseClicked END =====");
        ...
        if (tbObat.getSelectedRow() > -1) {
            ...
            param.put("finger",
                    "Dikeluarkan di " + akses.getnamars() + ", Kabupaten/Kota " + akses.getkabupatenrs()
                            ...
                            + (finger.equals("") ? tbObat.getValueAt(tbObat.getSelectedRow(), 79).toString() : finger)
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalKeperawatanIGD.jasper", "report",
                    "::[ Laporan Penilaian Awal Keperawatan IGD ]::",
                    // ******** QUERY DIBAWAH INI TELAH DISESUAIKAN ********
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,pasien.agama,bahasa_pasien.nama_bahasa,cacat_fisik.nama_cacat,penilaian_awal_keperawatan_igd.tanggal,penilaian_awal_keperawatan_igd.informasi,"
                            +
                            "penilaian_awal_keperawatan_igd.keluhan_utama,penilaian_awal_keperawatan_igd.rpd,penilaian_awal_keperawatan_igd.rpo,penilaian_awal_keperawatan_igd.status_kehamilan,penilaian_awal_keperawatan_igd.gravida,penilaian_awal_keperawatan_igd.para,"
                            +
                            "penilaian_awal_keperawatan_igd.abortus,penilaian_awal_keperawatan_igd.hpht," +
                            "penilaian_awal_keperawatan_igd.airway,penilaian_awal_keperawatan_igd.breathing,penilaian_awal_keperawatan_igd.spo2,penilaian_awal_keperawatan_igd.nadi,penilaian_awal_keperawatan_igd.crt,penilaian_awal_keperawatan_igd.warna_kulit,penilaian_awal_keperawatan_igd.circulation_perdarahan,penilaian_awal_keperawatan_igd.turgor_kulit,penilaian_awal_keperawatan_igd.respon_neurologi,penilaian_awal_keperawatan_igd.pupil_neurologi,penilaian_awal_keperawatan_igd.reflek,penilaian_awal_keperawatan_igd.gcs,"
                            +
                            "penilaian_awal_keperawatan_igd.tekanan,penilaian_awal_keperawatan_igd.pupil,penilaian_awal_keperawatan_igd.neurosensorik,penilaian_awal_keperawatan_igd.integumen,penilaian_awal_keperawatan_igd.turgor,"
                            +
                            "penilaian_awal_keperawatan_igd.edema,penilaian_awal_keperawatan_igd.mukosa,penilaian_awal_keperawatan_igd.perdarahan,penilaian_awal_keperawatan_igd.jumlah_perdarahan,penilaian_awal_keperawatan_igd.warna_perdarahan,penilaian_awal_keperawatan_igd.intoksikasi,"
                            +
                            "penilaian_awal_keperawatan_igd.bab,penilaian_awal_keperawatan_igd.xbab,penilaian_awal_keperawatan_igd.kbab,penilaian_awal_keperawatan_igd.wbab,penilaian_awal_keperawatan_igd.bak,penilaian_awal_keperawatan_igd.xbak,penilaian_awal_keperawatan_igd.wbak,"
    ...
    private void tampil() {
        ...
        try {
            String sql = "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,pasien.agama,bahasa_pasien.nama_bahasa,cacat_fisik.nama_cacat,penilaian_awal_keperawatan_igd.tanggal,penilaian_awal_keperawatan_igd.informasi,"
                    +
                    "penilaian_awal_keperawatan_igd.keluhan_utama,penilaian_awal_keperawatan_igd.rpd,penilaian_awal_keperawatan_igd.rpo,penilaian_awal_keperawatan_igd.status_kehamilan,penilaian_awal_keperawatan_igd.gravida,penilaian_awal_keperawatan_igd.para,"
                    +
                    "penilaian_awal_keperawatan_igd.abortus,penilaian_awal_keperawatan_igd.hpht," +
                    ...
                    "inner join penjab on penjab.kd_pj=reg_periksa.kd_pj " +
                    "inner join cacat_fisik on cacat_fisik.id=pasien.cacat_fisik where " +
                    "penilaian_awal_keperawatan_igd.tanggal between ? and ? ";

            if (!TCari.getText().trim().equals("")) {
                sql += "and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or " +
                        "penilaian_awal_keperawatan_igd.nip like ? or petugas.nama like ?) ";
            }
            sql += "order by penilaian_awal_keperawatan_igd.tanggal";
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[] {
                            ...
                            rs.getString("jk"), rs.getString("agama"), rs.getString("nama_bahasa"),
                            rs.getString("nama_cacat"),
                            rs.getString("tgl_lahir"), rs.getString("tanggal"), rs.getString("informasi"),
                            rs.getString("keluhan_utama"), rs.getString("rpd"), rs.getString("rpo"),
                            rs.getString("status_kehamilan"), rs.getString("gravida"),
                            rs.getString("para"), rs.getString("abortus"), rs.getString("hpht"),
                            rs.getString("airway"), rs.getString("breathing"), rs.getString("spo2"),
                            rs.getString("nadi"), rs.getString("crt"), rs.getString("warna_kulit"),
                            rs.getString("circulation_perdarahan"), rs.getString("turgor_kulit"),
                            rs.getString("respon_neurologi"), rs.getString("pupil_neurologi"), rs.getString("reflek"),
                            rs.getString("gcs"),
                            rs.getString("tekanan"), rs.getString("pupil"), rs.getString("neurosensorik"),
                            rs.getString("integumen"), rs.getString("turgor"),
                            ...
                            rs.getString("kbab"),
                            rs.getString("wbab"), rs.getString("bak"), rs.getString("xbak"), rs.getString("wbak"),
                            rs.getString("lbak"), rs.getString("psikologis"), rs.getString("jiwa"),
                            rs.getString("perilaku"), rs.getString("dilaporkan"),
                            ...
                            rs.getString("edukasi"),
                            rs.getString("ket_edukasi"), rs.getString("kemampuan"), rs.getString("aktifitas"),
                            rs.getString("alat_bantu"), rs.getString("ket_bantu"), rs.getString("nyeri"),
                            rs.getString("provokes"), rs.getString("ket_provokes"), rs.getString("quality"),
                            rs.getString("ket_quality"),
    ...
    private void getData() {
        ...
        if (tbObat.getSelectedRow() != -1) {
            ...
            System.out.println("Test value kolom 10: " + tbObat.getValueAt(row, 10));
            ...
            Airway.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 18).toString());
            Breathing.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 19).toString());
            Spo2.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 20).toString());
            Nadi.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 21).toString());
            CRT.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 22).toString());
            WarnaKulit.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 23).toString());
            CirculationPerdarahan.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 24).toString());
            TurgorKulit.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 25).toString());
            ResponNeurologi.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 26).toString());
            PupilNeurologi.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 27).toString());
            Reflek.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 28).toString());
            GCS.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 29).toString());

            // Penyesuaian indeks untuk data lama (indeks lama - 1)
            Tekanan.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 30).toString());
            Pupil.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 31).toString());
            Neurosensorik.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 32).toString());
            Integumen.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 33).toString());
            Turgor.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 34).toString());
            Edema.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 35).toString());
            Mukosa.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 36).toString());
            Perdarahan.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 37).toString());
            JumlahPerdarahan.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 38).toString());
            WarnaPerdarahan.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 39).toString());
            Intoksikasi.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 40).toString());
            BAB.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 41).toString());
            XBAB.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 42).toString());
            KBAB.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 43).toString());
            WBAB.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 44).toString());
            BAK.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 45).toString());
            XBAK.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 46).toString());
            WBAK.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 47).toString());
            LBAK.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 48).toString());
            Psikologis.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 49).toString());
            Jiwa.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 50).toString());
            Perilaku.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 51).toString());
            Dilaporkan.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 52).toString());
            Sebutkan.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 53).toString());
            Hubungan.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 54).toString());
            StatusPernikahan.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 55).toString());
            TinggalDengan.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 56).toString());
            KetTinggal.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 57).toString());
            Pekerjaan.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 58).toString());
            Pembayaran.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 59).toString());
            StatusBudaya.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 60).toString());
            KetBudaya.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 61).toString());
            PendidikanPasien.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 62).toString());
            PendidikanPJ.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 63).toString());
            KetPendidikanPJ.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 64).toString());
            Edukasi.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 65).toString());
            KetEdukasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 66).toString());
            ADL.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 67).toString());
            Aktifitas.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 68).toString());
            AlatBantu.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 69).toString());
            KetAlatBantu.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 70).toString());
            Nyeri.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 71).toString());
            Provokes.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 72).toString());
            KetProvokes.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 73).toString());
            Quality.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 74).toString());
            KetQuality.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 75).toString());
            Lokasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 76).toString());
            Menyebar.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 77).toString());
            SkalaNyeri.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 78).toString());
            ...
            PadaDokter.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 82).toString());
            KetDokter.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 83).toString());
            ATS.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 84).toString());
            ...
            Hasil.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 87).toString());
            Lapor.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 88).toString());
            KetLapor.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 89).toString());
            Rencana.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 90).toString());
            Valid.SetTgl2(TglAsuhan, tbObat.getValueAt(tbObat.getSelectedRow(), 8).toString());

            // ===== COMMENT OUT: Manipulasi tabel memicu emptTeks() =====
            // Tabel masalah dan rencana TIDAK di-populate saat edit untuk menghindari
            // trigger event listener yang membersihkan form
            /*
             * try {
             * ps = koneksi.prepareStatement(
             * "select master_masalah_keperawatan_igd.kode_masalah,master_masalah_keperawatan_igd.nama_masalah from master_masalah_keperawatan_igd "
             ...
             * rs = ps.executeQuery();
             * // Kosongkan tabel tanpa trigger listener, langsung clear semua row
             * while (tabModeMasalah.getRowCount() > 0) {
             * tabModeMasalah.removeRow(0);
             * }
             * while (rs.next()) {
             ...
             * 
             * try {
             * // DICOMMENT: Valid.tabelKosong membersihkan form saat dipanggil di getData()
             ...
             * rs = ps.executeQuery();
             * // Kosongkan tabel tanpa trigger listener, langsung clear semua row
             * while (tabModeRencana.getRowCount() > 0) {
             * tabModeRencana.removeRow(0);
             * }
             * while (rs.next()) {
    ...
    private void ganti() {
        if (Sequel.mengedittf("penilaian_awal_keperawatan_igd", "no_rawat=?",
                ...
                82, new String[] {
                        ...
                        WarnaPerdarahan.getText(), Intoksikasi.getSelectedItem().toString(), BAB.getText(),
                        XBAB.getText(), KBAB.getText(), WBAB.getText(), BAK.getText(), XBAK.getText(), WBAK.getText(),
    ...
    private void initPosisi() {
        ...
        KBAB.setBounds(443, 340 + y_offset, 175, 23);
        jLabel109.setBounds(369, 340 + y_offset, 70, 23);
        BAB.setBounds(229, 340 + y_offset, 50, 23);
        ...
        WBAB.setBounds(679, 340 + y_offset, 175, 23);
        jLabel112.setBounds(135, 370 + y_offset, 90, 23);
        BAK.setBounds(229, 370 + y_offset, 50, 23);
        jLabel113.setBounds(282, 370 + y_offset, 13, 23);
        XBAK.setBounds(298, 370 + y_offset, 70, 23);
        jLabel114.setBounds(369, 370 + y_offset, 70, 23);
        WBAK.setBounds(443, 370 + y_offset, 175, 23);
        jLabel115.setBounds(620, 370 + y_offset, 55, 23);
        LBAK.setBounds(679, 370 + y_offset, 175, 23);
        jSeparator12.setBounds(0, 400 + y_offset, 880, 1);
        jLabel94.setBounds(10, 400 + y_offset, 360, 23); // III. RIWAYAT PSIKOLOGIS
        jLabel117.setBounds(0, 420 + y_offset, 148, 23);
        Psikologis.setBounds(152, 420 + y_offset, 160, 23);
        jLabel119.setBounds(311, 420 + y_offset, 180, 23);
        Jiwa.setBounds(495, 420 + y_offset, 90, 23);
        jLabel120.setBounds(590, 420 + y_offset, 120, 23);
        StatusPernikahan.setBounds(714, 420 + y_offset, 140, 23);
        jLabel123.setBounds(0, 450 + y_offset, 140, 23);
        Perilaku.setBounds(144, 450 + y_offset, 235, 23);
        jLabel118.setBounds(378, 450 + y_offset, 82, 23);
        Dilaporkan.setBounds(464, 450 + y_offset, 163, 23);
        jLabel121.setBounds(625, 450 + y_offset, 62, 23);
        Sebutkan.setBounds(691, 450 + y_offset, 163, 23);
        jLabel122.setBounds(0, 480 + y_offset, 276, 23);
        Hubungan.setBounds(280, 480 + y_offset, 135, 23);
        jLabel124.setBounds(433, 480 + y_offset, 70, 23);
        Pekerjaan.setBounds(507, 480 + y_offset, 120, 23);
        jLabel125.setBounds(640, 480 + y_offset, 90, 23);
        Pembayaran.setBounds(734, 480 + y_offset, 120, 23);
        jLabel60.setBounds(0, 510 + y_offset, 138, 23);
        TinggalDengan.setBounds(142, 510 + y_offset, 112, 23);
        KetTinggal.setBounds(257, 510 + y_offset, 126, 23);
        jLabel76.setBounds(390, 510 + y_offset, 125, 23);
        Bahasa.setBounds(519, 510 + y_offset, 120, 23);
        jLabel126.setBounds(650, 510 + y_offset, 80, 23);
        PendidikanPasien.setBounds(734, 510 + y_offset, 120, 23);
        jLabel77.setBounds(0, 540 + y_offset, 95, 23);
        Agama.setBounds(99, 540 + y_offset, 110, 23);
        jLabel95.setBounds(217, 540 + y_offset, 350, 23);
        StatusBudaya.setBounds(571, 540 + y_offset, 100, 23);
        KetBudaya.setBounds(674, 540 + y_offset, 180, 23);
        jLabel127.setBounds(0, 570 + y_offset, 138, 23);
        PendidikanPJ.setBounds(142, 570 + y_offset, 137, 23);
        KetPendidikanPJ.setBounds(282, 570 + y_offset, 150, 23);
        jLabel58.setBounds(437, 570 + y_offset, 160, 23);
        Edukasi.setBounds(601, 570 + y_offset, 100, 23);
        KetEdukasi.setBounds(704, 570 + y_offset, 150, 23);
        jSeparator4.setBounds(0, 600 + y_offset, 880, 1);
        jLabel56.setBounds(10, 600 + y_offset, 230, 23); // IV. PENGKAJIAN FUNGSI
        jLabel57.setBounds(0, 620 + y_offset, 223, 23);
        ADL.setBounds(227, 620 + y_offset, 160, 23);
        jLabel55.setBounds(406, 620 + y_offset, 80, 23);
        Aktifitas.setBounds(490, 620 + y_offset, 112, 23);
        jLabel51.setBounds(615, 620 + y_offset, 100, 23);
        CacatFisik.setBounds(719, 620 + y_offset, 135, 23);
        jLabel50.setBounds(1, 650 + y_offset, 112, 23);
        AlatBantu.setBounds(117, 650 + y_offset, 80, 23);
        KetAlatBantu.setBounds(200, 650 + y_offset, 402, 23);
        jSeparator8.setBounds(0, 680 + y_offset, 880, 1);
        jLabel52.setBounds(10, 680 + y_offset, 380, 23); // V. SKALA NYERI
        PanelWall.setBounds(40, 700 + y_offset, 320, 130);
        jSeparator9.setBounds(360, 700 + y_offset, 1, 140);
        Nyeri.setBounds(375, 700 + y_offset, 130, 23);
        jLabel80.setBounds(510, 700 + y_offset, 60, 23);
        Provokes.setBounds(574, 700 + y_offset, 130, 23);
        KetProvokes.setBounds(708, 700 + y_offset, 146, 23);
        jLabel81.setBounds(370, 730 + y_offset, 55, 23);
        Quality.setBounds(429, 730 + y_offset, 140, 23);
        KetQuality.setBounds(573, 730 + y_offset, 281, 23);
        jLabel82.setBounds(370, 760 + y_offset, 55, 23);
        jLabel83.setBounds(394, 780 + y_offset, 60, 23);
        Lokasi.setBounds(458, 780 + y_offset, 220, 23);
        jLabel67.setBounds(691, 780 + y_offset, 79, 23);
        Menyebar.setBounds(774, 780 + y_offset, 80, 23);
        jLabel88.setBounds(370, 810 + y_offset, 55, 23);
        jLabel85.setBounds(428, 810 + y_offset, 60, 23);
        SkalaNyeri.setBounds(491, 810 + y_offset, 70, 23);
        jLabel87.setBounds(627, 810 + y_offset, 90, 23);
        Durasi.setBounds(721, 810 + y_offset, 90, 23);
        jLabel84.setBounds(815, 810 + y_offset, 35, 23);
        jLabel89.setBounds(0, 850 + y_offset, 130, 23);
        NyeriHilang.setBounds(134, 850 + y_offset, 130, 23);
        KetNyeri.setBounds(268, 850 + y_offset, 150, 23);
        jLabel86.setBounds(480, 850 + y_offset, 150, 23);
        PadaDokter.setBounds(634, 850 + y_offset, 80, 23);
        jLabel64.setBounds(720, 850 + y_offset, 50, 23);
        KetDokter.setBounds(774, 850 + y_offset, 80, 23);
        jSeparator6.setBounds(0, 880 + y_offset, 880, 1);
        jLabel63.setBounds(10, 880 + y_offset, 380, 23); // VI. PENILAIAN RESIKO JATUH
        jLabel72.setBounds(0, 900 + y_offset, 126, 23);
        jLabel65.setBounds(35, 920 + y_offset, 250, 23);
        ATS.setBounds(289, 920 + y_offset, 80, 23);
        jLabel66.setBounds(370, 920 + y_offset, 400, 23);
        BJM.setBounds(774, 920 + y_offset, 80, 23);
        jLabel70.setBounds(0, 950 + y_offset, 571, 23);
        MSA.setBounds(575, 950 + y_offset, 80, 23);
        jLabel68.setBounds(0, 980 + y_offset, 72, 23);
        Hasil.setBounds(76, 980 + y_offset, 293, 23);
        jLabel97.setBounds(381, 980 + y_offset, 190, 23);
        Lapor.setBounds(575, 980 + y_offset, 80, 23);
        jLabel71.setBounds(680, 980 + y_offset, 90, 23);
        KetLapor.setBounds(774, 980 + y_offset, 80, 23);
        jSeparator10.setBounds(0, 1010 + y_offset, 880, 1);
        Scroll8.setBounds(10, 1020 + y_offset, 400, 143);
        label12.setBounds(16, 1170 + y_offset, 60, 23);
        TCariMasalah.setBounds(80, 1170 + y_offset, 215, 23);
        BtnCariMasalah.setBounds(299, 1170 + y_offset, 28, 23);
        BtnAllMasalah.setBounds(331, 1170 + y_offset, 28, 23);
        BtnTambahMasalah.setBounds(363, 1170 + y_offset, 28, 23);
        TabRencanaKeperawatan.setBounds(433, 1020 + y_offset, 420, 143);
        label13.setBounds(439, 1170 + y_offset, 60, 23);
        TCariRencana.setBounds(503, 1170 + y_offset, 235, 23);
        BtnCariRencana.setBounds(742, 1170 + y_offset, 28, 23);
        BtnAllRencana.setBounds(774, 1170 + y_offset, 28, 23);
        BtnTambahRencana.setBounds(806, 1170 + y_offset, 28, 23);

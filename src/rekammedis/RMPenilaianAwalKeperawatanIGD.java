...
public final class RMPenilaianAwalKeperawatanIGD extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        try {
            // PERUBAHAN UTAMA: Membangun string SQL secara dinamis untuk memastikan tidak ada karakter aneh
            ...
            for (int row = 0; row < tbMasalahKeperawatan.getRowCount(); row++) {
                if (tbMasalahKeperawatan.getValueAt(row, 0).toString().equals("true")) {
                    Sequel.menyimpan2("penilaian_awal_keperawatan_igd_masalah", "?,?", 2, new String[]{TNoRw.getText(), tbMasalahKeperawatan.getValueAt(row, 1).toString()});
                }
            }
            for (int row = 0; row < tbRencanaKeperawatan.getRowCount(); row++) {
                if (tbRencanaKeperawatan.getValueAt(row, 0).toString().equals("true")) {
                    Sequel.menyimpan2("penilaian_awal_keperawatan_ralan_rencana_igd", "?,?", 2, new String[]{TNoRw.getText(), tbRencanaKeperawatan.getValueAt(row, 1).toString()});
                }
            }
    ...
    */
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("airway"), rs.getString("breathing"), rs.getString("spo2"), rs.getString("nadi"), rs.getString("crt"), rs.getString("warna_kulit"), rs.getString("circulation_perdarahan"), rs.getString("turgor_kulit"), rs.getString("respon_neurologi"), rs.getString("pupil_neurologi"), rs.getString("reflek"), rs.getString("gcs"),
                        rs.getString("tekanan"),rs.getString("pupil"),rs.getString("neurosensorik"),rs.getString("integumen"),rs.getString("turgor"),
        ...
        try{
            ...
            if(response.isArray()){
                for(i=0;i<tbMasalahKeperawatan.getRowCount();i++){
                    if(tbMasalahKeperawatan.getValueAt(i,0).toString().equals("true")){
                        for(JsonNode list:response){
                            if(list.path("KodeMasalah").asText().trim().equalsIgnoreCase(tbMasalahKeperawatan.getValueAt(i,1).toString().trim()) 
    ...
    private void ganti() {
        if(Sequel.mengedittf("penilaian_awal_keperawatan_igd","no_rawat=?","no_rawat=?,tanggal=?,keluhan_utama=?,rpd=?,rpo=?,status_kehamilan=?,gravida=?,"+
            ...
            "berjalan_a=?,berjalan_b=?,berjalan_c=?,hasil=?,lapor=?,ket_lapor=?,rencana=?,nip=?,informasi=?",82,new String[]{
            ...
            Airway.getSelectedItem().toString(),Breathing.getSelectedItem().toString(),Spo2.getText(),Nadi.getSelectedItem().toString(),CRT.getSelectedItem().toString(),WarnaKulit.getSelectedItem().toString(),
            CirculationPerdarahan.getSelectedItem().toString(),
            TurgorKulit.getSelectedItem().toString(),ResponNeurologi.getSelectedItem().toString(),PupilNeurologi.getSelectedItem().toString(),Reflek.getText(),GCS.getText(),
    ...
    private void initIGD(){
        ...
        Airway.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Bebas", "Gurgling", "Stridor", "Wheezing", "Ronchi", "Terintubasi" }));
        ...
        Breathing.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Spontan", "Tachipneu", "Dispneu", "Apneu", "Ventilasi Mekanik", "Memakai Ventilator" }));
        ...
        WarnaKulit.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Normal", "Pucat", "Ikterik", "Cyanosis" }));
        ...
        CirculationPerdarahan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya", "Terkontrol", "Tidak Terkontrol" }));
        ...
        ResponNeurologi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Alert", "Pain", "Verbal", "Unrespons" }));
        ...
        PupilNeurologi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Isokor", "Anisokor", "Pin Point", "Midriasis" }));

...
public final class RMDataCatatanCekGDS extends javax.swing.JDialog {
    ...
    public RMDataCatatanCekGDS(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Rawat","No.R.M.","Nama Pasien","Umur","JK","Tgl.Lahir","Tgl.Obser","Jam Obser","Nilai",
            "Insulin","Obat Gula","NIP","Nama Petugas","Jenis"
        }){
    ...
    private void initComponents() {
        ...
        jLabel12.setBounds(90, 70, 40, 23);
        ...
        Jenis.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "GDS", "GDP", "GD2PP" }));
        Jenis.setName("Jenis"); // NOI18N
        FormInput.add(Jenis);
        Jenis.setBounds(10, 70, 72, 20);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("catatan_cek_gds","?,?,?,?,?,?,?,?","Data",8,new String[]{
                ...
                GDP.getText(),Insulin.getText(),ObatGula.getText(),NIP.getText(),Jenis.getSelectedItem()+""
            })==true){
                tampil();
                emptTeks();
            }
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptDataCatatanCekGDS.jasper","report","::[ Data Catatan Cek GDS ]::",
                    ...
                    "catatan_cek_gds.insulin,catatan_cek_gds.obat_gula,catatan_cek_gds.nip,catatan_cek_gds.jenis,petugas.nama "+
    ...
    */
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("obat_gula"),rs.getString("nip"),rs.getString("nama"),rs.getString("Jenis")
                    });
                }
            } catch (Exception e) {
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Jenis.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),13).toString());
        }
    }
    ...
    private void ganti() {
        Sequel.mengedit("catatan_cek_gds","tgl_perawatan=? and jam_rawat=? and no_rawat=?","no_rawat=?,tgl_perawatan=?,jam_rawat=?,gdp=?,insulin=?,obat_gula=?,nip=?,jenis=?",11,new String[]{
            TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+""),Jam.getSelectedItem()+":"+Menit.getSelectedItem()+":"+Detik.getSelectedItem(),
            GDP.getText(),Insulin.getText(),ObatGula.getText(),NIP.getText(),Jenis.getSelectedItem().toString(),tbObat.getValueAt(tbObat.getSelectedRow(),6).toString(),

 ...
 * @author perpustakaan
 */
public final class RMPenilaianLanjutanRisikoJatuhDewasaThb extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public RMPenilaianLanjutanRisikoJatuhDewasaThb(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            ...
            "Skala Morse 6", "N.M. 6", "Skala Morse 7", "N.M. 7", "Skala Morse 8", "N.M. 8", "Skala Morse 9", "N.M. 9",
            "Skala Morse 10", "N.M. 10", "Total", "Hasil Skrining", "Saran", "NIP", "Petugas"
        }) {
            @Override
    ...
    private void initComponents() {
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "27-11-2024" }));
        ...
        jLabel18.setBounds(810, 390, 70, 23);

        NIP.setEditable(false);
        NIP.setHighlighter(null);
        NIP.setName("NIP"); // NOI18N
        FormInput.add(NIP);
        NIP.setBounds(880, 390, 94, 23);

        NamaPetugas.setEditable(false);
        NamaPetugas.setName("NamaPetugas"); // NOI18N
        FormInput.add(NamaPetugas);
        NamaPetugas.setBounds(980, 390, 187, 23);
        ...
        btnPetugas.setBounds(1170, 390, 28, 23);
        ...
        jLabel217.setText("2. Riwayat Jatuh ");
        jLabel217.setName("jLabel217"); // NOI18N
        FormInput.add(jLabel217);
        jLabel217.setBounds(30, 120, 260, 23);
        ...
        SkalaResiko2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak pernah jatuh", "Pernah jatuh < 1 tahun", "Pernah jatuh < 1 bulan", "Jatuh pada saat dirawat sekarang" }));
        ...
        SkalaResiko2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                SkalaResiko2ActionPerformed(evt);
            }
        });
        ...
        SkalaResiko2.setBounds(330, 120, 310, 23);

        jLabel218.setText("Nilai :");
        jLabel218.setName("jLabel218"); // NOI18N
        FormInput.add(jLabel218);
        jLabel218.setBounds(650, 120, 70, 23);

        NilaiResiko2.setFocusTraversalPolicyProvider(true);
        NilaiResiko2.setName("NilaiResiko2"); // NOI18N
        FormInput.add(NilaiResiko2);
        NilaiResiko2.setBounds(730, 120, 60, 23);

        jLabel220.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel220.setText("5. Kognitif");
        jLabel220.setName("jLabel220"); // NOI18N
        FormInput.add(jLabel220);
        jLabel220.setBounds(30, 210, 260, 23);

        jLabel221.setText("Skala :");
        jLabel221.setName("jLabel221"); // NOI18N
        FormInput.add(jLabel221);
        jLabel221.setBounds(250, 210, 80, 23);

        SkalaResiko5.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Orientasi baik", "Kesulitan mengerti perintah", "Gangguan memori", "Bingung/ Disorientasi" }));
        ...
        SkalaResiko5.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                SkalaResiko5ActionPerformed(evt);
            }
        });
        ...
        SkalaResiko5.setBounds(330, 210, 310, 23);

        jLabel222.setText("Nilai :");
        jLabel222.setName("jLabel222"); // NOI18N
        FormInput.add(jLabel222);
        jLabel222.setBounds(650, 210, 70, 23);

        NilaiResiko5.setFocusTraversalPolicyProvider(true);
        NilaiResiko5.setName("NilaiResiko5"); // NOI18N
        FormInput.add(NilaiResiko5);
        NilaiResiko5.setBounds(730, 210, 60, 23);

        jLabel223.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel223.setText("6. Pola BAB/ BAK");
        jLabel223.setName("jLabel223"); // NOI18N
        FormInput.add(jLabel223);
        jLabel223.setBounds(30, 240, 260, 23);

        jLabel224.setText("Skala :");
        jLabel224.setName("jLabel224"); // NOI18N
        FormInput.add(jLabel224);
        jLabel224.setBounds(250, 240, 80, 23);

        SkalaResiko6.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Teratur", "Inkontinensia Urin/ Faeses", "Nokturia", "Urgensi/ Frekuensi" }));
        ...
        SkalaResiko6.setBounds(330, 240, 310, 23);

        jLabel225.setText("Nilai :");
        jLabel225.setName("jLabel225"); // NOI18N
        FormInput.add(jLabel225);
        jLabel225.setBounds(650, 240, 70, 23);

        NilaiResiko6.setFocusTraversalPolicyProvider(true);
        NilaiResiko6.setName("NilaiResiko6"); // NOI18N
        FormInput.add(NilaiResiko6);
        NilaiResiko6.setBounds(730, 240, 60, 23);

        jLabel226.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel226.setText("7. Penglihatan");
        jLabel226.setName("jLabel226"); // NOI18N
        FormInput.add(jLabel226);
        jLabel226.setBounds(30, 270, 260, 23);

        jLabel227.setText("Skala :");
        jLabel227.setName("jLabel227"); // NOI18N
        FormInput.add(jLabel227);
        jLabel227.setBounds(250, 270, 80, 23);

        SkalaResiko7.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Kacamata bukan Biofokal", "Kacamata Biofokal", "Kacamata Multifokal", "Katarak/ Glaukoma", "Hampir tidak melihat/ Buta" }));
        ...
        SkalaResiko8.setBounds(330, 300, 310, 23);

        jLabel231.setText("Nilai :");
        jLabel231.setName("jLabel231"); // NOI18N
        FormInput.add(jLabel231);
        jLabel231.setBounds(650, 300, 70, 23);

        NilaiResiko8.setFocusTraversalPolicyProvider(true);
        NilaiResiko8.setName("NilaiResiko8"); // NOI18N
        FormInput.add(NilaiResiko8);
        NilaiResiko8.setBounds(730, 300, 60, 23);

        jLabel232.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel232.setText("9. Pengobatan");
        jLabel232.setName("jLabel232"); // NOI18N
        FormInput.add(jLabel232);
        jLabel232.setBounds(30, 330, 260, 23);

        jLabel233.setText("Skala :");
        jLabel233.setName("jLabel233"); // NOI18N
        FormInput.add(jLabel233);
        jLabel233.setBounds(250, 330, 80, 23);

        SkalaResiko9.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Kurang dari 4 jenis dan tidak termasuk yang tersebut di bawah", "Antihipertensi/ hipoglikemik/ Antidepresean/ Neurotopik", "Sedatif/ Psikotropika/ Narkotika", "infus Epidural/ Spinal/ Diuretik/ Laxatif" }));
        ...
        TingkatResiko.setBounds(30, 390, 640, 20);

        jLabel235.setText("Total :");
        jLabel235.setName("jLabel235"); // NOI18N
        FormInput.add(jLabel235);
        jLabel235.setBounds(650, 390, 70, 23);
        ...
        NilaiResikoTotal.setBounds(730, 390, 60, 23);

        jLabel30.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel30.setText("Hasil Skrining :");
        jLabel30.setName("jLabel30"); // NOI18N
        FormInput.add(jLabel30);
        jLabel30.setBounds(20, 420, 80, 23);
        ...
        scrollPane1.setBounds(40, 440, 755, 43);

        jLabel31.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel31.setText("Saran :");
        jLabel31.setName("jLabel31"); // NOI18N
        FormInput.add(jLabel31);
        jLabel31.setBounds(20, 490, 80, 23);
        ...
        scrollPane2.setBounds(40, 510, 755, 43);
        ...
        jSeparator3.setBounds(10, 420, 800, 3);
        ...
        jSeparator4.setBounds(10, 490, 800, 3);
        ...
        jLabel236.setBounds(30, 90, 260, 23);

        jLabel237.setText("Skala :");
        jLabel237.setName("jLabel237"); // NOI18N
        FormInput.add(jLabel237);
        jLabel237.setBounds(250, 90, 80, 23);

        SkalaResiko1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "< 60 tahun", "60 - 69 tahun", "> 70 tahun" }));
        ...
        SkalaResiko10.setBounds(330, 360, 310, 23);

        jLabel247.setText("Nilai :");
        jLabel247.setName("jLabel247"); // NOI18N
        FormInput.add(jLabel247);
        jLabel247.setBounds(650, 360, 70, 23);

        NilaiResiko10.setFocusTraversalPolicyProvider(true);
        NilaiResiko10.setName("NilaiResiko10"); // NOI18N
        FormInput.add(NilaiResiko10);
        NilaiResiko10.setBounds(730, 360, 60, 23);

        jLabel32.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel32.setText("PEDOMAN PENCEGAHAN PASIEN RISIKO JATUH");
        jLabel32.setName("jLabel32"); // NOI18N
        FormInput.add(jLabel32);
        jLabel32.setBounds(800, 10, 260, 23);

        scrollPane3.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane3.setName("scrollPane3"); // NOI18N

        Pedoman.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        Pedoman.setColumns(20);
        Pedoman.setRows(5);
        Pedoman.setText("Risiko Rendah (0-5)\n- Pastikan bel mudah terjangkau\n- Roda tempat tidur pada posisi terkunci\n- Posisikan tempat tidur pada posisi terendah\n- Pagar pengaman tempat tidur dinaikkan\n\nRisiko Sedang (6-13)\n- Lakukan semua pedoman pencegahan untuk risiko sedang\n- Pasang gelang khusus (warna kuning) sebagai tanda risiko jatuh\n- Beri tanda risko jatuh pada pintu kamar pasien\n\nRisiko Tinggi > 14\n- Lakukan semua pedoman pencegahan untuk risiko rendah dan sedang\n- Kunjungi dan monitor pasien setiap 1 jam\n- Tempatkan pasien dikamar yag paling dekat dengan Nurse Station (Jika memungkinkan)");
        Pedoman.setName("Pedoman"); // NOI18N
        Pedoman.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                PedomanKeyPressed(evt);
            }
        });
        scrollPane3.setViewportView(Pedoman);

        FormInput.add(scrollPane3);
        scrollPane3.setBounds(820, 30, 450, 230);
...
//            Valid.textKosong(HasilSkrining, "Hasil Skrining");
            ...
            if (Sequel.menyimpantf("penilaian_lanjutan_resiko_jatuh_dewasa_thb", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "Data", 26, new String[]{
                ...
                tabMode.addRow(new String[]{
                    ...
                    SkalaResiko2.getSelectedItem().toString(), NilaiResiko2.getText(), SkalaResiko5.getSelectedItem().toString(), NilaiResiko5.getText(), SkalaResiko6.getSelectedItem().toString(), NilaiResiko6.getText(),
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if (TCari.getText().trim().equals("")) {
                Valid.MyReportqry("rptLanjutanRisikoJatuhDewasa.jasper", "report", "::[ Data Penilaian Lanjutan Risiko Jatuh Dewasa ]::",
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,penilaian_lanjutan_resiko_jatuh_dewasa_thb.tanggal,"
                        + "penilaian_lanjutan_resiko_jatuh_dewasa_thb.penilaian_jatuhmorse_skala1,penilaian_lanjutan_resiko_jatuh_dewasa_thb.penilaian_jatuhmorse_nilai1,"
                        + "penilaian_lanjutan_resiko_jatuh_dewasa_thb.penilaian_jatuhmorse_skala2,penilaian_lanjutan_resiko_jatuh_dewasa_thb.penilaian_jatuhmorse_nilai2,"
                        + "penilaian_lanjutan_resiko_jatuh_dewasa_thb.penilaian_jatuhmorse_skala3,penilaian_lanjutan_resiko_jatuh_dewasa_thb.penilaian_jatuhmorse_nilai3,"
                        + "penilaian_lanjutan_resiko_jatuh_dewasa_thb.penilaian_jatuhmorse_skala4,penilaian_lanjutan_resiko_jatuh_dewasa_thb.penilaian_jatuhmorse_nilai4,"
                        + "penilaian_lanjutan_resiko_jatuh_dewasa_thb.penilaian_jatuhmorse_skala5,penilaian_lanjutan_resiko_jatuh_dewasa_thb.penilaian_jatuhmorse_nilai5,"
                        + "penilaian_lanjutan_resiko_jatuh_dewasa_thb.penilaian_jatuhmorse_skala6,penilaian_lanjutan_resiko_jatuh_dewasa_thb.penilaian_jatuhmorse_nilai6,"
                        + "penilaian_lanjutan_resiko_jatuh_dewasa_thb.penilaian_jatuhmorse_totalnilai,penilaian_lanjutan_resiko_jatuh_dewasa_thb.hasil_skrining,"
                        + "penilaian_lanjutan_resiko_jatuh_dewasa_thb.saran,penilaian_lanjutan_resiko_jatuh_dewasa_thb.nip,petugas.nama "
                        + "from penilaian_lanjutan_resiko_jatuh_dewasa_thb inner join reg_periksa on penilaian_lanjutan_resiko_jatuh_dewasa_thb.no_rawat=reg_periksa.no_rawat "
                        + "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                        + "inner join petugas on penilaian_lanjutan_resiko_jatuh_dewasa_thb.nip=petugas.nip where "
                        + "penilaian_lanjutan_resiko_jatuh_dewasa_thb.tanggal between '" + Valid.SetTgl(DTPCari1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.SetTgl(DTPCari2.getSelectedItem() + "") + " 23:59:59' "
                        + "order by penilaian_lanjutan_resiko_jatuh_dewasa_thb.tanggal", param);
            } else {
                Valid.MyReportqry("rptLanjutanRisikoJatuhDewasa.jasper", "report", "::[ Data Penilaian Lanjutan Risiko Jatuh Dewasa ]::",
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,penilaian_lanjutan_resiko_jatuh_dewasa_thb.tanggal,"
                        + "penilaian_lanjutan_resiko_jatuh_dewasa_thb.penilaian_jatuhmorse_skala1,penilaian_lanjutan_resiko_jatuh_dewasa_thb.penilaian_jatuhmorse_nilai1,"
                        ...
                        + "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                        + "inner join petugas on penilaian_lanjutan_resiko_jatuh_dewasa_thb.nip=petugas.nip where "
                        + "penilaian_lanjutan_resiko_jatuh_dewasa_thb.tanggal between '" + Valid.SetTgl(DTPCari1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.SetTgl(DTPCari2.getSelectedItem() + "") + " 23:59:59' and "
                        ...
                        + "or penilaian_lanjutan_resiko_jatuh_dewasa_thb.nip like '%" + TCari.getText().trim() + "%' or petugas.nama like '%" + TCari.getText().trim() + "%') "
                        + "order by penilaian_lanjutan_resiko_jatuh_dewasa_thb.tanggal ", param);
            }
        }
    ...
    private void btnPetugasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnPetugasKeyPressed
        Valid.pindah(evt, Detik, SkalaResiko2);
    ...
    private void MnPenilaianLanjutanRisikoJatuhActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianLanjutanRisikoJatuhActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            ...
            Valid.MyReportqry("rptFormulirPenilaianLanjutanRisikoJatuhDewasa.jasper", "report", "::[ Formulir Penilaian Lanjutan Risiko Jatuh Dewasa ]::",
                    ...
                    + "penilaian_lanjutan_resiko_jatuh_dewasa_thb.penilaian_jatuhmorse_skala5,penilaian_lanjutan_resiko_jatuh_dewasa_thb.penilaian_jatuhmorse_nilai5,"
                    + "penilaian_lanjutan_resiko_jatuh_dewasa_thb.penilaian_jatuhmorse_skala6,penilaian_lanjutan_resiko_jatuh_dewasa_thb.penilaian_jatuhmorse_nilai6,"
                    + "penilaian_lanjutan_resiko_jatuh_dewasa_thb.penilaian_jatuhmorse_skala7,penilaian_lanjutan_resiko_jatuh_dewasa_thb.penilaian_jatuhmorse_nilai7,"
                    + "penilaian_lanjutan_resiko_jatuh_dewasa_thb.penilaian_jatuhmorse_skala8,penilaian_lanjutan_resiko_jatuh_dewasa_thb.penilaian_jatuhmorse_nilai8,"
                    + "penilaian_lanjutan_resiko_jatuh_dewasa_thb.penilaian_jatuhmorse_skala9,penilaian_lanjutan_resiko_jatuh_dewasa_thb.penilaian_jatuhmorse_nilai9,"
                    + "penilaian_lanjutan_resiko_jatuh_dewasa_thb.penilaian_jatuhmorse_skala10,penilaian_lanjutan_resiko_jatuh_dewasa_thb.penilaian_jatuhmorse_nilai10,"        
                    + "penilaian_lanjutan_resiko_jatuh_dewasa_thb.penilaian_jatuhmorse_totalnilai,penilaian_lanjutan_resiko_jatuh_dewasa_thb.hasil_skrining,"
                    + "penilaian_lanjutan_resiko_jatuh_dewasa_thb.saran,penilaian_lanjutan_resiko_jatuh_dewasa_thb.nip,petugas.nama "
                    + "from penilaian_lanjutan_resiko_jatuh_dewasa_thb inner join reg_periksa on penilaian_lanjutan_resiko_jatuh_dewasa_thb.no_rawat=reg_periksa.no_rawat "
                    + "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                    + "inner join petugas on penilaian_lanjutan_resiko_jatuh_dewasa_thb.nip=petugas.nip where reg_periksa.no_rawat='" + tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString() + "'", param);
        }
    ...
    private void SkalaResiko2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_SkalaResiko2KeyPressed
        Valid.pindah(evt, btnPetugas, SkalaResiko5);
    ...
    private void SkalaResiko5KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_SkalaResiko5KeyPressed
        Valid.pindah(evt, SkalaResiko2, SkalaResiko6);
    ...
    private void SkalaResiko9KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_SkalaResiko9KeyPressed
        Valid.pindah(evt, SkalaResiko8, HasilSkrining);
    ...
    private void HasilSkriningKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_HasilSkriningKeyPressed
        Valid.pindah2(evt, SkalaResiko9, Saran);
    ...
    private void PedomanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PedomanKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_PedomanKeyPressed

    private void SkalaResiko2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SkalaResiko2ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_SkalaResiko2ActionPerformed
    ...
    private void SkalaResiko5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SkalaResiko5ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_SkalaResiko5ActionPerformed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianLanjutanRisikoJatuhDewasaThb dialog = new RMPenilaianLanjutanRisikoJatuhDewasaThb(new javax.swing.JFrame(), true);
    ...
    private widget.TextArea Pedoman;
        ...
        try {
            if (TCari.getText().toString().trim().equals("")) {
                ps = koneksi.prepareStatement(
                        ...
                        + "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                        + "inner join petugas on penilaian_lanjutan_resiko_jatuh_dewasa_thb.nip=petugas.nip where "
                        + "penilaian_lanjutan_resiko_jatuh_dewasa_thb.tanggal between ? and ? order by penilaian_lanjutan_resiko_jatuh_dewasa_thb.tanggal");
            } else {
                ps = koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,penilaian_lanjutan_resiko_jatuh_dewasa_thb.tanggal,"
                        + "penilaian_lanjutan_resiko_jatuh_dewasa_thb.penilaian_jatuhmorse_skala1,penilaian_lanjutan_resiko_jatuh_dewasa_thb.penilaian_jatuhmorse_nilai1,"
                        ...
                        + "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                        + "inner join petugas on penilaian_lanjutan_resiko_jatuh_dewasa_thb.nip=petugas.nip where "
                        + "penilaian_lanjutan_resiko_jatuh_dewasa_thb.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or penilaian_lanjutan_resiko_jatuh_dewasa_thb.nip like ? or petugas.nama like ?) "
                        + "order by penilaian_lanjutan_resiko_jatuh_dewasa_thb.tanggal ");
            }
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("penilaian_jatuhmorse_skala7"), rs.getString("penilaian_jatuhmorse_nilai7"), rs.getString("penilaian_jatuhmorse_skala8"), rs.getString("penilaian_jatuhmorse_nilai8"),
                        rs.getString("penilaian_jatuhmorse_skala9"), rs.getString("penilaian_jatuhmorse_nilai9"), rs.getString("penilaian_jatuhmorse_skala10"), rs.getString("penilaian_jatuhmorse_nilai10"),
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            Saran.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 28).toString());
    ...
    private void ganti() {
        if (Sequel.mengedittf("penilaian_lanjutan_resiko_jatuh_dewasa_thb", "tanggal=? and no_rawat=?", "no_rawat=?,tanggal=?,penilaian_jatuhmorse_skala1=?,penilaian_jatuhmorse_nilai1=?,"
                ...
                + "penilaian_jatuhmorse_nilai7=?,penilaian_jatuhmorse_skala7=?,penilaian_jatuhmorse_nilai8=?,penilaian_jatuhmorse_skala8=?,penilaian_jatuhmorse_nilai9=?,"
                + "penilaian_jatuhmorse_nilai9=?,penilaian_jatuhmorse_skala10=?,penilaian_jatuhmorse_nilai10=?,"
            ...
            tbObat.setValueAt(NilaiResiko5.getText(), tbObat.getSelectedRow(), 14);
            tbObat.setValueAt(SkalaResiko6.getSelectedItem().toString(), tbObat.getSelectedRow(), 15);
            tbObat.setValueAt(NilaiResiko6.getText(), tbObat.getSelectedRow(), 16);
            tbObat.setValueAt(SkalaResiko7.getSelectedItem().toString(), tbObat.getSelectedRow(), 17);
            tbObat.setValueAt(NilaiResiko7.getText(), tbObat.getSelectedRow(), 18);
            tbObat.setValueAt(SkalaResiko8.getSelectedItem().toString(), tbObat.getSelectedRow(), 19);
            tbObat.setValueAt(NilaiResiko8.getText(), tbObat.getSelectedRow(), 20);
            tbObat.setValueAt(SkalaResiko9.getSelectedItem().toString(), tbObat.getSelectedRow(), 21);
            tbObat.setValueAt(NilaiResiko9.getText(), tbObat.getSelectedRow(), 22);
            tbObat.setValueAt(SkalaResiko10.getSelectedItem().toString(), tbObat.getSelectedRow(), 23);
            tbObat.setValueAt(NilaiResiko10.getText(), tbObat.getSelectedRow(), 24);
            tbObat.setValueAt(NilaiResikoTotal.getText(), tbObat.getSelectedRow(), 25);
            tbObat.setValueAt(HasilSkrining.getText(), tbObat.getSelectedRow(), 26);
            tbObat.setValueAt(Saran.getText(), tbObat.getSelectedRow(), 27);
            tbObat.setValueAt(NIP.getText(), tbObat.getSelectedRow(), 28);
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from penilaian_lanjutan_resiko_jatuh_dewasa_thb where tanggal=? and no_rawat=?", 2, new String[]{
    ...
    private void isTotalResikoJatuh() {
        try {
            // Menghitung total nilai risiko
            int totalResiko = Integer.parseInt(NilaiResiko1.getText())
                    + Integer.parseInt(NilaiResiko2.getText())
                    + Integer.parseInt(NilaiResiko3.getText())
                    + Integer.parseInt(NilaiResiko4.getText())
                    + Integer.parseInt(NilaiResiko5.getText())
                    + Integer.parseInt(NilaiResiko6.getText())
                    + Integer.parseInt(NilaiResiko7.getText())
                    + Integer.parseInt(NilaiResiko8.getText())
                    + Integer.parseInt(NilaiResiko9.getText())
                    + Integer.parseInt(NilaiResiko10.getText());

            // Menampilkan total nilai risiko
            NilaiResikoTotal.setText(String.valueOf(totalResiko));

            // Menentukan tingkat risiko berdasarkan nilai total
            if (totalResiko >= 0 && totalResiko <= 5) {
                TingkatResiko.setText("Tingkat Resiko : Risiko Rendah (0-5)");
            } else if (totalResiko >= 6 && totalResiko <= 13) {
                TingkatResiko.setText("Tingkat Resiko : Risiko Sedang (6-13)");
            } else if (totalResiko >= 14) {
                TingkatResiko.setText("Tingkat Resiko : Risiko Tinggi (>14)");
            }
        } catch (Exception e) {
            // Penanganan jika ada input yang tidak valid
            NilaiResikoTotal.setText("0");
            TingkatResiko.setText("Tingkat Resiko : Risiko Rendah (0-5)");
        }
    }

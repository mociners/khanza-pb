...
import freehand.DlgMarkingImageAssMedisMata;
...
public final class RMPenilaianAwalMedisRalanMata extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMPenilaianAwalMedisRalanMata(java.awt.Window parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Conjungtiva Kanan","Conjungtiva Kiri","Cornea Kanan","Cornea Kiri","COA Kanan","COA kiri","Pupil Kanan","Pupil Kiri","Iris Kanan","Iris Kiri","Lensa Kanan","Lensa Kiri","Fundus Kanan","Fundus Kiri","Papil Kanan","Papil Kiri","Retina Kanan","Retina Kiri",
    ...
    private void initComponents() {
        ...
        jSeparator14.setBounds(60, 1370, 780, 1);
        ...
        jLabel101.setBounds(30, 1410, 190, 23);
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "09-06-2024 13:29:11" }));
        ...
        jLabel82.setBounds(450, 1520, 150, 23);
        ...
        jSeparator18.setBounds(60, 1330, 780, 1);
        ...
        scrollPane19.setBounds(450, 1540, 400, 43);
        ...
        scrollPane21.setBounds(40, 1540, 400, 43);

        jLabel84.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel84.setText("Tes Penglihatan :");
        jLabel84.setName("jLabel84"); // NOI18N
        FormInput.add(jLabel84);
        jLabel84.setBounds(40, 1520, 150, 23);
        ...
        jLabel35.setBounds(370, 820, 170, 23);
        ...
        jSeparator20.setBounds(60, 850, 780, 1);
        ...
        jSeparator21.setBounds(60, 890, 780, 1);
        ...
        jSeparator22.setBounds(60, 930, 780, 1);
        ...
        jSeparator23.setBounds(60, 970, 780, 1);
        ...
        jSeparator24.setBounds(60, 1010, 780, 1);
        ...
        jSeparator25.setBounds(60, 1050, 780, 1);
        ...
        jSeparator26.setBounds(60, 1090, 780, 1);
        ...
        jSeparator27.setBounds(70, 1170, 780, 1);
        ...
        jSeparator28.setBounds(70, 1210, 780, 1);
        ...
        jSeparator29.setBounds(70, 1250, 780, 1);
        ...
        jSeparator30.setBounds(70, 1290, 780, 1);
        ...
        MBOkiri.setBounds(540, 1380, 300, 23);
        ...
        Visuskanan.setBounds(70, 820, 300, 23);
        ...
        Visuskiri.setBounds(540, 820, 300, 23);
        ...
        CCkanan.setBounds(70, 860, 300, 23);
        ...
        CCkiri.setBounds(540, 860, 300, 23);
        ...
        Palkanan.setBounds(70, 900, 300, 23);
        ...
        Palkiri.setBounds(540, 900, 300, 23);
        ...
        Conkanan.setBounds(70, 940, 300, 23);
        ...
        Conkiri.setBounds(540, 940, 300, 23);
        ...
        Corneakanan.setBounds(70, 980, 300, 23);
        ...
        Corneakiri.setBounds(540, 980, 300, 23);
        ...
        COAkanan.setBounds(70, 1020, 300, 23);
        ...
        COAkiri.setBounds(540, 1020, 300, 23);
        ...
        Pupilkanan.setBounds(70, 1060, 300, 23);
        ...
        Pupilkiri.setBounds(540, 1060, 300, 23);
        ...
        Lensakanan.setBounds(70, 1140, 300, 23);
        ...
        Lensakiri.setBounds(540, 1140, 300, 23);
        ...
        Funduskanan.setBounds(70, 1180, 300, 23);
        ...
        Funduskiri.setBounds(540, 1180, 300, 23);
        ...
        Papilkanan.setBounds(70, 1220, 300, 23);
        ...
        Papilkiri.setBounds(540, 1220, 300, 24);
        ...
        Retinakanan.setBounds(70, 1260, 300, 23);
        ...
        Retinakiri.setBounds(540, 1260, 300, 23);
        ...
        Makulakanan.setBounds(70, 1300, 300, 23);
        ...
        Makulakiri.setBounds(540, 1300, 300, 23);
        ...
        TIOkanan.setBounds(70, 1340, 300, 23);
        ...
        TIOkiri.setBounds(540, 1340, 300, 23);
        ...
        jSeparator31.setBounds(20, 1410, 880, 1);
        ...
        scrollPane13.setBounds(590, 1450, 260, 63);

        jLabel109.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel109.setText("Penunjang Lainnya :");
        jLabel109.setName("jLabel109"); // NOI18N
        FormInput.add(jLabel109);
        jLabel109.setBounds(590, 1430, 190, 23);
        ...
        scrollPane9.setBounds(40, 1450, 260, 63);

        jLabel80.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel80.setText("Laboratorium :");
        jLabel80.setName("jLabel80"); // NOI18N
        FormInput.add(jLabel80);
        jLabel80.setBounds(40, 1430, 150, 23);

        jLabel81.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel81.setText("Radiologi :");
        jLabel81.setName("jLabel81"); // NOI18N
        FormInput.add(jLabel81);
        jLabel81.setBounds(320, 1430, 150, 23);
        ...
        scrollPane10.setBounds(320, 1450, 260, 63);
        ...
        jSeparator32.setBounds(0, 1590, 880, 1);

        jLabel110.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel110.setText("V. DIAGNOSIS/ASESMEN");
        jLabel110.setName("jLabel110"); // NOI18N
        FormInput.add(jLabel110);
        jLabel110.setBounds(10, 1590, 190, 23);
        ...
        scrollPane15.setBounds(40, 1630, 400, 43);
        ...
        jSeparator33.setBounds(0, 1680, 880, 1);

        jLabel103.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel103.setText("VI. PERMASALAHAN & TATALAKSANA");
        jLabel103.setName("jLabel103"); // NOI18N
        FormInput.add(jLabel103);
        jLabel103.setBounds(10, 1680, 190, 23);
        ...
        scrollPane20.setBounds(40, 1720, 400, 43);
        ...
        scrollPane23.setBounds(40, 1790, 810, 43);

        jLabel112.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel112.setText("Tindakan/Rencana Tindakan :");
        jLabel112.setName("jLabel112"); // NOI18N
        FormInput.add(jLabel112);
        jLabel112.setBounds(40, 1770, 320, 20);
        ...
        jSeparator34.setBounds(0, 1840, 880, 1);

        jLabel113.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel113.setText("VII. EDUKASI");
        jLabel113.setName("jLabel113"); // NOI18N
        FormInput.add(jLabel113);
        jLabel113.setBounds(10, 1840, 190, 23);
        ...
        scrollPane14.setBounds(40, 1860, 810, 63);
        ...
        jSeparator35.setBounds(60, 810, 780, 1);
        ...
        Iriskanan.setBounds(70, 1100, 300, 23);

        jLabel57.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel57.setText("Iris");
        jLabel57.setName("jLabel57"); // NOI18N
        FormInput.add(jLabel57);
        jLabel57.setBounds(370, 1100, 170, 23);
        ...
        Iriskiri.setBounds(540, 1100, 300, 23);
        ...
        BtnMarking.setBounds(330, 320, 160, 30);
        ...
        PanelWall.setBounds(45, 360, 809, 400);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("penilaian_medis_ralan_mata","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",58,new String[]{
                    ...
                    Iriskanan.getText(),Iriskiri.getText(),
            ...
            try{
                if(TCari.getText().trim().equals("")){
                    ps=koneksi.prepareStatement(
                        ...
                        "penilaian_medis_ralan_mata.corneakanan,penilaian_medis_ralan_mata.corneakiri,penilaian_medis_ralan_mata.coakanan,penilaian_medis_ralan_mata.coakiri,penilaian_medis_ralan_mata.pupilkanan,penilaian_medis_ralan_mata.pupilkiri,penilaian_medis_ralan_mata.iriskanan,penilaian_medis_ralan_mata.iriskiri,penilaian_medis_ralan_mata.lensakanan,penilaian_medis_ralan_mata.lensakiri,"+
                ...
                try {
                    ...
                    htmlContent.append(                             
                        "<tr class='isi'>"+
                            ...
                            "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>Iriskanan</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>Iriskiri</b></td>"+
                    ...
                    while(rs.next()){
                        htmlContent.append(
                            "<tr class='isi'>"+
                               ...
                               "<td valign='top'>"+rs.getString("iriskanan")+"</td>"+
                               "<td valign='top'>"+rs.getString("iriskiri")+"</td>"+        
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            try {                           
             param.put("lokalis","http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/imagefreehand/assesmentmedismata/imagemarking/assMdsMata"+TNoRw.getText().replaceAll("/","")+".png");    
            } catch (Exception e) {
            }
            try {
    ...
    private void BtnMarkingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnMarkingActionPerformed
        DlgMarkingImageAssMedisMata form=new DlgMarkingImageAssMedisMata(null,false);
    ...
    */
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("corneakanan"),rs.getString("corneakiri"),rs.getString("coakanan"),rs.getString("coakiri"),rs.getString("pupilkanan"),rs.getString("pupilkiri"),rs.getString("iriskanan"),rs.getString("iriskiri"),rs.getString("lensakanan"),rs.getString("lensakiri"),
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Iriskanan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),36).toString());
            Iriskiri.setText(tbObat.getValueAt(tbObat.getSelectedRow(),37).toString());
            Lensakanan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),38).toString());
            Lensakiri.setText(tbObat.getValueAt(tbObat.getSelectedRow(),39).toString());
            Funduskanan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),40).toString());
            Funduskiri.setText(tbObat.getValueAt(tbObat.getSelectedRow(),41).toString());
            Papilkanan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),42).toString());
            Papilkiri.setText(tbObat.getValueAt(tbObat.getSelectedRow(),43).toString());
            Retinakanan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),44).toString());
            Retinakiri.setText(tbObat.getValueAt(tbObat.getSelectedRow(),45).toString());
            Makulakanan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),46).toString());
            Makulakiri.setText(tbObat.getValueAt(tbObat.getSelectedRow(),47).toString());
            TIOkanan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),48).toString());
            TIOkiri.setText(tbObat.getValueAt(tbObat.getSelectedRow(),49).toString());
            MBOkanan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),50).toString());
            MBOkiri.setText(tbObat.getValueAt(tbObat.getSelectedRow(),51).toString());
            Laborat.setText(tbObat.getValueAt(tbObat.getSelectedRow(),52).toString());
            Radiologi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),53).toString());
            Penunjang.setText(tbObat.getValueAt(tbObat.getSelectedRow(),54).toString());
            TesPenglihatan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),55).toString());
            PemeriksaanLain.setText(tbObat.getValueAt(tbObat.getSelectedRow(),56).toString());
            Diagnosis.setText(tbObat.getValueAt(tbObat.getSelectedRow(),57).toString());
            DiagnosisBdg.setText(tbObat.getValueAt(tbObat.getSelectedRow(),58).toString());
            Permasalahan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),59).toString());
            Terapi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),60).toString());
            Tindakan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),61).toString());
    ...
    private void ganti() {
        if(Sequel.mengedittf("penilaian_medis_ralan_mata","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpd=?,rpo=?,alergi=?,status=?,td=?,nadi=?,rr=?,suhu=?,"+
                "nyeri=?,bb=?,visuskanan=?,visuskiri=?,cckanan=?,cckiri=?,palkanan=?,palkiri=?,conkanan=?,conkiri=?,corneakanan=?,corneakiri=?,coakanan=?,coakiri=?,pupilkanan=?,pupilkiri=?,iriskanan=?,iriskiri=?,lensakanan=?,lensakiri=?,funduskanan=?,funduskiri=?,papilkanan=?,papilkiri=?,retinakanan=?,retinakiri=?,"+
                "makulakanan=?,makulakiri=?,tiokanan=?,tiokiri=?,mbokanan=?,mbokiri=?,lab=?,rad=?,penunjang=?,tes=?,pemeriksaan=?,diagnosis=?,diagnosisbdg=?,permasalahan=?,terapi=?,tindakan=?,edukasi=?",59,new String[]{
                TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),KdDokter.getText(),Anamnesis.getSelectedItem().toString(),Hubungan.getText(),
                    KeluhanUtama.getText(),RPS.getText(),RPD.getText(),RPO.getText(),Alergi.getText(),StatusNutrisi.getText(),TD.getText(),Nadi.getText(),RR.getText(),Suhu.getText(),Nyeri.getText(),BB.getText(),
                    Visuskanan.getText(),Visuskiri.getText(),CCkanan.getText(),CCkiri.getText(),Palkanan.getText(),Palkiri.getText(),Conkanan.getText(),Conkiri.getText(),Corneakanan.getText(),Corneakiri.getText(),COAkanan.getText(),COAkiri.getText(),Pupilkanan.getText(),Pupilkiri.getText(),Iriskanan.getText(),Iriskiri.getText(),
                    Lensakanan.getText(),Lensakiri.getText(),Funduskanan.getText(),Funduskiri.getText(),Papilkanan.getText(),Papilkiri.getText(),Retinakanan.getText(),Retinakiri.getText(),Makulakanan.getText(),Makulakiri.getText(),TIOkanan.getText(),TIOkiri.getText(),MBOkanan.getText(),MBOkiri.getText(),

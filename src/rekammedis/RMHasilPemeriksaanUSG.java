...
public final class RMHasilPemeriksaanUSG extends javax.swing.JDialog {
    private final DefaultTableModel tabMode,tabModeDicom,tabMode2;
    ...
    private Connection koneksisalim=koneksiDBSalim.condb();
    ...
    private String finger="",auth,authEncrypt,requestJson,norawat;
    ...
    public RMHasilPemeriksaanUSG(java.awt.Frame parent, boolean modal) {
        ...
        tbListRadiologi.setModel(tabMode2);
    ...
    private void initComponents() {
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-05-2024 21:35:58" }));
        ...
        internalFrame5.add(scrollInput, java.awt.BorderLayout.PAGE_START);
        ...
        internalFrame5.add(Scroll4, java.awt.BorderLayout.PAGE_END);

        internalFrame2.add(internalFrame5);
            ...
            try {
                ...
                while (rs.next()) {
                    try {
                        ...
                        String urlHasil = koneksiDBSalim.URLWEBAPPS() + "hasilpemeriksaanusg/" + rs.getString("photo");
    ...
    */
    ...
    private void initComponents2() {           
        ...
        internalFrame4.setLayout(new BorderLayout());
        internalFrame4.add(panel);        
    }
            ...
            public void run() {
                ...
                engine.titleProperty().addListener((ObservableValue<? extends String> observable, String oldValue, final String newValue) -> {
                    SwingUtilities.invokeLater(() -> {
                        RMHasilPemeriksaanUSG.this.setTitle(newValue);
                    });
                });

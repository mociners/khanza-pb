...
public final class RMHasilPemeriksaanUSGGynecologi extends javax.swing.JDialog {
    private final DefaultTableModel tabMode,tabMode2,tabModeDicom;
    ...
    private void initComponents() {
        ...
        internalFrame2.setLayout(new java.awt.GridLayout());
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-12-2023 10:15:00" }));
            ...
            public void run() {
                ...
                engine.titleProperty().addListener((ObservableValue<? extends String> observable, String oldValue, final String newValue) -> {
                    SwingUtilities.invokeLater(() -> {
                        RMHasilPemeriksaanUSGGynecologi.this.setTitle(newValue);
                    });
                });

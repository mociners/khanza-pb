 ...
 * @author perpustakaan
 */
public final class RMDataCatatanObservasiIntradialitik extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMDataCatatanObservasiIntradialitik(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Rawat","No.R.M.","Nama Pasien","Tgl.Lahir","Tgl.Perawatan","Jam Perawatan","Jam Ke",
            "Keluhan","BB","Kesadaran","Tensi","Nadi","Respirasi","Suhu","Qb","Qd","Tekanan Vena",
            "TMP","Volume Ditarik","Asesmen","NIP","Nama Petugas"
        }){
        ...
        Keluhan.setDocument(new batasInput((byte)10).getKata(Keluhan));
        TD.setDocument(new batasInput((byte)8).getKata(TD));
        Nadi.setDocument(new batasInput((byte)5).getOnlyAngka(Nadi));
        Rr.setDocument(new batasInput((byte)5).getOnlyAngka(Rr));
        Suhu.setDocument(new batasInput((byte)5).getKata(Suhu));
        Bb.setDocument(new batasInput((byte)3).getOnlyAngka(Bb));
        Qb.setDocument(new batasInput((byte)3).getOnlyAngka(Qb));
        Qd.setDocument(new batasInput((byte)3).getOnlyAngka(Qd));
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pemantauan Intradialitik ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "17-02-2024" }));
        ...
        jLabel18.setBounds(0, 160, 70, 23);
        ...
        FormInput.add(NIP);
        NIP.setBounds(70, 160, 94, 23);

        NamaPetugas.setEditable(false);
        NamaPetugas.setName("NamaPetugas"); // NOI18N
        FormInput.add(NamaPetugas);
        NamaPetugas.setBounds(170, 160, 187, 23);
        ...
        btnPetugas.setBounds(360, 160, 28, 23);

        jLabel8.setText("Pemantauan Jam Ke-");
        jLabel8.setName("jLabel8"); // NOI18N
        FormInput.add(jLabel8);
        jLabel8.setBounds(400, 40, 110, 23);
        ...
        Keluhan.setBounds(80, 70, 320, 23);

        jLabel17.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel17.setText("x/menit");
        jLabel17.setName("jLabel17"); // NOI18N
        FormInput.add(jLabel17);
        jLabel17.setBounds(130, 100, 50, 23);
        ...
        FormInput.add(Nadi);
        Nadi.setBounds(80, 100, 40, 23);

        jLabel20.setText("Nadi:");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(30, 100, 40, 23);

        jLabel22.setText("Suhu :");
        jLabel22.setName("jLabel22"); // NOI18N
        FormInput.add(jLabel22);
        jLabel22.setBounds(310, 100, 40, 23);
        ...
        FormInput.add(Suhu);
        Suhu.setBounds(350, 100, 40, 23);

        jLabel23.setText("TD :");
        jLabel23.setName("jLabel23"); // NOI18N
        FormInput.add(jLabel23);
        jLabel23.setBounds(720, 70, 40, 23);
        ...
        FormInput.add(TD);
        TD.setBounds(760, 70, 70, 23);

        jLabel26.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel26.setText("°C");
        jLabel26.setName("jLabel26"); // NOI18N
        FormInput.add(jLabel26);
        jLabel26.setBounds(400, 100, 30, 23);

        jLabel27.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel27.setText("mmHg");
        jLabel27.setName("jLabel27"); // NOI18N
        FormInput.add(jLabel27);
        jLabel27.setBounds(840, 70, 40, 23);

        jLabel25.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel25.setText("x/menit");
        jLabel25.setName("jLabel25"); // NOI18N
        FormInput.add(jLabel25);
        jLabel25.setBounds(250, 100, 50, 23);
        ...
        FormInput.add(Rr);
        Rr.setBounds(200, 100, 40, 23);

        jLabel28.setText("RR :");
        jLabel28.setName("jLabel28"); // NOI18N
        FormInput.add(jLabel28);
        jLabel28.setBounds(160, 100, 40, 23);

        jLabel29.setText("BB:");
        jLabel29.setName("jLabel29"); // NOI18N
        FormInput.add(jLabel29);
        jLabel29.setBounds(400, 70, 40, 23);
        ...
        FormInput.add(Bb);
        Bb.setBounds(450, 70, 40, 23);

        jLabel35.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel35.setText("Kg");
        jLabel35.setName("jLabel35"); // NOI18N
        FormInput.add(jLabel35);
        jLabel35.setBounds(500, 70, 30, 23);
        ...
        FormInput.add(JamKe);
        JamKe.setBounds(520, 40, 120, 20);

        jLabel10.setText("Kesadaran:");
        jLabel10.setName("jLabel10"); // NOI18N
        FormInput.add(jLabel10);
        jLabel10.setBounds(520, 70, 70, 23);

        Kesadaran.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Compos Mentis", "Sopor", "Koma", "Apatis" }));
        Kesadaran.setName("Kesadaran"); // NOI18N
        FormInput.add(Kesadaran);
        Kesadaran.setBounds(590, 70, 120, 20);

        jLabel24.setText("Qb :");
        jLabel24.setName("jLabel24"); // NOI18N
        FormInput.add(jLabel24);
        jLabel24.setBounds(420, 100, 40, 23);
        ...
        FormInput.add(Qb);
        Qb.setBounds(460, 100, 70, 23);

        jLabel30.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel30.setText("ml/menit");
        jLabel30.setName("jLabel30"); // NOI18N
        FormInput.add(jLabel30);
        jLabel30.setBounds(540, 100, 40, 23);
        ...
        FormInput.add(Qd);
        Qd.setBounds(610, 100, 70, 23);

        jLabel32.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel32.setText("ml/menit");
        jLabel32.setName("jLabel32"); // NOI18N
        FormInput.add(jLabel32);
        jLabel32.setBounds(690, 100, 40, 23);

        jLabel33.setText("Tekanan vena :");
        jLabel33.setName("jLabel33"); // NOI18N
        FormInput.add(jLabel33);
        jLabel33.setBounds(720, 100, 90, 23);
        ...
        FormInput.add(TV);
        TV.setBounds(820, 100, 70, 23);

        jLabel34.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel34.setText("mmHg");
        jLabel34.setName("jLabel34"); // NOI18N
        FormInput.add(jLabel34);
        jLabel34.setBounds(900, 100, 40, 23);

        jLabel36.setText("TMP:");
        jLabel36.setName("jLabel36"); // NOI18N
        FormInput.add(jLabel36);
        jLabel36.setBounds(30, 130, 40, 23);
        ...
        FormInput.add(TMP);
        TMP.setBounds(70, 130, 70, 23);

        jLabel37.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel37.setText("mmHg");
        jLabel37.setName("jLabel37"); // NOI18N
        FormInput.add(jLabel37);
        jLabel37.setBounds(150, 130, 40, 23);

        jLabel38.setText("Volume yang ditarik:");
        jLabel38.setName("jLabel38"); // NOI18N
        FormInput.add(jLabel38);
        jLabel38.setBounds(190, 130, 100, 23);
        ...
        FormInput.add(VolumeTarik);
        VolumeTarik.setBounds(300, 130, 70, 23);

        jLabel39.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel39.setText("mmHg");
        jLabel39.setName("jLabel39"); // NOI18N
        FormInput.add(jLabel39);
        jLabel39.setBounds(380, 130, 40, 23);

        jLabel13.setText("Asesmen/ Internvensi/ Keterangan");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(420, 130, 200, 23);
        ...
        Asesmen.setBounds(630, 130, 320, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("pemantauan_intradialitik","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",18,new String[]{
                TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+""),Jam.getSelectedItem()+":"+Menit.getSelectedItem()+":"+Detik.getSelectedItem(),
                JamKe.getSelectedItem().toString(),Keluhan.getText(),Bb.getText(),Kesadaran.getSelectedItem().toString(),TD.getText(),Nadi.getText(),
                Rr.getText(),Suhu.getText(),Qb.getText(),Qd.getText(),TV.getText(),TMP.getText(),VolumeTarik.getText(),Asesmen.getText(),NIP.getText()
            })==true){
                ...
                JamKe.getSelectedItem().toString(),Keluhan.getText(),Bb.getText(),Kesadaran.getSelectedItem().toString(),TD.getText(),Nadi.getText(),
                Rr.getText(),Suhu.getText(),Qb.getText(),Qd.getText(),TV.getText(),TMP.getText(),VolumeTarik.getText(),Asesmen.getText(),NIP.getText(),NamaPetugas.getText()
                });
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptDataCatatanObservasiIGD.jasper","report","::[ Data Catatan Observasi IGD ]::",
                    ...
                    "pasien.jk,pasien.tgl_lahir,pemantauan_intradialitik.tgl_perawatan,pemantauan_intradialitik.jam_rawat,pemantauan_intradialitik.gcs,"+
                    "pemantauan_intradialitik.td,pemantauan_intradialitik.hr,pemantauan_intradialitik.rr,pemantauan_intradialitik.suhu,pemantauan_intradialitik.spo2,"+
                    "pemantauan_intradialitik.nip,petugas.nama from pemantauan_intradialitik inner join reg_periksa on pemantauan_intradialitik.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on pemantauan_intradialitik.nip=petugas.nip where "+
                    "pemantauan_intradialitik.tgl_perawatan between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' order by pemantauan_intradialitik.tgl_perawatan",param);
            }else{
                Valid.MyReportqry("rptDataCatatanObservasiIGD.jasper","report","::[ Data Catatan Observasi IGD ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,reg_periksa.umurdaftar,reg_periksa.sttsumur,"+
                    "pasien.jk,pasien.tgl_lahir,pemantauan_intradialitik.tgl_perawatan,pemantauan_intradialitik.jam_rawat,pemantauan_intradialitik.gcs,"+
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on pemantauan_intradialitik.nip=petugas.nip where "+
                    "pemantauan_intradialitik.tgl_perawatan between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' and "+
                    "(reg_periksa.no_rawat like '%"+TCari.getText().trim()+"%' or pasien.no_rkm_medis like '%"+TCari.getText().trim()+"%' or "+
                    "pasien.nm_pasien like '%"+TCari.getText().trim()+"%' or pemantauan_intradialitik.nip like '%"+TCari.getText().trim()+"%' or petugas.nama like '%"+TCari.getText().trim()+"%') "+
                    "order by pemantauan_intradialitik.tgl_perawatan ",param);
            }  
        }
    ...
    private void MnCatatanObservasiIGDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCatatanObservasiIGDActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptFormulirCatatanObservasiIGD.jasper","report","::[ Formulir Catatan Observasi IGD ]::",
                    ...
                    "pasien.jk,pasien.tgl_lahir,pemantauan_intradialitik.tgl_perawatan,pemantauan_intradialitik.jam_rawat,pemantauan_intradialitik.gcs,dokter.nm_dokter,"+
                    "pemantauan_intradialitik.td,pemantauan_intradialitik.hr,pemantauan_intradialitik.rr,pemantauan_intradialitik.suhu,pemantauan_intradialitik.spo2,"+
                    "petugas.nama from pemantauan_intradialitik inner join reg_periksa on pemantauan_intradialitik.no_rawat=reg_periksa.no_rawat "+
                    ...
                    "inner join petugas on pemantauan_intradialitik.nip=petugas.nip where reg_periksa.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMDataCatatanObservasiIntradialitik dialog = new RMDataCatatanObservasiIntradialitik(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().toString().trim().equals("")){
                ps=koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,reg_periksa.umurdaftar,reg_periksa.sttsumur,"+
                    "pasien.jk,pasien.tgl_lahir,pemantauan_intradialitik.tgl_perawatan,pemantauan_intradialitik.jam_rawat,pemantauan_intradialitik.jam_ke,"+
                    "pemantauan_intradialitik.keluhan,pemantauan_intradialitik.bb,pemantauan_intradialitik.kesadaran,pemantauan_intradialitik.td,pemantauan_intradialitik.nadi,"+
                    "pemantauan_intradialitik.rr,pemantauan_intradialitik.suhu,pemantauan_intradialitik.qb,pemantauan_intradialitik.qd,pemantauan_intradialitik.tv,pemantauan_intradialitik.tmp,pemantauan_intradialitik.volume_tarik,"+
                    "pemantauan_intradialitik.asesmen,pemantauan_intradialitik.nip,petugas.nama from pemantauan_intradialitik inner join reg_periksa on pemantauan_intradialitik.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on pemantauan_intradialitik.nip=petugas.nip where "+
                    "pemantauan_intradialitik.tgl_perawatan between ? and ? order by pemantauan_intradialitik.tgl_perawatan");
            }else{
                ps=koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,reg_periksa.umurdaftar,reg_periksa.sttsumur,"+
                    "pasien.jk,pasien.tgl_lahir,pemantauan_intradialitik.tgl_perawatan,pemantauan_intradialitik.jam_rawat,pemantauan_intradialitik.jam_ke,"+
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on pemantauan_intradialitik.nip=petugas.nip where "+
                    "pemantauan_intradialitik.tgl_perawatan between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or pemantauan_intradialitik.nip like ? or petugas.nama like ?) "+
                    "order by pemantauan_intradialitik.tgl_perawatan ");
            }
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("jam_ke")+" "+rs.getString("keluhan"),rs.getString("bb"),rs.getString("kesadaran"),
                        rs.getString("td"),rs.getString("nadi"),rs.getString("rr"),rs.getString("suhu"),
                        rs.getString("qb"),rs.getString("qd"),rs.getString("tv"),rs.getString("tmp"),rs.getString("volume_tarik"),
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            JamKe.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),6).toString());
            ...
            Kesadaran.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),9).toString());
            ...
            Qb.setText(tbObat.getValueAt(tbObat.getSelectedRow(),14).toString());
            Qd.setText(tbObat.getValueAt(tbObat.getSelectedRow(),15).toString());
            TV.setText(tbObat.getValueAt(tbObat.getSelectedRow(),16).toString());
            TMP.setText(tbObat.getValueAt(tbObat.getSelectedRow(),17).toString());
            VolumeTarik.setText(tbObat.getValueAt(tbObat.getSelectedRow(),18).toString());
            Asesmen.setText(tbObat.getValueAt(tbObat.getSelectedRow(),19).toString());            
    ...
    private void ganti() {
        if(Sequel.mengedittf("pemantauan_intradialitik","tgl_perawatan=? and jam_rawat=? and no_rawat=?","no_rawat=?,tgl_perawatan=?,jam_rawat=?,jam_ke=?,keluhan=?,bb=?,kesadaran=?,td=?,nadi=?,rr=?,suhu=?,qb=?,qd=?,tv=?,tmp=?,volume_tarik=?,asesmen=?,nip=?",21,new String[]{
            TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+""),Jam.getSelectedItem()+":"+Menit.getSelectedItem()+":"+Detik.getSelectedItem(),
            JamKe.getSelectedItem().toString(),Keluhan.getText(),Bb.getText(),Kesadaran.getSelectedItem().toString(),TD.getText(),Nadi.getText(),
            Rr.getText(),Suhu.getText(),Qb.getText(),Qd.getText(),TV.getText(),TMP.getText(),VolumeTarik.getText(),Asesmen.getText(),NIP.getText(),
        ...
        /*    tbObat.setValueAt(TNoRw.getText(),tbObat.getSelectedRow(),0);
            ...
            tbObat.setValueAt(Keluhan.getText(),tbObat.getSelectedRow(),8);
            ...
            tbObat.setValueAt(Bb.getText(),tbObat.getSelectedRow(),13);
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from pemantauan_intradialitik where tgl_perawatan=? and jam_rawat=? and no_rawat=?",3,new String[]{
            tbObat.getValueAt(tbObat.getSelectedRow(),4).toString(),tbObat.getValueAt(tbObat.getSelectedRow(),5).toString(),tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
        })==true){

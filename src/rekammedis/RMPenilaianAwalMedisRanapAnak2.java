 ...
 * @author perpustakaan
 */
public final class RMPenilaianAwalMedisRanapAnak2 extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public RMPenilaianAwalMedisRanapAnak2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalMedisRanapAnak2 dialog = new RMPenilaianAwalMedisRanapAnak2(new javax.swing.JFrame(), true);

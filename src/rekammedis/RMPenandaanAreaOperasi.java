...
public final class RMPenandaanAreaOperasi extends javax.swing.JDialog {
    ...
    public RMPenandaanAreaOperasi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[] {
                ...
                "Anamnesis",
                "Hubungan", "Ruangan", "Operasi", "Kode Petugas", "Nama Petugas", "Keterangan", "No Penandaan"
        }) {
            @Override
    ...
    private void initComponents() {
        ...
        KdPetugas.setBounds(80, 70, 90, 23);
        ...
        label19.setText("No Penandaan:");
        label19.setName("label19"); // NOI18N
        label19.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label19);
        label19.setBounds(380, 70, 100, 23);

        No.setName("No"); // NOI18N
        No.setPreferredSize(new java.awt.Dimension(80, 23));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRM.getText().trim().equals("")) {
            ...
            if (Sequel.menyimpantf("penandaan_area_operasi", "?,?,?,?,?,?,?,?,?,?", "No.Rawat", 10, new String[] {
                    TNoRw.getText(),
                    ...
                    Ruangan.getText(), Operasi.getText(), KdPetugas.getText(), Keterangan.getText(), No.getText()
            }) == true) {
                emptTeks();
            }
        }
    ...
    private void MnCetakActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_MnCetakActionPerformed
        if (tbObat.getSelectedRow() > -1) {
             ...
             * ,"Nama Dokter","Tanggal","Anamnesis",
             * "Hubungan","Ruangan","Operasi","Kode Petugas","Nama Petugas"
             * ,"Keterangan","No Penandaan"jas
             */

            param.put("url", Sequel.cariIsi(
                    "select url_image from penandaan_area_operasi_image_marking where no_rawat=?", TNoRw.getText()));
            try {
            ...
            // }
            // try {
            // param.put("lokalis","http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/imagefreehand/PenandaanOperasi/imagemarking/PenandaanOperasi"+TNoRw.getText().replaceAll("/","")+".png");
            // } catch (Exception e) {
            // }
            ...
            Valid.MyReportqry("rptCetakPenandaanLokasiOperasi.jasper", "report", "::[ Penandaan Area Operasi ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penandaan_area_operasi.tanggal,"
                            ...
                            + "penandaan_area_operasi.keterangan,penandaan_area_operasi.no_penandaan,dokter.nm_dokter "
                            + "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                            + "inner join penandaan_area_operasi on reg_periksa.no_rawat=penandaan_area_operasi.no_rawat "
                            + "inner join dokter on penandaan_area_operasi.kd_dokter=dokter.kd_dokter where penandaan_area_operasi.no_rawat='"
    ...
    private void BtnEdit2ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_BtnEdit2ActionPerformed
        ...
        form.addWindowListener(new WindowListener() {
            ...
            @Override
            public void windowClosed(WindowEvent e) {
                urlImage = Sequel.cariIsi("select url_image from penandaan_area_operasi_image_marking where no_rawat='"
                        + TNoRw.getText() + "' ");
    ...
    private void TabDataMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_TabDataMouseClicked
         ...
         * if(lokasifile.equals("")){
         * LoadHTML2.
         * setText("<html><body><center><br><br><font face='tahoma' size='2' color='#434343'>Kosong</font></center></body></html>"
         * );
         * }else{
         * LoadHTML2.setText("<html><body><center><img src='http://"+koneksiDB.
         * HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+
         * "/persetujuantindakan/"+
         * lokasifile+"' alt='photo' width='450' height='550'/></center></body></html>"
         * );
         * }
         * }else{
         ...
         * );
         * }else{
         * LoadHTML3.setText("<html><body><center><img src='http://"+koneksiDB.
         * HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+
         * "/persetujuantindakan/"+
         * lokasifile2+"' alt='photo' width='450' height='550'/></center></body></html>"
         * );
         * }
         * }
         */
        ...
        try {
            if (TCari.getText().trim().equals("")) {
                ps = koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penandaan_area_operasi.tanggal,"
                                + "penandaan_area_operasi.kd_dokter,penandaan_area_operasi.anamnesis,penandaan_area_operasi.hubungan,penandaan_area_operasi.ruangan,penandaan_area_operasi.operasi,"
                                + "dokter.nm_dokter,penandaan_area_operasi.kd_petugas,penandaan_area_operasi.keterangan,petugas.nama,penandaan_area_operasi.no_penandaan "
                                + "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                                + "inner join penandaan_area_operasi on reg_periksa.no_rawat=penandaan_area_operasi.no_rawat "
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[] {
                            ...
                            rs.getString("operasi"), rs.getString("kd_petugas"), rs.getString("nama"),
                            rs.getString("keterangan"), rs.getString("no_penandaan")
                    });
                }
            } catch (Exception e) {
    ...
    public void emptTeks() {
        ...
        Keterangan.setText("");
        Valid.autoNomer3(
                "select ifnull(MAX(CONVERT(RIGHT(penandaan_area_operasi.no_penandaan,3),signed)),0) from penandaan_area_operasi where penandaan_area_operasi.tanggal='"
                        + Valid.SetTgl(TglAsuhan.getSelectedItem() + "") + "' ",
                "PAO" + TglAsuhan.getSelectedItem().toString().substring(6, 10)
                        + TglAsuhan.getSelectedItem().toString().substring(3, 5)
                        + TglAsuhan.getSelectedItem().toString().substring(0, 2),
                3, No);
    ...
    public void setNoRm(String norwt, Date tgl2, String kdDokter, String nmDokter, String ruangan, String operasi) {
        TNoRw.setText(norwt);
        TCari.setText(norwt);
        DTPCari2.setDate(tgl2);
        isRawat();
    ...
    private void ganti() {
        if (Sequel.mengedittf("penandaan_area_operasi", "no_rawat=?",
                "no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,ruangan=?,operasi=?,kd_petugas=?,keterangan=?",
                10, new String[] {
                        TNoRw.getText(),
                        Valid.SetTgl(TglAsuhan.getSelectedItem() + "") + " "
                                + TglAsuhan.getSelectedItem().toString().substring(11, 19),
     ...
     * try {
     * ps = koneksi.
     * prepareStatement("select surat_penolakan_anjuran_medis_pembuat_pernyataan.photo from surat_penolakan_anjuran_medis_pembuat_pernyataan where surat_penolakan_anjuran_medis_pembuat_pernyataan.no_surat=?"
     * );
     * try {
     ...
     * LoadHTML2.setText("<html><body><center><img src='http://" +
     * koneksiDB.HOSTHYBRIDWEB() + ":" + koneksiDB.PORTWEB() + "/" +
     * koneksiDB.HYBRIDWEB() + "/penolakananjuranmedis/" + rs.getString("photo") +

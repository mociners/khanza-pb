...
public final class RMTriaseIGD extends javax.swing.JDialog {
    ...
    public RMTriaseIGD(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[] {
                ...
                "Riwayat Alergi", "Riwayat Sakit", "Pasien Khusus", "Restrain", "Petugas"
        }) {
            @Override
    ...
    private void initComponents() {
        ...
        AlasanKedatangan.setModel(
                new javax.swing.DefaultComboBoxModel(new String[] { "Datang Sendiri", "Polisi", "Rujukan", "-" }));
        ...
        if (TNoRw.getText().trim().equals("") || TPasien.getText().trim().equals("")) {
            ...
            if (TabTriase.getSelectedIndex() == 0) {
                ...
                if (PrimerKeluhanUtama.getText().trim().equals("")) {
                    ...
                    // MODIFIKASI: Query INSERT menjadi 20 parameter untuk memasukkan semua data
                    // baru
                    if (Sequel.menyimpantf("data_triase_igd", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Rawat", 20,
                            new String[] {
                                    TNoRw.getText(),
            ...
            if (evt.getKeyCode() == KeyEvent.VK_SHIFT) {
                ...
                if (tbTriase.getSelectedRow() != -1) {
                    try {
                        ...
                        // MODIFIKASI: Query SELECT Primer untuk mengambil semua data baru dari tabel
                        // data_triase_igd
                        ps = koneksi.prepareStatement(
                                "select data_triase_igdprimer.keluhan_utama,data_triase_igdprimer.kebutuhan_khusus,data_triase_igdprimer.catatan,"
                                        +
                        ...
                        try {
                            ...
                            if (rs.next()) {
                                ...
                                PrimerGDS.setText(rs.getString("gds"));
                                KebutuhanRestrain.setSelectedItem(rs.getString("kebutuhan_restrain"));
                                SekunderRestrain.setSelectedItem(rs.getString("kebutuhan_restrain")); // Juga diisi
                                                                                                      // untuk
                                                                                                      // konsistensi
                                ...
                                try {
                                    ...
                                    if (rs2.next()) {
                                        ...
                                        // DICOMMENT: tabelKosong bisa trigger clear form
                                            ...
                                            try {
                                                ...
                                                while (rs3.next()) {
                                                    tabModeSkala1.addRow(new Object[] {
                                                            true, rs3.getString("kode_skala1"),
                                            ...
                                            try {
                                                ...
                                                while (rs3.next()) {
                                                    tabModeSkala2.addRow(new Object[] {
                                                            true, rs3.getString("kode_skala2"),
                        ...
                        try {
                            ...
                            if (rs.next()) {
                                ...
                                SekunderGDS.setText(rs.getString("gds"));
                                SekunderRestrain.setSelectedItem(rs.getString("kebutuhan_restrain"));
                                KebutuhanRestrain.setSelectedItem(rs.getString("kebutuhan_restrain")); // Juga diisi
                                                                                                       // untuk
                                                                                                       // konsistensi
                                            ...
                                            try {
                                                ...
                                                while (rs3.next()) {
                                                    tabModeSkala3.addRow(new Object[] {
                                                            true, rs3.getString("kode_skala3"),
                                            ...
                                            try {
                                                ...
                                                while (rs3.next()) {
                                                    tabModeSkala4.addRow(new Object[] {
                                                            true, rs3.getString("kode_skala4"),
                                            ...
                                            try {
                                                ...
                                                while (rs3.next()) {
                                                    tabModeSkala5.addRow(new Object[] {
                                                            true, rs3.getString("kode_skala5"),
            ...
            if (tbTriase.getSelectedRow() > -1) {
                ...
                if (LoadHTML.getText().contains("#AA0000") || LoadHTML.getText().contains("#FF0000")) {
                    try {
                                ...
                                try {
                                    ...
                                    while (rs2.next()) {
                                        ...
                                        try {
                                            ...
                                            System.out.println("Notif Detail Triase Skala 1: " + e);
                                        } finally {
                                            if (rs3 != null) {
                                                rs3.close();
                                            }
                                    ...
                                    System.out.println("Notif Pengisian Temp Skala 1: " + e);
                                } finally {
                                    if (rs2 != null) {
                                        rs2.close();
                                    }
                                ...
                                try {
                                    ...
                                    while (rs2.next()) {
                                        ...
                                        try {
                                            ...
                                            System.out.println("Notif Detail Triase Skala 2: " + e);
                                        } finally {
                                            if (rs3 != null) {
                                                rs3.close();
                                            }
                                    ...
                                    System.out.println("Notif Pengisian Temp Skala 2: " + e);
                                } finally {
                                    if (rs2 != null) {
                                        rs2.close();
                                    }
                        ...
                        System.out.println("Notif Utama Skala Primer: " + e);
                    } finally {
                        if (rs != null) {
                            try {
                                rs.close();
                    ...
                    try {
                        if (LoadHTML.getText().contains("#AA0000")) {
                            pilihan = (String) JOptionPane.showInputDialog(null,
                                    "Silahkan pilih Lembar/PDF Triase Skala 1..!", "Pilihan",
                                    JOptionPane.QUESTION_MESSAGE, null,
                                    new Object[] { "Lembar Triase Skala 1", "PDF Triase Skala 1" },
                                    "Lambar Triase Skala 1");
                            if (pilihan != null) {
                                if (pilihan.equals("Lembar Triase Skala 1")) {
                                    Valid.MyReportqry("rptLembarTriaseSkala1.jasper", "report",
                                            "::[ Triase Skala 1 ]::", "select * from temporary where temporary.temp37='"
                                                    + akses.getalamatip() + "' order by temporary.no",
                                            param);
                                } else {
                                    Valid.MyReportqrypdf("rptLembarTriaseSkala1.jasper", "report",
                                            "::[ Triase Skala 1 ]::", "select * from temporary where temporary.temp37='"
                                                    + akses.getalamatip() + "' order by temporary.no",
                                            param);
                                }
                            ...
                            pilihan = (String) JOptionPane.showInputDialog(null,
                                    "Silahkan pilih Lembar/PDF Triase Skala 2..!", "Pilihan",
                                    JOptionPane.QUESTION_MESSAGE, null,
                                    new Object[] { "Lembar Triase Skala 2", "PDF Triase Skala 2" },
                                    "Lambar Triase Skala 2");
                            if (pilihan != null) {
                                if (pilihan.equals("Lembar Triase Skala 2")) {
                                    Valid.MyReportqry("rptLembarTriaseSkala2.jasper", "report",
                                            "::[ Triase Skala 2 ]::", "select * from temporary where temporary.temp37='"
                                                    + akses.getalamatip() + "' order by temporary.no",
                                            param);
                                } else {
                                    Valid.MyReportqrypdf("rptLembarTriaseSkala2.jasper", "report",
                                            "::[ Triase Skala 2 ]::", "select * from temporary where temporary.temp37='"
                                                    + akses.getalamatip() + "' order by temporary.no",
                                            param);
                                }
                ...
                } else if (LoadHTML.getText().contains("#C8C800") || LoadHTML.getText().contains("#00AA00")
                        || LoadHTML.getText().contains("#969696")) {
                    try {
                                ...
                                try {
                                    ...
                                    while (rs2.next()) {
                                        ...
                                        try {
                                            ...
                                            System.out.println("Notif Detail Triase Skala 3: " + e);
                                        } finally {
                                            if (rs3 != null) {
                                                rs3.close();
                                            }
                                    ...
                                    System.out.println("Notif Pengisian Temp Skala 3: " + e);
                                } finally {
                                    if (rs2 != null) {
                                        rs2.close();
                                    }
                                ...
                                try {
                                    ...
                                    while (rs2.next()) {
                                        ...
                                        try {
                                            ...
                                            System.out.println("Notif Detail Triase Skala 4: " + e);
                                        } finally {
                                            if (rs3 != null) {
                                                rs3.close();
                                            }
                                    ...
                                    System.out.println("Notif Pengisian Temp Skala 4: " + e);
                                } finally {
                                    if (rs2 != null) {
                                        rs2.close();
                                    }
                                ...
                                try {
                                    ...
                                    while (rs2.next()) {
                                        ...
                                        try {
                                            ...
                                            System.out.println("Notif Detail Triase Skala 5: " + e);
                                        } finally {
                                            if (rs3 != null) {
                                                rs3.close();
                                            }
                                    ...
                                    System.out.println("Notif Pengisian Temp Skala 5: " + e);
                                } finally {
                                    if (rs2 != null) {
                                        rs2.close();
                                    }
                        ...
                        System.out.println("Notif Utama Skala Sekunder: " + e);
                    } finally {
                        if (rs != null) {
                            try {
                                rs.close();
                    ...
                    try {
                        if (LoadHTML.getText().contains("#C8C800")) {
                            pilihan = (String) JOptionPane.showInputDialog(null,
                                    "Silahkan pilih Lembar/PDF Triase Skala 3..!", "Pilihan",
                                    JOptionPane.QUESTION_MESSAGE, null,
                                    new Object[] { "Lembar Triase Skala 3", "PDF Triase Skala 3" },
                                    "Lembar Triase Skala 3");
                            if (pilihan != null) {
                                if (pilihan.equals("Lembar Triase Skala 3")) {
                                    Valid.MyReportqry("rptLembarTriaseSkala3.jasper", "report",
                                            "::[ Triase Skala 3 ]::", "select * from temporary where temporary.temp37='"
                                                    + akses.getalamatip() + "' order by temporary.no",
                                            param);
                                } else {
                                    Valid.MyReportqrypdf("rptLembarTriaseSkala3.jasper", "report",
                                            "::[ Triase Skala 3 ]::", "select * from temporary where temporary.temp37='"
                                                    + akses.getalamatip() + "' order by temporary.no",
                                            param);
                                }
                            ...
                            pilihan = (String) JOptionPane.showInputDialog(null,
                                    "Silahkan pilih Lembar/PDF Triase Skala 4..!", "Pilihan",
                                    JOptionPane.QUESTION_MESSAGE, null,
                                    new Object[] { "Lembar Triase Skala 4", "PDF Triase Skala 4" },
                                    "Lembar Triase Skala 4");
                            if (pilihan != null) {
                                if (pilihan.equals("Lembar Triase Skala 4")) {
                                    Valid.MyReportqry("rptLembarTriaseSkala4.jasper", "report",
                                            "::[ Triase Skala 4 ]::", "select * from temporary where temporary.temp37='"
                                                    + akses.getalamatip() + "' order by temporary.no",
                                            param);
                                } else {
                                    Valid.MyReportqrypdf("rptLembarTriaseSkala4.jasper", "report",
                                            "::[ Triase Skala 4 ]::", "select * from temporary where temporary.temp37='"
                                                    + akses.getalamatip() + "' order by temporary.no",
                                            param);
                                }
                            ...
                            pilihan = (String) JOptionPane.showInputDialog(null,
                                    "Silahkan pilih Lembar/PDF Triase Skala 5..!", "Pilihan",
                                    JOptionPane.QUESTION_MESSAGE, null,
                                    new Object[] { "Lembar Triase Skala 5", "PDF Triase Skala 5" },
                                    "Lembar Triase Skala 5");
                            if (pilihan != null) {
                                if (pilihan.equals("Lembar Triase Skala 5")) {
                                    Valid.MyReportqry("rptLembarTriaseSkala5.jasper", "report",
                                            "::[ Triase Skala 5 ]::", "select * from temporary where temporary.temp37='"
                                                    + akses.getalamatip() + "' order by temporary.no",
                                            param);
                                } else {
                                    Valid.MyReportqrypdf("rptLembarTriaseSkala5.jasper", "report",
                                            "::[ Triase Skala 5 ]::", "select * from temporary where temporary.temp37='"
                                                    + akses.getalamatip() + "' order by temporary.no",
                                            param);
                                }
        ...
        try {
            ...
            ps = koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,data_triase_igd.tgl_kunjungan," +
                            ...
                            "data_triase_igd.keterangan_kedatangan,data_triase_igd.kode_kasus,master_triase_macam_kasus.macam_kasus,"
                            +
                            "data_triase_igd.bb,data_triase_igd.crt,data_triase_igd.gds,data_triase_igd.riwayat_alergi,data_triase_igd.riwayat_penyakit,"
                            + // <-- BARIS BARU
                            "data_triase_igd.id_pasien_khusus,data_triase_igd.kebutuhan_restrain," + // <-- BARIS BARU
                            "COALESCE(p1.nama, p2.nama, '-') as petugas " + // Ambil nama petugas dari primer atau
                                                                            // sekunder
                            "from reg_periksa inner join pasien inner join data_triase_igd inner join master_triase_macam_kasus "
                            +
                            "on reg_periksa.no_rkm_medis=pasien.no_rkm_medis and reg_periksa.no_rawat=data_triase_igd.no_rawat "
                            ...
                            +
                            "left join pegawai p1 on data_triase_igdprimer.nik=p1.nik " +
                            "left join data_triase_igdsekunder on data_triase_igd.no_rawat=data_triase_igdsekunder.no_rawat "
                            +
                            "left join pegawai p2 on data_triase_igdsekunder.nik=p2.nik " +
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    tabMode.addRow(new String[] {
                            ...
                            rs.getString("bb"), rs.getString("crt"), rs.getString("gds"),
                            rs.getString("riwayat_alergi"), // <-- BARIS BARU
                            rs.getString("riwayat_penyakit"), rs.getString("id_pasien_khusus"),
                            rs.getString("kebutuhan_restrain"), // <-- BARIS BARU
                            rs.getString("petugas") // <-- KOLOM PETUGAS
                    });
                }
            } catch (Exception e) {
                System.out.println("Notif : " + e);
            ...
            try {
                ...
                ps = koneksi.prepareStatement(
                        "select data_triase_igdprimer.keluhan_utama,data_triase_igdprimer.kebutuhan_khusus,data_triase_igdprimer.catatan,"
                                ...
                                "data_triase_igd.bb,data_triase_igd.crt,data_triase_igd.gds,data_triase_igd.riwayat_alergi,data_triase_igd.riwayat_penyakit, "
                                + // <-- BARIS BARU
                                "data_triase_igd.id_pasien_khusus,data_triase_igd.kebutuhan_restrain,data_triase_igd.no_rawat "
                                + // <-- BARIS BARU
                    ...
                    if (rs.next()) {
                        ...
                        htmlContent.append(
                                "<tr class='isi'>" +
                                        ...
                                        + ", Nadi(/m): " + rs.getString("nadi") + ", Saturasi O²(%): "
                                        + rs.getString("saturasi_o2") + ", Respirasi(/m): " + rs.getString("pernapasan")
                                        + ", BB(Kg): " + rs.getString("bb") + ", CRT(Detik): " + rs.getString("crt")
                                        + ", GDS(mg/dL): " + rs.getString("gds") + "</td>" +
                                        "</tr>" +
                                        "<tr class='isi'>" +
                                        ...
                                        "<td valign='middle'>"
                                        + rs.getString("riwayat_alergi").replaceAll("(\r\n|\r|\n|\n\r)", "<br>")
                                        + "</td>" +
                                        "</tr>" +
                                        "<tr class='isi'>" +
                                        "<td valign='middle'>Riwayat Sakit</td>" +
                                        "<td valign='middle'>"
                                        + rs.getString("riwayat_penyakit").replaceAll("(\r\n|\r|\n|\n\r)", "<br>")
                                        + "</td>" +
                                        "</tr>" +
                                        "<tr class='isi'>" +
                                        "<td valign='middle'>Pasien Khusus</td>" +
                                        "<td valign='middle'>"
                                        + rs.getString("id_pasien_khusus").replaceAll("(\r\n|\r|\n|\n\r)", "<br>")
                                        + "</td>" +
                                        "</tr>" +
                                        "<tr class='isi'>" +
        ...
        if (TabTriase.getSelectedIndex() == 0) {
            ...
            if (PrimerKeluhanUtama.getText().trim().equals("")) {
                ...
                if (Sequel.mengedittf("data_triase_igd", "no_rawat=?",
                        "no_rawat=?,tgl_kunjungan=?,cara_masuk=?,alat_transportasi=?,alasan_kedatangan=?,keterangan_kedatangan=?,kode_kasus=?,tekanan_darah=?,nadi=?,pernapasan=?,suhu=?,saturasi_o2=?,nyeri=?,bb=?,crt=?,gds=?,riwayat_alergi=?,riwayat_penyakit=?,id_pasien_khusus=?,kebutuhan_restrain=?",
                        21, new String[] {
                                TNoRw.getText(),
                                Valid.SetTgl(TanggalKunjungan.getSelectedItem() + "") + " "
                                        + TanggalKunjungan.getSelectedItem().toString().substring(11, 19),

...
public final class RMTriaseIGD extends javax.swing.JDialog {
    ...
    private widget.TextBox PrimerBB, PrimerCRT, PrimerGDS, SekunderBB, SekunderCRT, SekunderGDS;
    private widget.TextArea RiwayatAlergi, RiwayatPenyakit, PasienKhusus;
    private widget.ScrollPane scrollPaneAlergi, scrollPanePenyakit, scrollPaneKhusus;
    private widget.Label jLabelAlergi, jLabelPenyakit, jLabelKhusus;
    private widget.Label jLabelRestrain, jLabelSekunderRestrain;
    private widget.ComboBox KebutuhanRestrain, SekunderRestrain;    
    ...
    public RMTriaseIGD(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
                ...
                "Alasan Kedatangan","Keterangan","Kode Kasus","Macam Kasus","BB(Kg)","CRT(dtk)","GDS(mg/dL)",
                "Riwayat Alergi","Riwayat Sakit","Pasien Khusus","Restrain"
            }){
        ...
        for (i = 0; i < 17; i++) { // Ubah batas perulangan menjadi 17
            ...
            }else if(i==10){ // Kolom baru mulai dari sini
                column.setPreferredWidth(50); // BB
            }else if(i==11){
                column.setPreferredWidth(50); // CRT
            }else if(i==12){
                column.setPreferredWidth(65); // GDS
            }else if(i==13){
                column.setPreferredWidth(180); // Riwayat Alergi
            }else if(i==14){
                column.setPreferredWidth(180); // Riwayat Sakit
            }else if(i==15){
                column.setPreferredWidth(180); // Pasien Khusus
            }else if(i==16){
                column.setPreferredWidth(60); // Restrain
            }
        }
        ...
        PrimerCRT.setDocument(new batasInput((byte)5).getKata(PrimerCRT));
        PrimerGDS.setDocument(new batasInput((byte)5).getKata(PrimerGDS));
        SekunderBB.setDocument(new batasInput((byte)5).getKata(SekunderBB));
        SekunderCRT.setDocument(new batasInput((byte)5).getKata(SekunderCRT));
        SekunderGDS.setDocument(new batasInput((byte)5).getKata(SekunderGDS));
        RiwayatAlergi.setDocument(new batasInput((int)200).getKata(RiwayatAlergi));
        RiwayatPenyakit.setDocument(new batasInput((int)200).getKata(RiwayatPenyakit));
        PasienKhusus.setDocument(new batasInput((int)200).getKata(PasienKhusus));
        ...
        isMenu();
        ScrollTriase.setVerticalScrollBarPolicy(javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED);
        ScrollTriase.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_AS_NEEDED);
    }
    ...
    private void initComponents() {
        ...
        internalFrame7.setPreferredSize(new java.awt.Dimension(0, 134));
        ...
        PrimerKubutuhanKusus.setBounds(483, 70, 100, 23);
        ...
        PrimerTanggalTriase.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-09-2025 10:03:46" }));
        ...
        internalFrame9.setPreferredSize(new java.awt.Dimension(691, 250));
        ...
        internalFrame11.setPreferredSize(new java.awt.Dimension(0, 134));
        ...
        SekunderTanggalTriase.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-09-2025 10:03:48" }));
        ...
        internalFrame14.setPreferredSize(new java.awt.Dimension(691, 250));
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(100, 224));
        ...
        TanggalKunjungan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-09-2025 10:03:48" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRw.getText().trim().equals("") || TPasien.getText().trim().equals("")) {
            ...
            if (TabTriase.getSelectedIndex() == 0) {
                ...
                if (PrimerKeluhanUtama.getText().trim().equals("")) {
                ...
                } else if (PrimerBB.getText().trim().equals("")) { // PENAMBAHAN VALIDASI
                    sukses = false;
                    Valid.textKosong(PrimerBB, "BB");
                } else if (PrimerCRT.getText().trim().equals("")) { // PENAMBAHAN VALIDASI
                    sukses = false;
                    Valid.textKosong(PrimerCRT, "CRT");
                } else if (PrimerGDS.getText().trim().equals("")) { // PENAMBAHAN VALIDASI
                    sukses = false;
                    Valid.textKosong(PrimerGDS, "GDS");
                    ...
                    // MODIFIKASI: Query INSERT menjadi 20 parameter untuk memasukkan semua data baru
                    if (Sequel.menyimpantf("data_triase_igd", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Rawat", 20, new String[] {
                            ...
                            PrimerBB.getText(), PrimerCRT.getText(), PrimerGDS.getText(), // PENAMBAHAN DATA
                            RiwayatAlergi.getText(), RiwayatPenyakit.getText(), PasienKhusus.getText(), // PENAMBAHAN DATA
                            KebutuhanRestrain.getSelectedItem().toString() // PENAMBAHAN DATA
                        }) == true) {
                        ...
                        // MODIFIKASI: Query INSERT primer kembali menjadi 7 parameter (tanpa restrain)
                ...
                if (SekunderAnamnesa.getText().trim().equals("")) {
                ...
                } else if (SekunderBB.getText().trim().equals("")) { // PENAMBAHAN VALIDASI
                    sukses = false;
                    Valid.textKosong(SekunderBB, "BB");
                } else if (SekunderCRT.getText().trim().equals("")) { // PENAMBAHAN VALIDASI
                    sukses = false;
                    Valid.textKosong(SekunderCRT, "CRT");
                } else if (SekunderGDS.getText().trim().equals("")) { // PENAMBAHAN VALIDASI
                    sukses = false;
                    Valid.textKosong(SekunderGDS, "GDS");
                    ...
                    if (Sequel.menyimpantf("data_triase_igd", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Rawat", 20, new String[] {
                            ...
                            SekunderBB.getText(), SekunderCRT.getText(), SekunderGDS.getText(), // PENAMBAHAN DATA
                            RiwayatAlergi.getText(), RiwayatPenyakit.getText(), PasienKhusus.getText(), // PENAMBAHAN DATA
                            SekunderRestrain.getSelectedItem().toString() // PENAMBAHAN DATA
                        }) == true) {
    ...
    private void tbTriaseMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbTriaseMouseClicked
        if (tabMode.getRowCount() != 0) {
            try {
                ChkAccor.setSelected(true); // Memastikan panel kanan terbuka
                isMenu();
                getData(); // Memanggil method untuk mengisi data preview/print
            } catch (java.lang.NullPointerException e) {
                // Mengabaikan error jika terjadi null pointer
            }
        }
            ...
            if (evt.getKeyCode() == KeyEvent.VK_SHIFT) {
                ...
                if (tbTriase.getSelectedRow() != -1) {
                    try {
                        ...
                        // PENAMBAHAN: Ambil dan tampilkan data riwayat dari database
                        try {
                            ...
                            try {
                                psRiwayat.setString(1, TNoRw.getText());
                                ResultSet rsRiwayat = psRiwayat.executeQuery();
                                if (rsRiwayat.next()) {
                                    RiwayatAlergi.setText(rsRiwayat.getString("riwayat_alergi"));
                                    RiwayatPenyakit.setText(rsRiwayat.getString("riwayat_penyakit"));
                                    PasienKhusus.setText(rsRiwayat.getString("id_pasien_khusus"));
                                }
                            } finally {
                                if (psRiwayat != null) {
                                    psRiwayat.close();
                        ...
                        // MODIFIKASI: Query SELECT Primer untuk mengambil semua data baru dari tabel data_triase_igd
                        ps = koneksi.prepareStatement(
                            "select data_triase_igdprimer.keluhan_utama,data_triase_igdprimer.kebutuhan_khusus,data_triase_igdprimer.catatan," +
                            "data_triase_igdprimer.plan,data_triase_igdprimer.tanggaltriase,data_triase_igdprimer.nik,data_triase_igd.tekanan_darah," +
                            "data_triase_igd.nadi,data_triase_igd.pernapasan,data_triase_igd.suhu,data_triase_igd.saturasi_o2,data_triase_igd.nyeri," +
                            "data_triase_igd.bb,data_triase_igd.crt,data_triase_igd.gds,data_triase_igd.kebutuhan_restrain,data_triase_igd.no_rawat from data_triase_igdprimer inner join data_triase_igd on data_triase_igd.no_rawat=" +
                            "data_triase_igdprimer.no_rawat where data_triase_igd.no_rawat=?");
                        try {
                            ...
                            if (rs.next()) {
                                ...
                                // PENAMBAHAN: Tampilkan semua data baru ke form Primer
                                PrimerBB.setText(rs.getString("bb"));
                                PrimerCRT.setText(rs.getString("crt"));
                                PrimerGDS.setText(rs.getString("gds"));
                                KebutuhanRestrain.setSelectedItem(rs.getString("kebutuhan_restrain"));
                                SekunderRestrain.setSelectedItem(rs.getString("kebutuhan_restrain")); // Juga diisi untuk konsistensi
                                    ...
                                    if (rs2.next()) {
                                        ...
                                        while (rs2.next()) {
                                            tabModePemeriksaan.addRow(new String[] {
                                                rs2.getString("kode_pemeriksaan"),
                                            ...
                                            try {
                                                ...
                                                while (rs3.next()) {
                                                    tabModeSkala1.addRow(new Object[] {
                                                        true, rs3.getString("kode_skala1"), rs3.getString("pengkajian_skala1")
                                                    });
                                                }
                                            } catch (Exception e) {
                                                System.out.println("Notif : " + e);
                                            ...
                                            try {
                                                ...
                                                while (rs3.next()) {
                                                    tabModeSkala2.addRow(new Object[] {
                                                        true, rs3.getString("kode_skala2"), rs3.getString("pengkajian_skala2")
                                                    });
                                                }
                                            } catch (Exception e) {
                                                System.out.println("Notif : " + e);
                        ...
                        ps = koneksi.prepareStatement(
                            ...
                            "data_triase_igdsekunder.plan,data_triase_igdsekunder.tanggaltriase,data_triase_igdsekunder.nik,data_triase_igd.tekanan_darah," +
                            "data_triase_igd.nadi,data_triase_igd.pernapasan,data_triase_igd.suhu,data_triase_igd.saturasi_o2,data_triase_igd.nyeri," +
                            "data_triase_igd.bb,data_triase_igd.crt,data_triase_igd.gds,data_triase_igd.kebutuhan_restrain,data_triase_igd.no_rawat from data_triase_igdsekunder inner join data_triase_igd on data_triase_igd.no_rawat=" +
                            "data_triase_igdsekunder.no_rawat where data_triase_igd.no_rawat=?");
                        try {
                            ps.setString(1, tbTriase.getValueAt(tbTriase.getSelectedRow(), 0).toString());
                            rs = ps.executeQuery();
                            if (rs.next()) {
                                ...
                                // PENAMBAHAN: Tampilkan semua data baru ke form Sekunder
                                SekunderBB.setText(rs.getString("bb"));
                                SekunderCRT.setText(rs.getString("crt"));
                                SekunderGDS.setText(rs.getString("gds"));
                                SekunderRestrain.setSelectedItem(rs.getString("kebutuhan_restrain"));
                                KebutuhanRestrain.setSelectedItem(rs.getString("kebutuhan_restrain")); // Juga diisi untuk konsistensi
                                ...
                                try {
                                    ...
                                    if (rs2.next()) {
                                        ...
                                        rs2.beforeFirst();
                                        while (rs2.next()) {
                                            tabModePemeriksaan2.addRow(new String[] {
                                                rs2.getString("kode_pemeriksaan"),
                                                rs2.getString("nama_pemeriksaan")
                                            });
                                            ps3 = koneksi.prepareStatement(
                                            ...
                                            try {
                                                ...
                                                while (rs3.next()) {
                                                    tabModeSkala3.addRow(new Object[] {
                                                        true, rs3.getString("kode_skala3"), rs3.getString("pengkajian_skala3")
                                                    });
                                                }
                                            } catch (Exception e) {
                                                System.out.println("Notif : " + e);
                                            ...
                                            try {
                                                ...
                                                while (rs3.next()) {
                                                    tabModeSkala4.addRow(new Object[] {
                                                        true, rs3.getString("kode_skala4"), rs3.getString("pengkajian_skala4")
                                                    });
                                                }
                                            } catch (Exception e) {
                                                System.out.println("Notif : " + e);
                                            ...
                                            try {
                                                ...
                                                while (rs3.next()) {
                                                    tabModeSkala5.addRow(new Object[] {
                                                        true, rs3.getString("kode_skala5"), rs3.getString("pengkajian_skala5")
                                                    });
                                                }
                                            } catch (Exception e) {
                                                System.out.println("Notif : " + e);
    ...
    private void BtnPrint1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint1ActionPerformed
        if (TNoRM1.getText().trim().equals("") || TPasien1.getText().trim().equals("")) {
            ...
            if (tbTriase.getSelectedRow() > -1) {
                ...
                // BLOK UNTUK SKALA 1 & 2 (PRIMER)
                if (LoadHTML.getText().contains("#AA0000") || LoadHTML.getText().contains("#FF0000")) {
                    try {
                        ps = koneksi.prepareStatement(
                            "SELECT " +
                            "data_triase_igdprimer.keluhan_utama, data_triase_igdprimer.kebutuhan_khusus, data_triase_igdprimer.catatan, data_triase_igdprimer.plan, data_triase_igdprimer.nik, " +
                            "DATE_FORMAT(data_triase_igdprimer.tanggaltriase, '%d-%m-%Y') AS tgl_triase, DATE_FORMAT(data_triase_igdprimer.tanggaltriase, '%H:%i:%s') AS jam_triase, " +
                            "data_triase_igd.tekanan_darah, data_triase_igd.nadi, data_triase_igd.pernapasan, data_triase_igd.suhu, data_triase_igd.saturasi_o2, data_triase_igd.nyeri, " +
                            "data_triase_igd.bb, data_triase_igd.crt, data_triase_igd.gds, data_triase_igd.riwayat_alergi, data_triase_igd.riwayat_penyakit, data_triase_igd.id_pasien_khusus, data_triase_igd.kebutuhan_restrain, " +
                            ...
                            "INNER JOIN data_triase_igdprimer ON reg_periksa.no_rawat = data_triase_igdprimer.no_rawat " +
                        ...
                        if (rs.next()) {
                            ...
                            param.put("tanggallahir", rs.getString("tgllahir"));
                            ...
                            param.put("tanggaltriase", rs.getString("tgl_triase"));
                            param.put("jamtriase", rs.getString("jam_triase"));
                            param.put("pegawai", rs.getString("petgas"));
                            param.put("catatan", rs.getString("catatan"));
                            param.put("bb", rs.getString("bb"));
                            param.put("crt", rs.getString("crt"));
                            param.put("gds", rs.getString("gds"));
                            param.put("riwayat_alergi", rs.getString("riwayat_alergi"));
                            param.put("riwayat_penyakit", rs.getString("riwayat_penyakit"));
                            param.put("pasien_khusus", rs.getString("id_pasien_khusus"));
                            param.put("kebutuhan_restrain", rs.getString("kebutuhan_restrain"));
                            param.put("td", rs.getString("tekanan_darah"));
                            param.put("nadi", rs.getString("nadi"));
                            param.put("napas", rs.getString("pernapasan"));
                            param.put("temperatur", rs.getString("suhu"));
                            param.put("saturasi", rs.getString("saturasi_o2"));
                            param.put("nyeri", rs.getString("nyeri"));
                            ...
                            param.put("finger", "Dikeluarkan di " + akses.getnamars() + ", Kabupaten/Kota " + akses.getkabupatenrs() + "\nDitandatangani secara elektronik oleh " + rs.getString("petgas") + "\nID " + (finger.equals("") ? rs.getString("nik") : finger) + "\n" + Valid.SetTgl3(rs.getString("tgl_triase")));
                                ...
                                try {
                                    ...
                                    while(rs2.next()){
                                        ...
                                        try {
                                            ...
                                            ps3.setString(2, rs.getString("no_rawat"));
                                            rs3 = ps3.executeQuery();
                                            while (rs3.next()){ datatriase = rs3.getString("pengkajian_skala1") + ", " + datatriase; }
                                        } catch (Exception e) { System.out.println("Notif Detail Triase Skala 1: " + e); } 
                                        finally { if (rs3 != null) { rs3.close(); } if (ps3 != null) { ps3.close(); } }
                                        if(datatriase.endsWith(", ")){ datatriase = datatriase.substring(0,datatriase.length() - 2); }
                                        Sequel.menyimpan2("temporary", "'" + i + "','" + rs2.getString("nama_pemeriksaan") + "','" + datatriase + "','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','" + akses.getalamatip() + "'", "Transaksi");
                                        i++;
                                    }
                                } catch (Exception e) { System.out.println("Notif Pengisian Temp Skala 1: " + e); } 
                                finally { if (rs2 != null) { rs2.close(); } if (ps2 != null) { ps2.close(); } }
                            } else if (LoadHTML.getText().contains("#FF0000")) {
                                ps2 = koneksi.prepareStatement("select master_triase_pemeriksaan.kode_pemeriksaan,master_triase_pemeriksaan.nama_pemeriksaan from master_triase_pemeriksaan inner join master_triase_skala2 inner join data_triase_igddetail_skala2 on master_triase_pemeriksaan.kode_pemeriksaan=master_triase_skala2.kode_pemeriksaan and master_triase_skala2.kode_skala2=data_triase_igddetail_skala2.kode_skala2 where data_triase_igddetail_skala2.no_rawat=? group by master_triase_pemeriksaan.kode_pemeriksaan order by master_triase_pemeriksaan.kode_pemeriksaan");
                                try {
                                    ps2.setString(1, rs.getString("no_rawat"));
                                    rs2 = ps2.executeQuery();
                                    i = 1;
                                    while(rs2.next()){
                                        datatriase = "";
                                        ps3 = koneksi.prepareStatement("select master_triase_skala2.pengkajian_skala2 from master_triase_skala2 inner join data_triase_igddetail_skala2 on master_triase_skala2.kode_skala2=data_triase_igddetail_skala2.kode_skala2 where master_triase_skala2.kode_pemeriksaan=? and data_triase_igddetail_skala2.no_rawat=? order by data_triase_igddetail_skala2.kode_skala2");
                                        try {
                                            ps3.setString(1, rs2.getString("kode_pemeriksaan"));
                                            ps3.setString(2, rs.getString("no_rawat"));
                                            rs3 = ps3.executeQuery();
                                            while (rs3.next()){ datatriase = rs3.getString("pengkajian_skala2") + ", " + datatriase; }
                                        } catch (Exception e) { System.out.println("Notif Detail Triase Skala 2: " + e); } 
                                        finally { if (rs3 != null) { rs3.close(); } if (ps3 != null) { ps3.close(); } }
                                        if(datatriase.endsWith(", ")){ datatriase = datatriase.substring(0,datatriase.length() - 2); }
                                        Sequel.menyimpan2("temporary", "'" + i + "','" + rs2.getString("nama_pemeriksaan") + "','" + datatriase + "','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','" + akses.getalamatip() + "'", "Transaksi");
                                        i++;
                                    }
                                } catch (Exception e) { System.out.println("Notif Pengisian Temp Skala 2: " + e); } 
                                finally { if (rs2 != null) { rs2.close(); } if (ps2 != null) { ps2.close(); } }
                            }
                        }
                    } catch (Exception e) { System.out.println("Notif Utama Skala Primer: " + e); } 
                    finally {
                    ...
                    try {
                        if (LoadHTML.getText().contains("#AA0000")) {
                            ...
                            if (pilihan != null) {
                                if (pilihan.equals("Lembar Triase Skala 1")) { Valid.MyReportqry("rptLembarTriaseSkala1.jasper", "report", "::[ Triase Skala 1 ]::", "select * from temporary where temporary.temp37='" + akses.getalamatip() + "' order by temporary.no", param); } 
                                else { Valid.MyReportqrypdf("rptLembarTriaseSkala1.jasper", "report", "::[ Triase Skala 1 ]::", "select * from temporary where temporary.temp37='" + akses.getalamatip() + "' order by temporary.no", param); }
                            }
                        } else if (LoadHTML.getText().contains("#FF0000")) {
                            ...
                            if (pilihan != null) {
                                if (pilihan.equals("Lembar Triase Skala 2")) { Valid.MyReportqry("rptLembarTriaseSkala2.jasper", "report", "::[ Triase Skala 2 ]::", "select * from temporary where temporary.temp37='" + akses.getalamatip() + "' order by temporary.no", param); } 
                                else { Valid.MyReportqrypdf("rptLembarTriaseSkala2.jasper", "report", "::[ Triase Skala 2 ]::", "select * from temporary where temporary.temp37='" + akses.getalamatip() + "' order by temporary.no", param); }
                            }
                        }
                    } catch (Exception e) {}

                // BLOK UNTUK SKALA 3, 4, 5 (SEKUNDER)
                } else if (LoadHTML.getText().contains("#C8C800") || LoadHTML.getText().contains("#00AA00") || LoadHTML.getText().contains("#969696")) { 
                    try {
                        // PERBAIKAN: Query ditulis ulang tanpa menggunakan alias tabel
                        ps = koneksi.prepareStatement(
                            "SELECT data_triase_igdsekunder.anamnesa_singkat, data_triase_igdsekunder.catatan, data_triase_igdsekunder.plan, data_triase_igdsekunder.nik, " +
                            "DATE_FORMAT(data_triase_igdsekunder.tanggaltriase, '%d-%m-%Y') AS tgl_triase, DATE_FORMAT(data_triase_igdsekunder.tanggaltriase, '%H:%i:%s') AS jam_triase, " +
                            "data_triase_igd.tekanan_darah, data_triase_igd.nadi, data_triase_igd.pernapasan, data_triase_igd.suhu, data_triase_igd.saturasi_o2, data_triase_igd.nyeri, " +
                            "data_triase_igd.bb, data_triase_igd.crt, data_triase_igd.gds, data_triase_igd.riwayat_alergi, data_triase_igd.riwayat_penyakit, data_triase_igd.id_pasien_khusus, data_triase_igd.kebutuhan_restrain, " +
                            ...
                            "INNER JOIN pasien ON reg_periksa.no_rkm_medis = pasien.no_rkm_medis " +
                            "INNER JOIN data_triase_igdsekunder ON data_triase_igd.no_rawat = data_triase_igdsekunder.no_rawat " +
                        ...
                        if (rs.next()) {
                            ...
                            if(LoadHTML.getText().contains("#C8C800")){ // Skala 3
                                ps2 = koneksi.prepareStatement("select master_triase_pemeriksaan.kode_pemeriksaan,master_triase_pemeriksaan.nama_pemeriksaan from master_triase_pemeriksaan inner join master_triase_skala3 inner join data_triase_igddetail_skala3 on master_triase_pemeriksaan.kode_pemeriksaan=master_triase_skala3.kode_pemeriksaan and master_triase_skala3.kode_skala3=data_triase_igddetail_skala3.kode_skala3 where data_triase_igddetail_skala3.no_rawat=? group by master_triase_pemeriksaan.kode_pemeriksaan order by master_triase_pemeriksaan.kode_pemeriksaan");
                                try {
                                    ps2.setString(1, rs.getString("no_rawat"));
                                    rs2 = ps2.executeQuery();
                                    i = 1;
                                    while(rs2.next()){
                                        datatriase = "";
                                        ps3 = koneksi.prepareStatement("select master_triase_skala3.pengkajian_skala3 from master_triase_skala3 inner join data_triase_igddetail_skala3 on master_triase_skala3.kode_skala3=data_triase_igddetail_skala3.kode_skala3 where master_triase_skala3.kode_pemeriksaan=? and data_triase_igddetail_skala3.no_rawat=? order by data_triase_igddetail_skala3.kode_skala3");
                                        try {
                                            ps3.setString(1, rs2.getString("kode_pemeriksaan"));
                                            ps3.setString(2, rs.getString("no_rawat"));
                                            rs3 = ps3.executeQuery();
                                            while (rs3.next()){ datatriase = rs3.getString("pengkajian_skala3") + ", " + datatriase; }
                                        } catch (Exception e) { System.out.println("Notif Detail Triase Skala 3: " + e); } 
                                        finally { if (rs3 != null) { rs3.close(); } if (ps3 != null) { ps3.close(); } }
                                        if(datatriase.endsWith(", ")){ datatriase = datatriase.substring(0,datatriase.length() - 2); }
                                        Sequel.menyimpan2("temporary", "'" + i + "','" + rs2.getString("nama_pemeriksaan") + "','" + datatriase + "','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','" + akses.getalamatip() + "'", "Transaksi");
                                        i++;
                                    }
                                } catch (Exception e) { System.out.println("Notif Pengisian Temp Skala 3: " + e); } 
                                finally { if (rs2 != null) { rs2.close(); } if (ps2 != null) { ps2.close(); } }
                            } else if(LoadHTML.getText().contains("#00AA00")){ // Skala 4
                                ps2 = koneksi.prepareStatement("select master_triase_pemeriksaan.kode_pemeriksaan,master_triase_pemeriksaan.nama_pemeriksaan from master_triase_pemeriksaan inner join master_triase_skala4 inner join data_triase_igddetail_skala4 on master_triase_pemeriksaan.kode_pemeriksaan=master_triase_skala4.kode_pemeriksaan and master_triase_skala4.kode_skala4=data_triase_igddetail_skala4.kode_skala4 where data_triase_igddetail_skala4.no_rawat=? group by master_triase_pemeriksaan.kode_pemeriksaan order by master_triase_pemeriksaan.kode_pemeriksaan");
                                try {
                                    ps2.setString(1, rs.getString("no_rawat"));
                                    rs2 = ps2.executeQuery();
                                    i = 1;
                                    while(rs2.next()){
                                        datatriase = "";
                                        ps3 = koneksi.prepareStatement("select master_triase_skala4.pengkajian_skala4 from master_triase_skala4 inner join data_triase_igddetail_skala4 on master_triase_skala4.kode_skala4=data_triase_igddetail_skala4.kode_skala4 where master_triase_skala4.kode_pemeriksaan=? and data_triase_igddetail_skala4.no_rawat=? order by data_triase_igddetail_skala4.kode_skala4");
                                        try {
                                            ps3.setString(1, rs2.getString("kode_pemeriksaan"));
                                            ps3.setString(2, rs.getString("no_rawat"));
                                            rs3 = ps3.executeQuery();
                                            while (rs3.next()){ datatriase = rs3.getString("pengkajian_skala4") + ", " + datatriase; }
                                        } catch (Exception e) { System.out.println("Notif Detail Triase Skala 4: " + e); } 
                                        finally { if (rs3 != null) { rs3.close(); } if (ps3 != null) { ps3.close(); } }
                                        if(datatriase.endsWith(", ")){ datatriase = datatriase.substring(0,datatriase.length() - 2); }
                                        Sequel.menyimpan2("temporary", "'" + i + "','" + rs2.getString("nama_pemeriksaan") + "','" + datatriase + "','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','" + akses.getalamatip() + "'", "Transaksi");
                                        i++;
                                    }
                                } catch (Exception e) { System.out.println("Notif Pengisian Temp Skala 4: " + e); } 
                                finally { if (rs2 != null) { rs2.close(); } if (ps2 != null) { ps2.close(); } }
                            } else if(LoadHTML.getText().contains("#969696")){ // Skala 5
                                ps2 = koneksi.prepareStatement("select master_triase_pemeriksaan.kode_pemeriksaan,master_triase_pemeriksaan.nama_pemeriksaan from master_triase_pemeriksaan inner join master_triase_skala5 inner join data_triase_igddetail_skala5 on master_triase_pemeriksaan.kode_pemeriksaan=master_triase_skala5.kode_pemeriksaan and master_triase_skala5.kode_skala5=data_triase_igddetail_skala5.kode_skala5 where data_triase_igddetail_skala5.no_rawat=? group by master_triase_pemeriksaan.kode_pemeriksaan order by master_triase_pemeriksaan.kode_pemeriksaan");
                                try {
                                    ps2.setString(1, rs.getString("no_rawat"));
                                    rs2 = ps2.executeQuery();
                                    i = 1;
                                    while(rs2.next()){
                                        datatriase = "";
                                        ps3 = koneksi.prepareStatement("select master_triase_skala5.pengkajian_skala5 from master_triase_skala5 inner join data_triase_igddetail_skala5 on master_triase_skala5.kode_skala5=data_triase_igddetail_skala5.kode_skala5 where master_triase_skala5.kode_pemeriksaan=? and data_triase_igddetail_skala5.no_rawat=? order by data_triase_igddetail_skala5.kode_skala5");
                                        try {
                                            ps3.setString(1, rs2.getString("kode_pemeriksaan"));
                                            ps3.setString(2, rs.getString("no_rawat"));
                                            rs3 = ps3.executeQuery();
                                            while (rs3.next()){ datatriase = rs3.getString("pengkajian_skala5") + ", " + datatriase; }
                                        } catch (Exception e) { System.out.println("Notif Detail Triase Skala 5: " + e); } 
                                        finally { if (rs3 != null) { rs3.close(); } if (ps3 != null) { ps3.close(); } }
                                        if(datatriase.endsWith(", ")){ datatriase = datatriase.substring(0,datatriase.length() - 2); }
                                        Sequel.menyimpan2("temporary", "'" + i + "','" + rs2.getString("nama_pemeriksaan") + "','" + datatriase + "','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','" + akses.getalamatip() + "'", "Transaksi");
                                        i++;
                                    }
                                } catch (Exception e) { System.out.println("Notif Pengisian Temp Skala 5: " + e); } 
                                finally { if (rs2 != null) { rs2.close(); } if (ps2 != null) { ps2.close(); } }
                            }
                        }
                    } catch (Exception e) { System.out.println("Notif Utama Skala Sekunder: " + e); } 
                    finally {
                        if (rs != null) { try { rs.close(); } catch (Exception e) {} }
                        if (ps != null) { try { ps.close(); } catch (Exception e) {} }
                    }
                    ...
                    try {
                        if (LoadHTML.getText().contains("#C8C800")) {
                            ...
                            if (pilihan != null) {
                                if (pilihan.equals("Lembar Triase Skala 3")) { Valid.MyReportqry("rptLembarTriaseSkala3.jasper", "report", "::[ Triase Skala 3 ]::", "select * from temporary where temporary.temp37='" + akses.getalamatip() + "' order by temporary.no", param); } 
                                else { Valid.MyReportqrypdf("rptLembarTriaseSkala3.jasper", "report", "::[ Triase Skala 3 ]::", "select * from temporary where temporary.temp37='" + akses.getalamatip() + "' order by temporary.no", param); }
                            }
                            ...
                            if (pilihan != null) {
                                if (pilihan.equals("Lembar Triase Skala 4")) { Valid.MyReportqry("rptLembarTriaseSkala4.jasper", "report", "::[ Triase Skala 4 ]::", "select * from temporary where temporary.temp37='" + akses.getalamatip() + "' order by temporary.no", param); } 
                                else { Valid.MyReportqrypdf("rptLembarTriaseSkala4.jasper", "report", "::[ Triase Skala 4 ]::", "select * from temporary where temporary.temp37='" + akses.getalamatip() + "' order by temporary.no", param); }
                            }
                            ...
                            if (pilihan != null) {
                                if (pilihan.equals("Lembar Triase Skala 5")) { Valid.MyReportqry("rptLembarTriaseSkala5.jasper", "report", "::[ Triase Skala 5 ]::", "select * from temporary where temporary.temp37='" + akses.getalamatip() + "' order by temporary.no", param); } 
                                else { Valid.MyReportqrypdf("rptLembarTriaseSkala5.jasper", "report", "::[ Triase Skala 5 ]::", "select * from temporary where temporary.temp37='" + akses.getalamatip() + "' order by temporary.no", param); }
                            }
                        }
                    } catch (Exception e) {}
                }
    ...
    */
    ...
    public void tampil() {        
        ...
        try{
            // MODIFIKASI 3: Tambahkan kolom baru ke dalam pernyataan SELECT
            ps=koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,data_triase_igd.tgl_kunjungan,"+
                    "data_triase_igd.cara_masuk,data_triase_igd.alat_transportasi,data_triase_igd.alasan_kedatangan,"+
                    "data_triase_igd.keterangan_kedatangan,data_triase_igd.kode_kasus,master_triase_macam_kasus.macam_kasus," +
                    "data_triase_igd.bb,data_triase_igd.crt,data_triase_igd.gds,data_triase_igd.riwayat_alergi,data_triase_igd.riwayat_penyakit," + // <-- BARIS BARU
                    "data_triase_igd.id_pasien_khusus,data_triase_igd.kebutuhan_restrain "+ // <-- BARIS BARU
                    "from reg_periksa inner join pasien inner join data_triase_igd inner join master_triase_macam_kasus "+
                    "on reg_periksa.no_rkm_medis=pasien.no_rkm_medis and reg_periksa.no_rawat=data_triase_igd.no_rawat "+
                    "and data_triase_igd.kode_kasus=master_triase_macam_kasus.kode_kasus "+
            ...
            try {
                ...
                rs=ps.executeQuery();
                while(rs.next()){
                    // MODIFIKASI 4: Tambahkan data baru saat mengisi baris tabel
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("bb"),rs.getString("crt"),rs.getString("gds"),rs.getString("riwayat_alergi"), // <-- BARIS BARU
                        rs.getString("riwayat_penyakit"),rs.getString("id_pasien_khusus"),rs.getString("kebutuhan_restrain") // <-- BARIS BARU
                    });
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
    ...
    private void emptTeks(){
        ...
        PasienKhusus.setText("");
        KebutuhanRestrain.setSelectedIndex(0);
        SekunderRestrain.setSelectedIndex(0);   
    }
    ...
    private void getData() {
        if(tbTriase.getSelectedRow()!= -1){
            try {
                ...
                // MODIFIKASI 1: Menambahkan kolom baru ke kueri SQL Primer
                ps=koneksi.prepareStatement(
                        "select data_triase_igdprimer.keluhan_utama,data_triase_igdprimer.kebutuhan_khusus,data_triase_igdprimer.catatan,"+
                        "data_triase_igdprimer.plan,data_triase_igdprimer.tanggaltriase,data_triase_igdprimer.nik,data_triase_igd.tekanan_darah,"+
                        "data_triase_igd.nadi,data_triase_igd.pernapasan,data_triase_igd.suhu,data_triase_igd.saturasi_o2,data_triase_igd.nyeri,"+
                        "data_triase_igd.bb,data_triase_igd.crt,data_triase_igd.gds,data_triase_igd.riwayat_alergi,data_triase_igd.riwayat_penyakit, " + // <-- BARIS BARU
                        "data_triase_igd.id_pasien_khusus,data_triase_igd.kebutuhan_restrain,data_triase_igd.no_rawat " + // <-- BARIS BARU
                        "from data_triase_igdprimer inner join data_triase_igd on data_triase_igd.no_rawat="+
                        "data_triase_igdprimer.no_rawat where data_triase_igd.no_rawat=?");
                try {
                    ps.setString(1,tbTriase.getValueAt(tbTriase.getSelectedRow(),0).toString());
                    rs=ps.executeQuery();
                    if(rs.next()){
                        ...
                        htmlContent.append(    
                            ...
                            "<tr class='isi'>"+
                                ...
                                // MODIFIKASI 2: Menambahkan tampilan Tanda Vital baru (Primer)
                                "<td valign='middle'>Suhu(C): "+rs.getString("suhu")+", Nyeri: "+rs.getString("nyeri")+", Tensi: "+rs.getString("tekanan_darah")+", Nadi(/m): "+rs.getString("nadi")+", Saturasi O²(%): "+rs.getString("saturasi_o2")+", Respirasi(/m): "+rs.getString("pernapasan")+", BB(Kg): "+rs.getString("bb")+", CRT(Detik): "+rs.getString("crt")+", GDS(mg/dL): "+rs.getString("gds")+"</td>"+
                            "</tr>"+
                            "<tr class='isi'>"+
                                "<td valign='middle'>Kebutuhan Khusus</td>"+
                                "<td valign='middle'>"+rs.getString("kebutuhan_khusus")+"</td>"+
                            "</tr>"+
                            // MODIFIKASI 3: Menambahkan tampilan data riwayat dan kebutuhan baru (Primer)
                            "<tr class='isi'>"+
                                "<td valign='middle'>Riwayat Alergi</td>"+
                                "<td valign='middle'>"+rs.getString("riwayat_alergi").replaceAll("(\r\n|\r|\n|\n\r)","<br>")+"</td>"+
                            "</tr>"+
                            "<tr class='isi'>"+
                                "<td valign='middle'>Riwayat Sakit</td>"+
                                "<td valign='middle'>"+rs.getString("riwayat_penyakit").replaceAll("(\r\n|\r|\n|\n\r)","<br>")+"</td>"+
                            "</tr>"+
                            "<tr class='isi'>"+
                                "<td valign='middle'>Pasien Khusus</td>"+
                                "<td valign='middle'>"+rs.getString("id_pasien_khusus").replaceAll("(\r\n|\r|\n|\n\r)","<br>")+"</td>"+
                            "</tr>"+
                            "<tr class='isi'>"+
                                "<td valign='middle'>Kebutuhan Restrain</td>"+
                                "<td valign='middle'>"+rs.getString("kebutuhan_restrain")+"</td>"+
                            "</tr>"
                        );
                ...
                // MODIFIKASI 4: Menambahkan kolom baru ke kueri SQL Sekunder
                ps=koneksi.prepareStatement(
                        "select data_triase_igdsekunder.anamnesa_singkat,data_triase_igdsekunder.catatan,"+
                        "data_triase_igdsekunder.plan,data_triase_igdsekunder.tanggaltriase,data_triase_igdsekunder.nik,data_triase_igd.tekanan_darah,"+
                        "data_triase_igd.nadi,data_triase_igd.pernapasan,data_triase_igd.suhu,data_triase_igd.saturasi_o2,data_triase_igd.nyeri,"+
                        "data_triase_igd.bb,data_triase_igd.crt,data_triase_igd.gds,data_triase_igd.riwayat_alergi,data_triase_igd.riwayat_penyakit," + // <-- BARIS BARU
                        "data_triase_igd.id_pasien_khusus,data_triase_igd.kebutuhan_restrain,data_triase_igd.no_rawat " + // <-- BARIS BARU
                        "from data_triase_igdsekunder inner join data_triase_igd on data_triase_igd.no_rawat="+
                        "data_triase_igdsekunder.no_rawat where data_triase_igd.no_rawat=?");
                try {
                    ps.setString(1,tbTriase.getValueAt(tbTriase.getSelectedRow(),0).toString());
                    rs=ps.executeQuery();
                    if(rs.next()){
                        ...
                        htmlContent.append(    
                            ...
                            "<tr class='isi'>"+
                                "<td valign='middle'>Tanda Vital</td>"+
                                // MODIFIKASI 5: Menambahkan tampilan Tanda Vital baru (Sekunder)
                                "<td valign='middle'>Suhu(C): "+rs.getString("suhu")+", Nyeri: "+rs.getString("nyeri")+", Tensi: "+rs.getString("tekanan_darah")+", Nadi(/m): "+rs.getString("nadi")+", Saturasi O²(%): "+rs.getString("saturasi_o2")+", Respirasi(/m): "+rs.getString("pernapasan")+", BB(Kg): "+rs.getString("bb")+", CRT(Detik): "+rs.getString("crt")+", GDS(mg/dL): "+rs.getString("gds")+"</td>"+
                            "</tr>"+
                            // MODIFIKASI 6: Menambahkan tampilan data riwayat dan kebutuhan baru (Sekunder)
                            "<tr class='isi'>"+
                                "<td valign='middle'>Riwayat Alergi</td>"+
                                "<td valign='middle'>"+rs.getString("riwayat_alergi").replaceAll("(\r\n|\r|\n|\n\r)","<br>")+"</td>"+
                            "</tr>"+
    ...
    private void ganti() {
        ...
        if (TabTriase.getSelectedIndex() == 0) {
            ...
            if (PrimerKeluhanUtama.getText().trim().equals("")) {
                ...
                // MODIFIKASI: Query UPDATE menjadi 21 parameter untuk semua data baru
                if (Sequel.mengedittf("data_triase_igd", "no_rawat=?", "no_rawat=?,tgl_kunjungan=?,cara_masuk=?,alat_transportasi=?,alasan_kedatangan=?,keterangan_kedatangan=?,kode_kasus=?,tekanan_darah=?,nadi=?,pernapasan=?,suhu=?,saturasi_o2=?,nyeri=?,bb=?,crt=?,gds=?,riwayat_alergi=?,riwayat_penyakit=?,id_pasien_khusus=?,kebutuhan_restrain=?", 21, new String[] {
                        TNoRw.getText(), Valid.SetTgl(TanggalKunjungan.getSelectedItem() + "") + " " + TanggalKunjungan.getSelectedItem().toString().substring(11, 19),
                        CaraMasuk.getSelectedItem().toString(), Transportasi.getSelectedItem().toString(), AlasanKedatangan.getSelectedItem().toString(),
                        KeteranganKedatangan.getText(), KdKasus.getText(), PrimerTensi.getText(), PrimerNadi.getText(), PrimerRespirasi.getText(), PrimerSuhu.getText(),
                        PrimerSaturasi.getText(), PrimerNyeri.getText(),
                        PrimerBB.getText(), PrimerCRT.getText(), PrimerGDS.getText(), // PENAMBAHAN
                        RiwayatAlergi.getText(), RiwayatPenyakit.getText(), PasienKhusus.getText(), // PENAMBAHAN
                        KebutuhanRestrain.getSelectedItem().toString(), // PENAMBAHAN
            ...
            if (SekunderAnamnesa.getText().trim().equals("")) {
                ...
                if (Sequel.mengedittf("data_triase_igd", "no_rawat=?", "no_rawat=?,tgl_kunjungan=?,cara_masuk=?,alat_transportasi=?,alasan_kedatangan=?,keterangan_kedatangan=?,kode_kasus=?,tekanan_darah=?,nadi=?,pernapasan=?,suhu=?,saturasi_o2=?,nyeri=?,bb=?,crt=?,gds=?,riwayat_alergi=?,riwayat_penyakit=?,id_pasien_khusus=?,kebutuhan_restrain=?", 21, new String[] {
                        ...
                        KeteranganKedatangan.getText(), KdKasus.getText(), SekunderTensi.getText(), SekunderNadi.getText(), SekunderRespirasi.getText(), SekunderSuhu.getText(),
                        SekunderSaturasi.getText(), SekunderNyeri.getText(),
                        SekunderBB.getText(), SekunderCRT.getText(), SekunderGDS.getText(), // PENAMBAHAN
                        RiwayatAlergi.getText(), RiwayatPenyakit.getText(), PasienKhusus.getText(), // PENAMBAHAN
                        SekunderRestrain.getSelectedItem().toString(), // PENAMBAHAN
                        tbTriase.getValueAt(tbTriase.getSelectedRow(), 0).toString()
                    }) == true) {
                    if (SekunderZonaKuning.isSelected() == true) {
                        keputusan = "Zona Kuning";
    ...
    private void initTriase() {
        widget.Label jLabelBB1 = new widget.Label();
        PrimerBB = new widget.TextBox();
        widget.Label jLabelCRT1 = new widget.Label();
        PrimerCRT = new widget.TextBox();
        widget.Label jLabelGDS1 = new widget.Label();
        PrimerGDS = new widget.TextBox();
        widget.Label jLabelBB2 = new widget.Label();
        SekunderBB = new widget.TextBox();
        widget.Label jLabelCRT2 = new widget.Label();
        SekunderCRT = new widget.TextBox();
        widget.Label jLabelGDS2 = new widget.Label();
        SekunderGDS = new widget.TextBox();
        
        jLabelBB1.setText("BB(Kg) :");
        internalFrame7.add(jLabelBB1);
        jLabelBB1.setBounds(0, 100, 93, 23);
        internalFrame7.add(PrimerBB);
        PrimerBB.setBounds(97, 100, 55, 23);
        PrimerBB.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                // TODO: Event handler bisa ditambahkan nanti jika perlu
            }
        });

        jLabelCRT1.setText("CRT(Detik) :");
        internalFrame7.add(jLabelCRT1);
        jLabelCRT1.setBounds(180, 100, 100, 23);
        internalFrame7.add(PrimerCRT);
        PrimerCRT.setBounds(284, 100, 55, 23);
        PrimerCRT.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                // TODO: Event handler bisa ditambahkan nanti jika perlu
            }
        });

        jLabelGDS1.setText("GDS(mg/dL):");
        internalFrame7.add(jLabelGDS1);
        jLabelGDS1.setBounds(390, 100, 90, 23);
        internalFrame7.add(PrimerGDS);
        PrimerGDS.setBounds(483, 100, 55, 23);
        PrimerGDS.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                // TODO: Event handler bisa ditambahkan nanti jika perlu
            }
        });
        
        jLabelRestrain = new widget.Label();
        jLabelRestrain.setText("Restrain :");
        internalFrame7.add(jLabelRestrain);
        jLabelRestrain.setBounds(600, 70, 60, 23);

        KebutuhanRestrain = new widget.ComboBox();
        KebutuhanRestrain.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya" }));
        KebutuhanRestrain.setName("KebutuhanRestrain");
        internalFrame7.add(KebutuhanRestrain);
        KebutuhanRestrain.setBounds(665, 70, 70, 23);

        jLabelBB2.setText("BB(Kg) :");
        internalFrame11.add(jLabelBB2);
        jLabelBB2.setBounds(0, 100, 110, 23);
        internalFrame11.add(SekunderBB);
        SekunderBB.setBounds(114, 100, 55, 23);
        ...
        jLabelCRT2.setText("CRT(Detik) :");
        internalFrame11.add(jLabelCRT2);
        jLabelCRT2.setBounds(205, 100, 100, 23);
        internalFrame11.add(SekunderCRT);
        SekunderCRT.setBounds(309, 100, 55, 23);
        SekunderCRT.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                // TODO: Event handler bisa ditambahkan nanti jika perlu
            }
        });

        jLabelGDS2.setText("GDS(mg/dL):");
        internalFrame11.add(jLabelGDS2);
        jLabelGDS2.setBounds(370, 100, 84, 23);
        internalFrame11.add(SekunderGDS);
        SekunderGDS.setBounds(458, 100, 55, 23);
        SekunderGDS.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                // TODO: Event handler bisa ditambahkan nanti jika perlu
            }
        });
        
        jLabelSekunderRestrain = new widget.Label();
        jLabelSekunderRestrain.setText("Restrain :");
        internalFrame11.add(jLabelSekunderRestrain);
        jLabelSekunderRestrain.setBounds(520, 100, 60, 23);

        SekunderRestrain = new widget.ComboBox();
        SekunderRestrain.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya" }));
        SekunderRestrain.setName("SekunderRestrain");
        internalFrame11.add(SekunderRestrain);
        SekunderRestrain.setBounds(585, 100, 70, 23);
        
        jLabelAlergi = new widget.Label();
        jLabelAlergi.setText("Riwayat Alergi :");
        FormInput.add(jLabelAlergi);
        jLabelAlergi.setBounds(0, 100, 89, 23);

        scrollPaneAlergi = new widget.ScrollPane();
        RiwayatAlergi = new widget.TextArea();
        RiwayatAlergi.setColumns(20);
        RiwayatAlergi.setRows(5);
        scrollPaneAlergi.setViewportView(RiwayatAlergi);
        FormInput.add(scrollPaneAlergi);
        scrollPaneAlergi.setBounds(93, 100, 622, 35);

        jLabelPenyakit = new widget.Label();
        jLabelPenyakit.setText("Riwayat Sakit :");
        FormInput.add(jLabelPenyakit);
        jLabelPenyakit.setBounds(0, 140, 89, 23);

        scrollPanePenyakit = new widget.ScrollPane();
        RiwayatPenyakit = new widget.TextArea();
        RiwayatPenyakit.setColumns(20);
        RiwayatPenyakit.setRows(5);
        scrollPanePenyakit.setViewportView(RiwayatPenyakit);
        FormInput.add(scrollPanePenyakit);
        scrollPanePenyakit.setBounds(93, 140, 622, 35);

        jLabelKhusus = new widget.Label();
        jLabelKhusus.setText("Pasien Khusus:");
        FormInput.add(jLabelKhusus);
        jLabelKhusus.setBounds(0, 180, 89, 23);

        scrollPaneKhusus = new widget.ScrollPane();
        PasienKhusus = new widget.TextArea();
        PasienKhusus.setColumns(20);
        PasienKhusus.setRows(5);
        scrollPaneKhusus.setViewportView(PasienKhusus);
        FormInput.add(scrollPaneKhusus);
        scrollPaneKhusus.setBounds(93, 180, 622, 35);

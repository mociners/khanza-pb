...
public final class RMDataAsuhanGizi extends javax.swing.JDialog {
            ...
            public void keyPressed(KeyEvent e) {
                if(e.getKeyCode()==KeyEvent.VK_SPACE){
                    if(carilaborat.getTable().getSelectedRow()!= -1){
                        Biokimia.append(carilaborat.getTable().getValueAt(carilaborat.getTable().getSelectedRow(),3).toString()+", ");
                        Biokimia.requestFocus();
                    }
                }
            }
            @Override
        ...
        carilaborat.BtnKeluar.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                for (i= 0; i < carilaborat.getTable().getRowCount(); i++) {
                    Biokimia.append(carilaborat.getTable().getValueAt(i,3).toString()+", ");
                }
                Biokimia.requestFocus();
            }
        });
    ...
    private void initComponents() {
        ...
        BtnDokter3.setBounds(90, 200, 28, 23);

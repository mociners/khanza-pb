/** Dimodif oleh dr. Salim Mulyana, MMRS
 * Tahun 2024
...
public class DlgDaftarPemakaianAlatKassa extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public DlgDaftarPemakaianAlatKassa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        tabMode = new DefaultTableModel(null, new Object[]{
            "No Rawat", "Tanggal", "No RM", "Nama Pasien", "Diagnosa", "Tindakan"
        }) {
            @Override
...
// Menambahkan renderer untuk pewarnaan tabel
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Daftar Pemakaian Alat dan Kassa ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
...
private void KdKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TKdKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgDaftarPemakaianAlatKassa dialog = new DlgDaftarPemakaianAlatKassa(new javax.swing.JFrame(), true);
    ...
    public void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("SELECT petugas_beri_alatkassa_ok.no_rawat, petugas_beri_alatkassa_ok.tanggal, "
                    + "petugas_beri_alatkassa_ok.diagnosa, petugas_beri_alatkassa_ok.tindakan, "
                    + "reg_periksa.no_rawat, reg_periksa.no_rkm_medis, pasien.nm_pasien "
                    + "FROM petugas_beri_alatkassa_ok "
                    + "INNER JOIN reg_periksa ON reg_periksa.no_rawat = petugas_beri_alatkassa_ok.no_rawat "
                    + "INNER JOIN pasien ON reg_periksa.no_rkm_medis = pasien.no_rkm_medis "
                    + "WHERE petugas_beri_alatkassa_ok.no_rawat LIKE ? OR pasien.nm_pasien LIKE ? OR "
                    + "petugas_beri_alatkassa_ok.diagnosa LIKE ? "
                    + "GROUP BY petugas_beri_alatkassa_ok.no_rawat, petugas_beri_alatkassa_ok.tanggal, "
                    + "petugas_beri_alatkassa_ok.diagnosa, petugas_beri_alatkassa_ok.tindakan, "
                    + "reg_periksa.no_rawat, reg_periksa.no_rkm_medis, pasien.nm_pasien "
                    + "ORDER BY petugas_beri_alatkassa_ok.tanggal DESC");
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{
                        ...
                        "No Rawat","Tanggal","No RM","Nama Pasien","Diagnosa","Tindakan"
                         */
                        rs.getString("no_rawat"), rs.getString("tanggal"), rs.getString("no_rkm_medis"),
                        rs.getString("nm_pasien"), rs.getString("diagnosa"),
                        rs.getString("tindakan")

                    });
                    tabMode.addRow(new String[]{"", "", "Kode","Alat/ Kassa","Persediaan ","Terpakai","Sisa","Keterangan"});
                    ps2 = koneksi.prepareStatement("SELECT beri_alatkassa_ok.no_rawat, beri_alatkassa_ok.kd_alat, beri_alatkassa_ok.persediaan, "
                            + "beri_alatkassa_ok.terpakai, beri_alatkassa_ok.sisa, beri_alatkassa_ok.keterangan, alatkassa_ok.nm_instrumen FROM beri_alatkassa_ok "
                            + "INNER JOIN alatkassa_ok ON beri_alatkassa_ok.kd_alat = alatkassa_ok.kd_instrumen INNER JOIN reg_periksa "
                            + "ON beri_alatkassa_ok.no_rawat = reg_periksa.no_rawat where beri_alatkassa_ok.no_rawat like ? ");
                    try {
                        ps2.setString(1, rs.getString("no_rawat"));
                        rs2 = ps2.executeQuery();
                        while (rs2.next()) {
                            tabMode.addRow(new String[]{
                                "", "", rs2.getString("kd_alat"), rs2.getString("nm_instrumen"), rs2.getString("persediaan"), rs2.getString("terpakai"), rs2.getString("sisa"), rs2.getString("keterangan")
                            });
                        }
                    } catch (Exception e) {

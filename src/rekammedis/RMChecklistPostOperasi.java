...
public final class RMChecklistPostOperasi extends javax.swing.JDialog {
    ...
    public RMChecklistPostOperasi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[] {
                ...
                "Kode Dokter Anest", "Nama Dokter Anestesi", "Keadaan Umum", "Radiologi", "Keterangan Radiologi", "EKG",
                "Keterangan EKG", "USG",
                "Keterangan USG", "CT Scan", "Keterangan CT Scan", "MRI", "Keterangan MRI", "Jenis Cairan Infus",
                "Kateter Urine", "Tgl.Pemasangan",
                "Warna Urine", "Jml.Urine", "Area Luka Operasi", "Drain", "Jml.Drain", "Letak Drain", "Warna Drain",
                "Jaringan PA", "NIP OK",
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(
                ...
                "::[ Data Check List Post Operasi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
        ...
        if (TNoRw.getText().trim().equals("") || TPasien.getText().trim().equals("")) {
            ...
            if (Sequel.menyimpantf("checklist_post_operasi",
                ...
                tabMode.addRow(new String[] {
                        ...
                        MRI.getSelectedItem().toString(), KeteranganMRI.getText(), CairanInfus.getText(),
                        ...
                        Drain.getSelectedItem().toString(), JumlahDrain.getText(), LetakDrain.getText(),
                        WarnaDrain.getText(),
                        JaringanPA.getSelectedItem().toString(), KdPetugasOK.getText(), NmPetugasOK.getText(),
                        KdPetugasAnest.getText(), NmPetugasAnest.getText()
                });
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_BtnHapusActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            if (akses.getkode().equals("Admin Utama")) {
                ...
                if (akses.getkode().equals(tbObat.getValueAt(tbObat.getSelectedRow(), 34).toString())
                        || akses.getkode().equals(tbObat.getValueAt(tbObat.getSelectedRow(), 36).toString())) {
                    hapus();
                } else {
        ...
        if (tbObat.getSelectedRow() > -1) {
            ...
            param.put("finger",
                    "Dikeluarkan di " + akses.getnamars() + ", Kabupaten/Kota " + akses.getkabupatenrs()
                            ...
                            + (finger.equals("") ? tbObat.getValueAt(tbObat.getSelectedRow(), 34).toString() : finger)
            ...
            param.put("finger2",
                    "Dikeluarkan di " + akses.getnamars() + ", Kabupaten/Kota " + akses.getkabupatenrs()
                            ...
                            + (finger2.equals("") ? tbObat.getValueAt(tbObat.getSelectedRow(), 36).toString() : finger2)
                            + "\n" + Tanggal.getSelectedItem());
            Valid.MyReportqry("rptFormulirChecklistPostOperasi.jasper", "report",
                    "::[ Formulir Check List Post Operasi ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.tgl_lahir,pasien.jk,checklist_post_operasi.tanggal,"
                            ...
                            "where checklist_post_operasi.no_rawat='"
                            + tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString()
                            + "' and checklist_post_operasi.tanggal='"
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[] {
                            ...
                            rs.getString("jenis_cairan_infus"), rs.getString("kateter_urine"),
                            rs.getString("tanggal_pemasangan_kateter"), rs.getString("warna_kateter"),
                            rs.getString("jumlah_kateter"), rs.getString("area_luka_operasi"), rs.getString("drain"),
                            rs.getString("jumlah_drain"), rs.getString("letak_drain"),
                            rs.getString("warna_drain"), rs.getString("jaringan_pa"), rs.getString("nip_perawat_ok"),
                            rs.getString("petugasok"), rs.getString("nip_perawat_anestesi"),

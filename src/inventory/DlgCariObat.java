...
public final class DlgCariObat extends javax.swing.JDialog {
    ...
    private String signa1 = "1", signa2 = "1", nokunjungan = "", kdObatSK = "", requestJson = "", URL = "", otorisasi,
            ...
            rincianobat = "", finger = "", dokterrujukan = "", polirujukan = "";
            ...
            public void windowClosed(WindowEvent e) {
                if (aturanpakai.getTable().getSelectedRow() != -1) {
                    if (TabRawat.getSelectedIndex() == 0) {
                        tbObat.setValueAt(aturanpakai.getTable().getValueAt(aturanpakai.getTable().getSelectedRow(), 0)
    ...
    private void initComponents() {
        ...
        ppCetakTelaah = new javax.swing.JMenuItem();
        ...
        ppCetakTelaah.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppCetakTelaah.setForeground(new java.awt.Color(50, 50, 50));
        ppCetakTelaah.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppCetakTelaah.setText("Cetak Telaah Resep");
        ppCetakTelaah.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppCetakTelaah.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppCetakTelaah.setName("ppCetakTelaah"); // NOI18N
        ppCetakTelaah.setPreferredSize(new java.awt.Dimension(200, 25));
        ppCetakTelaah.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppCetakTelaahActionPerformed(evt);
            }
        });
        Popup.add(ppCetakTelaah);
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "09-12-2025" }));
            ...
            if (reply == JOptionPane.YES_OPTION) {
                try {
                                    ...
                                    ttljual = ttljual
                                            + Math.round(Double.parseDouble(tbObat.getValueAt(i, 8).toString()) +
                                                    ...
                                                    + (Double.parseDouble(tbObat.getValueAt(i, 6).toString()) *
                                                            Double.parseDouble(tbObat.getValueAt(i, 1).toString())));
                                    ttlhpp = ttlhpp
                                            + Math.round(Double.parseDouble(tbObat.getValueAt(i, 13).toString()) *
                                                    Double.parseDouble(tbObat.getValueAt(i, 1).toString()));
                                    if (!tbObat.getValueAt(i, 11).toString().equals("")) {
                                        Sequel.menyimpan("aturan_pakai", "?,?,?,?,?", 5, new String[] {
                                                Valid.SetTgl(DTPTgl.getSelectedItem() + ""),
                    ...
                    if (sukses == true) {
                        ...
                        if (ttljual > 0) {
                            Sequel.menyimpan("tampjurnal", "'" + Suspen_Piutang_Obat_Ralan
                                    + "','Suspen Piutang Obat Ralan','" + ttljual + "','0'", "Rekening");
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Obat_Ralan + "','Pendapatan Obat Rawat Jalan','0','" + ttljual + "'",
                                    "Rekening");
                        }
                        if (ttlhpp > 0) {
                            Sequel.menyimpan("tampjurnal", "'" + HPP_Obat_Rawat_Jalan
                                    + "','HPP Persediaan Obat Rawat Jalan','" + ttlhpp + "','0'", "Rekening");
                            Sequel.menyimpan("tampjurnal", "'" + Persediaan_Obat_Rawat_Jalan
                                    + "','Persediaan Obat Rawat Jalan','0','" + ttlhpp + "'", "Rekening");
                        }
    ...
    private void TabRawatMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_TabRawatMouseClicked
        ...
        styleSheet.addRule(
                ".isi td{border-right: 1px solid #e2e7dd;font: 8.5px tahoma;height:12px;border-bottom: 1px solid #e2e7dd;background: #ffffff;color:#323232;}.isi a{text-decoration:none;color:#8b9b95;padding:0 0 0 0px;font-family: Tahoma;font-size: 8.5px;border: white;}");
    ...
    private void ppCetakTelaahActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_ppCetakTelaahActionPerformed
        if (TNoRw.getText().trim().equals("") || TPasien.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan pilih dulu pasien...!!!");
        } else {
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            ...
            try {
                for (int r = 0; r < tbObat.getRowCount(); r++) {
                    if (Valid.SetAngka(tbObat.getValueAt(r, 1).toString()) > 0) {
                        Sequel.menyimpan("temporary_resep",
                                "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", 38,
                                new String[] {
                                        "" + i, tbObat.getValueAt(r, 3).toString(), tbObat.getValueAt(r, 11).toString(),
                ...
                for (int r = 0; r < tbObatRacikan.getRowCount(); r++) {
                    if (!tbObatRacikan.getValueAt(r, 1).toString().equals("")) {
                        String rincianobat = "";
                        for (int x = 0; x < tbDetailObatRacikan.getRowCount(); x++) {
                            if (tbDetailObatRacikan.getValueAt(x, 0).toString()
                                    .equals(tbObatRacikan.getValueAt(r, 0).toString())) {
                                if (Valid.SetAngka(tbDetailObatRacikan.getValueAt(x, 10).toString()) > 0) {
                                    rincianobat += tbDetailObatRacikan.getValueAt(x, 2).toString() + " "
                                            + tbDetailObatRacikan.getValueAt(x, 10).toString() + ",";
                                }
                            }
                        }
                        if (rincianobat.endsWith(",")) {
                        ...
                        Sequel.menyimpan("temporary_resep",
                                "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", 38,
                                new String[] {
                                        "" + i, tbObatRacikan.getValueAt(r, 1).toString() + " (" + rincianobat + ")",
                                        tbObatRacikan.getValueAt(r, 5).toString(),
                                        tbObatRacikan.getValueAt(r, 4).toString(),
                                        tbObatRacikan.getValueAt(r, 3).toString(),
                                        "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
                                        "", "", "", "", "", "", "", "", "", "", "", "",
                                        akses.getalamatip()
                                });
                ...
                if (rowCount == 0) {
                    this.setCursor(Cursor.getDefaultCursor());
                    JOptionPane.showMessageDialog(null, "Tidak ada obat yang dipilih atau jumlah masih 0.");
                    return;
                }
                ...
                String kd_dokter_fix = Sequel.cariIsi("select kd_dokter from resep_obat where no_resep=?",
                        NoResep.getText());
                String nm_dokter_fix = "";

                if (!kd_dokter_fix.equals("")) {
                    nm_dokter_fix = Sequel.cariIsi("select nm_dokter from dokter where kd_dokter=?", kd_dokter_fix);
                } else {
                    kd_dokter_fix = this.kodedokter;
                ...
                param.put("finger",
                        "Dikeluarkan di " + akses.getnamars() + ", Kabupaten/Kota " + akses.getkabupatenrs()
                                + "\nDitandatangani secara elektronik oleh " + nm_dokter_fix + "\nID "
                                + (finger.equals("") ? kd_dokter_fix : finger) + "\n"
                                + Valid.SetTgl(DTPTgl.getSelectedItem() + ""));

                param.put("diagnosa", Sequel.cariIsi(
                        "select concat(diagnosa_pasien.kd_penyakit,' ',penyakit.nm_penyakit) from diagnosa_pasien inner join penyakit on diagnosa_pasien.kd_penyakit=penyakit.kd_penyakit where diagnosa_pasien.no_rawat=? and diagnosa_pasien.prioritas='1'",
                        TNoRw.getText()));
                param.put("tanggallahir", Sequel.cariIsi(
                        "select DATE_FORMAT(tgl_lahir,'%d-%m-%Y') from pasien where no_rkm_medis=?", TNoRM.getText()));
                param.put("umur", Umur.getText());
                param.put("alergi",
                        Sequel.cariIsi("select alergi from pemeriksaan_ralan where no_rawat=?", TNoRw.getText()));
                param.put("berat",
                        Sequel.cariIsi("select berat from pemeriksaan_ralan where no_rawat=?", TNoRw.getText()));
                param.put("tinggi",
                        Sequel.cariIsi("select tinggi from pemeriksaan_ralan where no_rawat=?", TNoRw.getText()));

                String kamar = Sequel.cariIsi("select ifnull(kd_kamar,'') from kamar_inap where no_rawat='"
                        + TNoRw.getText() + "' order by tgl_masuk desc limit 1");
                String namakamar = "";
                if (!kamar.equals("")) {
                    namakamar = kamar + ", " + Sequel.cariIsi(
                            "select nm_bangsal from bangsal inner join kamar on bangsal.kd_bangsal=kamar.kd_bangsal where kamar.kd_kamar='"
                                    + kamar + "' ");
                    kamar = "Kamar";
                } else {
                    kamar = "Poli";
                    namakamar = Sequel.cariIsi(
                            "select nm_poli from poliklinik inner join reg_periksa on poliklinik.kd_poli=reg_periksa.kd_poli where reg_periksa.no_rawat='"
                                    + TNoRw.getText() + "'");
                }
                param.put("kamar", kamar);
                param.put("namakamar", namakamar);

                String noResepCari = NoResep.getText();
                param.put("resep_identifikasi_pasien", Sequel
                        .cariIsi("select resep_identifikasi_pasien from telaah_farmasi where no_resep=?", noResepCari));
                param.put("resep_ket_identifikasi_pasien", Sequel.cariIsi(
                        "select resep_ket_identifikasi_pasien from telaah_farmasi where no_resep=?", noResepCari));
                param.put("resep_tepat_obat",
                        Sequel.cariIsi("select resep_tepat_obat from telaah_farmasi where no_resep=?", noResepCari));
                param.put("resep_ket_tepat_obat", Sequel
                        .cariIsi("select resep_ket_tepat_obat from telaah_farmasi where no_resep=?", noResepCari));
                param.put("resep_tepat_dosis",
                        Sequel.cariIsi("select resep_tepat_dosis from telaah_farmasi where no_resep=?", noResepCari));
                param.put("resep_ket_tepat_dosis", Sequel
                        .cariIsi("select resep_ket_tepat_dosis from telaah_farmasi where no_resep=?", noResepCari));
                param.put("resep_tepat_cara_pemberian", Sequel.cariIsi(
                        "select resep_tepat_cara_pemberian from telaah_farmasi where no_resep=?", noResepCari));
                param.put("resep_ket_tepat_cara_pemberian", Sequel.cariIsi(
                        "select resep_ket_tepat_cara_pemberian from telaah_farmasi where no_resep=?", noResepCari));
                param.put("resep_tepat_waktu_pemberian", Sequel.cariIsi(
                        "select resep_tepat_waktu_pemberian from telaah_farmasi where no_resep=?", noResepCari));
                param.put("resep_ket_tepat_waktu_pemberian", Sequel.cariIsi(
                        "select resep_ket_tepat_waktu_pemberian from telaah_farmasi where no_resep=?", noResepCari));
                param.put("resep_ada_tidak_duplikasi_obat", Sequel.cariIsi(
                        "select resep_ada_tidak_duplikasi_obat from telaah_farmasi where no_resep=?", noResepCari));
                param.put("resep_ket_ada_tidak_duplikasi_obat", Sequel.cariIsi(
                        "select resep_ket_ada_tidak_duplikasi_obat from telaah_farmasi where no_resep=?", noResepCari));
                param.put("resep_interaksi_obat", Sequel
                        .cariIsi("select resep_interaksi_obat from telaah_farmasi where no_resep=?", noResepCari));
                param.put("resep_ket_interaksi_obat", Sequel
                        .cariIsi("select resep_ket_interaksi_obat from telaah_farmasi where no_resep=?", noResepCari));
                param.put("resep_kontra_indikasi_obat", Sequel.cariIsi(
                        "select resep_kontra_indikasi_obat from telaah_farmasi where no_resep=?", noResepCari));
                param.put("resep_ket_kontra_indikasi_obat", Sequel.cariIsi(
                        "select resep_ket_kontra_indikasi_obat from telaah_farmasi where no_resep=?", noResepCari));
                param.put("obat_tepat_pasien",
                        Sequel.cariIsi("select obat_tepat_pasien from telaah_farmasi where no_resep=?", noResepCari));
                param.put("obat_tepat_obat",
                        Sequel.cariIsi("select obat_tepat_obat from telaah_farmasi where no_resep=?", noResepCari));
                param.put("obat_tepat_dosis",
                        Sequel.cariIsi("select obat_tepat_dosis from telaah_farmasi where no_resep=?", noResepCari));
                param.put("obat_tepat_cara_pemberian", Sequel
                        .cariIsi("select obat_tepat_cara_pemberian from telaah_farmasi where no_resep=?", noResepCari));
                param.put("obat_tepat_waktu_pemberian", Sequel.cariIsi(
                        "select obat_tepat_waktu_pemberian from telaah_farmasi where no_resep=?", noResepCari));

                String finger2 = Sequel.cariIsi(
                        "select sha1(sidikjari.sidikjari) from sidikjari inner join pegawai on pegawai.id=sidikjari.id where pegawai.nik=?",
                        Sequel.cariIsi("select nip from telaah_farmasi where no_resep=?", noResepCari));
                param.put("finger2",
                        "Dikeluarkan di " + akses.getnamars() + ", Kabupaten/Kota " + akses.getkabupatenrs()
                                + "\nDitandatangani secara elektronik oleh " + nm_dokter_fix + "\nID "
                                + (finger2.equals("") ? kd_dokter_fix : finger2) + "\n"
                                + Valid.SetTgl(DTPTgl.getSelectedItem() + ""));

                Valid.MyReportqry("rptResepTelaah.jasper", "report", "::[ Lembar Telaah Resep ]::",
                        "select *, (SELECT IFNULL((SELECT no_sep FROM bridging_sep WHERE no_rawat='" + TNoRw.getText()
                                + "' AND jnspelayanan='1' LIMIT 1), (SELECT no_sep FROM bridging_sep WHERE no_rawat='"
                                + TNoRw.getText()
                                + "' AND jnspelayanan='2' LIMIT 1))) as no_sep from temporary_resep where temporary_resep.temp37='"
                                + akses.getalamatip() + "' order by temporary_resep.no",
                        param);

            } catch (Exception e) {
                System.out.println("Error Cetak Telaah: " + e);
                e.printStackTrace();
            } finally {
                this.setCursor(Cursor.getDefaultCursor());
            }
        }
    }// GEN-LAST:event_ppCetakTelaahActionPerformed
    ...
    private javax.swing.JMenuItem ppCetakTelaah;
            ...
            if (kenaikan > 0) {
                if (aktifkanbatch.equals("yes")) {
                    ...
                    psobat = koneksi.prepareStatement(
                            sql + " where gudangbarang.stok>0 and gudangbarang.kd_bangsal=? "
            ...
            try {
                ...
                while (rsracikan.next()) {
                    ...
                    try {
                        ...
                        while (rs2.next()) {
                            rincianobat = rs2.getString("nama_brng") + " " + rs2.getString("jml") + " "
                                    + rs2.getString("satuan") + "," + rincianobat;
                            rincianobat = rincianobat.substring(0, rincianobat.length() - 1);
                            Sequel.menyimpan("temporary_resep",
                                    "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", 38,
                                    new String[] {
                    ...
                    param.put("penanggung",
                            Sequel.cariIsi("select png_jawab from penjab where kd_pj=?", KdPj.getText()));
                    param.put("propinsirs", akses.getpropinsirs());
                    ...
                    param.put("logo", Sequel.cariGambar("select setting.logo from setting"));
                    Valid.MyReportqry("rptLembarObat2.jasper", "report", "::[ Resep Sebelum Validasi ]::",
    ...
    private void CetakObat() {
        ...
        try {
            ...
            for (int row = 0; row < tbObat.getRowCount(); row++) {
                ...
                if (tbObat.getValueAt(row, 1) != null && !tbObat.getValueAt(row, 1).toString().trim().equals("")
                        && Double.parseDouble(tbObat.getValueAt(row, 1).toString()) > 0) {
                    ...
                    Sequel.menyimpan("temporary_resep",
                            "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", 38,
                            new String[] {
                                    "" + i, namaObat, aturanPakai, jumlah, satuan, "", "", "", "", "", "", "", "", "",
                                    "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
                                    "", "", akses.getalamatip()
                            });
                    i++;
            ...
            // BAGIAN 2: Mengambil data obat racikan dari JTable tbObatRacikan &
            // tbDetailObatRacikan
                ...
                if (jumlahRacik != null && !jumlahRacik.trim().equals("") && Double.parseDouble(jumlahRacik) > 0) {
                    ...
                    for (int rowDetail = 0; rowDetail < tbDetailObatRacikan.getRowCount(); rowDetail++) {
                        if (tbDetailObatRacikan.getValueAt(rowDetail, 0).toString().equals(noRacik)) {
                            // Cek apakah ada jumlah yang diinput
                            if (tbDetailObatRacikan.getValueAt(rowDetail, 10) != null
                                    && !tbDetailObatRacikan.getValueAt(rowDetail, 10).toString().trim().equals("")
                                    && Double.parseDouble(
                                            tbDetailObatRacikan.getValueAt(rowDetail, 10).toString()) > 0) {
                    ...
                    Sequel.menyimpan("temporary_resep",
                            "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", 38,
                            new String[] {
                                    "" + i, namaRacikan + " (" + rincianFinal + ")", aturanPakaiRacikan, jumlahRacik,
                                    metodeRacik, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
                                    "", "", "", "", "", "", "", "", "", "", "", "", "", "", akses.getalamatip()
                            });
                    i++;
        ...
        String kodedokter_report = Sequel.cariIsi("select kd_dokter from resep_obat where no_resep=?",
                NoResep.getText());
        ...
        param.put("finger",
                "Dikeluarkan di " + akses.getnamars() + ", Kabupaten/Kota " + akses.getkabupatenrs()
                        ...
                        + (finger.equals("") ? kodedokter_report : finger) + "\n" + DTPTgl.getSelectedItem());
        param.put("jam", cmbJam.getSelectedItem() + ":" + cmbMnt.getSelectedItem() + ":" + cmbDtk.getSelectedItem());
        param.put("logo", Sequel.cariGambar("select setting.logo from setting"));
        String kamar = Sequel.cariIsi("select ifnull(kd_kamar,'') from kamar_inap where no_rawat='" + TNoRw.getText()
        ...
        param.put("sep",
                Sequel.cariIsi("select bridging_sep.no_sep from bridging_sep where no_rawat =?", TNoRw.getText()));
                ...
                if (aktifkanbatch.equals("yes")) {
                    psobat = koneksi.prepareStatement(
                            "select databarang.kode_brng,databarang.nama_brng,jenis.nama,detail_pemberian_obat.jml, " +
                                    "databarang.kode_sat,(databarang.h_beli+(databarang.h_beli*?)) as harga,databarang.letak_barang,"
                                    +
                                    "industrifarmasi.nama_industri,databarang.h_beli,databarang." + hppfarmasi
                                    + " as dasar,kategori_barang.nama as kategori," +
                ...
                while (rs.next()) {
                    ...
                    htmlContent.append(
                            "<tr class='isi'>" +
                                    ...
                                    "<td valign='top' width='1%' align='center'>:</td>" +
                                    "<td valign='top' width='79%'>" + rs.getString("tgl_registrasi") + " "
                                    ...
                                    "<td valign='top' width='1%' align='center'>:</td>" +
                                    "<td valign='top' width='79%'>" + rs.getString("nm_dokter") + dokterrujukan
                                    + "</td>" +
                                    "</tr>");
                    ...
                    htmlContent.append(
                            "<tr class='isi'>" +
                                    ...
                                    + Valid.SetAngka(rs.getDouble("biaya_reg")) + "</td>" +
                                    "</tr>" +
                                    "</table>");
                        ...
                        try {
                            rs2 = koneksi.prepareStatement(
                                    "select detail_pemberian_obat.tgl_perawatan,detail_pemberian_obat.jam,databarang.kode_sat, "
                                            ...
                                            "where detail_pemberian_obat.no_rawat='" + rs.getString("no_rawat")
                                ...
                                while (rs2.next()) {
                                    htmlContent.append(
                                            "<tr>" +
                                                    ...
                                                    "<td valign='top'>" + rs2.getString("tgl_perawatan") + " "
                                                    + rs2.getString("jam") + "</td>" +
                                                    "<td valign='top'>" + rs2.getString("kode_brng") + "</td>" +
                                                    "<td valign='top'>" + rs2.getString("nama_brng") + "</td>" +
                                                    "<td valign='top'>" + rs2.getDouble("jml") + " "
                                                    + rs2.getString("kode_sat") + "</td>" +
                                                    "<td valign='top'>"
                                                    + Sequel.cariIsi(
                                                            "select aturan from aturan_pakai where tgl_perawatan='"
                                                                    + rs2.getString("tgl_perawatan") + "' and jam='"
                                                                    + rs2.getString("jam") + "' and no_rawat='"
                                                                    + rs.getString("no_rawat") + "' and kode_brng='"
                                                                    + rs2.getString("kode_brng") + "'")
                                                    + "</td>" +
                                                    "<td valign='top' align='right'>"
                                                    + Valid.SetAngka(rs2.getDouble("total")) + "</td>" +
                                                    "</tr>");
                                    w++;
                        ...
                        try {
                            rs2 = koneksi.prepareStatement(
                                    "select databarang.kode_brng,databarang.nama_brng,detreturjual.kode_sat,detreturjual.h_retur, "
                                            ...
                                            "inner join returjual on returjual.no_retur_jual=detreturjual.no_retur_jual where returjual.no_retur_jual like '%"
                                            + rs.getString("no_rawat") + "%' order by databarang.nama_brng")
                                    .executeQuery();
                            if (rs2.next()) {
                                htmlContent.append(
                                        "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"
                                ...
                                while (rs2.next()) {
                                    htmlContent.append(
                                            "<tr>" +
                                                    ...
                                                    "<td valign='top'>" + rs2.getString("kode_brng") + "</td>" +
                                                    "<td valign='top'>" + rs2.getString("nama_brng") + "</td>" +
                                                    "<td valign='top'>" + rs2.getDouble("jumlah") + " "
                                                    + rs2.getString("kode_sat") + "</td>" +
                                                    "<td valign='top' align='right'>"
                                                    + Valid.SetAngka(rs2.getDouble("total")) + "</td>" +
                                                    "</tr>");
                        ...
                        try {
                            rs2 = koneksi.prepareStatement(
                                    "select resep_pulang.kode_brng,databarang.nama_brng,resep_pulang.dosis,resep_pulang.jml_barang, "
                                            ...
                                            "resep_pulang.no_rawat='" + rs.getString("no_rawat")
                                            + "' order by databarang.nama_brng")
                                    .executeQuery();
                            if (rs2.next()) {
                                htmlContent.append(
                                ...
                                while (rs2.next()) {
                                    htmlContent.append(
                                            "<tr>" +
                                                    ...
                                                    "<td valign='top'>" + rs2.getDouble("jml_barang") + " "
                                                    + rs2.getString("kode_sat") + "</td>" +
                                                    "<td valign='top' align='right'>"
                                                    + Valid.SetAngka(rs2.getDouble("total")) + "</td>" +
                                                    "</tr>");
                    ...
                    if (R4.isSelected() == true) {
                        if (rs.getString("status_lanjut").equals("Ralan")) {
                            get = new GetMethod("http://" + koneksiDB.HOSTHYBRIDWEB() + ":" + koneksiDB.PORTWEB() + "/"
                                    ...
                                    + rs.getString("kd_dokter").replace(" ", "_"));
                            ...
                            htmlContent.append(
                                    "<tr class='isi'>" +
                                            ...
                                            "<td valign='middle' width='79%' align='center'>Dokter Poli<br><img width='90' height='90' src='http://"
                                            + koneksiDB.HOSTHYBRIDWEB() + ":" + koneksiDB.PORTWEB() + "/"
                                            + koneksiDB.HYBRIDWEB() + "/penggajian/temp/" + rs.getString("kd_dokter")
                                            + ".png'/><br>" + rs.getString("nm_dokter") + "</td>" +
                                            "</tr>");
                            ...
                            try {
                                ...
                                if (rs3.next()) {
                                    ...
                                    urutdpjp = 1;
                                    while (rs3.next()) {
                                        get = new GetMethod("http://" + koneksiDB.HOSTHYBRIDWEB() + ":"
                                                + koneksiDB.PORTWEB() + "/" + koneksiDB.HYBRIDWEB()
                                                + "/penggajian/generateqrcode.php?kodedokter="
                                                + rs3.getString("kd_dokter").replace(" ", "_"));
                                        http.executeMethod(get);
                                        htmlContent.append("<td border='0' align='center'>Dokter DPJP " + urutdpjp
                                                + "<br><img width='90' height='90' src='http://"
                                                + koneksiDB.HOSTHYBRIDWEB() + ":" + koneksiDB.PORTWEB() + "/"
                                                + koneksiDB.HYBRIDWEB() + "/penggajian/temp/"
                                                + rs3.getString("kd_dokter") + ".png'/><br>"
                                                + rs3.getString("nm_dokter") + "</td>");
                                        urutdpjp++;
                                    }
                                    htmlContent.append(
                                            "</tr>" +
                                    ...
                                    htmlContent.append(
                                            "<tr class='isi'>" +
                                                    ...
                                                    "<td valign='middle' width='18%'>Tanda Tangan/Verifikasi</td>" +
                                                    "<td valign='middle' width='1%' align='center'>:</td>" +
                                                    "<td valign='middle' width='79%' align='center'>Dokter DPJP<br><img width='90' height='90' src='http://"
                                                    + koneksiDB.HOSTHYBRIDWEB() + ":" + koneksiDB.PORTWEB() + "/"
                                                    + koneksiDB.HYBRIDWEB() + "/penggajian/temp/"
                                                    + rs.getString("kd_dokter") + ".png'/><br>"
                                                    + rs.getString("nm_dokter") + "</td>" +
                                                    "</tr>");
                                }
                            } catch (Exception e) {
                    ...
                    teks.replaceAll("<head>", "<head><link href=\"file.css\" rel=\"stylesheet\" type=\"text/css\" />")
                            .replaceAll("<body>",
                                    "<body>" +
                                            ...
                                            "<td valign='top' width='1%' align='center'>:</td>" +
                                            "<td valign='top' width='79%'>"
                                            + Jk.getText().replaceAll("L", "Laki-Laki").replaceAll("P", "Perempuan")
                                            + "</td>" +
                                            "</tr>" +
                                            "<tr class='isi'>" +
                                            "<td valign='top' width='20%'>Tempat & Tanggal Lahir</td>" +
                                            "<td valign='top' width='1%' align='center'>:</td>" +
                                            "<td valign='top' width='79%'>" + TempatLahir.getText() + " "
                                            + TanggalLahir.getText() + "</td>" +
                                            "</tr>" +
                                            "<tr class='isi'>" +
                ...
                try {
                    rs2 = koneksi.prepareStatement(
                            "select uji_fungsi_kfr.tanggal,uji_fungsi_kfr.diagnosis_fungsional,uji_fungsi_kfr.diagnosis_medis,uji_fungsi_kfr.hasil_didapat,"
                                    ...
                                    +
                                    "uji_fungsi_kfr.no_rawat='" + norawat + "'")
                            .executeQuery();
                    if (rs2.next()) {
                        htmlContent.append(
                                "<tr class='isi'>" +
                        ...
                        while (rs2.next()) {
                            htmlContent.append(
                                    "<tr>" +
                                            ...
                                            +
                                            "<td width='66%' border='0'>Dokter : " + rs2.getString("kd_dokter") + " "
                                            + rs2.getString("nm_dokter") + "</td>" +
                                            "</tr>" +
                                            "</table>" +
                                            "</td>" +
                                            "</tr>" +
                                            ...
                                            "<td width='80%' border='0'>: " + rs2.getString("diagnosis_fungsional")
                                            + "</td>" +
                                            "</tr>" +
                                            "<tr>" +
                                            ...
                                            +
                                            "<tr>" +
                                            "<td width='100%' border='0'>Hasil yang didapat : "
                                            + rs2.getString("hasil_didapat") + "</td>" +
                                            "</tr>" +
                                            "<tr>" +
                                            "<td width='100%' border='0'>Kesimpulan : " + rs2.getString("kesimpulan")
                                            + "</td>" +
                                            "</tr>" +
                                            "<tr>" +
                                            "<td width='100%' border='0'>Rekomendasi : " + rs2.getString("rekomedasi")
                                            + "</td>" +
                                            "</tr>" +
                                            "</table>" +
                                            "</td>" +
                ...
                try {
                    rs2 = koneksi.prepareStatement(
                            "select rekonsiliasi_obat.no_rekonsiliasi,rekonsiliasi_obat.tanggal_wawancara,rekonsiliasi_obat.rekonsiliasi_obat_saat,"
                                    ...
                                    +
                                    "inner join petugas on rekonsiliasi_obat.nip=petugas.nip where rekonsiliasi_obat.no_rawat='"
                                    + norawat + "' " +
                        ...
                        while (rs2.next()) {
                            htmlContent.append(
                                    "<tr>" +
                                            ...
                                            +
                                            "<tr>" +
                                            "<td width='100%' colspan='3'>Petugas Wawancara : " + rs2.getString("nip")
                                            + " " + rs2.getString("nama") + "</td>" +
                                            "</tr>" +
                                            "<tr>" +
                                            "<td width='33%'>No.Rekonsiliasi : " + rs2.getString("no_rekonsiliasi")
                                            + "</td>" +
                                            "<td width='33%'>Tgl.Wawancara : " + rs2.getString("tanggal_wawancara")
                                            + "</td>" +
                                            "<td width='33%'>Rekonsiliasi Saat : "
                                            + rs2.getString("rekonsiliasi_obat_saat") + "</td>" +
                                            "</tr>" +
                                            "<tr>" +
                                            "<td width='33%'>Alergi Obat : " + rs2.getString("alergi_obat") + "</td>" +
                                            "<td width='33%'>Manifestasi Alergi : "
                                            + rs2.getString("manifestasi_alergi") + "</td>" +
                                            "<td width='33%'>Dampak Alergi : " + rs2.getString("dampak_alergi")
                                            + "</td>" +
                                            "</tr>" +
                                            "</table>" +
                                            "</td>" +
                                ...
                                while (rs3.next()) {
                                    htmlContent.append(
                                            "<tr>" +
                                                    ...
                                                    "<td valign='top' align='center'>" + rs3.getString("frekuensi")
                                                    + "</td>" +
                                                    "<td valign='top'>" + rs3.getString("cara_pemberian") + "</td>" +
                                                    "<td valign='top'>" + rs3.getString("waktu_pemberian_terakhir")
                                                    + "</td>" +
                                                    "<td valign='top' align='center'>" + rs3.getString("tindak_lanjut")
                                                    + "</td>" +
                                                    "<td valign='top'>" + rs3.getString("perubahan_aturan_pakai")
                                                    + "</td>" +
                                                    "</tr>");
                                    w++;
                                }
                                ...
                                if (rs3.next()) {
                                    htmlContent.append(
                                            "<tr>" +
                                                    ...
                                                    +
                                                    "<tr>" +
                                                    "<td width='33%'>Diterima Farmasi : "
                                                    + rs3.getString("diterima_farmasi") + "</td>" +
                                                    "<td width='33%'>Dikonfirmasi Apoteker : "
                                                    + rs3.getString("dikonfirmasi_apoteker") + "</td>" +
                                                    "<td width='33%'>Diserahkan Pasien : "
                                                    + rs3.getString("diserahkan_pasien") + "</td>" +
                                                    "</tr>" +
                                                    "<tr>" +
                                                    "<td width='100%' colspan='3'>Petugas Farmasi/Apoteker : "
                                                    + rs3.getString("nip") + " " + rs3.getString("nama") + "</td>" +
                                                    "</tr>" +
                                                    "</table>" +
                                                    "</td>" +
                                                    "</tr>");
                ...
                try {
                    rs2 = koneksi.prepareStatement(
                            "select konseling_farmasi.tanggal,konseling_farmasi.diagnosa,konseling_farmasi.obat_pemakaian,konseling_farmasi.riwayat_alergi,konseling_farmasi.keluhan,"
                                    ...
                                    "where konseling_farmasi.no_rawat='" + norawat
                        ...
                        while (rs2.next()) {
                            htmlContent.append(
                                    "<tr>" +
                                            ...
                                            +
                                            "<td width='40%' border='0'>Apoteker : " + rs2.getString("nip") + " "
                                            + rs2.getString("nama") + "</td>" +
                                            "<td width='30%' border='0'>Tgl.Konseling : " + rs2.getString("tanggal")
                                            + "</td>" +
                                            "</tr>" +
                                            "</table>" +
                                            "</td>" +
                                            ...
                                            "<td width='33%'>Pernah Konseling Sebelumnya : "
                                            + rs2.getString("pernah_datang") + " </td>" +
                                            "</tr>" +
                                            "<tr>" +
                                            "<td width='100%' colspan='3'>Nama Obat, Dosis & Cara Pemakaian : "
                                            + rs2.getString("obat_pemakaian") + "</td>" +
                                            "</tr>" +
                                            "<tr>" +
                                            "<td width='100%' colspan='3'>Keluhan : " + rs2.getString("keluhan")
                                            + "</td>" +
                                            "</tr>" +
                                            "<tr>" +
                                            "<td width='100%' colspan='3'>Tindak Lanjut : "
                                            + rs2.getString("tindak_lanjut") + "</td>" +
                                            "</tr>" +
                                            "</table>" +
                                            "</td>" +
                                            "</tr>");
                ...
                try {
                    rs2 = koneksi.prepareStatement(
                            "select pelayanan_informasi_obat.no_permintaan,pelayanan_informasi_obat.tanggal,pelayanan_informasi_obat.metode,pelayanan_informasi_obat.penanya,"
                                    ...
                                    +
                                    "where pelayanan_informasi_obat.no_rawat='" + norawat
                        ...
                        while (rs2.next()) {
                            htmlContent.append(
                                    "<tr>" +
                                            ...
                                            "<td width='30%'>No. Permintaan : " + rs2.getString("no_permintaan")
                                            + "</td>" +
                                            "</tr>" +
                                            "<tr>" +
                                            "<td width='70%' colspan='2'>Penanya : " + rs2.getString("penanya")
                                            + "</td>" +
                                            "<td width='30%'>Status Penanya : " + rs2.getString("status_penanya")
                                            + "</td>" +
                                            "</tr>" +
                                            "<tr>" +
                                            "<td width='30%'>No. Telp : " + rs2.getString("no_telp_penanya") + "</td>" +
                                            "<td width='70%' colspan='2'>Jenis Pertanyaan : "
                                            + rs2.getString("jenis_pertanyaan") + "</td>" +
                                            "</tr>" +
                                            "<tr>" +
                                            "<td width='100%' colspan='3'>Uraian Pertanyaan : "
                                            + rs2.getString("uraian_pertanyaan") + "</td>" +
                                            "</tr>" +
                                            "</table>" +
                                            "</td>" +
                                            "</tr>" +
                                            ...
                                            +
                                            "<tr>" +
                                            "<td width='34%'>Tanggal Jawaban : " + rs2.getString("tanggal_jawab")
                                            + " </td>" +
                                            "<td width='33%'>Penyampaian : " + rs2.getString("penyampaian_jawaban")
                                            + " </td>" +
                                            "<td width='33%'>Metode Jawab : " + rs2.getString("metodejawab") + " </td>"
                                            +
                                            "</tr>" +
                                            "<tr>" +
                                            "<td width='100%' colspan='3'>Apoteker Yang Menjawab : "
                                            + rs2.getString("nip") + " " + rs2.getString("nama") + "</td>" +
                                            "</tr>" +
                                            "<tr>" +
                                            "<td width='100%' colspan='3'>Jawaban Apoteker : "
                                            + rs2.getString("jawaban") + "</td>" +
                                            "</tr>" +
                                            "<tr>" +
                                            "<td width='100%' colspan='3'>Referensi Jawaban : "
                                            + rs2.getString("referensi") + "</td>" +
                                            "</tr>" +
                                            "</table>" +
                                            "</td>" +
                                            "</tr>");

...
public class DlgTTDPersetujuanUmum extends JDialog {
    ...
    public DlgTTDPersetujuanUmum(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        initCanvasLogic();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Tanda Tangan Pembuat Pernyataan");
        setResizable(false);
    ...
    private void simpanTTD() {
        try {
            ...
            String fileName = "TTDPU_" + safeNoSurat + ".jpeg";
    ...
    private boolean saveToDatabase(String fileName) {
        try {
            ...
            String sql = "UPDATE surat_persetujuan_umum SET photo=? WHERE no_surat=?";

...
public class DlgTTDPasien extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(
                ...
                ".:[ Tanda Tangan Pasien Kunjungan Pertama Fisioterapi ]:.",
                javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION,
                new java.awt.Font("Helvetica Neue", 0, 13), new java.awt.Color(70, 70, 70))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_BtnSimpanActionPerformed
        try {
            int w = panelGlass9.getWidth();
            int h = panelGlass9.getHeight();
            ...
            // Paint the signature canvas
            panelGlass9.printAll(g2d);
            g2d.dispose();
    ...
    public void setNoRm(String norawat, String noRm, String namaPasien, String Path, String NamaFile) {
        ...
        TPath.setText(Path);
        // isPsien();
        // Sequel.cariIsi("select catatan from catatan_pasien where
        // no_rkm_medis=?",TCatatan,TNoRawat.getText());
    }
    ...
    void uploadImage(String FileName, String docpath) {
        try {
            ...
            HttpPost postRequest = new HttpPost("http://" + koneksiDB.HOSTHYBRIDWEB() + ":" + koneksiDB.PORTWEB() + "/"
                    + koneksiDB.HYBRIDWEB() + "/imagefreehand/upload.php?doc=" + TPath.getText());

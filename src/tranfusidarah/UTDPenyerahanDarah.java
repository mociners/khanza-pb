...
public class UTDPenyerahanDarah extends javax.swing.JDialog {
    ...
    public UTDPenyerahanDarah(java.awt.Frame parent, boolean modal) {
        ...
        pasien.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(akses.getform().equals("UTDPenyerahanDarah")){
    ...
    private void initComponents() {
        ...
        scrollPane2.setPreferredSize(new java.awt.Dimension(1093, 160));

        panelisi3.setBorder(null);
        panelisi3.setName("panelisi3"); // NOI18N
        panelisi3.setPreferredSize(new java.awt.Dimension(89, 150));
        ...
        panelisi3.add(kdmem);
        kdmem.setBounds(220, 130, 100, 23);
        ...
        panelisi3.add(nmmem);
        nmmem.setBounds(330, 130, 232, 23);
        ...
        BtnMem.setBounds(560, 130, 28, 23);
...
*/
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(nopenyerahan.getText().trim().equals("")){
        ...
        }else if(kdmem.getText().trim().equals("")){
            Valid.textKosong(kdmem,"Nama Pasien");
        }
        else if(ttl<=0){
            ...
            if (reply == JOptionPane.YES_OPTION) {
                ...
                if(Sequel.menyimpantf("utd_penyerahan_darah","?,?,?,?,?,?,?,?,?,?,?,?","No.Penyerahan", 12,new String[]{
                    ...
                    nmpengambil.getText(),alamatpengambil.getText(),kdptgpj.getText(),""+besarppn,kdmem.getText()
                   })==true){
...
private void ppBersihkanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBersihkanActionPerformed
    ...
    private void BtnMemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnMemActionPerformed
        akses.setform("UTDPenyerahanDarah");
        pasien.isCek();
        pasien.emptTeks();

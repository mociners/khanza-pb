...
public class MasterKonsultasi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(
                ...
                "::[ Master Konsultasi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
        ...
        internalFrame1.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_BtnEditActionPerformed
        if (TKd.getText().trim().equals("")) {
            ...
            if (tbSpesialis.getSelectedRow() > -1) {
                Sequel.mengedit("master_konsultasi", "kode_masalah=?", "kode_masalah=?,nama_masalah=?", 3,
                        new String[] {

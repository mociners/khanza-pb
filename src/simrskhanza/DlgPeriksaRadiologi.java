...
public final class DlgPeriksaRadiologi extends javax.swing.JDialog {
    ...
    public DlgPeriksaRadiologi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Proyeksi","kV","mAS","FFD","BB","Inak","Jml Penyinaran","Dosis Radiasi"
        }){
...
private void ChkJlnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkJlnActionPerformed
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().equals("")||TNoRM.getText().equals("")||TPasien.getText().equals("")){
            ...
            int barisPemeriksaanDipilih = 0;
            for (int i = 0; i < tbPemeriksaan.getRowCount(); i++) {
                if (tbPemeriksaan.getValueAt(i, 0).toString().equals("true")) {
                    barisPemeriksaanDipilih++;
                    Object kvObj = tbPemeriksaan.getValueAt(i, 12);
                    Object masObj = tbPemeriksaan.getValueAt(i, 13);

                    String kv = (kvObj == null) ? "" : kvObj.toString().trim();
                    String mas = (masObj == null) ? "" : masObj.toString().trim();

                    if (kv.isEmpty() || mas.isEmpty()) {
                        JOptionPane.showMessageDialog(null, "Kolom kV dan mAS untuk pemeriksaan '" + tbPemeriksaan.getValueAt(i, 2).toString() + "' wajib diisi!");
                        tbPemeriksaan.requestFocus();
                        tbPemeriksaan.changeSelection(i, 12, false, false);
                        dataLengkap = false;
                        break;
                    }
                }
            ...
            if(barisPemeriksaanDipilih == 0){
                 JOptionPane.showMessageDialog(null, "Belum ada pemeriksaan yang dipilih. Silakan centang pemeriksaan yang akan disimpan.");
                 dataLengkap = false;
            }
            if (dataLengkap) {
                jmlparsial=0;
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(TNoRw.getText().equals("")||TNoRM.getText().equals("")||TPasien.getText().equals("")){
            ...
            for(i=0;i<tbPemeriksaan.getRowCount();i++){
                if(tbPemeriksaan.getValueAt(i,0).toString().equals("true")){
                    pemeriksaan=tbPemeriksaan.getValueAt(i,2).toString()+" dengan Proyeksi : "+tbPemeriksaan.getValueAt(i,11).toString()+", kV : "+tbPemeriksaan.getValueAt(i,12).toString()+", mAS : "+tbPemeriksaan.getValueAt(i,13).toString()+", FFD : "+tbPemeriksaan.getValueAt(i,14).toString()+", BB : "+tbPemeriksaan.getValueAt(i,15).toString()+", Inak : "+tbPemeriksaan.getValueAt(i,16).toString()+", Jml Penyinaran : "+tbPemeriksaan.getValueAt(i,17).toString()+", Dosis Radiasi : "+tbPemeriksaan.getValueAt(i,18).toString()+", "+pemeriksaan;
                }
            }
        ...
        if(status.equals("Ranap")){
            ...
            if(!norawatibu.equals("")){
                ...
                kelas=Sequel.cariIsi(
                    ...
                    "order by STR_TO_DATE(concat(kamar_inap.tgl_masuk,' ',kamar_inap.jam_masuk),'%Y-%m-%d %H:%i:%s') desc limit 1",norawatibu);
            }else{
                ...
                kelas=Sequel.cariIsi(
                    "select kamar.kelas from kamar inner join kamar_inap "+
                    "on kamar.kd_kamar=kamar_inap.kd_kamar where no_rawat=? "+
                    "order by STR_TO_DATE(concat(kamar_inap.tgl_masuk,' ',kamar_inap.jam_masuk),'%Y-%m-%d %H:%i:%s') desc limit 1",TNoRw.getText());
            } 

...
public class DlgCariPeriksaLabPetugas extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgCariPeriksaLabPetugas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        MnCetakHasilLabPetugas = new javax.swing.JMenuItem();
        ...
        MnCetakHasilLabPetugas.setBackground(new java.awt.Color(255, 255, 254));
        MnCetakHasilLabPetugas.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnCetakHasilLabPetugas.setForeground(new java.awt.Color(50, 50, 50));
        MnCetakHasilLabPetugas.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnCetakHasilLabPetugas.setText("Model 1 Petugas");
        MnCetakHasilLabPetugas.setName("MnCetakHasilLabPetugas"); // NOI18N
        MnCetakHasilLabPetugas.setPreferredSize(new java.awt.Dimension(100, 26));
        MnCetakHasilLabPetugas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnCetakHasilLabPetugasActionPerformed(evt);
            }
        });
        MnCetakLab.add(MnCetakHasilLabPetugas);
...
private void tbDokterKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbDokterKeyPressed
   if(tabMode.getRowCount()!=0){
    ...
    private void MnCetakHasilLabPetugasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakHasilLabPetugasActionPerformed
     this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data sudah habis...!!!!");
            TCari.requestFocus();
        ...
        this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_MnCetakHasilLabPetugasActionPerformed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariPeriksaLabPetugas dialog = new DlgCariPeriksaLabPetugas(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JMenuItem MnCetakHasilLabPetugas;
    ...
    public void isCek(){
        ...
        BtnPrint.setEnabled(akses.getsurveilans_ralan());
        ...
        MnCetakHasilLabPetugas.setEnabled(akses.gettindakan_ralan());
    }

...
public class DlgCariPeriksaLab extends javax.swing.JDialog {
                            ...
                            if (sukses == true) {
                                if (status.equals("Ranap")) {
                                    ...
                                    if (ttljmdokter > 0) {
                                        ...
                                        Sequel.menyimpan("tampjurnal", "'" + Utang_Jasa_Medik_Dokter_Laborat_Ranap
                                    ...
                                    if (ttlmenejemen > 0) {
                                        Sequel.menyimpan("tampjurnal", "'" + Beban_Jasa_Menejemen_Laborat_Ranap
                                                + "','Beban Jasa Menejemen Laborat Ranap','0','" + ttlmenejemen + "'",
                                                "kredit=kredit+'" + (ttlmenejemen) + "'",
                                                "kd_rek='" + Beban_Jasa_Menejemen_Laborat_Ranap + "'");
                                        Sequel.menyimpan("tampjurnal", "'" + Utang_Jasa_Menejemen_Laborat_Ranap
                                    ...
                                    Sequel.queryu("delete from tampjurnal");
                                    if (ttlpendapatan > 0) {
                                        Sequel.menyimpan("tampjurnal", "'" + Suspen_Piutang_Laborat_Ralan
                                    ...
                                    if (ttljmdokter > 0) {
                                        Sequel.menyimpan("tampjurnal", "'" + Beban_Jasa_Medik_Dokter_Laborat_Ralan
                                                + "','Beban Jasa Medik Dokter Laborat Ralan','0','" + ttljmdokter + "'",
                                                "kredit=kredit+'" + (ttljmdokter) + "'",
                                                "kd_rek='" + Beban_Jasa_Medik_Dokter_Laborat_Ralan + "'");
                                        Sequel.menyimpan("tampjurnal", "'" + Utang_Jasa_Medik_Dokter_Laborat_Ralan
                                    ...
                                    if (ttljasasarana > 0) {
                                        Sequel.menyimpan("tampjurnal", "'" + Beban_Jasa_Sarana_Laborat_Ralan
                                                + "','Beban Jasa Sarana Laborat Ralan','0','" + ttljasasarana + "'",
                                                "kredit=kredit+'" + (ttljasasarana) + "'",
                                                "kd_rek='" + Beban_Jasa_Sarana_Laborat_Ralan + "'");
                                        Sequel.menyimpan("tampjurnal", "'" + Utang_Jasa_Sarana_Laborat_Ralan
                                    ...
                                    if (ttljmperujuk > 0) {
                                        ...
                                        Sequel.menyimpan("tampjurnal", "'" + Utang_Jasa_Perujuk_Laborat_Ralan
                                                + "','Utang Jasa Perujuk Laborat Ralan','" + ttljmperujuk + "','0'",
                                                "debet=debet+'" + (ttljmperujuk) + "'",
                                                "kd_rek='" + Utang_Jasa_Perujuk_Laborat_Ralan + "'");
                                    }
                                    if (ttlmenejemen > 0) {
                                        Sequel.menyimpan("tampjurnal", "'" + Beban_Jasa_Menejemen_Laborat_Ralan
                                                + "','Beban Jasa Menejemen Laborat Ralan','0','" + ttlmenejemen + "'",
                                                "kredit=kredit+'" + (ttlmenejemen) + "'",
                                                "kd_rek='" + Beban_Jasa_Menejemen_Laborat_Ralan + "'");
                                        Sequel.menyimpan("tampjurnal", "'" + Utang_Jasa_Menejemen_Laborat_Ralan
                    ...
                    if (rs.next()) {
                        ...
                        try {
                            ...
                            while (rs2.next()) {
                                ...
                                ttl = ttl + item;
                                Sequel.menyimpan("temporary_lab", "'0','" + rs2.getString("kd_jenis_prw") + "','"
                                ...
                                try {
                                    ...
                                    while (rs3.next()) {
                                        ...
                                        ttl = ttl + item;
                                        Sequel.menyimpan("temporary_lab", "'0','" + rs3.getString("kd_jenis_prw")
                        ...
                        Valid.panggilUrl("billing/LaporanBiayaLab.php?norm=" + rs.getString("no_rkm_medis") + "&pasien="
                                ...
                                + "&petugas="
                                + tbDokter.getValueAt(tbDokter.getSelectedRow(), 2).toString().replaceAll(" ", "_")
                                + "&kasir="
            ...
            try {
                ...
                try {
                    ...
                    while (rs.next()) {
                        ...
                        String namaPetugasTabel = tbDokter.getValueAt(tbDokter.getSelectedRow(), 2).toString();
                        finger = Sequel.cariIsi(
                                "select sha1(sidikjari.sidikjari) from sidikjari inner join pegawai on pegawai.id=sidikjari.id where pegawai.nik=?",
                                rs.getString("nip"));
                        param.put("finger2",
                                "Dikeluarkan di " + akses.getnamars() + ", Kabupaten/Kota " + akses.getkabupatenrs()
                                        + "\nDitandatangani secara elektronik oleh " + namaPetugasTabel + "\nID "
    ...
    private void MnCetakHasilLabTTEActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_MnCetakHasilLabTTEActionPerformed
        if (tbDokter.getSelectedRow() > -1) {
            ...
            if (Sequel.cariInteger("select count(no_rawat) from berkas_tte_labpk where no_rawat='"
                ...
                createPdf(FileName);
                berkas.tampilPdfLocal(FileName, "local", "berkastte/laboratorium",
                        tbDokter.getValueAt(tbDokter.getSelectedRow(), 0).toString());
            }
            ;
    ...
    private void ppUploadPDFBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_ppUploadPDFBtnPrintActionPerformed
        FileName = "LAB_" + tbDokter.getValueAt(tbDokter.getSelectedRow(), 0).toString().replaceAll("/", "") + "_"
                + tbDokter.getValueAt(tbDokter.getSelectedRow(), 1).toString().replaceAll("[/()\\-:, ]", "") + "_"
                + tbDokter.getValueAt(tbDokter.getSelectedRow(), 3).toString();
        CreatePDF(FileName);
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    tabMode.addRow(new Object[] { rs.getString("no_rawat"),
                            ...
                            Sequel.cariIsi("select dokter.nm_dokter from dokter where dokter.kd_dokter=?",
                                    rs.getString("dokter_perujuk")),
                            rs.getString("nm_dokter"), rs.getString("no_tlp") });
                    ...
                    while (rs.next()) {
                        ...
                        try {
                            ...
                            if (rspermintaan.next()) {
                                ...
                                param.put("tanggalpermintaan", rspermintaan.getString("tgl_permintaan"));
                                param.put("jampermintaan", rspermintaan.getString("jam_permintaan"));
                                Valid.MyReportPDFWithName("rptPeriksaLabPermintaanTTE.jasper", "report", "tempfile",
                                        FileName, "::[ Pemeriksaan Laboratorium ]::", param);
                            } else {
                                Valid.MyReportPDFWithName("rptPeriksaLabTTE.jasper", "report", "tempfile", FileName,
                                        "::[ Pemeriksaan Laboratorium ]::", param);
                            }
                        } catch (Exception e) {
                            System.out.println("Notif : " + e);
                    ...
                    while (rs.next()) {
                        ...
                        try {
                            ...
                            if (rspermintaan.next()) {
                                ...
                                param.put("tanggalpermintaan", rspermintaan.getString("tgl_permintaan"));
                                param.put("jampermintaan", rspermintaan.getString("jam_permintaan"));
                                // Valid.MyReport("rptPeriksaLab9Permintaan.jasper", "report", "::[ Pemeriksaan
                                // Laboratorium ]::", param);
                                // Valid.MyReportPDFUpload("rptBridgingSEP.jasper", "report", "::[ Cetak SEP
                                // ]::", FileName, param);
                                Valid.MyReportPDFUpload("rptPeriksaLab9Permintaan.jasper", "report",
                                        "::[ Pemeriksaan Laboratorium ]::", FileName, param);
                            } else {
                                // Valid.MyReport("rptPeriksaLab9.jasper", "report", "::[ Pemeriksaan
                                // Laboratorium ]::", param);
                                // Valid.MyReportPDFUpload("rptBridgingSEP2.jasper", "report", "::[ Cetak SEP
                                // ]::", FileName, param);
    ...
    private void UploadPDF2(String FileName, String docpath) {
        try {
            ...
            byte[] data = FileUtils.readFileToByteArray(file);
            HttpClient httpClient = new DefaultHttpClient();
            HttpPost postRequest = new HttpPost("http://" + koneksiDB.HOSTWA() + ":" + koneksiDB.PORTWEBWA() + "/"
            ...
            if (response.getStatusLine().getStatusCode() == 200) {
                JOptionPane.showMessageDialog(null, "Pesan Berhasil di Antrikan di Wa Gateway!", "Sukses",
                        JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(null,
                        "Gagal mengupload file. Response code: " + response.getStatusLine().getStatusCode(),
            ...
            // TNoRm.setText(Sequel.cariIsi("select no_rkm_medis from reg_periksa where

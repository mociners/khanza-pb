...
public class DlgPasien extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        CmbKeluarga.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "AYAH", "IBU", "ISTRI", "SUAMI", "SAUDARA", "ANAK", "DIRI SENDIRI", "CUCU", "MENANTU", "TEMAN", "LAIN-LAIN" }));
    ...
    private void btnAmbilPhotoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAmbilPhotoActionPerformed
        ...
        if(NoRekamMedisDipilih.getText().equals("")||NamaPasienDipilih.getText().equals("")){
           JOptionPane.showMessageDialog(null,"Maaf, silahkan pilih data pasien terlebih dahulu...!!!!"); 
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            Sequel.menyimpan2("wajahpasien","?,'',''",1,new String[]{NoRekamMedisDipilih.getText()});
            Valid.panggilUrl("wajahpasien/login.php?act=login&usere="+koneksiDB.USERHYBRIDWEB()+"&passwordte="+koneksiDB.PASHYBRIDWEB()+"&norm="+NoRekamMedisDipilih.getText());
            this.setCursor(Cursor.getDefaultCursor()); 
        }   
        this.setCursor(Cursor.getDefaultCursor());

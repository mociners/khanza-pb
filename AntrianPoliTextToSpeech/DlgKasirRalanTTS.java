 ...
 * @author dosen
 */
public final class DlgKasirRalanTTS extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public DlgKasirRalanTTS(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        billing.dokter.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("DlgKasirRalanTTS")) {
    ...
    private void initComponents() {
        ...
        ppMasukPoli.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/bell.png"))); // NOI18N
        ...
        TglSakit1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "29-11-2023" }));
        ...
        TglSakit2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "29-11-2023" }));
        ...
        CrPoli.setPreferredSize(new java.awt.Dimension(255, 23));
...
private void BtnSeek3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSeek3ActionPerformed
    akses.setform("DlgKasirRalanTTS");
    pilihan = 2;
...
private void MnDataPemberianObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDataPemberianObatActionPerformed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgKasirRalanTTS dialog = new DlgKasirRalanTTS(new javax.swing.JFrame(), true);
    ...
    private widget.Button BtnKasir;
